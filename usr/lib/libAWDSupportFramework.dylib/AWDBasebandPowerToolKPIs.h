...
@interface AWDBasebandPowerToolKPIs : PBCodable <NSCopying> {
	...
	SCD_Struct_AW15* _armUtilityPDFs;
	SCD_Struct_AW15* _causeCodeBackgroundActivityARMUtilitys;
	SCD_Struct_AW15* _causeCodeBackgroundActivityDurations;
	SCD_Struct_AW15* _causeCodeCumulativeARMUtilitys;
	SCD_Struct_AW15* _causeCodeCumulativeDurations;
	SCD_Struct_AW15* _causeCodeMarginalCoverageARMUtilitys;
	SCD_Struct_AW15* _causeCodeMarginalCoverageDurations;
	SCD_Struct_AW15* _causeCodeOOSARMUtilitys;
	SCD_Struct_AW15* _causeCodeOOSDurations;
	SCD_Struct_AW15* _causeCodeRACHFailARMUtilitys;
	SCD_Struct_AW15* _causeCodeRACHFailDurations;
	SCD_Struct_AW15* _causeCodeStruckInDCHARMUtilitys;
	SCD_Struct_AW15* _causeCodeStruckInDCHDurations;
	SCD_Struct_AW15* _causeCodeTcXONotShuttingARMUtilitys;
	SCD_Struct_AW15* _causeCodeTcXONotShuttingDurations;
	SCD_Struct_AW15* _causeCodeUnknownARMUtilitys;
	SCD_Struct_AW15* _causeCodeUnknownDurations;
