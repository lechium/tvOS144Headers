...
- (void).cxx_destruct;	// IMP=0x000000010007dabc
...
- (_Bool)validateAfterStartWithAuditTokens:(id)arg1;	// IMP=0x000000010007d974
@property(readonly) _Bool isPerUser;
- (void)addUUIDs:(id)arg1;	// IMP=0x000000010007d6e0
- (void)setPluginPID:(int)arg1 uuids:(id)arg2;	// IMP=0x000000010007d658
- (_Bool)supportsMultipleInstancesOfExtension;	// IMP=0x000000010007d5e8
- (void)terminate;	// IMP=0x000000010007d554
- (void)disposeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007cf74
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007ca00
- (void)sendSetupCommandWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007c350
- (id)description;	// IMP=0x000000010007c348
- (_Bool)matchesAuditToken:(id)arg1 expectedCDHashes:(id)arg2 requiredEntitlement:(id)arg3;	// IMP=0x000000010007c340
- (id)initWithPluginType:(id)arg1 pluginVersion:(long long)arg2 pluginClass:(long long)arg3 pluginInfo:(id)arg4 userID:(id)arg5;	// IMP=0x000000010007c1e0
