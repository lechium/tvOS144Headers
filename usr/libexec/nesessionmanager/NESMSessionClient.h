...
- (void).cxx_destruct;	// IMP=0x000000010008e288
...
- (void)cancel;	// IMP=0x000000010008e244
- (void)sendStatusChangedNotification;	// IMP=0x000000010008e19c
- (id)description;	// IMP=0x000000010008e194
- (int)type;	// IMP=0x000000010008e18c
- (id)initWithPID:(int)arg1;	// IMP=0x000000010008e090
- (id)initWithConnection:(id)arg1;	// IMP=0x000000010008dee0
