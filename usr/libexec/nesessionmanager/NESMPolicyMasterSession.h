...
+ (_Bool)lock:(CDUnknownBlockType)arg1;	// IMP=0x000000010002a3f8
- (void).cxx_destruct;	// IMP=0x000000010002ad30
...
- (_Bool)unregisterSession:(id)arg1;	// IMP=0x000000010002ac64
- (_Bool)registerSession:(id)arg1;	// IMP=0x000000010002abe4
- (_Bool)apply;	// IMP=0x000000010002aae0
- (_Bool)removeAllPoliciesLow:(id)arg1;	// IMP=0x000000010002a94c
- (_Bool)removeAllPolicies:(id)arg1;	// IMP=0x000000010002a7b8
- (_Bool)addPolicyLow:(id)arg1 policyIDList:(id)arg2;	// IMP=0x000000010002a644
- (_Bool)addPolicy:(id)arg1 policyIDList:(id)arg2;	// IMP=0x000000010002a4d0
- (id)initPrivate;	// IMP=0x000000010002a2bc
- (id)init;	// IMP=0x000000010002a294
