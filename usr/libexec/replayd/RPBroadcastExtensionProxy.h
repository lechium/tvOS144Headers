...
- (void).cxx_destruct;	// IMP=0x000000010000c738
...
- (void)processPayload:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000c458
- (void)finishBroadcastWithError:(id)arg1;	// IMP=0x000000010000c35c
- (void)ping;	// IMP=0x000000010000c280
- (void)updateBroadcastURL:(id)arg1;	// IMP=0x000000010000c190
- (void)updateServiceInfo:(id)arg1;	// IMP=0x000000010000c0a0
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010000c07c
- (void)setupNewConnection:(id)arg1;	// IMP=0x000000010000bd78
- (void)invalidateConnection;	// IMP=0x000000010000bbe4
- (void)establishConnectionWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010000b6e8
- (id)initWithBroadcastUploadListenerEndpoint:(id)arg1;	// IMP=0x000000010000b58c
- (id)initWithBroadcastUploadExtension:(id)arg1;	// IMP=0x000000010000b3c8
