...
+ (struct AudioStreamBasicDescription)audioStreamBasicDescriptionWithStereo:(_Bool)arg1;	// IMP=0x00000001000285d4
- (void).cxx_destruct;	// IMP=0x00000001000295b8
- (void)stop;	// IMP=0x00000001000291f0
- (void)resumeWithProcessID:(int)arg1;	// IMP=0x00000001000290cc
- (void)startWithProcessID:(int)arg1 outputHandler:(CDUnknownBlockType)arg2 didStartHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100028780
- (_Bool)handleStartAudioQueueFailed:(int)arg1 didFailHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000286c8
- (id)init;	// IMP=0x0000000100028620
