...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100005da0
- (void)flushBuffer;	// IMP=0x0000000100005c68
- (unsigned long long)getTotalNumberOfSamples;	// IMP=0x0000000100005c58
- (id)getSamplesForSeconds:(double)arg1;	// IMP=0x0000000100005940
- (const struct opaqueCMFormatDescription *)getFormatDescription;	// IMP=0x00000001000058d8
- (void)addFrameToBuffer:(struct opaqueCMSampleBuffer *)arg1 isKeyFrame:(_Bool)arg2;	// IMP=0x00000001000055c0
- (id)init;	// IMP=0x0000000100005544
