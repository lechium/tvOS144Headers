...
- (void).cxx_destruct;	// IMP=0x0000000100007230
...
- (void)resetHomeKitUserIdentifiers;	// IMP=0x00000001000071a4
- (id)filterHomeKitUserIdentifiers:(id)arg1;	// IMP=0x0000000100006d40
- (id)homeKitUserIdentifiers;	// IMP=0x0000000100006acc
- (void)invalidate;	// IMP=0x0000000100006a18
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000100006940
