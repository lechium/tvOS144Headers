...
- (void).cxx_destruct;	// IMP=0x00000001000195ec
...
- (id)description;	// IMP=0x0000000100019554
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x00000001000194b8
