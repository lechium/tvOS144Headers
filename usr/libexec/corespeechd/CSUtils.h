...
+ (struct AudioStreamBasicDescription)aiffFileASBD;	// IMP=0x0000000100035810
+ (struct AudioStreamBasicDescription)utteranceFileASBD;	// IMP=0x0000000100035754
+ (struct AudioStreamBasicDescription)lpcmNarrowBandASBD;	// IMP=0x00000001000356c0
+ (struct AudioStreamBasicDescription)lpcmASBD;	// IMP=0x000000010003562c
+ (struct AudioStreamBasicDescription)lpcmNonInterleavedASBDWithSampleRate:(float)arg1 numberOfChannels:(unsigned int)arg2;	// IMP=0x0000000100035558
+ (struct AudioStreamBasicDescription)lpcmMonoNonInterleavedWithRemoteVADASBD;	// IMP=0x000000010003550c
+ (struct AudioStreamBasicDescription)lpcmNonInterleavedWithRemoteVADASBD;	// IMP=0x0000000100035498
+ (struct AudioStreamBasicDescription)lpcmNonInterleavedASBD;	// IMP=0x0000000100035424
+ (struct AudioStreamBasicDescription)lpcmInterleavedASBDWithSampleRate:(float)arg1 numberOfChannels:(unsigned int)arg2;	// IMP=0x0000000100035350
+ (struct AudioStreamBasicDescription)lpcmMonoInterleavedWithRemoteVADASBD;	// IMP=0x0000000100035304
+ (struct AudioStreamBasicDescription)lpcmInterleavedWithRemoteVADASBD;	// IMP=0x0000000100035290
+ (struct AudioStreamBasicDescription)lpcmInterleavedASBD;	// IMP=0x000000010003521c
+ (struct AudioStreamBasicDescription)speexASBD;	// IMP=0x00000001000351e4
+ (struct AudioStreamBasicDescription)opusNarrowBandASBD;	// IMP=0x000000010003518c
+ (struct AudioStreamBasicDescription)opusASBD;	// IMP=0x0000000100035134
+ (struct AudioStreamBasicDescription)lpcmFloatASBD;	// IMP=0x00000001000350a0
+ (struct AudioStreamBasicDescription)lpcmInt16NarrowBandASBD;	// IMP=0x0000000100035040
+ (struct AudioStreamBasicDescription)lpcmInt16ASBD;	// IMP=0x0000000100034fe0
+ (id)_contentsOfDirectoryAtURL:(id)arg1 matchingPattern:(id)arg2 includingPropertiesForKeys:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000493c8
+ (void)_sortedURLsInDirectory:(id)arg1 matchingPattern:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100048fe8
+ (void)URLsInDirectory:(id)arg1 matchingPattern:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100048ef0
+ (void)clearLogFilesInDirectory:(id)arg1 matchingPattern:(id)arg2 exceedNumber:(unsigned long long)arg3;	// IMP=0x0000000100048a28
+ (void)removeLogFilesInDirectory:(id)arg1 matchingPattern:(id)arg2 beforeDays:(float)arg3;	// IMP=0x00000001000483d8
+ (id)_sharedDisposeLoggingQueue;	// IMP=0x0000000100048320
+ (_Bool)hasRemoteBuiltInMic;	// IMP=0x000000010005f498
+ (void)getTrialIdsForAssetType:(unsigned long long)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000010005f57c
+ (unsigned long long)getAssetTypeForNamespace:(id)arg1;	// IMP=0x000000010005f4a0
+ (id)recordContextString:(id)arg1;	// IMP=0x0000000100064cd0
+ (_Bool)isRecordContextJarvisButtonPress:(id)arg1;	// IMP=0x0000000100064c58
+ (_Bool)isRecordContextJarvisVoiceTrigger:(id)arg1;	// IMP=0x0000000100064be0
+ (_Bool)isRecordContextRaiseToSpeak:(id)arg1;	// IMP=0x0000000100064b68
+ (_Bool)isRecordContextHearstDoubleTap:(id)arg1;	// IMP=0x0000000100064af0
+ (_Bool)isRecordContextHearstVoiceTrigger:(id)arg1;	// IMP=0x0000000100064a78
+ (_Bool)isRecordContextSpeakerIdTrainingTrigger:(id)arg1;	// IMP=0x0000000100064a00
+ (_Bool)isRecordContextAutoPrompt:(id)arg1;	// IMP=0x0000000100064988
+ (_Bool)isRecordContextHomeButtonPress:(id)arg1;	// IMP=0x0000000100064910
+ (_Bool)isRecordContextVoiceTrigger:(id)arg1;	// IMP=0x0000000100064898
