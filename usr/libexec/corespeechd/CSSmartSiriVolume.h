...
- (float)estimatedTTSVolumeForNoiseLevelAndLKFS:(float)arg1 LKFS:(float)arg2;	// IMP=0x000000010006bf60
- (void)didDetectKeywordWithResult:(id)arg1;	// IMP=0x000000010006bb64
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x000000010006bb60
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x000000010006b9c4
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x000000010006b718
- (void)reset;	// IMP=0x000000010006b678
- (void)_resumeSSVProcessing;	// IMP=0x000000010006b554
- (void)_pauseSSVProcessing;	// IMP=0x000000010006b434
- (float)estimateSoundLevelbySoundType:(long long)arg1;	// IMP=0x000000010006b218
- (void)_processAudioChunk:(id)arg1 soundType:(long long)arg2;	// IMP=0x000000010006af40
- (void)prepareSoundLevelBufferFromSamples:(id)arg1 soundType:(long long)arg2 firedVoiceTriggerEvent:(_Bool)arg3 triggerStartTimeSampleOffset:(unsigned long long)arg4 triggerEndTimeSampleOffset:(unsigned long long)arg5;	// IMP=0x000000010006ad64
- (void)_prepareSoundLevelBufferFromSamples:(unsigned int)arg1 soundType:(long long)arg2;	// IMP=0x000000010006acdc
- (void)_reset;	// IMP=0x000000010006ac4c
- (void)_setAsset:(id)arg1;	// IMP=0x000000010006a8c4
- (void)setAsset:(id)arg1;	// IMP=0x000000010006a82c
- (void)fetchInitSystemVolumes;	// IMP=0x000000010006a738
- (void)initializeTimerState;	// IMP=0x000000010006a584
- (void)initializeAlarmState;	// IMP=0x000000010006a3d0
- (void)initializeMediaPlayingState;	// IMP=0x000000010006a170
- (void)_stopListening;	// IMP=0x0000000100069f48
- (void)_startListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010006985c
- (void)_startListenPollingWithInterval:(double)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000693ec
- (void)_startListenPolling;	// IMP=0x00000001000692dc
- (void)startSmartSiriVolume;	// IMP=0x0000000100068efc
- (id)initWithSamplingRate:(float)arg1 asset:(id)arg2;	// IMP=0x0000000100068ad4
