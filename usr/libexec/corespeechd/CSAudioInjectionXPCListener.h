...
- (void).cxx_destruct;	// IMP=0x0000000100039838
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000396fc
- (void)listen;	// IMP=0x00000001000395bc
