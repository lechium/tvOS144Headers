...
- (void).cxx_destruct;	// IMP=0x000000010004b9d8
...
- (void)siriClientBehaviorMonitor:(id)arg1 willStopStream:(id)arg2;	// IMP=0x000000010004b770
- (void)siriClientBehaviorMonitor:(id)arg1 willStartStreamWithContext:(id)arg2 option:(id)arg3;	// IMP=0x000000010004b76c
- (void)siriClientBehaviorMonitor:(id)arg1 didStopStream:(id)arg2 withEventUUID:(id)arg3;	// IMP=0x000000010004b654
- (void)siriClientBehaviorMonitor:(id)arg1 didStartStreamWithContext:(id)arg2 successfully:(_Bool)arg3 option:(id)arg4 withEventUUID:(id)arg5;	// IMP=0x000000010004b4ac
- (void)opportuneSpeakEventMonitor:(id)arg1 didStreamStateChanged:(_Bool)arg2;	// IMP=0x000000010004b398
- (void)CSVoiceTriggerEnabledMonitor:(id)arg1 didReceiveEnabled:(_Bool)arg2;	// IMP=0x000000010004b30c
- (void)_transitHearstAPEnable:(_Bool)arg1;	// IMP=0x000000010004b2d4
- (_Bool)_shouldHearstAPModeEnabled;	// IMP=0x000000010004b234
- (void)_teardownSecondPass;	// IMP=0x000000010004b1f4
- (void)_createSecondPass;	// IMP=0x000000010004b0fc
- (void)_cancelLastAudioStreamHold;	// IMP=0x000000010004b050
- (void)_addAudioStreamHold:(id)arg1;	// IMP=0x000000010004affc
- (void)_handleSecondPassResult:(unsigned long long)arg1 voiceTriggerInfo:(id)arg2 deviceId:(id)arg3 secondChanceCandidate:(_Bool)arg4 error:(id)arg5;	// IMP=0x000000010004ad30
- (void)keywordAnalyzerNDAPI:(id)arg1 hasResultAvailable:(id)arg2 forChannel:(unsigned long long)arg3;	// IMP=0x000000010004a6bc
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x000000010004a6b8
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x000000010004a470
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x000000010004a3d0
- (void)_stopListening;	// IMP=0x000000010004a168
- (void)_startListenWithAudioProviderUUID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100049980
- (void)_reset;	// IMP=0x0000000100049970
- (void)_setAsset:(id)arg1;	// IMP=0x0000000100049894
- (void)setAsset:(id)arg1;	// IMP=0x00000001000497fc
- (void)start;	// IMP=0x000000010004970c
- (id)init;	// IMP=0x0000000100049664
