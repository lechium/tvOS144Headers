...
+ (id)sharedMonitor;	// IMP=0x0000000100026768
- (void).cxx_destruct;	// IMP=0x00000001000269c4
@property(nonatomic) __weak id <CSVoiceTriggerAssetChangeDelegate> delegate; // @synthesize delegate=_delegate;
- (void)notifyVoiceTriggerAssetChanged;	// IMP=0x0000000100026994
- (void)startMonitoring;	// IMP=0x0000000100026844
- (id)init;	// IMP=0x00000001000267d4
