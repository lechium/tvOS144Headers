...
+ (void)dumpEARSpeechRecognitionResults:(id)arg1;	// IMP=0x00000001000043e0
- (void).cxx_destruct;	// IMP=0x0000000100004b5c
...
- (double)_getConfidence:(id)arg1;	// IMP=0x00000001000048c0
- (void)_calculateTriggerConfidence:(id)arg1;	// IMP=0x00000001000046d4
@property(readonly, nonatomic) NSDictionary *phraseIdScores;
- (void)processAudioChunk:(id)arg1;	// IMP=0x0000000100003d68
- (void)flushAudio;	// IMP=0x0000000100003bf0
- (void)resetWithLanguage:(id)arg1 withFarField:(unsigned char)arg2 withAudioSource:(id)arg3;	// IMP=0x0000000100003a5c
- (id)initWithConfigPath:(id)arg1 triggerTokens:(id)arg2 useKeywordSpotting:(_Bool)arg3;	// IMP=0x00000001000036a4
