...
+ (id)createSmartSiriVolumeListener;	// IMP=0x000000010005ff14
- (void).cxx_destruct;	// IMP=0x00000001000c2ae0
...
- (void)resumeConnection;	// IMP=0x00000001000c2a38
- (void)notifyClientsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001000c26c4
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000c1bac
- (void)dealloc;	// IMP=0x00000001000c1ad0
- (id)initWithMachService:(id)arg1 withServiceInterface:(id)arg2 withServiceObject:(id)arg3 withDelegateInterface:(id)arg4;	// IMP=0x00000001000c1828
