...
- (void).cxx_destruct;	// IMP=0x000000010001fbd8
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010001f83c
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x000000010001f5fc
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010001f054
- (long long)versionFromTask:(id)arg1;	// IMP=0x000000010001eff8
- (void)updateDb:(unsigned long long)arg1;	// IMP=0x000000010001ee2c
- (void)reschedule;	// IMP=0x000000010001ec40
