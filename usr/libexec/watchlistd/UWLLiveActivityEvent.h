...
- (void).cxx_destruct;	// IMP=0x0000000100006168
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100005ef8
- (unsigned long long)hash;	// IMP=0x0000000100005db0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100005ba8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000059dc
- (void)copyTo:(id)arg1;	// IMP=0x000000010000585c
- (void)writeTo:(id)arg1;	// IMP=0x0000000100005700
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000056f8
- (id)dictionaryRepresentation;	// IMP=0x0000000100004d90
- (id)description;	// IMP=0x0000000100004cdc
- (int)StringAsContractOrTimed:(id)arg1;	// IMP=0x0000000100004c3c
- (id)contractOrTimedAsString:(int)arg1;	// IMP=0x0000000100004bc4
...
- (int)StringAsCause:(id)arg1;	// IMP=0x00000001000049c8
- (id)causeAsString:(int)arg1;	// IMP=0x0000000100004938
