...
+ (Class)cookiesType;	// IMP=0x000000010001da0c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010001e88c
- (unsigned long long)hash;	// IMP=0x000000010001e7b8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010001e608
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010001e3a0
- (void)copyTo:(id)arg1;	// IMP=0x000000010001e21c
- (void)writeTo:(id)arg1;	// IMP=0x000000010001e058
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010001e050
- (id)dictionaryRepresentation;	// IMP=0x000000010001dacc
- (id)description;	// IMP=0x000000010001da18
- (id)cookiesAtIndex:(unsigned long long)arg1;	// IMP=0x000000010001d9f4
- (unsigned long long)cookiesCount;	// IMP=0x000000010001d9dc
- (void)addCookies:(id)arg1;	// IMP=0x000000010001d968
- (void)clearCookies;	// IMP=0x000000010001d950
