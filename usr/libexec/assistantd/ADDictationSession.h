...
- (void).cxx_destruct;	// IMP=0x00000001000bfef8
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00000001000bfb98
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00000001000bf878
- (void)dealloc;	// IMP=0x00000001000bf58c
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00000001000bf460
- (id)init;	// IMP=0x00000001000bf448
