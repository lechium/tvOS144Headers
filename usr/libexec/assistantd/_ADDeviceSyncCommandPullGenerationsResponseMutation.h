...
- (void).cxx_destruct;	// IMP=0x00000001002b0e80
- (id)generate;	// IMP=0x00000001002b0dcc
- (void)setGenerationsByDataType:(id)arg1;	// IMP=0x00000001002b0d98
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001002b0d20
- (id)init;	// IMP=0x00000001002b0d10
