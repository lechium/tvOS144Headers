...
- (void).cxx_destruct;	// IMP=0x00000001001e162c
...
- (id)analyticsDictionary;	// IMP=0x00000001001e1334
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x00000001001e1328
- (void)markSucceeded;	// IMP=0x00000001001e131c
- (void)markEndTime;	// IMP=0x00000001001e12d8
- (void)markStartTime;	// IMP=0x00000001001e1294
- (_Bool)hasFailureType;	// IMP=0x00000001001e1284
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x00000001001e11f8
