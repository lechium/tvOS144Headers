...
- (void).cxx_destruct;	// IMP=0x0000000100189524
- (id)generate;	// IMP=0x0000000100189470
- (void)setGenerationsByDataType:(id)arg1;	// IMP=0x000000010018943c
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001001893c4
- (id)init;	// IMP=0x00000001001893b4
