...
- (void).cxx_destruct;	// IMP=0x000000010012652c
...
- (void)reset;	// IMP=0x0000000100126198
...
- (id)initWithZone:(id)arg1 dataStore:(id)arg2 subscriptionNames:(id)arg3;	// IMP=0x0000000100125f68
- (id)initWithZoneName:(id)arg1 subscriptionNames:(id)arg2;	// IMP=0x0000000100125e8c
- (id)initWithZoneName:(id)arg1 subscriptionName:(id)arg2;	// IMP=0x0000000100125da8
