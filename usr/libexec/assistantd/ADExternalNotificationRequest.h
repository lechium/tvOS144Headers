...
- (void).cxx_destruct;	// IMP=0x0000000100050740
...
- (void)dealloc;	// IMP=0x000000010005064c
- (void)completeNotificationWithSuccess:(_Bool)arg1;	// IMP=0x0000000100050608
- (id)initWithNotification:(id)arg1 appID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010005050c
