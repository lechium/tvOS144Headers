...
- (void).cxx_destruct;	// IMP=0x000000010005035c
- (id)generate;	// IMP=0x000000010005005c
- (void)setCommandPullSnapshotResponse:(id)arg1;	// IMP=0x0000000100050024
- (void)setCommandPullSnapshotRequest:(id)arg1;	// IMP=0x000000010004ffec
- (void)setCommandPullDeltaResponse:(id)arg1;	// IMP=0x000000010004ffb8
- (void)setCommandPullDeltaRequest:(id)arg1;	// IMP=0x000000010004ff80
- (void)setCommandPullGenerationsResponse:(id)arg1;	// IMP=0x000000010004ff48
- (void)setCommandPullGenerationsRequest:(id)arg1;	// IMP=0x000000010004ff10
- (void)setCommandPushGenerationsResponse:(id)arg1;	// IMP=0x000000010004fed8
- (void)setCommandPushGenerationsRequest:(id)arg1;	// IMP=0x000000010004fea0
- (void)setType:(long long)arg1;	// IMP=0x000000010004fe88
- (void)setSequence:(unsigned long long)arg1;	// IMP=0x000000010004fe74
- (id)initWithBaseModel:(id)arg1;	// IMP=0x000000010004fdfc
- (id)init;	// IMP=0x000000010004fdec
