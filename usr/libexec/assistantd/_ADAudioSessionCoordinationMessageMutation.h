...
- (void).cxx_destruct;	// IMP=0x00000001002a5dd8
- (id)generate;	// IMP=0x00000001002a5b60
- (void)setPayloadEndAudioSessionResponse:(id)arg1;	// IMP=0x00000001002a5b2c
- (void)setPayloadEndAudioSessionRequest:(id)arg1;	// IMP=0x00000001002a5af4
- (void)setPayloadKeepAudioSessionAliveResponse:(id)arg1;	// IMP=0x00000001002a5abc
- (void)setPayloadKeepAudioSessionAliveRequest:(id)arg1;	// IMP=0x00000001002a5a84
- (void)setPayloadBeginAudioSessionResponse:(id)arg1;	// IMP=0x00000001002a5a4c
- (void)setPayloadBeginAudioSessionRequest:(id)arg1;	// IMP=0x00000001002a5a14
- (void)setType:(long long)arg1;	// IMP=0x00000001002a59fc
- (void)setHostTime:(unsigned long long)arg1;	// IMP=0x00000001002a59e8
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001002a5970
- (id)init;	// IMP=0x00000001002a5960
