...
- (void).cxx_destruct;	// IMP=0x00000001000dcb14
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000dca94
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000dca90
- (void)setDuration:(double)arg1;	// IMP=0x00000001000dca0c
- (void)setState:(unsigned long long)arg1;	// IMP=0x00000001000dc9e8
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) long long type;
- (id)initWithTimerID:(id)arg1 state:(unsigned long long)arg2 duration:(double)arg3 remainingTime:(double)arg4 lastModifiedDate:(id)arg5 title:(id)arg6 siriContext:(id)arg7;	// IMP=0x00000001000dc784
