...
@interface ADBackgroundContextCache : NSObject
{
    ...
    SARemotePlaybackDeviceList *_playbackDeviceList;	// 96 = 0x60
    SAHomeCommunicationAnnouncement *_homeAnnouncement;	// 104 = 0x68
}

+ (id)_backgroundContextWithObjects:(id)arg1;	// IMP=0x00000001001b2818
- (void).cxx_destruct;	// IMP=0x00000001001b31e0
...
- (id)backgroundContextWithCachedObjects;	// IMP=0x00000001001b2a98
- (void)_updateDefaultTokenInDynamiteClientState:(id)arg1;	// IMP=0x00000001001b294c
- (void)_setDefaultToken:(id)arg1 inDynamiteClientState:(id)arg2;	// IMP=0x00000001001b2880
