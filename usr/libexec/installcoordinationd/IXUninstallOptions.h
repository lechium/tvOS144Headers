...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100008f90
...
- (id)description;	// IMP=0x00000001000094e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000091a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000090f4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000903c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100008f98
