...
- (oneway void)_remote_setTryDeltaCopy:(_Bool)arg1;	// IMP=0x0000000100027cb8
- (oneway void)_remote_setShouldCopy:(_Bool)arg1;	// IMP=0x0000000100027b9c
- (oneway void)_remote_setTransferPath:(id)arg1;	// IMP=0x0000000100027a58
