...
- (unsigned long long)bytesConsumedOnDisk;	// IMP=0x000000010001e90c
- (unsigned long long)totalBytesForProgress;	// IMP=0x000000010001e894
- (void)reset;	// IMP=0x000000010001e7fc
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x000000010001e384
- (oneway void)_remote_setArchiveBytesConsumed:(unsigned long long)arg1;	// IMP=0x000000010001e9bc
