...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000481f8
- (void).cxx_destruct;	// IMP=0x0000000100048704
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100048580
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000483c0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100048200
