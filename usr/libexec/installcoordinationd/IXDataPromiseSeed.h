...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000313f4
- (void).cxx_destruct;	// IMP=0x000000010003154c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000313fc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100031288
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010003110c
