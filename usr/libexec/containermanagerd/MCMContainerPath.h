...
+ (id)_posixOwnerForContainerSubdirectories:(unsigned long long)arg1 user:(id)arg2;	// IMP=0x0000000100089788
+ (Class)_containerClassPathClass;	// IMP=0x000000010008977c
+ (id)containerPathFromURL:(id)arg1 containerClassPath:(id)arg2 relativePath:(id *)arg3;	// IMP=0x0000000100089520
+ (id)containerPathIdentifierForCodeSignIdentifier:(id)arg1 containerClass:(unsigned long long)arg2;	// IMP=0x00000001000893c0
+ (id)containerPathForContainerClassPath:(id)arg1 containerPathIdentifier:(id)arg2;	// IMP=0x0000000100089288
+ (id)containerPathForUserIdentity:(id)arg1 containerClass:(unsigned long long)arg2 containerPathIdentifier:(id)arg3;	// IMP=0x0000000100089194
+ (id)containerPathForContainerIdentity:(id)arg1 containerPathIdentifier:(id)arg2;	// IMP=0x00000001000890d4
- (void).cxx_destruct;	// IMP=0x0000000100088dfc
...
- (_Bool)_createURLIfNecessary:(id)arg1 mode:(unsigned short)arg2 owner:(id)arg3 dataProtectionClass:(int)arg4 error:(id *)arg5;	// IMP=0x0000000100088c10
- (_Bool)_obj1:(id)arg1 isEqualToObj2:(id)arg2;	// IMP=0x0000000100088bac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100088af0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100088a78
- (_Bool)isEqualToContainerPath:(id)arg1;	// IMP=0x00000001000889e4
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithContainerClassPath:(id)arg1 containerPathIdentifier:(id)arg2 containerRootComponent:(id)arg3 containerDataComponent:(id)arg4;	// IMP=0x0000000100088638
@property(readonly, nonatomic) NSURL *classURL;
@property(readonly, nonatomic) NSURL *categoryURL;
@property(readonly, nonatomic) NSURL *baseURL;
- (_Bool)createDataURLIfNecessaryWithDataProtectionClass:(int)arg1 error:(id *)arg2;	// IMP=0x00000001000883d4
- (_Bool)createIfNecessaryWithDataProtectionClass:(int)arg1 error:(id *)arg2;	// IMP=0x0000000100088238
