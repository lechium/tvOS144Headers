...
+ (id)stagingContainerPathForDestinationContainerPath:(id)arg1 stagingPathIdentifier:(id)arg2;	// IMP=0x0000000100089950
+ (Class)_containerClassPathClass;	// IMP=0x0000000100089944
- (void).cxx_destruct;	// IMP=0x0000000100089930
