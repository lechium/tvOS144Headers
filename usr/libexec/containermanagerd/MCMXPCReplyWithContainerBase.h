...
- (void).cxx_destruct;	// IMP=0x000000010002c680
...
- (void)dealloc;	// IMP=0x000000010002c5f0
- (id)initWithMetadata:(id)arg1 sandboxToken:(const char *)arg2;	// IMP=0x000000010002c420
- (id)initWithUUID:(id)arg1 existed:(_Bool)arg2 url:(id)arg3 containerPathIdentifier:(id)arg4 identifier:(id)arg5 containerClass:(unsigned long long)arg6 personaUniqueString:(id)arg7 sandboxToken:(const char *)arg8;	// IMP=0x000000010002c2d4
- (_Bool)encodeReplyOntoXPCObject:(id)arg1;	// IMP=0x000000010002c054
