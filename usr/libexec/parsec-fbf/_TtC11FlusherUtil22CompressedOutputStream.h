...
- (void).cxx_destruct;	// IMP=0x000000010002cf80
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x000000010002d13c
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x000000010002d090
- (id)initToMemory;	// IMP=0x000000010002d020
- (void)close;	// IMP=0x000000010002cf28
- (void)open;	// IMP=0x000000010002cc2c
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x000000010002c9b0
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x000000010002c4c0
- (id)init;	// IMP=0x000000010002c1ec
