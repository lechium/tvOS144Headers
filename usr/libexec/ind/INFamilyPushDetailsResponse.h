...
- (void).cxx_destruct;	// IMP=0x000000010000e200
- (_Bool)_booleanValueOfObject:(id)arg1;	// IMP=0x000000010000e17c
- (id)description;	// IMP=0x000000010000e0dc
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x000000010000dd0c
