...
- (void)schedule;	// IMP=0x00000001000040e4
- (void)invalidate;	// IMP=0x0000000100004068
- (void)checkIn;	// IMP=0x0000000100003e4c
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000100003d7c
