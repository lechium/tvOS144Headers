...
- (void).cxx_destruct;	// IMP=0x0000000100007904
...
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleDialogRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100007700
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleAuthenticateRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010000720c
- (id)_handleDialogRequest:(id)arg1;	// IMP=0x0000000100006d98
- (void)_sendMetricsForUpdate;	// IMP=0x0000000100006d94
- (void)_sendMetricsForDialog;	// IMP=0x0000000100006d90
- (long long)_runUpdateRequestWithStyle:(unsigned long long)arg1 primaryCerts:(id)arg2 extendedCerts:(id)arg3 error:(id *)arg4;	// IMP=0x0000000100006688
- (_Bool)_runConfirmationDialogWithError:(id *)arg1;	// IMP=0x0000000100005ff8
- (void)_releaseLock;	// IMP=0x0000000100005fe8
- (_Bool)_takeLockWithError:(id *)arg1;	// IMP=0x0000000100005f0c
- (id)performUpdate;	// IMP=0x0000000100004d84
- (id)initWithAccount:(id)arg1;	// IMP=0x0000000100004d04
