...
+ (id)entityFromContext:(id)arg1;	// IMP=0x000000010006b210
- (void)_assignToContact:(id)arg1 inContactStore:(id)arg2 withSoundIdentifier:(id)arg3;	// IMP=0x000000010006b644
- (void)_assignToPersonWithID:(int)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010006b5d4
- (void)_assignToContactWithID:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010006b4cc
- (void)loadFromPurchase:(id)arg1;	// IMP=0x000000010006b388
- (void)applyUserActionWithToneIdentifier:(id)arg1;	// IMP=0x000000010006b258
