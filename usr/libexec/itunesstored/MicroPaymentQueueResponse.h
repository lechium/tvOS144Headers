...
- (_Bool)_ntsLoadFromPropertyList:(id)arg1;	// IMP=0x0000000100048bfc
- (id)_dsidFromDictionary:(id)arg1;	// IMP=0x0000000100048b4c
- (id)_copyPaymentsFromDictionary:(id)arg1;	// IMP=0x0000000100048940
- (id)_copyAppReceiptFromDictionary:(id)arg1;	// IMP=0x00000001000488dc
@property(copy) NSNumber *userIdentifier;
@property _Bool shouldTriggerQueueCheck;
- (void)setRangesToLoad:(id)arg1;	// IMP=0x0000000100048748
...
- (_Bool)loadFromPropertyList:(id)arg1;	// IMP=0x00000001000484c4
- (void)appendResponse:(id)arg1;	// IMP=0x00000001000481a0
- (void)dealloc;	// IMP=0x0000000100048138
- (id)initWithRequestType:(long long)arg1;	// IMP=0x00000001000480f0
