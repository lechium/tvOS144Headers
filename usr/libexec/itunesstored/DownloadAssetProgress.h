...
- (void).cxx_destruct;	// IMP=0x00000001001e6d60
...
- (id)_newProgressForMediaSelection:(id)arg1;	// IMP=0x00000001001e6c10
- (void)setMediaSelectionDidComplete:(id)arg1;	// IMP=0x00000001001e6c00
- (void)setProgress:(double)arg1 forMediaSelection:(id)arg2;	// IMP=0x00000001001e6a54
@property(readonly, nonatomic) double progress;
- (id)init;	// IMP=0x00000001001e69d0
