...
- (void).cxx_destruct;	// IMP=0x00000001001e55e8
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00000001001e54e4
- (id)description;	// IMP=0x00000001001e53c4
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x00000001001e529c
