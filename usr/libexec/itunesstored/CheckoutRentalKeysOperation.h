...
- (void)_showErrorDialogForOutput:(id)arg1;	// IMP=0x000000010002a6ec
- (void)_run;	// IMP=0x000000010002a178
- (id)_primarySINF;	// IMP=0x000000010002a124
- (_Bool)_performCheckout:(id *)arg1;	// IMP=0x0000000100029cfc
- (_Bool)_haveValidRentalInformation;	// IMP=0x0000000100029730
- (_Bool)_handleResponse:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000291a0
- (id)_copyRentalIdentifier;	// IMP=0x000000010002910c
- (id)_copyAccountIdentifier;	// IMP=0x0000000100029078
- (id)_bodyData;	// IMP=0x00000001000286a0
- (void)run;	// IMP=0x0000000100028694
...
- (void)dealloc;	// IMP=0x00000001000283c4
- (id)initWithStoreDownloadSinfs:(id)arg1;	// IMP=0x000000010002821c
- (id)initWithAccountIdentifier:(id)arg1 rentalKeyIdentifier:(id)arg2;	// IMP=0x0000000100028104
- (id)initWithSinfs:(id)arg1;	// IMP=0x0000000100028028
- (id)init;	// IMP=0x0000000100028018
