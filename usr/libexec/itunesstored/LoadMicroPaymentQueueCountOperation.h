...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100089334
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x0000000100089040
- (void)run;	// IMP=0x0000000100088d70
- (void)dealloc;	// IMP=0x0000000100088d00
