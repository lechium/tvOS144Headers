...
- (void)addRefreshed:(id)arg1;	// IMP=0x000000010011cf48
- (void)addRevoked:(id)arg1;	// IMP=0x000000010011ceec
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010011ce00
- (void)dealloc;	// IMP=0x000000010011cd90
