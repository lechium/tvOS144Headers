...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0000000100015d8c
- (void).cxx_destruct;	// IMP=0x0000000100016308
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100016144
- (id)copyXPCEncoding;	// IMP=0x0000000100016070
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000100015e2c
