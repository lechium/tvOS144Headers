...
- (void).cxx_destruct;	// IMP=0x00000001001e1e74
@property(nonatomic) __weak id <MediaSocialStatusPollingDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_finishRequests:(id)arg1 withResponses:(id)arg2;	// IMP=0x00000001001e18c0
- (void)_addBackgroundTaskJob;	// IMP=0x00000001001e15e8
- (void)_handleBackgroundTaskEvent:(id)arg1;	// IMP=0x00000001001e0fe8
@property(readonly, nonatomic) long long numberOfPollRequests;
- (void)addPollRequest:(id)arg1;	// IMP=0x00000001001e0ee4
- (void)dealloc;	// IMP=0x00000001001e0e64
- (id)initWithDispatchQueue:(id)arg1;	// IMP=0x00000001001e0c5c
