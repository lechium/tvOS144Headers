...
- (void)_setResponse:(id)arg1;	// IMP=0x0000000100094fc4
- (_Bool)_runAuthorizationWithAuthentication:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0000000100094a5c
- (_Bool)_runAuthentication:(id *)arg1;	// IMP=0x0000000100094858
- (void)_run;	// IMP=0x00000001000943bc
- (id)_newURLOperation;	// IMP=0x00000001000940dc
- (id)_newMachineDataOperationWithResponse:(id)arg1;	// IMP=0x0000000100094014
- (id)_newBodyDictionary;	// IMP=0x0000000100093b04
- (id)_newAuthenticationContext;	// IMP=0x00000001000939bc
- (_Bool)_handleResponse:(id)arg1 error:(id *)arg2;	// IMP=0x000000010009373c
- (id)_accountIdentifier;	// IMP=0x00000001000936e8
- (void)run;	// IMP=0x00000001000936dc
...
- (void)dealloc;	// IMP=0x0000000100092ecc
- (id)initWithAuthorizationRequest:(id)arg1;	// IMP=0x0000000100092da8
