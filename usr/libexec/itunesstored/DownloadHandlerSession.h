...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001948ec
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100194878
- (unsigned long long)hash;	// IMP=0x0000000100194870
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x000000010019484c
@property(copy, nonatomic) NSString *statusDescription;
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x00000001001947e4
@property(nonatomic) long long sessionState;
- (void)setSessionPropertyValues:(id)arg1;	// IMP=0x0000000100194708
...
- (void)dealloc;	// IMP=0x0000000100194498
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x0000000100194450
- (id)init;	// IMP=0x00000001001943a8
