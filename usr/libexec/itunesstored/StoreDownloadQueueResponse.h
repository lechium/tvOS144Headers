...
- (void).cxx_destruct;	// IMP=0x0000000100015240
...
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2;	// IMP=0x0000000100015138
...
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x0000000100014e30
@property(readonly) NSOrderedSet *downloads;
- (id)initWithError:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0000000100014c34
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2 preferredAssetFlavor:(id)arg3;	// IMP=0x0000000100013f34
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0000000100013ed4
- (id)init;	// IMP=0x0000000100013ec8
- (id)_initStoreDownloadQueueResponse;	// IMP=0x0000000100013e60
- (id)_newManifestWithStoreDownloadQueueResponse:(id)arg1 accountID:(id)arg2 accountName:(id)arg3;	// IMP=0x0000000100174948
- (void)enumerateActivitiesWithAccountID:(id)arg1 accountName:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000100174224
- (id)copyJobManifestWithAccountID:(id)arg1 accountName:(id)arg2;	// IMP=0x000000010017418c
