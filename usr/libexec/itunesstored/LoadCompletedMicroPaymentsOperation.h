...
- (void).cxx_destruct;	// IMP=0x000000010006abe4
- (void)_runForIdentity:(id)arg1;	// IMP=0x000000010006a278
- (id)_newFetchOperationForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3;	// IMP=0x0000000100069cc4
- (id)_copyResponseForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3 returningError:(id *)arg4;	// IMP=0x0000000100069a30
- (void)run;	// IMP=0x000000010006967c
