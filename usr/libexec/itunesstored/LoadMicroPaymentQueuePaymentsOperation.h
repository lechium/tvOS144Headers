...
- (_Bool)_parsePropertyList:(id)arg1 error:(id *)arg2;	// IMP=0x000000010008bb7c
- (_Bool)_loadResponseReturningError:(id *)arg1;	// IMP=0x000000010008b888
- (_Bool)_appendRangeRequestsToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x000000010008b64c
- (void)run;	// IMP=0x000000010008b5e8
- (void)dealloc;	// IMP=0x000000010008b578
