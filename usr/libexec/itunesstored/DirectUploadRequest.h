...
- (void).cxx_destruct;	// IMP=0x00000001001a6878
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001a6724
- (id)initWithEntity:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x00000001001a6440
