...
- (_Bool)_loadPaymentsWithExpectedCount:(long long)arg1 error:(id *)arg2;	// IMP=0x000000010008c518
- (_Bool)_getQueueCount:(long long *)arg1 error:(id *)arg2;	// IMP=0x000000010008c404
- (void)run;	// IMP=0x000000010008c310
- (void)dealloc;	// IMP=0x000000010008c280
