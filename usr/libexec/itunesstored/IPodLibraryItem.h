...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x0000000100105658
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x0000000100106dc0
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x0000000100106c54
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x00000001001062b0
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001054c0
- (void)dealloc;	// IMP=0x0000000100105448
- (id)init;	// IMP=0x00000001001053ec
