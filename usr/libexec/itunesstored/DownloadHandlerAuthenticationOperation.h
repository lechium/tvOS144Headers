...
- (void)_setURLCredential:(id)arg1;	// IMP=0x0000000100195e10
- (void)_setState:(long long)arg1;	// IMP=0x0000000100195db0
- (id)_openSession;	// IMP=0x0000000100195b54
- (void)downloadHandlerManager:(id)arg1 sessionsDidChange:(id)arg2;	// IMP=0x0000000100195984
- (void)run;	// IMP=0x00000001001954f0
- (void)cancel;	// IMP=0x0000000100195460
...
- (void)dealloc;	// IMP=0x0000000100195264
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x00000001001951e8
