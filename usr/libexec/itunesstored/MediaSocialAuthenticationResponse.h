...
- (void).cxx_destruct;	// IMP=0x00000001000df2b8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000df1d4
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00000001000df17c
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00000001000df124
- (id)init;	// IMP=0x00000001000df0a8
