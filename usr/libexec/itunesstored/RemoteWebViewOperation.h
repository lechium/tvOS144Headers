...
- (void).cxx_destruct;	// IMP=0x000000010018a2c4
...
- (void)_sendActivationWithError:(id)arg1;	// IMP=0x000000010018a0ec
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x0000000100189f0c
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0000000100189d54
- (void)remoteAlertHandleDidActivate:(id)arg1;	// IMP=0x0000000100189bac
- (void)run;	// IMP=0x00000001001894cc
- (id)initWithWebViewRequest:(id)arg1;	// IMP=0x0000000100189424
