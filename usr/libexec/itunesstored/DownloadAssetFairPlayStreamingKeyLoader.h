...
- (void).cxx_destruct;	// IMP=0x000000010009e4f4
...
- (id)_track;	// IMP=0x000000010009e14c
- (void)_persistURI:(id)arg1 persistentContentKey:(id)arg2;	// IMP=0x000000010009e148
- (void)_persistKeys;	// IMP=0x000000010009e144
- (id)_pastisKeyServerURL;	// IMP=0x000000010009e084
- (id)_pastisCertificateURL;	// IMP=0x000000010009dfc4
- (_Bool)resourceLoader:(id)arg1 shouldWaitForLoadingOfRequestedResource:(id)arg2;	// IMP=0x000000010009dfbc
- (void)persistKeys;	// IMP=0x000000010009dfb8
- (void)applyResourceLoaderDelegate:(id)arg1;	// IMP=0x000000010009df9c
- (id)initWithDownloadEntity:(id)arg1;	// IMP=0x000000010009de08
