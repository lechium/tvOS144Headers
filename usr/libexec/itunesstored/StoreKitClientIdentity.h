...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x00000001001b125c
+ (void)initialize;	// IMP=0x00000001001b1220
...
- (id)description;	// IMP=0x00000001001b1a8c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001b1978
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x00000001001b16b8
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x00000001001b14a0
- (void)dealloc;	// IMP=0x00000001001b1428
