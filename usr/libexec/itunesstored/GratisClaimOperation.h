...
- (id)_newRetryRequestPropertiesWithURL:(id)arg1;	// IMP=0x0000000100152df0
- (id)_newDefaultRequestProperties;	// IMP=0x0000000100152c9c
- (id)_bodyData;	// IMP=0x0000000100152bc4
- (id)_authenticationContext;	// IMP=0x0000000100152ac0
- (id)_accountID;	// IMP=0x0000000100152a14
- (void)operation:(id)arg1 didAuthenticateWithDSID:(id)arg2;	// IMP=0x000000010015292c
- (void)run;	// IMP=0x000000010015243c
...
- (void)dealloc;	// IMP=0x00000001001520f0
- (id)initWithRequestBody:(id)arg1;	// IMP=0x0000000100152048
- (id)initWithPurchase:(id)arg1;	// IMP=0x0000000100151ecc
