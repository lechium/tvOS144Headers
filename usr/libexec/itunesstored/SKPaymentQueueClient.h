...
- (void).cxx_destruct;	// IMP=0x00000001000a578c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000a55a4
- (id)copyXPCEncoding;	// IMP=0x00000001000a5498
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00000001000a5290
