...
- (void).cxx_destruct;	// IMP=0x00000001000c400c
...
- (id)_localizedStringForKey:(id)arg1;	// IMP=0x00000001000c3f50
- (void)previousSegment;	// IMP=0x00000001000c3ec8
- (void)nextSegment;	// IMP=0x00000001000c3e50
...
- (id)initWithSegments:(id)arg1;	// IMP=0x00000001000c3afc
