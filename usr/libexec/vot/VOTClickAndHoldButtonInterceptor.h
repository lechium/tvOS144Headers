...
- (void).cxx_destruct;	// IMP=0x00000001001082d4
...
- (void)_drainQueueAndSendEventsToSystem:(_Bool)arg1;	// IMP=0x00000001001080b4
- (void)_releaseTimerFired;	// IMP=0x000000010010803c
- (void)_holdTimerFired;	// IMP=0x0000000100107fc4
- (void)_resetStateAndSendPendingEventsToSystem:(_Bool)arg1;	// IMP=0x0000000100107f50
- (void)_processStateChangeWithEvent:(long long)arg1 axEvent:(id)arg2;	// IMP=0x0000000100107b80
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x0000000100107aac
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x00000001001079d8
- (void)dealloc;	// IMP=0x0000000100107944
- (id)initWithThreadKey:(id)arg1;	// IMP=0x00000001001077b4
