...
+ (id)pointPickerWithMode:(long long)arg1 menu:(id)arg2;	// IMP=0x00000001000bd640
+ (id)mostSuitablePointPickerWithMenu:(id)arg1;	// IMP=0x00000001000bd5a4
- (void).cxx_destruct;	// IMP=0x00000001000bdc38
...
- (void)didFetchElements:(id)arg1 foundNewElements:(_Bool)arg2 currentFocusContext:(id)arg3 didChangeActiveElementManager:(_Bool)arg4;	// IMP=0x00000001000bdb24
- (void)scannerManager:(id)arg1 didActivateElement:(id)arg2;	// IMP=0x00000001000bdaec
- (void)resetRefinedSelectedPoint;	// IMP=0x00000001000bdadc
- (void)refineSelectedPoint;	// IMP=0x00000001000bda78
- (id)identifier;	// IMP=0x00000001000bda68
...
- (_Bool)isRefiningPoint;	// IMP=0x00000001000bd8e8
- (void)moveToPoint:(struct CGPoint)arg1;	// IMP=0x00000001000bd8dc
- (void)_savePoint:(struct CGPoint)arg1 andNotifyDelegate:(_Bool)arg2;	// IMP=0x00000001000bd7dc
- (id)description;	// IMP=0x00000001000bd67c
- (id)_initWithMenu:(id)arg1;	// IMP=0x00000001000bd648
