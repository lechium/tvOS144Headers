...
+ (_Bool)isValidForElement:(id)arg1;	// IMP=0x00000001000833ac
- (void).cxx_destruct;	// IMP=0x0000000100084a50
...
- (void)menuItemWasActivated:(id)arg1;	// IMP=0x0000000100084504
- (void)_performScrollAction:(int)arg1;	// IMP=0x0000000100084184
- (void)reload;	// IMP=0x00000001000840c8
- (long long)preferredTipObject;	// IMP=0x00000001000840c0
- (id)makeMenuItemsIfNeeded;	// IMP=0x0000000100083548
- (id)initWithMenu:(id)arg1 scrollableElement:(id)arg2 fallbackScrollAncestorDelegate:(id)arg3;	// IMP=0x0000000100083484
