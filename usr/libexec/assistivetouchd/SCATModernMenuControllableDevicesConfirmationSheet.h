...
- (void).cxx_destruct;	// IMP=0x0000000100056644
...
- (void)viewControllerViewWillDisappear:(_Bool)arg1;	// IMP=0x0000000100056544
- (_Bool)shouldKeepScannerAwake;	// IMP=0x000000010005653c
- (void)menuItemWasActivated:(id)arg1;	// IMP=0x000000010005640c
- (id)makeMenuItemsIfNeeded;	// IMP=0x000000010005631c
- (id)initWithMenu:(id)arg1 interDeviceSearchResult:(id)arg2;	// IMP=0x0000000100056284
