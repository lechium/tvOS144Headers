...
- (void).cxx_destruct;	// IMP=0x000000010009d508
...
- (_Bool)scatIsValid;	// IMP=0x000000010009d4bc
- (struct CGRect)scatFrame;	// IMP=0x000000010009d440
- (unsigned long long)hash;	// IMP=0x000000010009d3f4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010009d2c8
- (id)initWithSelectionPath:(id)arg1 generatorDelegate:(id)arg2;	// IMP=0x000000010009d218
