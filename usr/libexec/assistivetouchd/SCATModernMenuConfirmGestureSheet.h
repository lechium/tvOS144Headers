...
- (void).cxx_destruct;	// IMP=0x000000010008f4ac
@property(nonatomic) __weak id <SCATMenuGestureConfirmationItemsViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void)menuItemWasActivated:(id)arg1;	// IMP=0x000000010008f324
- (_Bool)shouldKeepScannerAwake;	// IMP=0x000000010008f31c
- (struct CGRect)rectToClear;	// IMP=0x000000010008f308
- (_Bool)allowsExitAction;	// IMP=0x000000010008f300
- (_Bool)allowsBackAction;	// IMP=0x000000010008f2f8
- (id)makeMenuItemsIfNeeded;	// IMP=0x000000010008f120
