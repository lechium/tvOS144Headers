...
- (void).cxx_destruct;	// IMP=0x00000001000a29a0
...
- (id)_urlForSoundEffect:(int)arg1;	// IMP=0x00000001000a270c
- (void)_flushSoundIDs;	// IMP=0x00000001000a2528
- (void)_playSoundWithSoundID:(unsigned int)arg1;	// IMP=0x00000001000a251c
- (void)cancelSpeech;	// IMP=0x00000001000a24e4
- (void)dispatchSpeechAction:(id)arg1;	// IMP=0x00000001000a243c
- (void)playSound:(int)arg1;	// IMP=0x00000001000a216c
- (id)_voiceOverBundle;	// IMP=0x00000001000a2150
- (void)dealloc;	// IMP=0x00000001000a1e1c
- (id)init;	// IMP=0x00000001000a1d44
@property(readonly, nonatomic) _Bool scanningInterruptsSpeech;
- (void)outputScannerAnnouncement:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001000a2bc8
- (void)outputScannerFocusContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000a29e8
