...
- (id)_axSubviews;	// IMP=0x000000010004a60c
- (void)_axPrintSubviews:(long long)arg1 string:(id)arg2;	// IMP=0x000000010004a3a8
- (void)didUpdateScatMenuItemStyle;	// IMP=0x0000000100089174
...
- (_Bool)isGroup;	// IMP=0x000000010009fefc
@property(readonly, nonatomic) _Bool scatPathIsInSceneReferenceSpace;
- (id)highestAncestorGroup;	// IMP=0x000000010009fea0
...
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x000000010009fd44
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x000000010009fbc0
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x000000010009fbb4
@property(readonly, nonatomic) NSArray *scatCustomActions;
- (id)scatSupportedGestures;	// IMP=0x000000010009fba4
- (void)scatScrollToVisible;	// IMP=0x000000010009fba0
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x000000010009fb98
...
- (id)scrollableElement;	// IMP=0x000000010009f988
- (id)keyboardContainer;	// IMP=0x000000010009f980
