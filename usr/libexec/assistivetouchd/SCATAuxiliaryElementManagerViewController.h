...
- (_Bool)_elementContainsAllSubviewsOfView:(id)arg1 view:(id)arg2;	// IMP=0x000000010007b3e0
- (void)updateCustomFocusingViewStateForViewsWithElement:(id)arg1;	// IMP=0x000000010007b000
- (id)viewsRequiringStateUpdate;	// IMP=0x000000010007aff8
- (void)updateWithContextElement:(id)arg1;	// IMP=0x000000010007aff4
- (void)viewDidLoad;	// IMP=0x000000010007afa0
- (void)loadView;	// IMP=0x000000010007af4c
