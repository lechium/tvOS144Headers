...
- (void).cxx_destruct;	// IMP=0x000000010005cdc0
...
- (_Bool)updateFocusState:(long long)arg1;	// IMP=0x000000010005c790
- (id)description;	// IMP=0x000000010005c6dc
- (void)layoutSubviews;	// IMP=0x000000010005c47c
- (id)initWithAxis:(long long)arg1;	// IMP=0x000000010005b47c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005b46c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010005b45c
