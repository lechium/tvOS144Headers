...
- (void).cxx_destruct;	// IMP=0x000000010003de1c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010003dd58
- (unsigned long long)hash;	// IMP=0x000000010003dcf0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003dc0c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010003db64
- (void)copyTo:(id)arg1;	// IMP=0x000000010003daec
- (void)writeTo:(id)arg1;	// IMP=0x000000010003da7c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010003d7d0
- (id)dictionaryRepresentation;	// IMP=0x000000010003d6e0
- (id)description;	// IMP=0x000000010003d62c
