...
- (void).cxx_destruct;	// IMP=0x000000010004e0d8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010004df70
- (unsigned long long)hash;	// IMP=0x000000010004dea8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010004dd48
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010004dc20
- (void)copyTo:(id)arg1;	// IMP=0x000000010004db44
- (void)writeTo:(id)arg1;	// IMP=0x000000010004da74
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010004da6c
- (id)dictionaryRepresentation;	// IMP=0x000000010004d900
- (id)description;	// IMP=0x000000010004d84c
