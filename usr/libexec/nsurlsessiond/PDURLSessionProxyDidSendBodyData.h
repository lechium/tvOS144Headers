...
- (void).cxx_destruct;	// IMP=0x0000000100041664
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010004152c
- (unsigned long long)hash;	// IMP=0x0000000100041484
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100041358
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010004125c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100041190
- (void)writeTo:(id)arg1;	// IMP=0x00000001000410cc
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100040cc8
- (id)dictionaryRepresentation;	// IMP=0x0000000100040b24
- (id)description;	// IMP=0x0000000100040a70
