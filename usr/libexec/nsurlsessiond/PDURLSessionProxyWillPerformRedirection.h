...
- (void).cxx_destruct;	// IMP=0x000000010005f5ac
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010005f46c
- (unsigned long long)hash;	// IMP=0x000000010005f3f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005f2f8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005f220
- (void)copyTo:(id)arg1;	// IMP=0x000000010005f194
- (void)writeTo:(id)arg1;	// IMP=0x000000010005f114
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010005ee8c
- (id)dictionaryRepresentation;	// IMP=0x000000010005ed68
- (id)description;	// IMP=0x000000010005ecb4
