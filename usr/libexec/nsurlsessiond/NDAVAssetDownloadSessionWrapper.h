...
- (void).cxx_destruct;	// IMP=0x000000010000db30
...
- (void)assetDownloadSession:(id)arg1 didResolveMediaSelection:(id)arg2;	// IMP=0x000000010000da04
- (void)assetDownloadSession:(id)arg1 didFinishDownloadForMediaSelection:(id)arg2;	// IMP=0x000000010000d930
- (void)assetDownloadSession:(id)arg1 didLoadTimeRange:(CDStruct_3c1748cc)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(CDStruct_3c1748cc)arg4 forMediaSelection:(id)arg5;	// IMP=0x000000010000d83c
- (void)assetDownloadSession:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x000000010000d768
- (void)assetDownloadSessionDidFinishDownload:(id)arg1;	// IMP=0x000000010000d6c8
- (void)startLoadingMetadata;	// IMP=0x000000010000d670
- (void)cancelAndDeliverError:(id)arg1;	// IMP=0x000000010000d5dc
- (void)cancel;	// IMP=0x000000010000d570
- (void)suspend;	// IMP=0x000000010000d4c0
- (void)resume;	// IMP=0x000000010000d348
- (void)releasePowerAssertion;	// IMP=0x000000010000d240
- (void)takePowerAssertion;	// IMP=0x000000010000cfe8
- (void)sendProgressUpdate;	// IMP=0x000000010000ceb8
- (void)didReceiveMediaSelectionResolutionNotification:(id)arg1;	// IMP=0x000000010000ce60
- (void)didReceiveTimeRangesChangedNotification:(id)arg1;	// IMP=0x000000010000cddc
- (void)didReceiveFileSizeAvailableNotification:(id)arg1;	// IMP=0x000000010000cdd8
- (void)didReceiveFailedNotification:(id)arg1;	// IMP=0x000000010000cd80
- (void)didReceiveSucceededNotification:(id)arg1;	// IMP=0x000000010000cd28
- (void)disavowSession;	// IMP=0x000000010000cc24
- (void)removeSessionObservers;	// IMP=0x000000010000caec
- (void)addSessionObservers;	// IMP=0x000000010000c98c
- (id)initWithURLAsset:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x000000010000bfb8
- (id)initWithURL:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x000000010000bd90
- (_Bool)doesAVAssetDownloadSessionSupportMultipleDownloads;	// IMP=0x000000010000bd68
