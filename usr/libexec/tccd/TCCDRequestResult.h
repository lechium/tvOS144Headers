...
+ (void)populateReplyMessageToDeny:(id)arg1 withError:(id)arg2;	// IMP=0x000000010002ef9c
- (void).cxx_destruct;	// IMP=0x000000010002f990
...
- (void)populateReplyMessage:(id)arg1;	// IMP=0x000000010002f504
- (id)description;	// IMP=0x000000010002f4f4
- (id)descriptionWithRespectToService:(id)arg1;	// IMP=0x000000010002f240
- (void)denyAuthorizationWithErrorCode:(long long)arg1 format:(id)arg2;	// IMP=0x000000010002f0ec
- (id)init;	// IMP=0x000000010002f090
