...
- (void).cxx_destruct;	// IMP=0x000000010002d504
...
- (id)initForSyncRequestForSubjectBundleIdentifier:(id)arg1 service:(id)arg2;	// IMP=0x000000010002d18c
- (id)init;	// IMP=0x000000010002d174
- (id)initWithRequestMessage:(id)arg1 forServer:(id)arg2 error:(id *)arg3;	// IMP=0x000000010002cd14
