...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x0000000100016728
+ (_Bool)supportsDeduplication;	// IMP=0x0000000100016720
- (void).cxx_destruct;	// IMP=0x0000000100016664
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x00000001000164b4
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x0000000100016438
- (_Bool)isPassthroughConversion;	// IMP=0x00000001000163bc
- (void)startProgressUpdateTimer;	// IMP=0x00000001000163b8
- (void)cancel;	// IMP=0x00000001000163b4
- (void)performConversion;	// IMP=0x0000000100016338
- (void)didEnqueue;	// IMP=0x00000001000162d4
- (CDStruct_3c1748cc)trimTimeRange;	// IMP=0x000000010001621c
- (_Bool)hasTrimTimeRange;	// IMP=0x00000001000161b8
- (_Bool)wantsResultAsData;	// IMP=0x000000010001613c
- (void)updateResultTracker;	// IMP=0x0000000100015fe8
- (void)callCompletionHandler;	// IMP=0x0000000100015cc0
- (void)loadAsset;	// IMP=0x0000000100015b20
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x000000010001586c
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x00000001000156f8
