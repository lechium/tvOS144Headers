...
- (void).cxx_destruct;	// IMP=0x0000000100010cd4
...
- (void)dealloc;	// IMP=0x0000000100010a08
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x000000010000fe9c
- (_Bool)_validateOutputSize;	// IMP=0x000000010000fd34
- (_Bool)_validateOrientation;	// IMP=0x000000010000fbec
- (_Bool)_validateMetadata;	// IMP=0x000000010000fa54
- (_Bool)_validateSource;	// IMP=0x000000010000f828
- (void)_validate;	// IMP=0x000000010000f6b0
- (_Bool)validateSourceAndOptions;	// IMP=0x000000010000f670
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x000000010000f518
