...
- (void).cxx_destruct;	// IMP=0x000000010003ec1c
...
- (id)sessionTaskWithSession:(id)arg1;	// IMP=0x000000010003e7b4
- (id)sessionConfiguration;	// IMP=0x000000010003e5f0
- (id)initWithInstallInfo:(id)arg1;	// IMP=0x000000010003e23c
- (id)initWithDownload:(id)arg1;	// IMP=0x000000010003de58
