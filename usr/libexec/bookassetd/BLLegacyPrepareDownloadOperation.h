...
+ (void)enumerateOperationsWithDownloads:(id)arg1 downloadPolicyManager:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000010003f2a4
...
- (void)run;	// IMP=0x000000010003f5e8
@property(copy) CDUnknownBlockType outputBlock;
@property(readonly, nonatomic) NSString *downloadIdentifier;
- (id)_initWithDownload:(id)arg1 policy:(id)arg2;	// IMP=0x000000010003f1e8
