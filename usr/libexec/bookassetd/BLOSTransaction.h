...
- (void).cxx_destruct;	// IMP=0x0000000100055ed8
@property(retain, nonatomic) NSObject<OS_os_transaction> *osTransaction; // @synthesize osTransaction=_osTransaction;
- (void)dealloc;	// IMP=0x0000000100055dd0
- (void)endTransaction;	// IMP=0x0000000100055c90
- (id)initWithTransactionName:(const char *)arg1;	// IMP=0x0000000100055b94
