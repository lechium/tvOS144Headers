...
- (void).cxx_destruct;	// IMP=0x000000010000ed0c
...
- (id)_sortedAccountIDs:(id)arg1;	// IMP=0x000000010000ea54
- (void)_sanitizeRestoreItemAccountID:(id)arg1 accountsHelper:(id)arg2 error:(id *)arg3;	// IMP=0x000000010000e7b0
- (void)_applyResponses:(id)arg1;	// IMP=0x000000010000e268
- (void)restoreDownloadItemsOperation:(id)arg1 didReceiveResponse:(id)arg2;	// IMP=0x000000010000e1ac
- (void)run;	// IMP=0x000000010000d19c
- (id)initWithRestoreDownloadItems:(id)arg1 authenticationQueue:(id)arg2 responseItemBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000010000d098
