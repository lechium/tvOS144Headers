...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x0000000100012654
- (void).cxx_destruct;	// IMP=0x0000000100014190
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x0000000100013fcc
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x0000000100013df0
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x00000001000132b4
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100012450
- (id)init;	// IMP=0x00000001000123e8
