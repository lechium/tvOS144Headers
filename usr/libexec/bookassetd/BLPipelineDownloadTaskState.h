...
- (void).cxx_destruct;	// IMP=0x000000010000cfb4
...
- (id)_overallProgress;	// IMP=0x000000010000cd54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000c88c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000c7cc
- (unsigned long long)hash;	// IMP=0x000000010000c7bc
- (void)setTransferProgressWithBytesWritten:(long long)arg1 totalBytesExpected:(long long)arg2;	// IMP=0x000000010000c794
- (void)setTransferProgress:(double)arg1;	// IMP=0x000000010000c728
- (void)setFinishProgress:(double)arg1;	// IMP=0x000000010000c6b0
- (id)initWithPrepareDownloadResponse:(id)arg1;	// IMP=0x000000010000c324
