...
- (void).cxx_destruct;	// IMP=0x0000000100055824
@property(retain, nonatomic) BLBookInstallInfo *installInfo; // @synthesize installInfo=_installInfo;
@property(readonly, nonatomic) NSError *error; // @synthesize error=_error;
@property(readonly, nonatomic) _Bool success; // @synthesize success=_success;
- (_Bool)_decryptAsset:(id *)arg1;	// IMP=0x0000000100055458
- (void)main;	// IMP=0x0000000100055400
- (id)initWithInstallInfo:(id)arg1;	// IMP=0x0000000100055380
