...
- (_Bool)isAutomaticDownloadingEnabled;	// IMP=0x000000010001c810
- (_Bool)deletableSystemAppCanBeInstalledOnWatchWithBundleID:(id)arg1;	// IMP=0x000000010001c808
- (id)isPairedSystemVersionAtLeast:(id)arg1;	// IMP=0x000000010001c75c
- (_Bool)isActivePairedWatchSystemVersionAtLeastMajorVersion:(id)arg1 minorVersion:(id)arg2 patchVersion:(id)arg3;	// IMP=0x000000010001c754
- (_Bool)deviceHasCapabilities:(id)arg1;	// IMP=0x000000010001c734
...
- (void)accountStoreDidChange:(id)arg1;	// IMP=0x000000010001c4d4
- (void)dealloc;	// IMP=0x000000010001c45c
- (id)initWithAccountStore:(id)arg1;	// IMP=0x000000010001c36c
