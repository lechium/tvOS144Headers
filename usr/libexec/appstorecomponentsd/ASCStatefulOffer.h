...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100019664
- (void).cxx_destruct;	// IMP=0x000000010001a778
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100019f60
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000100019b90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100019b8c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100019940
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010001966c
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x0000000100019450
