...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000c448
...
- (id)description;	// IMP=0x000000010000ca90
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000c840
- (unsigned long long)hash;	// IMP=0x000000010000c724
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000c720
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000c600
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000c450
- (id)initWithID:(id)arg1 kind:(id)arg2 context:(id)arg3 limit:(long long)arg4;	// IMP=0x000000010000c338
