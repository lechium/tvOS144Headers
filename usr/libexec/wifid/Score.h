...
+ (id)generateNewScoreObjectFromMOC:(id)arg1;	// IMP=0x0000000100121940
+ (id)copyFetchRequest;	// IMP=0x0000000100121914
+ (id)fetchRequest;	// IMP=0x0000000100129404
- (void)updateScoreForSwitch:(_Bool)arg1;	// IMP=0x0000000100121dbc
- (_Bool)checkIncrementForOverflowWithMuliplier:(long long)arg1 multiplier:(long long)arg2;	// IMP=0x0000000100121db4
- (id)copyScoreLog;	// IMP=0x0000000100121c7c
- (long long)getTotalScore;	// IMP=0x0000000100121ab4
