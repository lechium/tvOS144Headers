...
- (void).cxx_destruct;	// IMP=0x0000000100005d34
...
- (void)grabStats:(int)arg1 deviceContext:(void *)arg2 wifiManagerCtxt:(void *)arg3 withContext:(id)arg4;	// IMP=0x0000000100005454
