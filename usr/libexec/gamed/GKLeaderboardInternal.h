...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100133dcc
- (void).cxx_destruct;	// IMP=0x0000000100134574
...
- (unsigned long long)hash;	// IMP=0x0000000100134250
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100134168
