...
+ (id)entityName;	// IMP=0x000000010004e2b8
- (id)internalRepresentation;	// IMP=0x000000010004e038
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004dd68
