...
+ (id)entityName;	// IMP=0x0000000100053c3c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100053c48
- (id)internalRepresentation;	// IMP=0x0000000100053ac4
