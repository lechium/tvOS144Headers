...
- (void).cxx_destruct;	// IMP=0x00000001000c8aa4
...
- (void)cancelConnection;	// IMP=0x00000001000c8a24
- (void)readData;	// IMP=0x00000001000c8a20
- (void)_sendData:(id)arg1;	// IMP=0x00000001000c8a1c
- (_Bool)sendData:(id)arg1;	// IMP=0x00000001000c89b0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000c8784
- (void)dealloc;	// IMP=0x00000001000c86e8
- (id)initWithConnection:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;	// IMP=0x00000001000c85f0
