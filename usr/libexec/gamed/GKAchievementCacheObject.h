...
+ (id)entityName;	// IMP=0x000000010004eb64
- (id)internalRepresentation;	// IMP=0x000000010004eb5c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004e950
