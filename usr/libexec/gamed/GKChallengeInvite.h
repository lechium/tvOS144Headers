...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100098958
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010009918c
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100098a10
- (id)initWithChallenge:(id)arg1;	// IMP=0x00000001000989b8
- (id)challengeInternalObject;	// IMP=0x00000001000989b0
- (id)description;	// IMP=0x0000000100098960
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010009886c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000986c0
- (void)dealloc;	// IMP=0x0000000100098638
