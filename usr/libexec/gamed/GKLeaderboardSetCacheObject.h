...
+ (id)entityName;	// IMP=0x0000000100050df4
- (id)internalRepresentation;	// IMP=0x0000000100050be8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00000001000507a4
