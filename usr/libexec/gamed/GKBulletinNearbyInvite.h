...
- (void)handleAction:(id)arg1;	// IMP=0x00000001000fdf90
- (void)dealloc;	// IMP=0x00000001000fdf40
- (id)initWithPlayer:(id)arg1 localizedGameName:(id)arg2 inviteDictionary:(id)arg3;	// IMP=0x00000001000fd9b0
