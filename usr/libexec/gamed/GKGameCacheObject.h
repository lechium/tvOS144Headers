...
+ (id)entityName;	// IMP=0x000000010004dc34
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x000000010004c1a0
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x000000010004c060
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x000000010004bf20
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x000000010004bd70
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x000000010004bcd4
+ (id)fetchSortDescriptors;	// IMP=0x000000010004bc28
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x000000010004bc1c
+ (id)uniqueAttributeName;	// IMP=0x000000010004bc10
- (id)gameDescriptor;	// IMP=0x000000010004d97c
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x000000010004d900
- (id)internalRepresentation;	// IMP=0x000000010004d7d8
- (_Bool)storePiecesExpired;	// IMP=0x000000010004d7a8
- (_Bool)storePiecesValid;	// IMP=0x000000010004d764
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004d1c0
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004cb58
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x000000010004c560
- (_Bool)isValid;	// IMP=0x000000010004c4e4
- (void)invalidate;	// IMP=0x000000010004bbbc
