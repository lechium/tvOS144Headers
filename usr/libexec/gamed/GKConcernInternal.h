...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001326f8
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100132690
...
- (unsigned long long)hash;	// IMP=0x000000010013289c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001327fc
- (void)dealloc;	// IMP=0x0000000100132698
