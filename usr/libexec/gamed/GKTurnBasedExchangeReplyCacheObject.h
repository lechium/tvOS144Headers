...
+ (id)entityName;	// IMP=0x000000010005c39c
- (id)internalRepresentation;	// IMP=0x000000010005c5e4
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005c3a8
