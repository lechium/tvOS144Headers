...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x00000001000fcb10
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000fc7a4
- (void).cxx_destruct;	// IMP=0x00000001000fd00c
