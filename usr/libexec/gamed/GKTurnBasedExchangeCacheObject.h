...
+ (id)entityName;	// IMP=0x000000010005bd38
- (id)internalRepresentation;	// IMP=0x000000010005c394
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x000000010005bd44
