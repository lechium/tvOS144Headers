...
+ (long long)coalescingDelay;	// IMP=0x00000001001d8004
+ (id)bagKey;	// IMP=0x00000001001d7ff8
- (void).cxx_destruct;	// IMP=0x00000001001d9248
...
- (id)taskInfo;	// IMP=0x00000001001d8f30
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001d8c1c
- (id)postBody;	// IMP=0x00000001001d8b84
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001d8b14
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00000001001d8aa0
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00000001001d86d4
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00000001001d8420
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithAchievements:(id)arg1 bundleID:(id)arg2;	// IMP=0x00000001001d80c8
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001d800c
