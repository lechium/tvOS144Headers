...
+ (id)entityName;	// IMP=0x000000010005ba38
- (id)internalRepresentation;	// IMP=0x000000010005bd30
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005ba44
