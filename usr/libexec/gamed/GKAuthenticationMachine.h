...
+ (void)migratePreSundanceAccountInformation;	// IMP=0x000000010008dc44
+ (void)migratePreBlacktailAccountInformation;	// IMP=0x000000010008d848
+ (id)authMachineForEnvironment:(long long)arg1;	// IMP=0x000000010008d68c
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010008d684
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010008d7a0
- (void)dealloc;	// IMP=0x000000010008d758
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010008d694
