...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100091d64
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x0000000100091fa4
- (_Bool)isNetworkError;	// IMP=0x0000000100091f64
- (_Bool)isTimeout;	// IMP=0x0000000100091f24
- (_Bool)isCancelled;	// IMP=0x0000000100091ee4
- (_Bool)isFinished;	// IMP=0x0000000100091ea4
- (int)_incrementSequence;	// IMP=0x0000000100091e94
- (void)dealloc;	// IMP=0x0000000100091cb4
