...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100129940
+ (id)propertiesToFetch;	// IMP=0x0000000100140ae8
...
- (id)description;	// IMP=0x0000000100129c30
- (id)serverRepresentation;	// IMP=0x0000000100129c24
- (void)dealloc;	// IMP=0x00000001001298b0
- (unsigned long long)hash;	// IMP=0x000000010012988c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100129808
- (id)defaultCategory;	// IMP=0x000000010012a298
- (unsigned short)numberOfCategories;	// IMP=0x000000010012a28c
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100140b3c
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00000001001404e0
