...
+ (Class)classForFamiliarity:(int)arg1;	// IMP=0x00000001001300f0
+ (id)displayNameWithOptions:(unsigned char)arg1 alias:(id)arg2 composite:(id)arg3;	// IMP=0x0000000100130070
+ (id)compositeNameForFirstName:(id)arg1 lastName:(id)arg2;	// IMP=0x000000010012ff30
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012f6b4
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010012f6ac
+ (id)propertiesToFetch;	// IMP=0x00000001001426f4
+ (int)familiarity;	// IMP=0x00000001001426ec
+ (unsigned char)piecesToLoad;	// IMP=0x00000001001426b0
...
- (id)debugDescription;	// IMP=0x0000000100130360
...
- (void)setAllowNearbyMultiplayer:(_Bool)arg1;	// IMP=0x0000000100130330
- (_Bool)allowNearbyMultiplayer;	// IMP=0x0000000100130328
...
- (int)defaultFamiliarity;	// IMP=0x0000000100130150
- (id)displayNameWithOptions:(unsigned char)arg1;	// IMP=0x000000010012ffcc
- (id)minimalInternal;	// IMP=0x000000010012fc98
- (unsigned long long)hash;	// IMP=0x000000010012fc74
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012fbd8
- (id)serverRepresentation;	// IMP=0x000000010012fae8
- (id)conciseDescription;	// IMP=0x000000010012fa60
- (id)cacheKey;	// IMP=0x000000010012fa54
- (void)dealloc;	// IMP=0x000000010012f55c
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100142748
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00000001001422b8
