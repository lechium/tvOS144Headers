...
- (void).cxx_destruct;	// IMP=0x00000001001067d8
...
- (void)_performTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x0000000100106538
- (id)_validateTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x0000000100106060
- (id)missingTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x000000010010601c
- (_Bool)_setCurrentState:(id)arg1;	// IMP=0x0000000100105df0
@property(retain) NSString *currentState; // @synthesize currentState=_currentState;
- (_Bool)applyState:(id)arg1;	// IMP=0x0000000100105dd8
- (void)dealloc;	// IMP=0x0000000100105d48
- (id)init;	// IMP=0x0000000100105d0c
