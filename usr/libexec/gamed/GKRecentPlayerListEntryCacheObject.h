...
+ (id)entityName;	// IMP=0x0000000100057cc0
- (id)internalRepresentation;	// IMP=0x0000000100057e88
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100057ccc
