...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012b980
...
- (id)description;	// IMP=0x000000010012b87c
@property(readonly) NSString *scopeAsString;
- (void)dealloc;	// IMP=0x000000010012b6f0
- (unsigned long long)hash;	// IMP=0x000000010012b6cc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012b574
