...
- (void).cxx_destruct;	// IMP=0x0000000100019e1c
...
- (id)initWithURLResponse:(id)arg1 data:(id)arg2;	// IMP=0x00000001000198d8
- (id)_parsePlistFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100019728
