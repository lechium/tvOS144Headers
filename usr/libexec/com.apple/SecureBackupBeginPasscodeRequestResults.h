...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100012a70
- (void).cxx_destruct;	// IMP=0x0000000100012d3c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100012ba8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100012a78
- (id)description;	// IMP=0x0000000100012924
- (id)initWithStoredCertificate:(id)arg1 uuid:(id)arg2;	// IMP=0x00000001000127f8
