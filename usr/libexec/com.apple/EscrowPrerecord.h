...
+ (id)createPrerecordFromCandidate:(id)arg1 storedCertificate:(id)arg2 request:(id)arg3 error:(id *)arg4;	// IMP=0x000000010004eefc
- (void).cxx_destruct;	// IMP=0x00000001000458bc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100045578
- (unsigned long long)hash;	// IMP=0x0000000100045410
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100045178
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100044f34
- (void)copyTo:(id)arg1;	// IMP=0x0000000100044d7c
- (void)writeTo:(id)arg1;	// IMP=0x0000000100044bf4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100044bec
- (id)dictionaryRepresentation;	// IMP=0x00000001000445d0
- (id)description;	// IMP=0x000000010004451c
@property(readonly, nonatomic) _Bool hasDuplicateEscrowBlob;
- (int)StringAsPassphraseType:(id)arg1;	// IMP=0x0000000100044444
- (id)passphraseTypeAsString:(int)arg1;	// IMP=0x00000001000443b4
...
- (id)initWithCandidate:(id)arg1 certificate:(id)arg2 escrowBlob:(id)arg3 passphraseType:(int)arg4;	// IMP=0x000000010004ec58
