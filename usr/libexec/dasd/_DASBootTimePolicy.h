...
+ (id)getDeviceBootTime;	// IMP=0x000000010001fe34
+ (id)policyInstance;	// IMP=0x000000010001fd80
- (void).cxx_destruct;	// IMP=0x00000001000201a0
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010001fee8
- (double)weightForActivity:(id)arg1;	// IMP=0x000000010001fe28
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010001fdf4
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010001fdec
