...
+ (id)userRequestedBackupKeyPath;	// IMP=0x0000000100068da0
+ (id)managerWithContext:(id)arg1;	// IMP=0x0000000100068d4c
- (void).cxx_destruct;	// IMP=0x0000000100069864
...
- (void)syncRequested;	// IMP=0x00000001000697e0
- (void)_queue_obtainPendingBackupTasks;	// IMP=0x0000000100069630
- (_Bool)activityEligibleForRunning:(id)arg1;	// IMP=0x0000000100069554
- (void)reportActivityNoLongerRunning:(id)arg1;	// IMP=0x00000001000690b4
- (void)reportActivityRunning:(id)arg1;	// IMP=0x0000000100068f50
- (void)activitySubmitted:(id)arg1;	// IMP=0x0000000100068e24
- (id)initWithContext:(id)arg1;	// IMP=0x0000000100068bf0
