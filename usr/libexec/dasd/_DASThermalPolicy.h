...
+ (id)policyInstance;	// IMP=0x000000010002c688
- (void).cxx_destruct;	// IMP=0x000000010002d0ec
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002cbf0
- (_Bool)isRestoreInProgressWithContext:(id)arg1;	// IMP=0x000000010002cb98
- (_Bool)isUnderPeakPowerPressureWithContext:(id)arg1;	// IMP=0x000000010002cb90
- (int)maxAllowableThermalPressureForActivity:(id)arg1 restoreInProgress:(_Bool)arg2;	// IMP=0x000000010002cadc
- (double)getScoreForThermalLevel:(int)arg1;	// IMP=0x000000010002ca7c
- (double)weightForActivity:(id)arg1;	// IMP=0x000000010002ca74
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010002c9b0
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002c854
- (void)updateSystemConstraintsWithContext:(id)arg1;	// IMP=0x000000010002c6f4
- (id)init;	// IMP=0x000000010002c544
- (id)initializeTriggers;	// IMP=0x000000010002c414
