...
- (void)analyzeValues:(id)arg1 currentContext:(id)arg2;	// IMP=0x000000010000eadc
- (double)getReferenceChargeRateForContext:(id)arg1 reader:(id)arg2;	// IMP=0x000000010000e938
- (void)recordValue;	// IMP=0x000000010000e888
- (void)stop;	// IMP=0x000000010000e81c
- (void)start;	// IMP=0x000000010000e78c
- (id)initWithQueueLimit:(unsigned long long)arg1 reader:(id)arg2 monitoringInterval:(unsigned long long)arg3 analyzeToMonitorRatio:(unsigned long long)arg4;	// IMP=0x000000010000e534
