...
+ (_Bool)isDeviceInUse:(id)arg1;	// IMP=0x0000000100023f1c
+ (id)policyInstance;	// IMP=0x0000000100023928
+ (void)printLowLikelihoodRegions;	// IMP=0x00000001000233e4
- (void).cxx_destruct;	// IMP=0x00000001000245dc
...
- (double)predictedScoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x00000001000244f0
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x0000000100024108
- (_Bool)backgroundTaskAllowedWithType:(id)arg1 withRationale:(id)arg2 withState:(id)arg3;	// IMP=0x0000000100023fc8
- (double)scoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100023b94
- (double)weightForActivity:(id)arg1;	// IMP=0x0000000100023b24
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x0000000100023a9c
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x00000001000239c4
- (_Bool)shouldLogScoreToPowerLog;	// IMP=0x0000000100023920
- (id)predictionForDeviceActivity;	// IMP=0x00000001000238b4
- (id)init;	// IMP=0x00000001000236c0
- (id)initializeTriggers;	// IMP=0x0000000100023590
