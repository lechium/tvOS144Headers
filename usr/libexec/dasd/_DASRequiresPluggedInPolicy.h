...
+ (_Bool)isWirelessCharger:(id)arg1;	// IMP=0x000000010002a7e0
+ (id)policyInstance;	// IMP=0x000000010002a530
- (void).cxx_destruct;	// IMP=0x000000010002adf4
...
- (double)predictedScoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x000000010002aa64
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002a884
- (double)scoreForActivity:(id)arg1 isPluggedIn:(_Bool)arg2;	// IMP=0x000000010002a7a4
- (double)weightForActivity:(id)arg1;	// IMP=0x000000010002a6f4
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010002a6d0
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002a59c
- (_Bool)shouldLogScoreToPowerLog;	// IMP=0x000000010002a528
- (id)predictionForDevicePluggedIn;	// IMP=0x000000010002a4bc
- (id)init;	// IMP=0x000000010002a2e8
- (id)initializeTriggers;	// IMP=0x000000010002a190
