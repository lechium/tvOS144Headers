...
+ (id)persistence;	// IMP=0x0000000100005030
...
- (id)convertNameFromCompactToFull:(id)arg1;	// IMP=0x0000000100005c20
- (id)convertNameFromFullToCompact:(id)arg1;	// IMP=0x0000000100005b7c
- (void)saveModulationDate:(id)arg1;	// IMP=0x000000010000597c
- (void)updateBudget:(id)arg1;	// IMP=0x000000010000582c
- (void)saveBudgets:(id)arg1;	// IMP=0x0000000100005568
- (id)loadBudgetsWithExpectedNames:(id)arg1;	// IMP=0x00000001000050d4
