...
- (double)scoreForApplication:(id)arg1 atDate:(id)arg2;	// IMP=0x000000010003fe78
- (id)scoresForAllApplicationsAtDate:(id)arg1;	// IMP=0x000000010003f660
- (id)initWithAlgorithms:(id)arg1;	// IMP=0x000000010003f4f0
