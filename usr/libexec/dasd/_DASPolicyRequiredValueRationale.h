...
- (void).cxx_destruct;	// IMP=0x000000010002f568
...
- (id)description;	// IMP=0x000000010002f4e8
- (id)initWithCondition:(id)arg1 withRequiredValue:(double)arg2 withCurrentValue:(double)arg3;	// IMP=0x000000010002f45c
