...
+ (id)sharedInstance;	// IMP=0x00000001000107e8
- (void).cxx_destruct;	// IMP=0x0000000100013638
...
- (_Bool)checkFileForEntitlements:(id)arg1 forCorrespondingManifestEntry:(id)arg2;	// IMP=0x0000000100013010
- (void)registerEntitlementNotificationHandler;	// IMP=0x0000000100012dec
- (_Bool)runAppLayoutSecurityCheck:(id)arg1;	// IMP=0x000000010001241c
- (_Bool)runSecurityChecksForSection:(id)arg1 dataType:(id)arg2;	// IMP=0x0000000100011944
- (_Bool)runSecurityCheck;	// IMP=0x0000000100010e08
- (_Bool)secureManifestCheckForSegmentedManifest:(id)arg1;	// IMP=0x0000000100010cb0
- (id)init;	// IMP=0x0000000100010854
