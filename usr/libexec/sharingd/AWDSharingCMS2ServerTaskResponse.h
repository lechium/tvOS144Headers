...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100175c30
- (unsigned long long)hash;	// IMP=0x0000000100175b7c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100175a30
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100175920
- (void)copyTo:(id)arg1;	// IMP=0x000000010017582c
- (void)writeTo:(id)arg1;	// IMP=0x000000010017573c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100175734
- (id)dictionaryRepresentation;	// IMP=0x0000000100175050
- (id)description;	// IMP=0x0000000100174f9c
