...
- (void).cxx_destruct;	// IMP=0x000000010005cfd0
...
- (void)invalidate;	// IMP=0x000000010005cdc4
- (int)closeNode:(struct __SFNode *)arg1;	// IMP=0x000000010005cd3c
- (int)removeNode:(struct __SFNode *)arg1;	// IMP=0x000000010005ccd4
- (int)addNode:(struct __SFNode *)arg1;	// IMP=0x000000010005cc6c
@property(copy) NSDictionary *options;
@property long long mode;
- (id)sidebarChildren;	// IMP=0x000000010005cb38
- (id)childrenForNode:(struct __SFNode *)arg1;	// IMP=0x000000010005cac8
- (struct __SFNode *)copyRootNode;	// IMP=0x000000010005cab8
- (int)openNode:(struct __SFNode *)arg1 forProtocol:(id)arg2 flags:(unsigned long long)arg3;	// IMP=0x000000010005c938
- (void)nodeBrowser:(id)arg1 nodesChangedForParent:(struct __SFNode *)arg2 protocol:(id)arg3 error:(int)arg4;	// IMP=0x000000010005c8c0
- (void)dealloc;	// IMP=0x000000010005c85c
- (id)initWithKind:(id)arg1 rootNode:(struct __SFNode *)arg2;	// IMP=0x000000010005c77c
