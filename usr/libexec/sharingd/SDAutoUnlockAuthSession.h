...
- (void).cxx_destruct;	// IMP=0x00000001001624f8
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x0000000100161b8c
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010016169c
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010016162c
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x0000000100160efc
- (void)sendAWDLInfo;	// IMP=0x0000000100160eec
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100160e24
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100160d08
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100160cb0
- (void)_start;	// IMP=0x0000000100160ca4
- (void)start;	// IMP=0x0000000100160c18
- (id)getAppName;	// IMP=0x0000000100160c10
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0000000100160c0c
- (void)connectionActivated;	// IMP=0x0000000100160c08
- (void)invalidate;	// IMP=0x0000000100160af8
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0000000100160a30
