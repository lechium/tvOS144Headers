...
- (void).cxx_destruct;	// IMP=0x00000001001d54d0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001d5280
- (unsigned long long)hash;	// IMP=0x00000001001d512c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001d4f08
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001d4d40
- (void)copyTo:(id)arg1;	// IMP=0x00000001001d4bbc
- (void)writeTo:(id)arg1;	// IMP=0x00000001001d4a5c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001d4a54
- (id)dictionaryRepresentation;	// IMP=0x00000001001d4188
- (id)description;	// IMP=0x00000001001d40d4
