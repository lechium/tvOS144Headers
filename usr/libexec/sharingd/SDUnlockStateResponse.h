...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000f8ca0
- (unsigned long long)hash;	// IMP=0x00000001000f8c2c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000f8b30
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000f8a70
- (void)copyTo:(id)arg1;	// IMP=0x00000001000f89cc
- (void)writeTo:(id)arg1;	// IMP=0x00000001000f8924
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000f891c
- (id)dictionaryRepresentation;	// IMP=0x00000001000f8424
- (id)description;	// IMP=0x00000001000f8370
