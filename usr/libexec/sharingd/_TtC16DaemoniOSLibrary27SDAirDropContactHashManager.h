...
+ (id)shared;	// IMP=0x00000001001dec00
- (void).cxx_destruct;	// IMP=0x00000001001e70bc
- (id)init;	// IMP=0x00000001001e0608
- (_Bool)acquireTokenForIdentifier:(unsigned long long)arg1;	// IMP=0x00000001001dec40
