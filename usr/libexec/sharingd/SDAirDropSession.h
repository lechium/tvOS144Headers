...
- (void).cxx_destruct;	// IMP=0x000000010003ae38
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010003aa44
- (void)handleConversionProgress:(id)arg1;	// IMP=0x000000010003a954
- (void)startProgress;	// IMP=0x000000010003a6a8
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x000000010003a6a4
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x0000000100039f34
- (void)removeClientAlerts;	// IMP=0x0000000100039e0c
- (void)dealloc;	// IMP=0x0000000100039d80
- (void)stop;	// IMP=0x0000000100039bec
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x00000001000398e0
- (void)serversChanged:(id)arg1;	// IMP=0x0000000100039608
- (_Bool)send;	// IMP=0x00000001000394dc
- (void)start;	// IMP=0x00000001000392ec
- (void)releaseSandboxExtensions;	// IMP=0x00000001000391d8
- (void)consumeSandboxExtensions;	// IMP=0x0000000100038f6c
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000100038f04
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x0000000100038d10
