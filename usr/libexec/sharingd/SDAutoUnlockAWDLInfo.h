...
- (void).cxx_destruct;	// IMP=0x00000001000c7374
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000c715c
- (unsigned long long)hash;	// IMP=0x00000001000c7028
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000c6e28
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000c6c88
- (void)copyTo:(id)arg1;	// IMP=0x00000001000c6b2c
- (void)writeTo:(id)arg1;	// IMP=0x00000001000c69f0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000c69e8
- (id)dictionaryRepresentation;	// IMP=0x00000001000c6218
- (id)description;	// IMP=0x00000001000c6164
