...
- (void).cxx_destruct;	// IMP=0x000000010015e440
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x000000010015e3c0
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010015e1a0
- (void)disableService:(id)arg1;	// IMP=0x000000010015e118
- (void)enableService:(id)arg1;	// IMP=0x000000010015e094
- (id)streamHandlerForService:(id)arg1;	// IMP=0x000000010015e030
- (void)stop;	// IMP=0x000000010015de44
- (void)start;	// IMP=0x000000010015ddf4
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010015dcec
