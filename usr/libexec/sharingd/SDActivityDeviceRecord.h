...
- (void).cxx_destruct;	// IMP=0x000000010004e0bc
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010004d1a4
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010004d148
- (id)description;	// IMP=0x000000010004d058
- (id)initWithDevice:(id)arg1;	// IMP=0x000000010004cfbc
