...
- (void).cxx_destruct;	// IMP=0x00000001000c5ef4
...
- (void)sendProxyTrigger;	// IMP=0x00000001000c5a08
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001000c5934
- (void)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001000c56c4
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001000c554c
- (id)results;	// IMP=0x00000001000c53cc
- (void)removeObservers;	// IMP=0x00000001000c537c
- (void)addObservers;	// IMP=0x00000001000c5314
- (void)invalidate;	// IMP=0x00000001000c522c
- (void)_start;	// IMP=0x00000001000c5174
- (void)start;	// IMP=0x00000001000c50e8
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001000c501c
