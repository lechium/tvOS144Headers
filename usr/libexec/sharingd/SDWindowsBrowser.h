...
- (void).cxx_destruct;	// IMP=0x0000000100137178
...
- (void)stop;	// IMP=0x00000001001370f0
- (void)start;	// IMP=0x0000000100136ff0
- (void)bonjourNodesDidChange:(id)arg1;	// IMP=0x0000000100136fb4
@property(readonly, copy) NSArray *nodes;
- (void)dealloc;	// IMP=0x0000000100136f58
- (id)initWithWorkgroup:(id)arg1;	// IMP=0x0000000100136ed4
