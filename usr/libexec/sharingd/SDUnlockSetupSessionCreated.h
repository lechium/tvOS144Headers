...
- (void).cxx_destruct;	// IMP=0x000000010016409c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100163e14
- (unsigned long long)hash;	// IMP=0x0000000100163ca4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100163a6c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010016387c
- (void)copyTo:(id)arg1;	// IMP=0x00000001001636d0
- (void)writeTo:(id)arg1;	// IMP=0x000000010016354c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100163544
- (id)dictionaryRepresentation;	// IMP=0x0000000100162ba0
- (id)description;	// IMP=0x0000000100162aec
