...
- (void).cxx_destruct;	// IMP=0x00000001000a02dc
...
- (_Bool)stateIsNearby;	// IMP=0x000000010009ff60
- (_Bool)stateIsMedium;	// IMP=0x000000010009ff1c
- (_Bool)stateIsClose;	// IMP=0x000000010009ff08
- (void)resetTicks;	// IMP=0x000000010009fd5c
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x000000010009fa18
- (_Bool)canTransition:(int)arg1;	// IMP=0x000000010009f91c
- (id)description;	// IMP=0x000000010009f580
