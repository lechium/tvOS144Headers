...
- (void).cxx_destruct;	// IMP=0x00000001001c7354
...
- (void)cancel;	// IMP=0x00000001001c7258
- (void)resolve;	// IMP=0x00000001001c6de8
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x00000001001c6a30
- (void)notifyClient:(int)arg1;	// IMP=0x00000001001c69e0
- (void)dealloc;	// IMP=0x00000001001c6994
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x00000001001c6854
