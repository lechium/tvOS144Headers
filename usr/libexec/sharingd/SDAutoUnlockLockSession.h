...
- (void).cxx_destruct;	// IMP=0x00000001001d1d30
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x00000001001d0e20
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x00000001001d0b20
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x00000001001d0388
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x00000001001cff68
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001cfc60
- (void)consumeAuthTokenIfReady;	// IMP=0x00000001001cf6e4
- (void)startAWDL;	// IMP=0x00000001001ceb50
- (void)handleConfirmationACK;	// IMP=0x00000001001ce8f0
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x00000001001ce4bc
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x00000001001cdcb8
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x00000001001cd94c
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x00000001001cd2c4
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00000001001cce20
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001001ccbd0
- (void)handleWiFiRequestInvalidated;	// IMP=0x00000001001ccb64
- (void)handleRangingStarted;	// IMP=0x00000001001ccac4
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x00000001001cc9fc
- (void)handleAWDLUp;	// IMP=0x00000001001cc828
- (void)handlePeerOutOfRange;	// IMP=0x00000001001cc550
- (void)handlePeerInRange;	// IMP=0x00000001001cc3f8
- (_Bool)peerInRange:(id)arg1;	// IMP=0x00000001001cc144
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x00000001001cbce4
- (void)invalidateConfirmationTimer;	// IMP=0x00000001001cbc0c
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00000001001cb988
- (void)handleTimerFired;	// IMP=0x00000001001cb420
- (void)invalidateTimerIfReady;	// IMP=0x00000001001cb3c8
- (id)aksPeerAvailable;	// IMP=0x00000001001cb1c0
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001001cadd8
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x00000001001caae0
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001001caa74
- (void)connectionActivated;	// IMP=0x00000001001ca758
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x00000001001ca13c
- (id)getAppName;	// IMP=0x00000001001ca134
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x00000001001ca000
- (_Bool)isAcceptor;	// IMP=0x00000001001c9ff8
- (id)attemptResults;	// IMP=0x00000001001c9430
- (void)logResults;	// IMP=0x00000001001c8618
- (void)displayConfigChanged:(id)arg1;	// IMP=0x00000001001c8574
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x00000001001c84d0
- (void)removeObservers;	// IMP=0x00000001001c8480
- (void)addObservers;	// IMP=0x00000001001c8378
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x00000001001c8210
- (void)_handleCanceledAfterSuccess;	// IMP=0x00000001001c8108
- (void)handleCanceledAfterSuccess;	// IMP=0x00000001001c807c
- (void)lockKeyBagIfNeeded;	// IMP=0x00000001001c7f98
- (void)_cancel;	// IMP=0x00000001001c7c24
- (void)cancel;	// IMP=0x00000001001c7b98
- (void)invalidateNoDisconnect;	// IMP=0x00000001001c7b64
- (void)invalidate;	// IMP=0x00000001001c7960
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001001c756c
