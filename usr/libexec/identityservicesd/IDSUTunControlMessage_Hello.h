...
- (void).cxx_destruct;	// IMP=0x0000000100163d10
...
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2 loggingPrefixString:(id)arg3;	// IMP=0x0000000100161258
- (id)data;	// IMP=0x00000001001606a4
- (id)init;	// IMP=0x000000010016061c
- (_Bool)_isTinkerFlagSet;	// IMP=0x000000010016059c
- (_Bool)_isSupportIPsecLinkFlagSet;	// IMP=0x000000010016051c
- (id)description;	// IMP=0x0000000100160314
