...
- (void).cxx_destruct;	// IMP=0x0000000100107814
...
- (id)initWithBroadcastBlock:(CDUnknownBlockType)arg1 needsClientAck:(_Bool)arg2 messageUUID:(id)arg3 priority:(long long)arg4 senderID:(id)arg5 sequenceNumber:(unsigned int)arg6;	// IMP=0x00000001001072f4
- (id)init;	// IMP=0x00000001001071c4
