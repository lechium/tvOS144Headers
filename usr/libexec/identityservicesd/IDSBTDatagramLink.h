...
- (void).cxx_destruct;	// IMP=0x00000001000118d8
...
- (id)copyLinkStatsDict;	// IMP=0x00000001000115a4
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x0000000100011208
- (void)_processIncomingPacket;	// IMP=0x0000000100010738
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x00000001000106ac
- (unsigned long long)sendPacketBuffer:(CDStruct_78c9ccae *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x000000010000fbec
- (void)start;	// IMP=0x000000010000f7c4
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)invalidate;	// IMP=0x000000010000f3f4
- (void)dealloc;	// IMP=0x000000010000f390
- (id)initWithPipe:(id)arg1 withDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x000000010000f09c
