...
- (void).cxx_destruct;	// IMP=0x00000001001b0ea0
...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x00000001001b0a70
- (void)sendMonitorMessage;	// IMP=0x00000001001b0048
- (void)checkConnectivityState:(id)arg1;	// IMP=0x00000001001afc0c
- (id)init;	// IMP=0x00000001001afa6c
