...
- (void).cxx_destruct;	// IMP=0x00000001000b192c
...
- (void)decryptData:(id)arg1 usingIdentifier:(id)arg2 onQueue:(id)arg3 isRetry:(_Bool)arg4 replayKey:(id)arg5 withCompletion:(CDUnknownBlockType)arg6;	// IMP=0x00000001000aebbc
- (void)encryptData:(id)arg1 onQueue:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000ad264
- (id)encryptData:(id)arg1 usedIdentifier:(id *)arg2 error:(id *)arg3;	// IMP=0x00000001000ad098
- (_Bool)_isReplayError:(id)arg1;	// IMP=0x00000001000ace74
- (id)_lookupIdentityWithLastResortFallback:(_Bool *)arg1;	// IMP=0x00000001000acab0
- (id)_lookupEndpoint;	// IMP=0x00000001000ac934
- (void)setupWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5;	// IMP=0x00000001000ac7e0
- (id)initWithPeerIDManager:(id)arg1 fullDeviceIdentityContainerEncrypter:(id)arg2 rateLimiter:(id)arg3 replayCommitter:(id)arg4 publicIdentityCache:(id)arg5 avoidMainQueue:(_Bool)arg6;	// IMP=0x00000001000ac5fc
