...
- (void).cxx_destruct;	// IMP=0x000000010009408c
...
- (void)copyOpportunisticCacheWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100093bdc
- (id)initWithQueue:(id)arg1 connection:(id)arg2 opportunisticCache:(id)arg3;	// IMP=0x0000000100093a9c
