...
+ (id)entryFromPublicDataRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100171b30
- (void).cxx_destruct;	// IMP=0x0000000100172608
...
- (id)description;	// IMP=0x0000000100172270
- (id)publicDataRepresentationWithError:(id *)arg1;	// IMP=0x0000000100171f00
- (id)initWithStableGroupID:(id)arg1 groupServerEntry:(id)arg2;	// IMP=0x00000001001718a4
