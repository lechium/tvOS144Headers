...
- (void).cxx_destruct;	// IMP=0x000000010007a470
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000010007a0a0
- (double)anisetteHeadersTimeout;	// IMP=0x000000010007a088
- (id)messageBody;	// IMP=0x000000010007a01c
- (id)requiredKeys;	// IMP=0x0000000100079fb0
- (id)bagKey;	// IMP=0x0000000100079f94
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100079dd0
- (id)init;	// IMP=0x0000000100079d04
