...
- (void).cxx_destruct;	// IMP=0x0000000100055b34
...
- (void)dealloc;	// IMP=0x0000000100055a84
- (id)initWithPacketBuffer:(CDStruct_78c9ccae *)arg1 metadata:(const char *)arg2 metadataSize:(unsigned int)arg3;	// IMP=0x0000000100055898
- (id)initWithBytesBuffer:(char *)arg1 bufferSize:(unsigned int)arg2 metadata:(const char *)arg3 metadataSize:(unsigned int)arg4;	// IMP=0x00000001000556ac
