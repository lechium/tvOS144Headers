...
- (id)initWithUsedLastResortCache:(_Bool)arg1 usedCachedData:(_Bool)arg2;	// IMP=0x00000001001ce5b8
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x00000001001ce538
- (id)init;	// IMP=0x00000001001ce4bc
- (id)initWithEncryptionType:(long long)arg1 usedLastResortCache:(_Bool)arg2 usedCachedData:(_Bool)arg3;	// IMP=0x00000001001ce3c4
