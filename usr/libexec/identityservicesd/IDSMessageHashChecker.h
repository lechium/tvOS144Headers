...
- (void).cxx_destruct;	// IMP=0x00000001001a9f8c
...
- (id)_legacyIdentity;	// IMP=0x00000001001a9dd0
- (_Bool)allowMessageData:(id)arg1 withDelayedCommitBlock:(CDUnknownBlockType *)arg2;	// IMP=0x00000001001a9ae0
- (_Bool)allowMessageData:(id)arg1;	// IMP=0x00000001001a98f8
- (id)initWithRegistrationKeyManager:(id)arg1 messageHashStore:(id)arg2 usePairingKey:(_Bool)arg3;	// IMP=0x00000001001a97bc
- (id)initWithRegistrationKeyManager:(id)arg1;	// IMP=0x00000001001a96b4
