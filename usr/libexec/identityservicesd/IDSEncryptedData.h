...
- (void).cxx_destruct;	// IMP=0x0000000100138fe8
...
- (id)description;	// IMP=0x0000000100138eb0
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x0000000100138d7c
