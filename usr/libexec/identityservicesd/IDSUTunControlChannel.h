...
- (void).cxx_destruct;	// IMP=0x00000001001bb8b4
...
- (void)resumeOTRNegotiation;	// IMP=0x00000001001bb414
- (void)suspendOTRNegotiation:(id)arg1;	// IMP=0x00000001001bb378
- (_Bool)processSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00000001001badb4
- (void)sendSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00000001001baaac
- (_Bool)processOTRNegotiationMessage:(id)arg1;	// IMP=0x00000001001ba0f4
- (void)sendOTRNegotiationMessage:(id)arg1 negotiationCount:(unsigned int)arg2 negotiationData:(id)arg3;	// IMP=0x00000001001b9bfc
- (void)_destroyFairplayDeviceSession;	// IMP=0x00000001001b9be8
- (void)_destroyFairplayHostSession;	// IMP=0x00000001001b9ae0
- (void)_handleFairplayAuthenticationFailure;	// IMP=0x00000001001b9a04
- (_Bool)processFairplayDeviceSessionInfo:(id)arg1;	// IMP=0x00000001001b93b8
- (_Bool)processFairplayDeviceInfo:(id)arg1;	// IMP=0x00000001001b8ee0
- (_Bool)processFairplayHostSessionInfo:(id)arg1;	// IMP=0x00000001001b8e84
- (id)_utunControlMessageFairplayDeviceSessionInfo:(char *)arg1 grappaDeviceSessionInfoSize:(unsigned int)arg2;	// IMP=0x00000001001b8e60
- (id)_utunControlMessageFairplayHostSessionInfo:(unsigned char)arg1 deviceType:(unsigned char)arg2 protocolVersion:(unsigned int)arg3;	// IMP=0x00000001001b8abc
- (id)_utunControlMessageFairplayDeviceInfo;	// IMP=0x00000001001b8aa0
- (void)dealloc;	// IMP=0x00000001001b8a3c
- (void)invalidate;	// IMP=0x00000001001b89c0
- (void)sendPriorityMessage:(id)arg1;	// IMP=0x00000001001b8908
- (void)sendMessage:(id)arg1;	// IMP=0x00000001001b8850
- (void)_checkSendNewMessage;	// IMP=0x00000001001b6ca0
- (void)_clearChannel;	// IMP=0x00000001001b6acc
@property(readonly, nonatomic) _Bool connected;
- (void)cancelConnection;	// IMP=0x00000001001b6a54
- (void)_cancelConnectionAndResetDataConnections:(_Bool)arg1 shouldObliterate:(_Bool)arg2 encryptionFailure:(_Bool)arg3 shouldTriggerCorruptionRecovery:(_Bool)arg4;	// IMP=0x00000001001b6810
- (void)_callHandlerWithMessage:(id)arg1 resetDataConnections:(_Bool)arg2 shouldObliterate:(_Bool)arg3 decryptionFailed:(_Bool)arg4 shouldTriggerCorruptionRecovery:(_Bool)arg5;	// IMP=0x00000001001b6744
- (void)useConnection:(id)arg1 withFirstMessage:(id)arg2;	// IMP=0x00000001001b5478
- (void)writeToConnection;	// IMP=0x00000001001b4a88
- (void)readFromConnection;	// IMP=0x00000001001b26e4
@property(readonly, nonatomic) _Bool isDefaultPairedDeviceStartingToEncrypt;
- (void)encryptControlChannelForStoredIdentities;	// IMP=0x00000001001b2308
- (void)simulateDecryptionFailure;	// IMP=0x00000001001b222c
- (void)_cleanupConnection;	// IMP=0x00000001001b2174
- (id)initWithDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 receiveHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001b1e44
- (id)description;	// IMP=0x00000001001b1cf0
