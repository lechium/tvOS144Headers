...
+ (id)agentFromData:(id)arg1;	// IMP=0x000000010005afb8
+ (id)agentType;	// IMP=0x000000010005af98
+ (id)agentDomain;	// IMP=0x000000010005af18
- (void).cxx_destruct;	// IMP=0x000000010005c068
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x000000010005bda4
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x000000010005bb88
- (_Bool)startAgentWithOptions:(id)arg1;	// IMP=0x000000010005b96c
- (void)closeNexusWithOptions:(id)arg1;	// IMP=0x000000010005b710
- (_Bool)requestNexusWithOptions:(id)arg1;	// IMP=0x000000010005b34c
...
- (id)copyAgentData;	// IMP=0x000000010005b024
