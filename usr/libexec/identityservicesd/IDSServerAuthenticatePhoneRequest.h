...
- (void).cxx_destruct;	// IMP=0x000000010002d2b8
...
- (id)initWithUser:(id)arg1 phoneSignature:(id)arg2 certificateSigningRequest:(id)arg3 pushToken:(id)arg4;	// IMP=0x000000010002d0c4
