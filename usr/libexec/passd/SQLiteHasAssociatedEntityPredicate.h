...
+ (id)predicateWithAssociatedEntityClass:(Class)arg1;	// IMP=0x0000000100053cc4
- (void).cxx_destruct;	// IMP=0x0000000100053efc
- (id)SQLForEntityClass:(Class)arg1;	// IMP=0x0000000100053cf4
