...
- (void).cxx_destruct;	// IMP=0x0000000100078030
...
- (unsigned long long)hash;	// IMP=0x0000000100077f50
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100077ea4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100077dbc
