...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x0000000100056f18
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100056e58
- (void)dealloc;	// IMP=0x0000000100056df8
