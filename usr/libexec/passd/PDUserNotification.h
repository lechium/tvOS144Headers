...
+ (_Bool)supportsCoalescing;	// IMP=0x0000000100142b9c
+ (_Bool)allowReinsertionAfterDismissal;	// IMP=0x0000000100142b94
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001425b8
- (void).cxx_destruct;	// IMP=0x00000001001436ac
...
- (id)notificationContentWithDataSource:(id)arg1;	// IMP=0x0000000100142bbc
- (unsigned long long)coalesceWithExistingUserNotification:(id)arg1;	// IMP=0x0000000100142bb4
@property(readonly, nonatomic) unsigned long long notificationType;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isCashFamilyNotification;	// IMP=0x0000000100142b8c
- (id)description;	// IMP=0x0000000100142a44
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001428a8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001425c0
- (id)initWithNotificationIdentifier:(id)arg1 forPassUniqueIdentifier:(id)arg2;	// IMP=0x00000001001424d4
