...
- (void)applySeedToIntegratorFromControlEffort:(int)arg1 currentTemperature:(float)arg2;	// IMP=0x0000000100009be0
- (_Bool)isIntegratorAtMin;	// IMP=0x0000000100009bd0
- (_Bool)isEqualMType:(int)arg1;	// IMP=0x0000000100009bc0
- (void)calculateControlEffort:(float)arg1;	// IMP=0x0000000100009b40
- (void)dealloc;	// IMP=0x0000000100009af4
- (id)initPIDWith:(struct __CFDictionary *)arg1;	// IMP=0x00000001000099e0
