...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x000000010002ff94
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x000000010002fed0
- (int)numberOfFields;	// IMP=0x000000010002fec8
- (_Bool)isFrontCameraPowered;	// IMP=0x000000010002fec0
- (_Bool)isRearCameraPowered;	// IMP=0x000000010002feb8
- (void)handleOdeonStateNotification:(unsigned long long)arg1;	// IMP=0x000000010002fdd4
- (void)handleFrontCameraPowerStateNotification:(unsigned long long)arg1;	// IMP=0x000000010002fcf0
- (void)handleRearCameraPowerStateNotification:(unsigned long long)arg1;	// IMP=0x000000010002fc0c
- (void)updatePackageFloorsAndCeilings:(_Bool)arg1;	// IMP=0x000000010002fafc
- (void)updateMaxLIFloorsAndCeilings;	// IMP=0x000000010002f624
- (void)updateInternal;	// IMP=0x000000010002e8dc
- (void)update;	// IMP=0x000000010002e86c
- (id)initWithParams:(id)arg1 backlightController:(id)arg2 product:(id)arg3;	// IMP=0x000000010002d394
- (id)init;	// IMP=0x000000010002d37c
