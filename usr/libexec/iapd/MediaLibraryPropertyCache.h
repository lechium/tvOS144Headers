...
- (void)setItemNames:(id)arg1 forRange:(struct _NSRange)arg2;	// IMP=0x000000010003eb74
- (id)itemNamesForRange:(struct _NSRange)arg1;	// IMP=0x000000010003ea64
- (void)removeNonGlobalCache;	// IMP=0x000000010003e9d8
- (void)dealloc;	// IMP=0x000000010003e930
- (id)initForProperty:(id)arg1;	// IMP=0x000000010003e884
- (id)init;	// IMP=0x000000010003e84c
- (id)description;	// IMP=0x000000010003e7a8
