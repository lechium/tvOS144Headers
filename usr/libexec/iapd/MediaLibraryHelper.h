...
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x00000001000e8aec
- (void)applicationsWillUninstall:(id)arg1;	// IMP=0x00000001000e89d8
- (void)applicationsDidInstall:(id)arg1;	// IMP=0x00000001000e88c4
- (int)getFilteredMediaTypesMask:(int)arg1;	// IMP=0x00000001000e8844
- (void)handleAppUninstall:(id)arg1;	// IMP=0x00000001000e8604
- (void)handleAppInstall:(id)arg1;	// IMP=0x00000001000e8400
- (void)dealloc;	// IMP=0x00000001000e8380
- (id)init;	// IMP=0x00000001000e8204
@property(readonly) _Bool iTunesRadioEnabled;
- (void)_updateITunesRadioEnabled;	// IMP=0x00000001000e8100
