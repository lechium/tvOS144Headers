...
+ (id)fetchInfoForBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100004acc
+ (id)entryForBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100004818
+ (_Bool)enumeratePluginKitPluginsInBundle:(id)arg1 updatingPluginParentID:(_Bool)arg2 ensurePluginsAreExecutable:(_Bool)arg3 installProfiles:(_Bool)arg4 error:(id *)arg5 enumerator:(CDUnknownBlockType)arg6;	// IMP=0x0000000100004154
...
- (_Bool)performGatherWithError:(id *)arg1;	// IMP=0x000000010000577c
- (void)errorOccurred:(id)arg1;	// IMP=0x00000001000056f0
- (_Bool)scanExecutableBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005394
- (id)_setForEntry:(id)arg1;	// IMP=0x000000010000516c
- (_Bool)_scanBundle:(id)arg1 inBundleContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100004ed8
- (id)initWithEnumerator:(CDUnknownBlockType)arg1;	// IMP=0x0000000100003f98
