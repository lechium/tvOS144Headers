...
+ (_Bool)_validateStubSignature:(id)arg1 withSigningID:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100057ef4
+ (_Bool)_validateBundleExecutable:(id)arg1 againstStubAt:(id)arg2 trustedHashes:(id)arg3 sectionName:(id)arg4 signingIdentifier:(id)arg5 error:(id *)arg6;	// IMP=0x00000001000575c8
+ (_Bool)validateWatchKitV2StubExecutableBundle:(id)arg1 error:(id *)arg2;	// IMP=0x000000010005735c
+ (_Bool)validateWatchKitV1StubExecutableBundle:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000570f0
+ (id)_validateSignatureAndCopyInfoForURL:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100055b74
+ (id)codeSigningVerifierForBundle:(id)arg1;	// IMP=0x0000000100055b20
- (void).cxx_destruct;	// IMP=0x00000001000582a0
...
- (_Bool)performValidationWithError:(id *)arg1;	// IMP=0x000000010005601c
- (id)_loadSystemDetachedSignatureForBundleID:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100055e84
- (id)initWithBundle:(id)arg1;	// IMP=0x0000000100055aa0
