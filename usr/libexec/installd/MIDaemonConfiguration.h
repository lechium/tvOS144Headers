...
+ (id)sharedInstance;	// IMP=0x0000000100023b58
...
- (id)diskImageMountPoints;	// IMP=0x0000000100024114
- (id)diskImageAppBundleIDToInfoMap;	// IMP=0x0000000100023f94
...
- (id)init;	// IMP=0x00000001000236dc
