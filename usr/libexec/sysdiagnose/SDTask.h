...
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 asUID:(unsigned int)arg3 outputFile:(id)arg4;	// IMP=0x000000010003673c
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 inBootstrapDomainOfUID:(unsigned int)arg3 outputFile:(id)arg4;	// IMP=0x00000001000366bc
+ (id)shellTaskWithCommand:(id)arg1 outputFile:(id)arg2;	// IMP=0x00000001000365b8
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3 withRuntimeChecks:(unsigned long long)arg4;	// IMP=0x0000000100036518
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3;	// IMP=0x0000000100036490
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3 withSubDir:(id)arg4;	// IMP=0x00000001000363f0
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3 taskDelegate:(id)arg4;	// IMP=0x0000000100036350
+ (id)taskWithCommand:(id)arg1 arguments:(id)arg2 outputFile:(id)arg3 withSubDir:(id)arg4 taskDelegate:(id)arg5;	// IMP=0x0000000100036238
...
- (int)signalRunningTask:(int)arg1;	// IMP=0x000000010003a4c8
- (_Bool)resume;	// IMP=0x000000010003a4a0
- (_Bool)suspend;	// IMP=0x000000010003a478
- (void)interrupt;	// IMP=0x000000010003a468
- (void)terminate;	// IMP=0x000000010003a458
- (int)_launch;	// IMP=0x0000000100039ab4
- (void)_waitForExitInformation;	// IMP=0x00000001000395fc
- (void)_stop;	// IMP=0x00000001000388f4
- (int)_start;	// IMP=0x0000000100037074
- (id)fileHandleForError;	// IMP=0x0000000100036dd4
- (id)fileHandleForOutput;	// IMP=0x00000001000367d4
- (id)description;	// IMP=0x0000000100036194
- (id)init;	// IMP=0x0000000100035f4c
- (void *)SDTaskPOSIXSpawnAttributes;	// IMP=0x0000000100035bf0
