...
@interface MRDDiagnostic : NSObject
{
    ...
    MRDCompanionConnectionController *_companionEndpoint;	// 272 = 0x110
    NSArray *_hostedDiscoverySessions;	// 280 = 0x118
    NSArray *_endpoints;	// 288 = 0x120
    NSDictionary *_hostedExternalDevices;	// 296 = 0x128
    NSArray *_recordingEndpointClients;	// 304 = 0x130
    NSArray *_registeredVirtualAudioDevices;	// 312 = 0x138
    NSArray *_transactions;	// 320 = 0x140
    unsigned long long _usedTransactionMemory;	// 328 = 0x148
    unsigned long long _allowedTransactionMemory;	// 336 = 0x150
    double _transactionWaitDuration;	// 344 = 0x158
}

- (void).cxx_destruct;	// IMP=0x00000001000954f4
...
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4 usingDebugDescription:(_Bool)arg5;	// IMP=0x0000000100094f18
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4;	// IMP=0x0000000100094e98
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x0000000100094e24
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 usingDebugDescription:(_Bool)arg4;	// IMP=0x0000000100094d5c
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x0000000100094cec
- (void)_appendSubheader:(id)arg1 toString:(id)arg2;	// IMP=0x0000000100094c9c
- (id)createDiagnosticInfo;	// IMP=0x0000000100094128
- (id)init;	// IMP=0x00000001000940c4
