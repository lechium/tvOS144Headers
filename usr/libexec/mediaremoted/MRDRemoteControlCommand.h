...
- (void).cxx_destruct;	// IMP=0x00000001000b8b40
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x00000001000b8a38
- (id)_optionsDictionary;	// IMP=0x00000001000b89b0
- (void)_setCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000b8978
- (CDUnknownBlockType)_completionHandler;	// IMP=0x00000001000b8960
- (id)optionValueForKey:(struct __CFString *)arg1;	// IMP=0x00000001000b8904
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b8318
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b82e0
- (id)debugDescription;	// IMP=0x00000001000b818c
- (id)description;	// IMP=0x00000001000b8068
- (id)initWithCommandType:(unsigned int)arg1 playerPath:(id)arg2 unresolvedPlayerPath:(id)arg3 senderAppDisplayID:(id)arg4 optionsData:(id)arg5;	// IMP=0x00000001000b7ec0
