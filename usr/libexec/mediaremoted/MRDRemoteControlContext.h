...
- (void).cxx_destruct;	// IMP=0x0000000100013650
...
- (void)clearRoutedCommands;	// IMP=0x00000001000135d4
- (void)addRoutedCommand:(id)arg1;	// IMP=0x00000001000133e4
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x00000001000131d8
