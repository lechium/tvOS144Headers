...
- (id)_newIOKitDeviceProperties;	// IMP=0x00000001000b0228
- (_Bool)handleTouchEvent:(struct _MRHIDTouchEvent)arg1;	// IMP=0x00000001000afe98
- (_Bool)handleHIDReport:(id)arg1;	// IMP=0x00000001000afd68
- (id)deviceProperties;	// IMP=0x00000001000afd20
- (void)dealloc;	// IMP=0x00000001000afcd4
- (id)initWithDeviceDescriptor:(id)arg1;	// IMP=0x00000001000afb7c
