...
- (void).cxx_destruct;	// IMP=0x00000001000b95b0
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x00000001000b9504
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b94c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b948c
