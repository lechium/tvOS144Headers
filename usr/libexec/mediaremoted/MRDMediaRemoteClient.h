...
- (void).cxx_destruct;	// IMP=0x00000001000ae55c
...
- (void)_wakeDevice:(_Bool)arg1 dismissScreenSaver:(_Bool)arg2 reason:(id)arg3;	// IMP=0x00000001000ae29c
- (id)_createNotificationMessage:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000001000ae1c4
- (id)_runAssertionName;	// IMP=0x00000001000ae174
- (void)_invalidate;	// IMP=0x00000001000ae0c8
- (void)_handleXPCMessage:(id)arg1;	// IMP=0x00000001000ae054
- (id)createNowPlayingClient;	// IMP=0x00000001000adfc8
- (_Bool)hasRegisteredCustomOrigin:(id)arg1;	// IMP=0x00000001000ade78
- (void)removeRegisteredCustomOrigin:(id)arg1;	// IMP=0x00000001000adce4
- (void)addRegisteredCustomOrigin:(id)arg1;	// IMP=0x00000001000adb48
- (id)registeredCustomOrigins;	// IMP=0x00000001000ada48
- (void)_relayXPCMessage:(id)arg1 andReply:(_Bool)arg2 resultCallback:(CDUnknownBlockType)arg3;	// IMP=0x00000001000ad4b0
- (void)relayXPCMessage:(id)arg1 andReply:(_Bool)arg2 resultCallback:(CDUnknownBlockType)arg3;	// IMP=0x00000001000ad208
- (void)relayXPCMessage:(id)arg1 andReply:(_Bool)arg2;	// IMP=0x00000001000ad1f8
- (void)sendRemoteControlCommand:(id)arg1 withCompletionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001000ac55c
- (_Bool)takeAssertionAndBlessForReason:(id)arg1;	// IMP=0x00000001000abe78
- (void)postNotification:(id)arg1;	// IMP=0x00000001000abba4
- (void)_onConnectionQueue_postNotification:(id)arg1;	// IMP=0x00000001000ab6ac
- (void)_onConnectionQueue_connectionResumed;	// IMP=0x00000001000ab31c
- (void)_onConnectionQueue_connectionSuspended;	// IMP=0x00000001000ab268
- (void)flushPendingPlaybackSessionMigrateEvents:(CDUnknownBlockType)arg1;	// IMP=0x00000001000aafdc
- (_Bool)removePendingPlaybackSessionMigrateEvent:(id)arg1;	// IMP=0x00000001000aae60
- (void)addPendingPlaybackSessionMigrateEvent:(id)arg1 playerPath:(id)arg2;	// IMP=0x00000001000aacec
@property(copy, nonatomic) NSArray *applicationPickedRoutes;
@property(readonly, nonatomic) _Bool isActive;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000aa71c
- (id)debugDescription;	// IMP=0x00000001000aa4e0
- (id)description;	// IMP=0x00000001000aa428
@property(readonly, nonatomic) NSString *displayName;
@property(readonly, nonatomic) NSData *auditToken;
@property(readonly, nonatomic) int pid;
- (void)dealloc;	// IMP=0x00000001000aa120
- (id)initWithConnection:(id)arg1;	// IMP=0x00000001000a9a64
