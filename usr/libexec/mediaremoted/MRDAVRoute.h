...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b9128
- (void).cxx_destruct;	// IMP=0x00000001000b9320
...
- (unsigned long long)sampleRate;	// IMP=0x00000001000b92c0
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x00000001000b9248
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000001000b91a8
