...
- (id)_fp_getNumberWithQueryOptions:(int)arg1;	// IMP=0x000000010006ea88
...
- (id)lib_gzippedData;	// IMP=0x00000001001eaf10
- (void)lib_enumerateSubdataWithOffset:(unsigned long long)arg1 length:(unsigned long long)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000001001eadf8
