...
+ (id)_titleForProtectionSpace:(id)arg1;	// IMP=0x00000001000dbd30
+ (id)_messageForProtectionSpace:(id)arg1;	// IMP=0x00000001000dba74
- (void).cxx_destruct;	// IMP=0x00000001000dbe20
...
- (id)initWithAuthenticationChallenge:(id)arg1;	// IMP=0x00000001000db934
