...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x00000001000ad2ec
- (void).cxx_destruct;	// IMP=0x00000001000ad980
...
- (id)description;	// IMP=0x00000001000ad258
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x00000001000acfb4
