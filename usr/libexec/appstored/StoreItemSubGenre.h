...
- (void).cxx_destruct;	// IMP=0x00000001002d9398
@property(readonly) NSNumber *genreID; // @synthesize genreID=_genreID;
@property(readonly) NSString *genre; // @synthesize genre=_genre;
- (void)_parseDictionary:(id)arg1;	// IMP=0x00000001002d92ec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002d9254
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000001002d91e0
