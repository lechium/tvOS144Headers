...
+ (id)doesNotContainPredicateWithProperty:(id)arg1 values:(id)arg2;	// IMP=0x00000001002b64e4
+ (id)containsPredicateWithProperty:(id)arg1 query:(id)arg2 queryProperty:(id)arg3;	// IMP=0x00000001002b63e0
+ (id)containsPredicateWithProperty:(id)arg1 values:(id)arg2;	// IMP=0x00000001002b6318
- (void).cxx_destruct;	// IMP=0x00000001002b6b98
...
- (id)SQLForEntityClass:(Class)arg1;	// IMP=0x00000001002b6958
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001002b6718
- (void)applyBinding:(id)arg1 atIndex:(inout int *)arg2;	// IMP=0x00000001002b65b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002b65b0
