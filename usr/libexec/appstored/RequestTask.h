...
- (void).cxx_destruct;	// IMP=0x000000010013565c
...
- (void)_setResponse:(id)arg1;	// IMP=0x00000001001355b0
@property(readonly) ASDRequestResponse *response; // @synthesize response=_response;
- (id)initForClient:(id)arg1 withOptions:(id)arg2;	// IMP=0x0000000100135400
