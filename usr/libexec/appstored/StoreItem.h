...
+ (id)itemWithDictionary:(id)arg1;	// IMP=0x0000000100282288
- (void).cxx_destruct;	// IMP=0x0000000100283754
...
- (void)_parseMetadataFromDictionary:(id)arg1;	// IMP=0x0000000100282c5c
- (void)_parseAssetsFromDictionary:(id)arg1 applyingAssetStrategy:(long long)arg2 withInstalledItem:(id)arg3;	// IMP=0x0000000100282a08
- (id)description;	// IMP=0x0000000100282964
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002824b0
- (id)copyWritableMetadataForAccount:(id)arg1 includeVariant:(_Bool)arg2;	// IMP=0x00000001002823e4
- (id)copyWritableMetadataForAccount:(id)arg1;	// IMP=0x00000001002823d4
- (id)initWithDictionary:(id)arg1 applyingAssetStrategy:(long long)arg2 installedItem:(id)arg3;	// IMP=0x00000001002822e0
- (id)_newDateFormatter;	// IMP=0x0000000100283a04
