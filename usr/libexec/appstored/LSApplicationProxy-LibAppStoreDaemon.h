...
- (_Bool)_lib_isValidDSID:(id)arg1;	// IMP=0x0000000100240064
- (id)lib_storeMetadataError:(id *)arg1;	// IMP=0x000000010023ffcc
- (id)lib_extensionType:(long long)arg1;	// IMP=0x000000010023fe38
