...
- (void).cxx_destruct;	// IMP=0x0000000100211650
- (void)_updateStatisticsFromSnapshots;	// IMP=0x00000001002114a8
- (void)setCurrentValue:(unsigned long long)arg1;	// IMP=0x00000001002112b4
@property(readonly, nonatomic) double estimatedTimeRemaining;
- (id)initWithMaxValue:(unsigned long long)arg1;	// IMP=0x0000000100211160
