...
- (void).cxx_destruct;	// IMP=0x0000000100281d1c
...
- (void)handleDialogRequest:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100281c00
- (void)handleAuthenticateRequest:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100281b7c
- (void)main;	// IMP=0x0000000100281800
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x0000000100281794
