...
- (void).cxx_destruct;	// IMP=0x0000000100170bec
- (void)main;	// IMP=0x000000010017038c
- (void)_setProcessedExternalIDs:(id)arg1;	// IMP=0x000000010017030c
@property(readonly) NSArray *processedExternalIDs; // @synthesize processedExternalIDs=_processedExternalIDs;
- (id)initWithEnterpriseApps:(id)arg1 isXDCRequest:(_Bool)arg2 requestToken:(id)arg3;	// IMP=0x00000001001701f0
