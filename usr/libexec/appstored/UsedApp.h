...
- (void).cxx_destruct;	// IMP=0x00000001000b6078
...
- (id)description;	// IMP=0x00000001000b5fd4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b5f20
- (id)initWithBundleID:(id)arg1;	// IMP=0x00000001000b5ebc
