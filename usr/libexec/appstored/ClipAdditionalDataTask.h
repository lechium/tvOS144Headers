...
+ (void)addRequiredBagKeysToAggregator:(id)arg1;	// IMP=0x0000000100006b88
+ (id)bagKeySet;	// IMP=0x0000000100006a9c
- (void).cxx_destruct;	// IMP=0x0000000100006dcc
...
- (id)_requestParameters;	// IMP=0x0000000100006c6c
- (id)perform;	// IMP=0x000000010000635c
- (id)initWithBag:(id)arg1;	// IMP=0x00000001000062a8
