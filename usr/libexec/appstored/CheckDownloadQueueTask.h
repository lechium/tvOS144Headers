...
- (void).cxx_destruct;	// IMP=0x00000001000e3ff8
...
- (void)_setItems:(id)arg1;	// IMP=0x00000001000e3fa4
- (void)_runPendingCancelDownloadOperations;	// IMP=0x00000001000e3ed8
- (id)_metadataForStoreItems:(id)arg1;	// IMP=0x00000001000e3b70
- (id)_requestURL:(id *)arg1;	// IMP=0x00000001000e3a94
- (id)_newBaseRequestBodyDictionaryWithAccountID:(id)arg1;	// IMP=0x00000001000e3950
- (void)main;	// IMP=0x00000001000e3304
@property(readonly) long long numberOfAvailableDownloads; // @synthesize numberOfAvailableDownloads=_numberOfAvailableDownloads;
- (id)initWithDownloadQueueType:(long long)arg1;	// IMP=0x00000001000e326c
- (id)init;	// IMP=0x00000001000e3228
