...
- (void).cxx_destruct;	// IMP=0x000000010015df10
...
- (id)_authenticateAccount:(id)arg1 withClientInfo:(id)arg2 error:(id *)arg3;	// IMP=0x000000010015d9d4
- (id)_runRequestWithError:(id *)arg1;	// IMP=0x000000010015d758
- (void)main;	// IMP=0x000000010015cfa4
- (id)initWithClient:(id)arg1;	// IMP=0x000000010015ce78
