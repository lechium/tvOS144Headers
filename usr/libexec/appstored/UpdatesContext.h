...
+ (id)contextWithReason:(long long)arg1;	// IMP=0x0000000100080178
+ (id)defaultContext;	// IMP=0x000000010008013c
- (void).cxx_destruct;	// IMP=0x0000000100080420
...
- (void)_setLogKey:(id)arg1;	// IMP=0x0000000100080388
...
- (id)humanReadableReason;	// IMP=0x0000000100080260
- (id)init;	// IMP=0x00000001000801b8
