...
+ (Class)provisioningProfileType;	// IMP=0x0000000100278f58
- (void).cxx_destruct;	// IMP=0x000000010027c218
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010027b9a8
- (unsigned long long)hash;	// IMP=0x000000010027b614
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010027b020
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010027aa14
- (void)writeTo:(id)arg1;	// IMP=0x000000010027a558
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010027a550
- (id)dictionaryRepresentation;	// IMP=0x000000010027924c
- (id)description;	// IMP=0x0000000100279198
...
- (id)provisioningProfileAtIndex:(unsigned long long)arg1;	// IMP=0x0000000100278f40
- (unsigned long long)provisioningProfilesCount;	// IMP=0x0000000100278f28
- (void)addProvisioningProfile:(id)arg1;	// IMP=0x0000000100278eb4
- (void)clearProvisioningProfiles;	// IMP=0x0000000100278e9c
