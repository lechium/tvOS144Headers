...
- (void).cxx_destruct;	// IMP=0x000000010016c264
...
- (void)softFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x000000010016c194
- (void)itemSucceeded:(id)arg1 storeItem:(id)arg2;	// IMP=0x000000010016be80
- (void)hardFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x000000010016bde8
- (id)initWithItems:(id)arg1 account:(id)arg2;	// IMP=0x000000010016b9d4
