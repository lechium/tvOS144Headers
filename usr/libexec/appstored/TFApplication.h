...
- (void).cxx_destruct;	// IMP=0x000000010011c4cc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010011c2f4
- (unsigned long long)hash;	// IMP=0x000000010011c1e8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010011c020
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010011beac
- (void)copyTo:(id)arg1;	// IMP=0x000000010011bd84
- (void)writeTo:(id)arg1;	// IMP=0x000000010011bc78
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010011bc70
- (id)dictionaryRepresentation;	// IMP=0x000000010011b66c
- (id)description;	// IMP=0x000000010011b5b8
