...
+ (id)contextWithBundleID:(id)arg1 transactionID:(unsigned long long)arg2;	// IMP=0x00000001000e7160
+ (id)contextWithBundleID:(id)arg1;	// IMP=0x00000001000e70f4
- (void).cxx_destruct;	// IMP=0x00000001000e71f8
...
- (id)init;	// IMP=0x00000001000e704c
