...
- (void).cxx_destruct;	// IMP=0x000000010000dd7c
...
- (void)pushToTestLog:(id)arg1;	// IMP=0x000000010000dbf0
- (id)description;	// IMP=0x000000010000db60
- (void)appendDownloadedFileSize:(long long)arg1;	// IMP=0x000000010000da60
- (void)processServerRangeResponse:(id)arg1;	// IMP=0x000000010000d930
- (id)getRangeHeaderForDownload;	// IMP=0x000000010000d748
- (_Bool)isDownloadComplete;	// IMP=0x000000010000d5b0
- (id)init;	// IMP=0x000000010000d56c
