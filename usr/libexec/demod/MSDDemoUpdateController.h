...
+ (id)sharedInstance;	// IMP=0x00000001000375c0
- (void).cxx_destruct;	// IMP=0x000000010003b28c
...
- (void)setAutomatedDeviceGroupStoreID;	// IMP=0x000000010003adfc
- (void)setMacSpecificSettings;	// IMP=0x000000010003adf8
- (void)setTVSpecificSettings;	// IMP=0x000000010003acc8
- (_Bool)migrateDataWithBlockingUI:(int)arg1;	// IMP=0x000000010003a85c
- (_Bool)PLHasCompletedMomentAnalysis;	// IMP=0x000000010003a7b0
- (_Bool)PLHasCompletedRestorePostProcessing;	// IMP=0x000000010003a704
- (_Bool)removeLowerPriorityAppsTillFreeSpace:(long long)arg1;	// IMP=0x000000010003a214
- (void)loadInstallationOrder:(id)arg1;	// IMP=0x0000000100039e44
- (void)checkWithTimeKeeper:(id)arg1;	// IMP=0x0000000100039c48
- (_Bool)continueToUpdateDemoContentWithServer:(id)arg1;	// IMP=0x0000000100039a18
- (_Bool)updateDemoContentWithServer:(id)arg1;	// IMP=0x0000000100038008
- (_Bool)enrollWithServer:(id)arg1 name:(id)arg2 pairingCredential:(id)arg3 error:(id *)arg4;	// IMP=0x000000010003794c
- (_Bool)enrolledWith:(id)arg1;	// IMP=0x0000000100037840
- (void)getDemoUpdateInProgress:(_Bool *)arg1 operationAllowed:(_Bool *)arg2;	// IMP=0x000000010003779c
- (id)init;	// IMP=0x000000010003762c
