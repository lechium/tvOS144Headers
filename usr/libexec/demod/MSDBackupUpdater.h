...
+ (id)sharedInstance;	// IMP=0x00000001000441bc
- (void).cxx_destruct;	// IMP=0x0000000100045200
...
- (_Bool)installProvisioningProfiles;	// IMP=0x0000000100044d34
- (id)namesForBackupsOfRange:(struct _NSRange)arg1;	// IMP=0x0000000100044b98
- (_Bool)updateBackup:(struct _NSRange)arg1 error:(id *)arg2;	// IMP=0x00000001000442f0
- (id)init;	// IMP=0x0000000100044228
