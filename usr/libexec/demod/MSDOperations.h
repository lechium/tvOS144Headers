...
- (void).cxx_destruct;	// IMP=0x000000010002f2dc
...
- (_Bool)restoreAllAttributesFromManifest;	// IMP=0x000000010002f048
- (_Bool)processAlreadyHaveList:(id)arg1;	// IMP=0x000000010002e6ac
- (_Bool)downloadAndVerifyFile:(id)arg1 to:(id)arg2 withError:(id *)arg3;	// IMP=0x000000010002e1ac
- (_Bool)downloadCreationList:(id)arg1;	// IMP=0x000000010002d770
- (_Bool)processCreationList:(id)arg1;	// IMP=0x000000010002c1b0
- (_Bool)verify;	// IMP=0x000000010002ba24
- (_Bool)process:(id *)arg1;	// IMP=0x000000010002b5b4
- (id)initWithMasterManifest:(id)arg1 andDeviceManifest:(id)arg2 forSection:(id)arg3;	// IMP=0x000000010002aebc
