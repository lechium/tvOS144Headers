...
+ (id)sharedInstance;	// IMP=0x00000001000756b4
- (void).cxx_destruct;	// IMP=0x0000000100077de0
...
- (void)demoUpdateCompleted:(id)arg1;	// IMP=0x0000000100077d38
- (void)demoUpdateAllowCancel:(_Bool)arg1;	// IMP=0x0000000100077a6c
- (void)demoUpdateProgress:(long long)arg1;	// IMP=0x0000000100077780
- (void)demoUpdateFailed:(id)arg1;	// IMP=0x00000001000771dc
- (_Bool)launchFullScreenUI_tv;	// IMP=0x0000000100076d60
- (void)handleFullScreenUIAppStateChange:(unsigned int)arg1;	// IMP=0x00000001000769c0
- (void)deactivateFullScreenUIAppMonitor;	// IMP=0x000000010007692c
- (void)activateFullScreenUIAppMonitor;	// IMP=0x0000000100076724
- (_Bool)launchFullScreenUI;	// IMP=0x00000001000766b0
- (void)requestFullScreenUI;	// IMP=0x0000000100076478
- (void)fullScreenUICanceledByUser;	// IMP=0x0000000100076334
- (void)stopFullScreenUI:(id)arg1;	// IMP=0x0000000100075d84
- (void)startFullScreenUIWith:(id)arg1 allowCancel:(_Bool)arg2;	// IMP=0x0000000100075b10
@property(retain) NSObject<OS_xpc_object> *connection; // @synthesize connection=_connection;
- (id)init;	// IMP=0x0000000100075720
