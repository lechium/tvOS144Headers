...
+ (id)purgeOpAtUrgency:(int)arg1 info:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000010003f85c
- (void).cxx_destruct;	// IMP=0x000000010003f90c
...
- (id)initWithUrgency:(int)arg1 info:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000010003f7a4
