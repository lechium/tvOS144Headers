...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000212d8
- (unsigned long long)hash;	// IMP=0x0000000100021278
- (id)copy;	// IMP=0x000000010002122c
- (id)initWithType:(int)arg1 appId:(id)arg2 createTime:(id)arg3;	// IMP=0x0000000100021170
