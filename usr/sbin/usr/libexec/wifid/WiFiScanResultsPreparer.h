...
+ (_Bool)wifiNetworkShouldBeProminentlyDisplayed:(struct __WiFiNetwork *)arg1;	// IMP=0x00000001000e792c
...
- (id)topRecommendableNetwork;	// IMP=0x00000001000e7a00
- (void)_prepareScanResults:(id)arg1;	// IMP=0x00000001000e70e0
- (void)dealloc;	// IMP=0x00000001000e7078
- (id)initWithManager:(struct __WiFiDeviceManager *)arg1 availabilityEngine:(id)arg2 scanResults:(id)arg3 disableProminentFiltering:(_Bool)arg4 blacklistedSSIDs:(id)arg5;	// IMP=0x00000001000e6fb4
- (id)initWithManager:(struct __WiFiDeviceManager *)arg1 availabilityEngine:(id)arg2 scanResults:(id)arg3;	// IMP=0x00000001000e6fa4
- (id)initWithManager:(struct __WiFiDeviceManager *)arg1 availabilityEngine:(id)arg2 scanResults:(id)arg3 disableProminentFiltering:(_Bool)arg4;	// IMP=0x00000001000e6f94
