...
- (void).cxx_destruct;	// IMP=0x00000001000864cc
...
- (void)WiFiDeviceManagerHandlePowerUnchangedPowerBudget:(unsigned long long)arg1:(CDStruct_777f7d9a *)arg2;	// IMP=0x00000001000863b8
- (void)WiFiDeviceManagerHandlePowerBudgetChange:(unsigned long long)arg1;	// IMP=0x00000001000863ac
- (void)WiFiDeviceManagerHandleInterfaceAvailability:(unsigned long long)arg1;	// IMP=0x00000001000863a0
- (unsigned long long)WiFiBatteryManagerHandleCpmsAllocatedBudgetReturnIndex:(id)arg1;	// IMP=0x0000000100085fa4
- (id)getDutyCycleForPowerNumber:(int)arg1;	// IMP=0x0000000100085f3c
- (id)getPowerNumberForDutyCycle:(int)arg1;	// IMP=0x0000000100085ed4
- (void)releasePowerResources;	// IMP=0x0000000100085c60
- (int)admissionCheck;	// IMP=0x000000010008581c
- (int)requestPowerResource:(unsigned long long)arg1:(void *)arg2;	// IMP=0x0000000100085618
- (_Bool)isPowerResourceAvailable:(unsigned long long)arg1;	// IMP=0x00000001000854c4
- (void)WiFiBatteryManagerHandlePowerAdmissionResponse:(unsigned long long)arg1;	// IMP=0x0000000100085088
- (void)dealloc;	// IMP=0x0000000100084fc0
- (void)WiFiBatteryManagerPpmCallbackConfiguration:(struct __WiFiDeviceManager *)arg1;	// IMP=0x0000000100084ab0
- (void)WiFiBatteryManagerCpmsCallbackConfiguration:(struct __WiFiDeviceManager *)arg1;	// IMP=0x000000010008476c
- (id)WiFiBatteryManagerPopulatePowerTable;	// IMP=0x000000010008453c
- (_Bool)configureWiFiClientAndRegisterWithBatteryModule:(_Bool)arg1:(struct __WiFiDeviceManager *)arg2:(id)arg3:(id)arg4;	// IMP=0x000000010008417c
- (_Bool)setup;	// IMP=0x0000000100084028
- (id)initWithContext:(void *)arg1;	// IMP=0x0000000100083b30
