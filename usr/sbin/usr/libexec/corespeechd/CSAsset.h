...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x0000000100038d94
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x0000000100038d54
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x0000000100038d1c
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0000000100038ce4
...
- (id)_sha256:(id)arg1;	// IMP=0x0000000100052b60
- (id)_sha1:(id)arg1;	// IMP=0x0000000100052a58
- (id)localeMapWithName:(id)arg1;	// IMP=0x00000001000528b0
- (id)jarvisRTModelLocaleMap;	// IMP=0x000000010005289c
- (id)hearstRTModelLocaleMap;	// IMP=0x0000000100052888
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x000000010005215c
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x0000000100051e24
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x0000000100051dbc
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x00000001000517d8
