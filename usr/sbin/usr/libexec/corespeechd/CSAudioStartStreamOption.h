...
+ (id)noAlertOption;	// IMP=0x0000000100023988
...
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00000001000239c4
- (long long)_alertBehaviorTypeFromAVVCOberrideType:(long long)arg1;	// IMP=0x00000001000063d4
- (long long)_avvcAlertOverrideType:(long long)arg1;	// IMP=0x00000001000063c0
- (id)avvcAlertBehavior;	// IMP=0x00000001000061e4
- (void)setAVVCAlertBehavior:(id)arg1;	// IMP=0x0000000100005fa4
- (id)avvcSettings;	// IMP=0x0000000100005e7c
- (id)avvcStartRecordSettingsWithAudioStreamHandleId:(unsigned long long)arg1;	// IMP=0x0000000100005bb4
