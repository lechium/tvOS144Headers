...
- (void).cxx_destruct;	// IMP=0x0000000100037f60
...
- (void)CSXPCConnectionReceivedClientError:(id)arg1 clientError:(id)arg2 client:(id)arg3;	// IMP=0x0000000100037d94
- (void)_handleNewRemoteConnection:(id)arg1;	// IMP=0x0000000100037c14
- (void)_handleListenerError:(id)arg1;	// IMP=0x0000000100037bbc
- (void)_handleListenerEvent:(id)arg1;	// IMP=0x0000000100037a94
- (void)listen;	// IMP=0x0000000100037900
- (id)init;	// IMP=0x0000000100037810
