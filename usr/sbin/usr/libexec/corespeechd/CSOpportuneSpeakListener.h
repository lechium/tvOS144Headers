...
- (void).cxx_destruct;	// IMP=0x000000010005d47c
...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2;	// IMP=0x000000010005d06c
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x000000010005d068
- (_Bool)_shouldReportBoron;	// IMP=0x000000010005d050
- (_Bool)_popRemoteVADSignal;	// IMP=0x000000010005cfc8
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x000000010005cf24
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x000000010005cbe4
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x000000010005cb34
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010005cb20
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010005c754
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010005c1cc
- (void)_resetAlignBuffer;	// IMP=0x000000010005c19c
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010005bd00
- (id)init;	// IMP=0x000000010005bc2c
