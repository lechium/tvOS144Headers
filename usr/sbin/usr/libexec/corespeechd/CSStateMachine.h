...
- (void).cxx_destruct;	// IMP=0x00000001000163e0
...
- (void)performTransitionForEvent:(long long)arg1;	// IMP=0x00000001000161d0
- (void)addTransitionFrom:(long long)arg1 to:(long long)arg2 for:(long long)arg3;	// IMP=0x0000000100016020
- (void)reset;	// IMP=0x0000000100016014
- (id)initWithInitialState:(long long)arg1;	// IMP=0x0000000100015f98
