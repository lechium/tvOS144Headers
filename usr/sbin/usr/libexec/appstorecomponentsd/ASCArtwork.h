...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000165ec
- (void).cxx_destruct;	// IMP=0x00000001000172e8
...
- (id)makeURLWithSubstitutions:(id)arg1;	// IMP=0x0000000100017118
- (id)description;	// IMP=0x0000000100016f64
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100016c5c
- (unsigned long long)hash;	// IMP=0x0000000100016af0
@property(readonly, copy, nonatomic) NSString *URLTemplate;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100016a40
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000168c0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000165f4
- (id)initWithURLTemplate:(id)arg1 width:(double)arg2 height:(double)arg3 decoration:(id)arg4 preferredCrop:(id)arg5 preferredFormat:(id)arg6;	// IMP=0x00000001000164a8
