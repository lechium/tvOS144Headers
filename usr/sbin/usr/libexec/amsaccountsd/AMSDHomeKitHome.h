...
- (void).cxx_destruct;	// IMP=0x0000000100018be4
@property(retain, nonatomic) AMSDHomeKitDataSource *dataSource; // @synthesize dataSource=_dataSource;
@property(retain, nonatomic) HMHome *home; // @synthesize home=_home;
- (unsigned long long)mediaProfileEnabledForUser:(id)arg1;	// IMP=0x0000000100018850
...
- (id)initWithHome:(id)arg1 dataSource:(id)arg2;	// IMP=0x00000001000180c8
