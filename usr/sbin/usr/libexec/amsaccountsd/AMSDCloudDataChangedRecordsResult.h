...
@interface AMSDCloudDataChangedRecordsResult : NSObject <AMSHashable>
{
...
- (void).cxx_destruct;	// IMP=0x0000000100007c60
...
- (id)initWithChangedRecords:(id)arg1 deletedRecords:(id)arg2 errors:(id)arg3 changeTokens:(id)arg4;	// IMP=0x0000000100007968
