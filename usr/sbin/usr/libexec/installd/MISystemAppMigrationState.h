...
+ (id)defaultManager;	// IMP=0x0000000100024c04
- (void).cxx_destruct;	// IMP=0x0000000100025220
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x0000000100024fcc
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x0000000100024ac8
