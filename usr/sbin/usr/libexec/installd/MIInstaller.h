...
+ (id)installerForURL:(id)arg1 withOptions:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000eecc
- (void).cxx_destruct;	// IMP=0x0000000100014718
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x0000000100012a78
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x0000000100012624
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x00000001000122b0
- (_Bool)_discoverInstallablesWithError:(id *)arg1;	// IMP=0x0000000100011294
- (void)_writeLockBundles:(id)arg1;	// IMP=0x0000000100011074
- (void)_acquireTerminationAssertionsForBundles:(id)arg1;	// IMP=0x0000000100010e70
- (id)_bundlesAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100010abc
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x0000000100010640
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x000000010000fe80
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x000000010000f2a8
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x000000010000f040
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x000000010000efd4
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x000000010000ef60
- (void)dealloc;	// IMP=0x000000010000ecf0
- (id)initWithURL:(id)arg1 options:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000ec20
- (id)init;	// IMP=0x000000010000ec14
