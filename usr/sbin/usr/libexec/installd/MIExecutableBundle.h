...
+ (id)bundlesInParentBundle:(id)arg1 subDirectory:(id)arg2 matchingPredicate:(CDUnknownBlockType)arg3 error:(id *)arg4;	// IMP=0x000000010002d564
- (void).cxx_destruct;	// IMP=0x0000000100034dfc
...
- (_Bool)hasOnlyAllowedWatchKitAppInfoPlistKeysForWatchKitVersion:(unsigned char)arg1 error:(id *)arg2;	// IMP=0x0000000100034894
- (id)watchKitV2AppBundleWithError:(id *)arg1;	// IMP=0x000000010003419c
- (id)_discoverWatchAppBundleAsPlaceholder:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0000000100033abc
- (id)watchKitV1AppBundleWithError:(id *)arg1;	// IMP=0x000000010003376c
- (id)watchKitAppBundleForWKVersionOrEarlier:(unsigned char)arg1 error:(id *)arg2;	// IMP=0x000000010003359c
- (unsigned char)watchKitVersionWithError:(id *)arg1;	// IMP=0x00000001000333f8
- (id)watchKitPluginWithError:(id *)arg1;	// IMP=0x00000001000331e0
...
- (_Bool)_hasResource:(id)arg1 withExtension:(id)arg2;	// IMP=0x0000000100032804
- (_Bool)validateSinfWithError:(id *)arg1;	// IMP=0x00000001000325fc
- (id)fairPlaySinfInfoWithError:(id *)arg1;	// IMP=0x0000000100031fbc
@property(readonly, nonatomic) _Bool hasSinf;
@property(readonly, nonatomic) _Bool needsSinf;
- (void)removeSinf;	// IMP=0x0000000100031dcc
- (_Bool)replicateRootSinfWithError:(id *)arg1;	// IMP=0x0000000100031cc8
- (id)updateAndValidateSinf:(id)arg1 withRollback:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00000001000319e4
- (id)updateAndValidateSinf:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000319d0
- (void)bestEffortRollbackSinfData:(id)arg1;	// IMP=0x000000010003187c
- (_Bool)updateSinfWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100031720
...
- (_Bool)validatePluginMetadataWithError:(id *)arg1;	// IMP=0x00000001000311ac
- (_Bool)makeExecutableWithError:(id *)arg1;	// IMP=0x0000000100030ff0
@property(readonly, copy, nonatomic) NSArray *vpnPluginIdentifiers;
- (id)_dataContainerCreatingIfNeeded:(_Bool)arg1 makeLive:(_Bool)arg2 checkIfNeeded:(_Bool)arg3 created:(_Bool *)arg4 error:(id *)arg5;	// IMP=0x0000000100030abc
- (id)dataContainerCreatingIfNeeded:(_Bool)arg1 makeLive:(_Bool)arg2 created:(_Bool *)arg3 error:(id *)arg4;	// IMP=0x0000000100030aa4
- (id)dataContainerWithError:(id *)arg1;	// IMP=0x0000000100030a84
@property(readonly, nonatomic) Class dataContainerClass;
@property(readonly, nonatomic) long long dataContainerContentClass;
- (_Bool)hasNoConflictsWithOtherInstalledEntitiesForSigningInfo:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100030160
- (_Bool)_hasNoConflictWithSystemAppsForSigningInfo:(id)arg1 error:(id *)arg2;	// IMP=0x000000010002fb40
- (int)installEmbeddedProvisioningProfileWithProgress:(CDUnknownBlockType)arg1;	// IMP=0x000000010002f9e4
- (id)codeSigningInfoByValidatingResources:(_Bool)arg1 performingOnlineAuthorization:(_Bool)arg2 ignoringCachedSigningInfo:(_Bool)arg3 checkingTrustCacheIfApplicable:(_Bool)arg4 skippingProfileIDValidation:(_Bool)arg5 error:(id *)arg6;	// IMP=0x000000010002ece8
- (id)_codeSigningInfoFromMCM;	// IMP=0x000000010002eaf8
- (_Bool)updateMCMWithCodeSigningInfoAsAdvanceCopy:(_Bool)arg1 withError:(id *)arg2;	// IMP=0x000000010002e6ec
- (_Bool)needsDataContainer;	// IMP=0x000000010002e400
- (_Bool)_hasNonContainerizingEntitlement:(id)arg1 checkSeatbeltProfiles:(_Bool)arg2;	// IMP=0x000000010002e1d0
- (_Bool)_isGrandfatheredNonContainerized:(id)arg1;	// IMP=0x000000010002e0e8
@property(readonly, nonatomic) unsigned int maxLinkedSDKVersion;
- (_Bool)makeAndSetNewInstallationIdentityWithError:(id *)arg1;	// IMP=0x000000010002e014
- (_Bool)transferInstallationIdentityFromBundle:(id)arg1 error:(id *)arg2;	// IMP=0x000000010002df10
- (id)installationIdentitySettingIfNotSet:(_Bool)arg1 withError:(id *)arg2;	// IMP=0x000000010002de58
- (id)watchKitAppExecutableHashWithError:(id *)arg1;	// IMP=0x000000010002db54
- (void)setBundleParentDirectoryURL:(id)arg1;	// IMP=0x000000010002da58
- (id)lsInstallTypeWithError:(id *)arg1;	// IMP=0x000000010002d7d4
...
- (id)initWithBundleInContainer:(id)arg1 withExtension:(id)arg2 error:(id *)arg3;	// IMP=0x000000010002d490
- (_Bool)_validateWithError:(id *)arg1;	// IMP=0x000000010002d1a4
- (void)dealloc;	// IMP=0x000000010002d14c
