...
+ (id)bundleForURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000010002a734
+ (_Bool)bundleIsBlacklisted:(id)arg1;	// IMP=0x0000000100029d68
+ (id)bundlesInParentBundle:(id)arg1 subDirectory:(id)arg2 matchingPredicate:(CDUnknownBlockType)arg3 error:(id *)arg4;	// IMP=0x00000001000280fc
+ (id)_URLOfFirstBundleInDirectory:(id)arg1 withExtension:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100026804
...
- (_Bool)sdkBuildVersionIsAtLeast:(id)arg1;	// IMP=0x000000010002c0a0
@property(readonly, copy, nonatomic) NSString *sdkBuildVersion;
- (_Bool)validateAppMetadataWithError:(id *)arg1;	// IMP=0x000000010002bd90
@property(readonly, nonatomic) NSSet *siriIntents;
- (id)description;	// IMP=0x000000010002ba1c
- (_Bool)thinningMatchesCurrentDeviceWithError:(id *)arg1;	// IMP=0x000000010002b5f8
@property(readonly, copy, nonatomic) NSArray *supportedDevices;
- (_Bool)isApplicableToCurrentDeviceCapabilitiesWithError:(id *)arg1;	// IMP=0x000000010002b294
- (_Bool)isApplicableToOSVersionEarlierThan:(id)arg1;	// IMP=0x000000010002b208
- (_Bool)isApplicableToOSVersion:(id)arg1 error:(id *)arg2;	// IMP=0x000000010002b0a4
- (_Bool)isApplicableToCurrentOSVersionWithError:(id *)arg1;	// IMP=0x000000010002afd0
- (id)currentOSVersionForValidationWithError:(id *)arg1;	// IMP=0x000000010002af4c
- (_Bool)isApplicableToCurrentDeviceFamilyWithError:(id *)arg1;	// IMP=0x000000010002ac3c
- (_Bool)isCompatibleWithDeviceFamily:(int)arg1;	// IMP=0x000000010002aadc
...
- (id)xpcServiceBundlesWithError:(id *)arg1;	// IMP=0x000000010002a0b4
- (id)frameworkBundlesWithError:(id *)arg1;	// IMP=0x0000000100029ebc
- (_Bool)validatePluginMetadataWithError:(id *)arg1;	// IMP=0x0000000100028f88
- (id)pluginKitBundlesWithError:(id *)arg1;	// IMP=0x0000000100028f74
- (id)pluginKitBundlesPerformingPlatformValidation:(unsigned char)arg1 withError:(id *)arg2;	// IMP=0x000000010002864c
- (id)pluginKitBundlesSkippingPlatformValidation:(_Bool)arg1 withError:(id *)arg2;	// IMP=0x0000000100028634
- (_Bool)allowsAppExtensionsNotInExtensionCache;	// IMP=0x000000010002862c
- (_Bool)setIsPlaceholderWithError:(id *)arg1;	// IMP=0x0000000100028048
...
- (id)_infoPlistKeysToLoad;	// IMP=0x0000000100026ba0
- (id)initWithBundleInDirectory:(id)arg1 withExtension:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100026ad4
- (id)initWithBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100026750
- (id)initWithParentBundle:(id)arg1 parentSubdirectory:(id)arg2 bundleName:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000265fc
- (id)initWithBundleParentURL:(id)arg1 parentSubdirectory:(id)arg2 bundleName:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000264ec
- (_Bool)_validateWithError:(id *)arg1;	// IMP=0x00000001000261c8
- (id)_extraInfoPlistLogging;	// IMP=0x0000000100025a20
