...
+ (id)monitorStatusString:(long long)arg1;	// IMP=0x000000010008a87c
- (void).cxx_destruct;	// IMP=0x000000010008dc24
...
- (void)unassertFallbackForClient:(id)arg1;	// IMP=0x000000010008d878
- (void)assertFallbackForClient:(id)arg1 process:(id)arg2;	// IMP=0x000000010008d780
...
- (void)updatePolicies:(_Bool)arg1 agent:(_Bool)arg2;	// IMP=0x000000010008cc20
- (void)updateFallbackInUse;	// IMP=0x000000010008c96c
- (void)postFallbackInUseWithDelay:(unsigned long long)arg1;	// IMP=0x000000010008c940
- (void)postFallbackInUse;	// IMP=0x000000010008c730
- (id)copyUUIDsForBundleIDArray:(id)arg1;	// IMP=0x000000010008c4b0
- (id)currentFallbackBundleIDs;	// IMP=0x000000010008c210
- (id)fallbackExceptionBundleIDsForce:(_Bool)arg1;	// IMP=0x000000010008bf6c
- (id)currentRouteRules:(id)arg1 defaultPathRule:(id)arg2;	// IMP=0x000000010008bba8
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010008ac68
- (void)handleChangeEventForFallbackInterfaces:(id)arg1;	// IMP=0x000000010008a8a8
- (void)dealloc;	// IMP=0x000000010008a830
- (void)uninstall;	// IMP=0x000000010008a7a4
- (void)install;	// IMP=0x000000010008a680
- (void)didStopTrackingAllNOIs:(id)arg1;	// IMP=0x000000010008a520
- (void)didStopTrackingNOI:(id)arg1;	// IMP=0x000000010008a43c
- (void)didStartTrackingNOI:(id)arg1;	// IMP=0x000000010008a354
- (void)removeFallbackNotifications;	// IMP=0x000000010008a13c
- (void)setupFallbackNotifications;	// IMP=0x0000000100089e30
- (void)cancelFallbackNotificationTimer;	// IMP=0x0000000100089de0
- (void)resetFallbackNotificationTimeout:(unsigned long long)arg1;	// IMP=0x0000000100089d7c
- (void)createFallbackNotificationTimer;	// IMP=0x0000000100089c80
- (void)checkBundleIDsForFallback:(id)arg1;	// IMP=0x00000001000896f0
- (void)teardownRoamingMonitor;	// IMP=0x00000001000895f4
- (void)setupRoamingMonitor;	// IMP=0x000000010008934c
- (void)handleInstalledAppsChanged;	// IMP=0x00000001000890f8
- (void)handleNetworkDetectionNotification:(int)arg1;	// IMP=0x0000000100088fa4
- (_Bool)handleUpdateConfiguration:(id)arg1;	// IMP=0x0000000100088e6c
- (void)handleStopMessageWithReason:(int)arg1;	// IMP=0x0000000100088cec
- (void)handleStartMessage:(id)arg1;	// IMP=0x0000000100088c70
- (_Bool)shouldBeIdleForStatus:(int)arg1;	// IMP=0x0000000100088c54
- (int)type;	// IMP=0x0000000100088c4c
- (id)initWithConfiguration:(id)arg1 andServer:(id)arg2;	// IMP=0x0000000100088acc
- (_Bool)configurationNeedsFallbackNotifications;	// IMP=0x0000000100088a18
- (_Bool)configurationNeedsRoamingMonitorIgnoreFallback:(_Bool)arg1;	// IMP=0x000000010008881c
