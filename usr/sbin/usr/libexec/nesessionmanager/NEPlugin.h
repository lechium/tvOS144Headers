...
- (void).cxx_destruct;	// IMP=0x000000010001489c
...
- (id)pluginType;	// IMP=0x0000000100014754
- (long long)pluginVersion;	// IMP=0x0000000100014708
@property(readonly) int pid;
- (void)terminate;	// IMP=0x000000010001464c
- (void)wakeup;	// IMP=0x000000010001460c
- (void)sleep;	// IMP=0x0000000100014348
- (void)updateConfiguration:(id)arg1;	// IMP=0x00000001000142dc
- (void)dispose;	// IMP=0x0000000100013f9c
- (_Bool)createRemotePluginDriverWithEndpoint:(id)arg1;	// IMP=0x0000000100013c78
- (_Bool)createLocalPluginDriverWithEndpoint:(id)arg1;	// IMP=0x0000000100013984
- (_Bool)startWithConfiguration:(id)arg1;	// IMP=0x00000001000131cc
- (id)managerObjectWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000131c8
@property(readonly) id managerObject;
- (id)remotePluginObjectWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100013134
@property(readonly, nonatomic) id remotePluginObject;
- (void)handleXPCConnectionDown;	// IMP=0x0000000100012f8c
- (void)handlePluginFailedWithError:(id)arg1;	// IMP=0x0000000100012f88
- (id)description;	// IMP=0x0000000100012f7c
- (id)initWithAgent:(id)arg1 delegateQueue:(id)arg2 andDelegate:(id)arg3;	// IMP=0x0000000100012e40
