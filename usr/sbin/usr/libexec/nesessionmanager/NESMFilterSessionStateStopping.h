...
- (void)handleTimeout;	// IMP=0x000000010005ca38
- (void)handlePluginDisposeComplete:(id)arg1;	// IMP=0x000000010005c920
- (void)enterWithSession:(id)arg1;	// IMP=0x000000010005c640
- (id)init;	// IMP=0x000000010005c5f4
