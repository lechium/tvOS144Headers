...
- (void).cxx_destruct;	// IMP=0x0000000100258cac
...
- (id)description;	// IMP=0x0000000100258b9c
- (_Bool)_canCoalesceRequest:(id)arg1;	// IMP=0x0000000100258b20
- (_Bool)coalesceWithRequest:(id)arg1;	// IMP=0x0000000100258a8c
- (id)initWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001002589d8
