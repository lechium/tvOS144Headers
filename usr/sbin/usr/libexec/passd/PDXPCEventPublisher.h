...
- (void).cxx_destruct;	// IMP=0x00000001001601f4
...
- (void)sendEvent:(id)arg1;	// IMP=0x000000010015fe1c
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x000000010015fa8c
- (id)initWithStreamName:(id)arg1;	// IMP=0x000000010015f764
