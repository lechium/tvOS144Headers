...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100155540
- (void).cxx_destruct;	// IMP=0x0000000100155a60
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100155730
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100155548
