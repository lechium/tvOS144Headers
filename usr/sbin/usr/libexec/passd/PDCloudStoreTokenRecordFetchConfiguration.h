...
- (void).cxx_destruct;	// IMP=0x000000010010b294
...
- (id)description;	// IMP=0x000000010010b0d8
- (_Bool)hasContainerDatabase;	// IMP=0x000000010010b0c8
- (_Bool)hasCloudStoreZones;	// IMP=0x000000010010af6c
