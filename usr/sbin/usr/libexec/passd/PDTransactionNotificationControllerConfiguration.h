...
- (void).cxx_destruct;	// IMP=0x000000010016b4f0
...
- (id)description;	// IMP=0x000000010016b204
- (_Bool)shouldReceiveNotificationsForPeerPaymentNotificationType:(unsigned long long)arg1;	// IMP=0x000000010016b160
- (id)passUniqueIdentifier;	// IMP=0x000000010016b150
