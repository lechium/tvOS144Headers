...
- (id)_messageString;	// IMP=0x000000010014a5c0
- (id)_titleString;	// IMP=0x000000010014a570
- (unsigned long long)notificationType;	// IMP=0x000000010014a568
- (id)initWithPaymentTransaction:(id)arg1 forPassUniqueIdentifier:(id)arg2 familyMember:(id)arg3 reminderPeriod:(unsigned long long)arg4;	// IMP=0x000000010014a37c
