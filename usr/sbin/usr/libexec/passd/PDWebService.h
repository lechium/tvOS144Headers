...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001551f8
- (void).cxx_destruct;	// IMP=0x00000001001554ec
...
- (void)generateNewDeviceIdentifier;	// IMP=0x0000000100155444
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100155390
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100155200
- (id)description;	// IMP=0x0000000100155100
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100154ea4
