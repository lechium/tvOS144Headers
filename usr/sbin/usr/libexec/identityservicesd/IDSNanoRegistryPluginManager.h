...
+ (id)sharedInstance;	// IMP=0x00000001000744f0
- (void).cxx_destruct;	// IMP=0x0000000100076188
...
- (void)_initializePluginWithClass:(Class)arg1;	// IMP=0x0000000100075694
- (void)_initializePlugin;	// IMP=0x0000000100075360
- (void)executeSynchronouslyOnCallbackQueue:(CDUnknownBlockType)arg1;	// IMP=0x0000000100075268
- (void)initializePluginWithClass:(Class)arg1;	// IMP=0x0000000100075184
- (void)notifyWatchToStopAdvertising;	// IMP=0x0000000100074e84
- (void)notifyWatchDidStopAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x0000000100074c6c
- (void)notifyWatchToStartAdvertising;	// IMP=0x0000000100074970
- (void)notifyWatchDidStartAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x00000001000747a0
- (id)init;	// IMP=0x00000001000745bc
