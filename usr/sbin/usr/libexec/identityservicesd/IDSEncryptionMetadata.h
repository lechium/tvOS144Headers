...
- (id)initWithMPIdentityIdentifier:(id)arg1;	// IMP=0x00000001001ce7e0
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x00000001001ce720
- (id)init;	// IMP=0x00000001001ce6b0
