...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010007a4f0
- (void).cxx_destruct;	// IMP=0x000000010007a900
...
- (id)description;	// IMP=0x000000010007a788
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010007a5cc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010007a510
