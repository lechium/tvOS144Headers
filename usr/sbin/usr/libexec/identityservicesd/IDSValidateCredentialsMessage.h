...
- (void).cxx_destruct;	// IMP=0x000000010015d08c
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000010015cbcc
- (id)bagKey;	// IMP=0x000000010015cbb0
- (id)requiredKeys;	// IMP=0x000000010015cb44
- (id)messageBody;	// IMP=0x000000010015c950
- (id)additionalMessageHeaders;	// IMP=0x000000010015c7b0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015c4f0
