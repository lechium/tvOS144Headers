...
+ (id)builderWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 avoidMainQueue:(_Bool)arg7 forceLegacy:(_Bool)arg8;	// IMP=0x000000010012223c
- (void).cxx_destruct;	// IMP=0x0000000100123024
...
- (id)encrypterWithOTRToken:(id)arg1;	// IMP=0x0000000100122ce4
- (id)encrypterWithEndpoint:(id)arg1;	// IMP=0x0000000100122b68
- (id)encrypterWithDeviceID:(id)arg1;	// IMP=0x0000000100122a38
- (id)encrypterWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5;	// IMP=0x0000000100122758
- (id)_createHashingDeviceIdentityEncrypter;	// IMP=0x0000000100122634
- (id)initWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 avoidMainQueue:(_Bool)arg7 forceLegacy:(_Bool)arg8;	// IMP=0x00000001001223f8
