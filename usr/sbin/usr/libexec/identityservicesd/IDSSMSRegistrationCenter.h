...
+ (id)sharedInstance;	// IMP=0x000000010022a698
- (void).cxx_destruct;	// IMP=0x000000010022fe48
...
- (void)requestUserConsentToValidatePhoneNumberForCTPNR:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010022efc4
- (void)_sendABCForFailureForIdentifier:(id)arg1 WithEvent:(long long)arg2 context:(id)arg3;	// IMP=0x000000010022ed14
- (void)_resetRateLimitersForSMSTimeoutForIdentifier:(id)arg1;	// IMP=0x000000010022ec8c
- (_Bool)_hasThresholdReachedForSMSTimeoutForIdentifier:(id)arg1;	// IMP=0x000000010022eb94
- (void)validator:(id)arg1 handleABCEvent:(long long)arg2;	// IMP=0x000000010022e9b4
- (void)validator:(id)arg1 failedIdentificationWithRegistrationError:(long long)arg2;	// IMP=0x000000010022e898
- (void)validator:(id)arg1 identifiedPhoneNumber:(id)arg2 token:(id)arg3 phoneBookNumber:(id)arg4;	// IMP=0x000000010022e570
- (id)_identifierForValidator:(id)arg1;	// IMP=0x000000010022e314
- (void)_notifyNeedsNewIdentification;	// IMP=0x000000010022e06c
- (void)_notifySuccess:(id)arg1 token:(id)arg2 identifier:(id)arg3;	// IMP=0x000000010022d4a0
- (void)_notifyFailureWithError:(long long)arg1 registration:(id)arg2 identifier:(id)arg3;	// IMP=0x000000010022ccd8
- (void)removeListener:(id)arg1;	// IMP=0x000000010022cc70
- (void)addListener:(id)arg1;	// IMP=0x000000010022cbac
- (void)_noteRegistrationAttemptForIdentifier:(id)arg1 withRegistrationInfo:(id)arg2;	// IMP=0x000000010022c6d8
- (void)notePhoneNumberRegistrationReset;	// IMP=0x000000010022c528
- (void)cancelActionsForRegistrationInfo:(id)arg1;	// IMP=0x000000010022c46c
- (void)_clearConsentDenialsForUniqueIdentifier:(id)arg1;	// IMP=0x000000010022c29c
- (void)clearConsentDenialsForPhoneUser:(id)arg1;	// IMP=0x000000010022c1f0
- (void)clearConsentDenialsForRegistration:(id)arg1;	// IMP=0x000000010022c144
- (void)_cleanupUntrackedValidators;	// IMP=0x000000010022bd0c
- (void)sendRegistration:(id)arg1;	// IMP=0x000000010022b1a8
- (void)setRegistrationReason:(long long)arg1 forUserUniqueIdentifier:(id)arg2;	// IMP=0x000000010022b0dc
- (void)setRegistrationReason:(long long)arg1 forPhoneNumber:(id)arg2;	// IMP=0x000000010022ad88
- (void)dealloc;	// IMP=0x000000010022ab64
- (id)init;	// IMP=0x000000010022a914
