...
- (void).cxx_destruct;	// IMP=0x0000000100074438
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0000000100074164
- (id)bagKey;	// IMP=0x0000000100074148
- (id)messageBody;	// IMP=0x0000000100073f84
- (id)additionalMessageHeaders;	// IMP=0x0000000100073d88
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100073b18
