...
+ (id)sharedInstance;	// IMP=0x000000010015d17c
- (void).cxx_destruct;	// IMP=0x000000010015ece4
...
- (void)rapportClient:(id)arg1 didReceiveMessage:(id)arg2 fromID:(id)arg3;	// IMP=0x000000010015e970
- (unsigned int)_nextMessageID;	// IMP=0x000000010015e930
- (void)sendMessage:(id)arg1 messageID:(id)arg2 topic:(id)arg3 command:(id)arg4 destinationIDs:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x000000010015d550
- (void)dealloc;	// IMP=0x000000010015d4e4
- (id)init;	// IMP=0x000000010015d434
- (id)initWithRapportClient:(id)arg1;	// IMP=0x000000010015d328
