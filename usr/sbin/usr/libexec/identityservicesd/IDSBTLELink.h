...
- (void).cxx_destruct;	// IMP=0x000000010015c448
...
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x000000010015bee8
- (void)didReceiveData:(id)arg1;	// IMP=0x000000010015b45c
- (void)setHasSpaceAvailable:(_Bool)arg1;	// IMP=0x000000010015b08c
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x000000010015b000
- (unsigned long long)sendPacketBuffer:(CDStruct_78c9ccae *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x000000010015ace0
- (id)copyLinkStatsDict;	// IMP=0x000000010015ab48
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)start;	// IMP=0x000000010015aa8c
- (void)triggerBTCorruptionRecovery;	// IMP=0x000000010015aa58
- (void)_localDetectedCorruption;	// IMP=0x000000010015aa44
- (void)dealloc;	// IMP=0x000000010015a9dc
- (id)initWithWPLinkManager:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010015a844
