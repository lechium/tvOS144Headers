...
- (void).cxx_destruct;	// IMP=0x00000001000a9e14
...
- (id)messageBody;	// IMP=0x00000001000a8b7c
- (id)requiredKeys;	// IMP=0x00000001000a8a88
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000a8478
- (void)logFailureInfo;	// IMP=0x00000001000a7d44
- (_Bool)expectingMoreResponses;	// IMP=0x00000001000a7cec
- (id)_processMessageResponseForMessage:(id)arg1 withError:(id)arg2 resultCode:(long long)arg3 toURI:(id)arg4 fromURI:(id)arg5 service:(id)arg6 fromIdentity:(id)arg7;	// IMP=0x00000001000a6ad0
- (void)noteResponseForToken:(id)arg1;	// IMP=0x00000001000a6090
- (void)callAllAckBlocks;	// IMP=0x00000001000a5ea0
- (void)clearAllPendingResponseTokens;	// IMP=0x00000001000a5dfc
- (void)callAllIndividualCompletionBlocksWithDeliveryContext:(id)arg1;	// IMP=0x00000001000a5c04
- (_Bool)removeAllAggregatableMessages;	// IMP=0x00000001000a5a70
- (_Bool)addAggregatableMessage:(id)arg1;	// IMP=0x00000001000a5880
- (_Bool)hasSpaceForAggregatableMessage:(id)arg1;	// IMP=0x00000001000a57a4
- (id)initWithPeerMessage:(id)arg1 service:(id)arg2 fromIdentity:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x00000001000a5060
- (id)initWithHighPriority:(_Bool)arg1;	// IMP=0x00000001000a4f64
- (id)init;	// IMP=0x00000001000a4e98
