...
- (void).cxx_destruct;	// IMP=0x0000000100141938
...
- (void)handleResponseHeaders:(id)arg1;	// IMP=0x0000000100141324
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0000000100141228
- (id)messageBody;	// IMP=0x0000000100140b38
- (id)additionalMessageHeadersForOutgoingPush;	// IMP=0x0000000100140a8c
- (id)topic;	// IMP=0x0000000100140a70
- (_Bool)wantsIntegerUniqueIDs;	// IMP=0x0000000100140a50
- (_Bool)wantsResponse;	// IMP=0x0000000100140a30
- (_Bool)isIDSMessage;	// IMP=0x0000000100140a10
- (_Bool)highPriority;	// IMP=0x00000001001409f0
- (_Bool)wantsAPSRetries;	// IMP=0x00000001001409d0
- (_Bool)wantsIDSProtocolVersion;	// IMP=0x00000001001409b0
- (_Bool)isWebTunnelMessage;	// IMP=0x0000000100140990
- (_Bool)wantsCompressedBody;	// IMP=0x0000000100140970
- (_Bool)wantsBinaryPush;	// IMP=0x0000000100140950
- (long long)responseCommand;	// IMP=0x0000000100140938
- (long long)command;	// IMP=0x0000000100140920
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100140664
