...
- (void).cxx_destruct;	// IMP=0x000000010024f108
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forSession:(id)arg2;	// IMP=0x000000010024edf8
- (void)addSession:(id)arg1;	// IMP=0x000000010024ed78
- (void)addServiceType:(id)arg1;	// IMP=0x000000010024ed0c
- (void)addAlias:(id)arg1;	// IMP=0x000000010024eca4
- (id)init;	// IMP=0x000000010024eb64
