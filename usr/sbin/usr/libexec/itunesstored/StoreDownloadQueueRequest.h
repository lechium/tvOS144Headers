...
+ (void)initialize;	// IMP=0x00000001000bbe58
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000bbdb4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000bbc6c
- (unsigned long long)hash;	// IMP=0x00000001000bbc5c
- (id)description;	// IMP=0x00000001000bbbec
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00000001000bbb34
