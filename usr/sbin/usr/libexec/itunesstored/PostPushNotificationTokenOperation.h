...
- (_Bool)_postTokenToURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000a1520
- (void)run;	// IMP=0x00000001000a1004
@property(readonly) NSData *tokenData;
@property(copy) SSAuthenticationContext *authenticationContext;
@property(readonly) NSString *environmentName;
- (void)dealloc;	// IMP=0x00000001000a0e94
- (id)initWithEnvironmentName:(id)arg1 tokenData:(id)arg2;	// IMP=0x00000001000a0e04
- (id)init;	// IMP=0x00000001000a0df0
