...
- (void).cxx_destruct;	// IMP=0x0000000100151530
...
- (id)_privacyAcknowledgementURLString;	// IMP=0x000000010015124c
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x0000000100151080
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0000000100150edc
- (void)run;	// IMP=0x0000000100150068
- (id)initWithPrivacyIdentifier:(id)arg1;	// IMP=0x000000010014ffe8
