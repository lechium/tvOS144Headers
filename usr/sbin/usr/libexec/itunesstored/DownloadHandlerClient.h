...
- (id)description;	// IMP=0x0000000100026ee4
...
- (id)resetDisavowedSessionProperties;	// IMP=0x0000000100026a18
@property(readonly) NSSet *disavowedSessionProperties;
- (void)addDisavowedSessionProperties:(id)arg1;	// IMP=0x00000001000265d0
- (void)dealloc;	// IMP=0x0000000100026570
- (id)initWithInputConnection:(id)arg1;	// IMP=0x000000010002651c
