...
- (void)runWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001000506c0
@property(readonly, nonatomic) _Bool blocksAppInstallation;
- (_Bool)applicationIsInstalled:(id)arg1;	// IMP=0x0000000100050630
- (void)dealloc;	// IMP=0x00000001000505e8
- (id)initWithApplicationHandle:(id)arg1;	// IMP=0x0000000100050588
