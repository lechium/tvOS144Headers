...
@interface PrepareDownloadResponse : NSObject
{
    ...
    _Bool _isPerDeviceVPP;	// 257 = 0x101
    _Bool _hasHDR;	// 258 = 0x102
    _Bool _has4K;	// 259 = 0x103
    DownloadHandle *_downloadHandle;	// 264 = 0x108
    NSNumber *_downloadRestoreState;	// 272 = 0x110
}

- (void).cxx_destruct;	// IMP=0x0000000100180628
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x000000010017fbe0
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x000000010017f5ec
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1;	// IMP=0x000000010017f228
- (id)sessionConfiguration;	// IMP=0x000000010017f048
