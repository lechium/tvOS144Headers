...
- (id)_overallProgress;	// IMP=0x00000001000350e8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100034fd8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100034f4c
- (unsigned long long)hash;	// IMP=0x0000000100034f44
- (void)setTransferProgressWithBytesWritten:(long long)arg1 totalBytesExpected:(long long)arg2;	// IMP=0x0000000100034f1c
- (void)setTransferProgress:(double)arg1;	// IMP=0x0000000100034eb0
- (void)setFinishProgress:(double)arg1;	// IMP=0x0000000100034e38
@property(readonly, nonatomic) SSOperationProgress *overallProgress;
- (id)initWithPrepareDownloadResponse:(id)arg1;	// IMP=0x0000000100034c48
