...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x00000001001a6a10
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x00000001001a69ec
- (void)dealloc;	// IMP=0x00000001001a698c
