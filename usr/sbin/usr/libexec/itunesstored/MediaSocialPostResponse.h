...
+ (id)_unrecoverableErrors;	// IMP=0x0000000100157550
- (void).cxx_destruct;	// IMP=0x0000000100157670
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x00000001001574c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015740c
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x0000000100156fe8
