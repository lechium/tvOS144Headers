...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010018dd9c
- (void)dealloc;	// IMP=0x000000010018dd4c
- (id)initWithPolicyIdentifiers:(id)arg1;	// IMP=0x000000010018dcec
