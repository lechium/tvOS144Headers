...
- (void).cxx_destruct;	// IMP=0x00000001001a3eac
@property(nonatomic) long long postID; // @synthesize postID=_postID;
- (id)_targetDictionaryWithContentItem:(id)arg1;	// IMP=0x00000001001a3da8
- (id)_requestBodyDictionary;	// IMP=0x00000001001a3760
- (id)_externalServiceDictionaryWithDestination:(id)arg1;	// IMP=0x00000001001a3598
- (id)_attachmentDictionaryWithAttachment:(id)arg1;	// IMP=0x00000001001a2f90
- (void)run;	// IMP=0x00000001001a2250
@property(copy) NSString *userAgent;
@property(copy) CDUnknownBlockType resultBlock;
- (id)initWithPostEntity:(id)arg1;	// IMP=0x00000001001a1c60
- (id)initWithPostDescription:(id)arg1;	// IMP=0x00000001001a1a84
