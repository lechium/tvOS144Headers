...
- (void)_setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000100012b2c
...
- (void)dealloc;	// IMP=0x0000000100012a08
- (id)initWithManifestItemDictionary:(id)arg1;	// IMP=0x00000001000129a8
- (id)init;	// IMP=0x0000000100012950
