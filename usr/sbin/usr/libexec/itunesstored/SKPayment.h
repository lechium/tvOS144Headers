...
+ (id)paymentWithProductIdentifier:(id)arg1;	// IMP=0x000000010010ffe4
+ (id)paymentFromPurchaseIntentWithProduct:(id)arg1;	// IMP=0x000000010010fee4
+ (id)paymentWithProduct:(id)arg1;	// IMP=0x000000010010fdf0
- (void).cxx_destruct;	// IMP=0x000000010011022c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001100e8
- (unsigned long long)hash;	// IMP=0x0000000100110070
@property(readonly, copy, nonatomic) NSString *applicationUsername;
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010010fd7c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010010fd08
- (id)init;	// IMP=0x000000010010fca4
