...
- (id)_ntsQueryParameters:(id *)arg1;	// IMP=0x0000000100089fb0
- (id)_copyApplicationIdentity:(id *)arg1;	// IMP=0x0000000100089d54
- (id)description;	// IMP=0x0000000100089c9c
...
- (id)newStoreURLOperation:(id *)arg1;	// IMP=0x00000001000897bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000896a4
- (void)dealloc;	// IMP=0x000000010008963c
- (id)init;	// IMP=0x00000001000895e4
