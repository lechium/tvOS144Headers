...
- (void).cxx_destruct;	// IMP=0x00000001001053ac
- (void)run;	// IMP=0x0000000100105234
- (id)initWithClientIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100105158
