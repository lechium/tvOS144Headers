...
- (void).cxx_destruct;	// IMP=0x0000000100027428
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000272ec
- (unsigned long long)hash;	// IMP=0x00000001000272dc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010002720c
