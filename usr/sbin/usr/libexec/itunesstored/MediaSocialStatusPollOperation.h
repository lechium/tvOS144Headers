...
- (void).cxx_destruct;	// IMP=0x0000000100188780
- (id)_requestURL;	// IMP=0x0000000100188628
- (void)main;	// IMP=0x0000000100187cf4
@property(readonly, copy) NSArray *statusPollRequests;
@property(copy) CDUnknownBlockType responseBlock;
- (id)initWithStatusPollRequests:(id)arg1;	// IMP=0x0000000100187b20
