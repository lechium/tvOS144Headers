...
- (void).cxx_destruct;	// IMP=0x000000010004e8f0
@property(readonly) NSObject<OS_xpc_object> *XPCEndpoint; // @synthesize XPCEndpoint=_inputEndpoint;
- (void)_handleMessage:(id)arg1 connection:(id)arg2;	// IMP=0x000000010004e740
- (void)_disconnect;	// IMP=0x000000010004e62c
@property __weak id <SpringBoardAlertProxyDelegate> delegate;
- (void)sendMessage:(id)arg1;	// IMP=0x000000010004e504
- (void)dealloc;	// IMP=0x000000010004e394
- (id)initWithMessage:(id)arg1;	// IMP=0x000000010004dfe4
