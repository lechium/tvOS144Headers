...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010013bd2c
- (void)performAction;	// IMP=0x000000010013bd10
- (_Bool)hasOccurred;	// IMP=0x000000010013bcf4
- (void)dealloc;	// IMP=0x000000010013bc94
