...
- (void).cxx_destruct;	// IMP=0x00000001000ad688
...
- (void)dealloc;	// IMP=0x00000001000ad618
- (id)initWithProcessAssertion:(id)arg1 invalidationBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001000ad568
