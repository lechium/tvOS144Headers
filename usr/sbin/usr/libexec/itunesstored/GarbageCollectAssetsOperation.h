...
- (void).cxx_destruct;	// IMP=0x0000000100053ee4
- (void)run;	// IMP=0x0000000100052274
- (id)initWithClientIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100052198
