...
- (void).cxx_destruct;	// IMP=0x000000010005b024
...
- (id)description;	// IMP=0x000000010005ad54
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x000000010005ad38
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x000000010005ac58
- (id)initWithAttributes:(id)arg1;	// IMP=0x000000010005a91c
