...
+ (id)brailleEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0000000100016618
+ (id)appleTVRemoteEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0000000100016580
+ (id)systemServerEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x00000001000164e8
+ (id)internalEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0000000100016450
+ (id)touchEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x00000001000163b8
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2;	// IMP=0x0000000100016358
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2 otherInfo:(id)arg3;	// IMP=0x0000000100016294
+ (id)externalDeviceEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x00000001000161fc
- (void).cxx_destruct;	// IMP=0x00000001000169e4
...
- (id)description;	// IMP=0x0000000100016830
@property(nonatomic) _Bool bypassHelp; // @dynamic bypassHelp;
- (id)objectForIndex:(unsigned long long)arg1;	// IMP=0x0000000100016810
- (void)setObject:(id)arg1 forIndex:(unsigned long long)arg2;	// IMP=0x0000000100016790
- (void)setInfo:(id)arg1;	// IMP=0x0000000100016738
@property(retain, nonatomic) VOTKeyInfo *keyInfo; // @dynamic keyInfo;
- (_Bool)isAppleTVRemoteEvent;	// IMP=0x0000000100016708
- (_Bool)isSystemServerEvent;	// IMP=0x00000001000166f8
- (_Bool)isBrailleEvent;	// IMP=0x00000001000166e8
- (_Bool)isExternalDeviceEvent;	// IMP=0x00000001000166d8
- (_Bool)isTouchEvent;	// IMP=0x00000001000166c8
- (_Bool)isKeyEvent;	// IMP=0x00000001000166b8
- (double)time;	// IMP=0x00000001000166b0
- (id)initWithType:(long long)arg1;	// IMP=0x00000001000161a4
