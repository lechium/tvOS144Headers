...
+ (id)keyboardManager;	// IMP=0x00000001000dfb40
+ (void)initialize;	// IMP=0x00000001000dfaec
- (void).cxx_destruct;	// IMP=0x00000001000e4118
...
- (void)clearConsecutiveKeyPressCount;	// IMP=0x00000001000e4048
- (void)_postEvent:(id)arg1;	// IMP=0x00000001000e3fb0
- (void)_handleQuickNavPressTimer:(id)arg1;	// IMP=0x00000001000e3f5c
- (void)_handleQuickNavPress:(id)arg1;	// IMP=0x00000001000e3c00
- (void)_handleQuickNavDownArrowRepostPress:(id)arg1;	// IMP=0x00000001000e3ae4
- (void)_postKeyboardKey:(id)arg1 keyCode:(unsigned short)arg2 eventFlags:(unsigned int)arg3 keyFlags:(unsigned short)arg4 keyDown:(_Bool)arg5 source:(unsigned short)arg6;	// IMP=0x00000001000e3890
- (void)_sendEventForCommand:(id)arg1 withKeyInfo:(id)arg2 arrowMask:(long long)arg3;	// IMP=0x00000001000e37d8
- (void)_sendEvent:(id)arg1 withKeyInfo:(id)arg2 arrowMask:(long long)arg3;	// IMP=0x00000001000e36c4
- (void)_keyRepeat:(id)arg1;	// IMP=0x00000001000e366c
- (void)_dispatchKeyEventIntoSystem:(id)arg1;	// IMP=0x00000001000e332c
- (_Bool)_keyInfoIsModifierOnly:(id)arg1;	// IMP=0x00000001000e323c
- (void)_handleKeyboardKeyEvent:(id)arg1 isRepeatedEvent:(_Bool)arg2;	// IMP=0x00000001000e2f54
- (void)_handleModifierCapsLockBehavior:(id)arg1;	// IMP=0x00000001000e2e94
- (void)_handleCapsLockToggle:(id)arg1;	// IMP=0x00000001000e2b14
- (void)_dispatchEventRepresentationIntoSystem:(id)arg1;	// IMP=0x00000001000e2aa0
- (_Bool)_keyEventShouldGoToFocusedContext:(id)arg1;	// IMP=0x00000001000e2a98
- (void)_handleKeyboardKeyEvent:(id)arg1;	// IMP=0x00000001000e2a88
- (void)_updateEventFlags:(id)arg1;	// IMP=0x00000001000e299c
- (void)_handleAnnouncementsForKeyInfo:(id)arg1;	// IMP=0x00000001000e285c
- (void)_speakCapsLockKey;	// IMP=0x00000001000e27b0
- (_Bool)_handleArrowKeyEvent:(id)arg1;	// IMP=0x00000001000e2354
- (void)_initializeQuickNav;	// IMP=0x00000001000e2274
- (void)_axEndPassthroughTouch;	// IMP=0x00000001000e21a4
- (void)_axStartPassthroughTouch;	// IMP=0x00000001000e2010
- (_Bool)_dispatchCommandForKeyInfo:(id)arg1 isRepeatedEvent:(_Bool)arg2;	// IMP=0x00000001000e1324
- (id)_localizeKeyboardString:(id)arg1;	// IMP=0x00000001000e12b0
- (void)setKeyDownInfo:(id)arg1;	// IMP=0x00000001000e122c
- (void)_updateConsecutiveKeyCount:(id)arg1;	// IMP=0x00000001000e1134
- (void)updateQuickNavState:(_Bool)arg1;	// IMP=0x00000001000e1128
- (id)keyDownInfo;	// IMP=0x00000001000e10fc
- (id)threadSafe_keyDownInfo;	// IMP=0x00000001000e10a8
- (void)postEvent:(id)arg1;	// IMP=0x00000001000e1024
- (id)singleLetterCommandForKeyInfo:(id)arg1;	// IMP=0x00000001000e0f3c
- (id)keyboardEventForKeyInfo:(id)arg1;	// IMP=0x00000001000e0804
- (id)_characterStringRepresentationForKey:(id)arg1;	// IMP=0x00000001000e0394
- (void)loadKeyboardMap;	// IMP=0x00000001000e0018
- (void)handleKeyboardKeyEvent:(id)arg1 eventOrigin:(long long)arg2;	// IMP=0x00000001000dff7c
- (void)_initializeThread;	// IMP=0x00000001000dfee8
- (_Bool)modifierKeyLockEnabled;	// IMP=0x00000001000dfee0
- (void)toggleVoiceOverModifierKeyLock;	// IMP=0x00000001000dfed0
- (void)_verifyCorrectThread;	// IMP=0x00000001000dfe00
- (id)init;	// IMP=0x00000001000dfbd8
- (void)dealloc;	// IMP=0x00000001000dfb58
- (void)setCommandManager:(id)arg1;	// IMP=0x00000001000dfb4c
