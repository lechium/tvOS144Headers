...
- (void).cxx_destruct;	// IMP=0x000000010005b84c
...
- (long long)_repeatStateForEvent:(id)arg1;	// IMP=0x000000010005b750
- (long long)_currentGestureRepeaterEvent;	// IMP=0x000000010005b728
- (double)_delayForCurrentRepeatCount;	// IMP=0x000000010005b71c
- (void)_handleRepeaterTimerDidFire:(id)arg1;	// IMP=0x000000010005b61c
- (void)updateWithEvent:(id)arg1;	// IMP=0x000000010005b3e0
- (void)dealloc;	// IMP=0x000000010005b2bc
- (id)initWithThread:(id)arg1;	// IMP=0x000000010005b05c
