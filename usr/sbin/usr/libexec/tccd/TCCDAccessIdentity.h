...
+ (id)bundleForAppWithBundleIdentifier:(id)arg1;	// IMP=0x0000000100013cc8
...
- (_Bool)isPlugInWithExtensionPointIdentifier:(id)arg1;	// IMP=0x0000000100015bd0
- (_Bool)getSDKVersion:(unsigned int *)arg1 platformType:(unsigned int *)arg2;	// IMP=0x0000000100015438
@property(readonly) NSString *attributionPath;
- (id)displayName;	// IMP=0x00000001000153e4
- (id)initWithIdentifier:(id)arg1 type:(int)arg2 executableURL:(id)arg3 SDKVersion:(unsigned int)arg4 platformType:(unsigned int)arg5;	// IMP=0x0000000100014f64
- (id)initWithBundleIdentifier:(id)arg1 isWK2Proxy:(_Bool)arg2;	// IMP=0x0000000100014db0
- (id)initWithMessage:(id)arg1;	// IMP=0x0000000100014ae4
- (id)initWithAttributionChain:(id)arg1 preferMostSpecificIdentifier:(_Bool)arg2;	// IMP=0x0000000100014838
- (id)initWithPid:(int)arg1 accessorToken:(CDStruct_4c969caf)arg2 preferMostSpecificIdentifier:(_Bool)arg3;	// IMP=0x0000000100014648
- (_Bool)_initFromProcessStateAndBinaryPathURL:(id)arg1 dynamicCodeRef:(void *)arg2 preferMostSpecificIdentifier:(_Bool)arg3;	// IMP=0x0000000100013f3c
- (void)_makeDisplayNameBlockForURL:(id)arg1;	// IMP=0x0000000100013e1c
