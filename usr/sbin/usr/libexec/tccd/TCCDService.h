...
+ (id)subsequentRequestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000289c4
+ (id)subsequentRequestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000289ac
+ (id)subsequentRequestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0000000100028994
+ (id)requestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x000000010002897c
+ (id)requestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0000000100028964
+ (id)requestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x000000010002894c
+ (id)requestAdditionalTextForSubsequentRequestsKeyNameForServiceName:(id)arg1;	// IMP=0x0000000100028934
+ (id)requestAdditionalTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x000000010002891c
+ (id)requestAdditionalTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0000000100028904
+ (id)requestTitleTextForSubsequentRequestsLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000288ec
+ (id)requestTitleTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000288d4
+ (id)requestTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00000001000288bc
+ (id)localizationKeyName:(id)arg1 forServiceName:(id)arg2;	// IMP=0x0000000100028854
+ (id)versionStringFromDYLDVersionNumber:(id)arg1;	// IMP=0x00000001000287dc
+ (id)tccdPlatformNameForDYLDPlatformName:(id)arg1;	// IMP=0x0000000100028708
+ (id)serviceDescriptionsForPlatformName:(id)arg1;	// IMP=0x000000010002843c
+ (id)serviceAll;	// IMP=0x000000010002839c
+ (id)allServices;	// IMP=0x0000000100025354
- (void).cxx_destruct;	// IMP=0x0000000100029f34
...
- (long long)developmentAuthorizationValue;	// IMP=0x00000001000298f8
...
- (id)descriptionForAuthorizationValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x0000000100029810
- (id)authorizationRightStateForValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x0000000100029794
- (_Bool)isAuthorizationValue:(unsigned long long)arg1 equalToRight:(unsigned long long)arg2;	// IMP=0x0000000100029754
- (long long)compare:(id)arg1;	// IMP=0x00000001000296b8
- (id)descriptionDictionary;	// IMP=0x0000000100028de8
- (id)description;	// IMP=0x0000000100028ddc
- (id)initWithName:(id)arg1 availability:(id)arg2;	// IMP=0x00000001000289dc
