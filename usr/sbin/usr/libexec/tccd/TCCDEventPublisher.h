...
+ (id)publisher;	// IMP=0x000000010002fe9c
- (void).cxx_destruct;	// IMP=0x0000000100031178
...
- (void)publish:(id)arg1;	// IMP=0x00000001000310a8
- (void)sendEvent:(id)arg1;	// IMP=0x0000000100030cf4
- (void)addPendingEvent:(id)arg1;	// IMP=0x0000000100030bc4
- (void)removeSubscriber:(unsigned long long)arg1;	// IMP=0x0000000100030a50
- (void)addSubscriber:(unsigned long long)arg1;	// IMP=0x0000000100030544
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x00000001000302e0
- (void)handleError:(int)arg1;	// IMP=0x0000000100030278
- (id)init;	// IMP=0x000000010002ff08
