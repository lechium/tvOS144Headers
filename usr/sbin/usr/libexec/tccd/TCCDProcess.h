...
+ (id)identifierForInvalidCode;	// IMP=0x00000001000317fc
- (void).cxx_destruct;	// IMP=0x0000000100032888
...
- (_Bool)hasEntitlement:(id)arg1 containsServiceAllOrService:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000100032720
- (_Bool)hasEntitlement:(id)arg1 containsService:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000100032478
- (id)description;	// IMP=0x0000000100032354
- (id)arrayValueForEntitlement:(id)arg1;	// IMP=0x0000000100032220
- (_Bool)boolValueForEntitlement:(id)arg1;	// IMP=0x00000001000320f0
@property(readonly) NSString *responsiblePath; // @synthesize responsiblePath=_responsiblePath;
- (void)dealloc;	// IMP=0x0000000100032084
- (id)initWithPID:(int)arg1 responsiblePath:(id)arg2;	// IMP=0x0000000100031d74
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1 responsiblePath:(id)arg2;	// IMP=0x000000010003188c
- (id)logHandle;	// IMP=0x0000000100031808
