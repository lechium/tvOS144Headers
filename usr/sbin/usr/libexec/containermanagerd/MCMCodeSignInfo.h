...
- (void).cxx_destruct;	// IMP=0x000000010000f49c
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x000000010000f178
- (id)initWithURL:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x000000010000f124
