...
+ (id)privilegedClientIdentityWithUserIdentity:(id)arg1 kernel:(_Bool)arg2;	// IMP=0x000000010001fd34
+ (id)anonymousPrivilegedClientIdentity;	// IMP=0x000000010001fcc8
+ (id)_clientIdentityWithXPCConnection:(id)arg1 personaUniqueString:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000100020844
+ (id)clientIdentityWithXPCConnection:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x0000000100020784
+ (id)clientIdentityWithClient:(struct container_client *)arg1;	// IMP=0x0000000100020688
- (void).cxx_destruct;	// IMP=0x000000010001f7b0
...
- (id)shortDescription;	// IMP=0x000000010001f6ec
- (id)description;	// IMP=0x000000010001f67c
- (void)dealloc;	// IMP=0x000000010001f634
- (_Bool)boolValueOfEntitlement:(id)arg1;	// IMP=0x000000010001f570
- (id)initWithClient:(struct container_client *)arg1 userIdentity:(id)arg2 entitlements:(id)arg3 sandboxed:(_Bool)arg4 kernel:(_Bool)arg5;	// IMP=0x000000010001f2e4
- (id)init;	// IMP=0x000000010001f1c8
- (id)clientIdentityWithXPCConnection:(id)arg1 xpcMessage:(id)arg2;	// IMP=0x000000010001fe8c
