...
- (void).cxx_destruct;	// IMP=0x0000000100063978
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x0000000100063620
- (void)_addPaths:(id)arg1;	// IMP=0x00000001000635e0
- (id)managedPathForURL:(id)arg1;	// IMP=0x0000000100063440
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x0000000100063130
- (id)initWithDaemonUser:(id)arg1;	// IMP=0x0000000100063008
