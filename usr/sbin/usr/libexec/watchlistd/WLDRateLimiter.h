...
- (void).cxx_destruct;	// IMP=0x000000010001c37c
- (_Bool)_claimToken;	// IMP=0x000000010001c2c4
- (void)_addToken;	// IMP=0x000000010001c250
@property unsigned long long burst;
@property unsigned long long rate;
- (_Bool)doOperation;	// IMP=0x000000010001bff4
- (id)initWithRate:(unsigned long long)arg1 burst:(unsigned long long)arg2;	// IMP=0x000000010001be7c
- (id)init;	// IMP=0x000000010001be30
