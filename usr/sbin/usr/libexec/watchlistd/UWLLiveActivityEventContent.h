...
- (void).cxx_destruct;	// IMP=0x000000010001bdc8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010001bc1c
- (unsigned long long)hash;	// IMP=0x000000010001bb3c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010001b9a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010001b858
- (void)copyTo:(id)arg1;	// IMP=0x000000010001b75c
- (void)writeTo:(id)arg1;	// IMP=0x000000010001b670
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010001b668
- (id)dictionaryRepresentation;	// IMP=0x000000010001b15c
- (id)description;	// IMP=0x000000010001b0a8
