...
+ (id)sharedLTSStatsManager;	// IMP=0x00000001000048cc
- (void).cxx_destruct;	// IMP=0x00000001000057bc
...
- (id)getLifetimeStats;	// IMP=0x0000000100005490
- (void)updateLifetimeStats;	// IMP=0x0000000100005428
- (void)updateLifetimeStatsGated;	// IMP=0x0000000100005234
- (int)updateLifetimeStatsForChannel:(struct __CFDictionary *)arg1;	// IMP=0x0000000100004e18
- (id)getStatsSinceBoot;	// IMP=0x0000000100004d68
- (void)dealloc;	// IMP=0x0000000100004cd0
- (id)init;	// IMP=0x0000000100004970
