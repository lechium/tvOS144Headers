...
- (void).cxx_destruct;	// IMP=0x000000010004e990
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004e80c
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004e6e4
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004e5cc
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004e4a4
- (void)xpcConnectionInvalidated;	// IMP=0x000000010004e31c
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x000000010004e1dc
