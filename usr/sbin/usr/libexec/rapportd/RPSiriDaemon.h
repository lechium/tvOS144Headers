...
- (void).cxx_destruct;	// IMP=0x000000010004f7cc
@property(retain, nonatomic) id <RPMessageable> messenger; // @synthesize messenger=_messenger;
- (void)_handleSiriStop:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010004f55c
- (void)_handleSiriStart:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010004ef78
- (void)_handleSiriAudio:(id)arg1;	// IMP=0x000000010004eee0
- (void)invalidate;	// IMP=0x000000010004edf0
- (_Bool)activateAndReturnError:(id *)arg1;	// IMP=0x000000010004ea4c
- (id)init;	// IMP=0x000000010004e9e4
