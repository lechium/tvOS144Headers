...
- (void).cxx_destruct;	// IMP=0x0000000100004b58
...
- (void)_scheduleNextFireForDate:(id)arg1;	// IMP=0x000000010000481c
- (void)_configureXPCActivityWithCriteria:(id)arg1;	// IMP=0x000000010000436c
- (void)ensureNextActivityWillOccurBeforeDate:(id)arg1;	// IMP=0x0000000100003fc0
- (void)stop;	// IMP=0x0000000100003e88
- (void)checkIn;	// IMP=0x0000000100003e14
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000100003d74
