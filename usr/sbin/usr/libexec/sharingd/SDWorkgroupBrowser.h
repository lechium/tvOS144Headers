...
+ (id)sharedBrowser;	// IMP=0x00000001000ccf14
- (void).cxx_destruct;	// IMP=0x00000001000cd34c
- (void)stop;	// IMP=0x00000001000cd2e8
- (void)start;	// IMP=0x00000001000cd1d8
- (void)bonjourNodesDidChange:(id)arg1;	// IMP=0x00000001000cd180
@property(readonly, copy) NSSet *workgroups;
@property(readonly, copy) NSArray *nodes;
- (id)init;	// IMP=0x00000001000ccf80
