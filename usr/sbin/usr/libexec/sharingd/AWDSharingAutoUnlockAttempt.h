...
- (void).cxx_destruct;	// IMP=0x00000001000f7aec
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000f71f0
- (unsigned long long)hash;	// IMP=0x00000001000f6cec
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000f65f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000f5f68
- (void)copyTo:(id)arg1;	// IMP=0x00000001000f5940
- (void)writeTo:(id)arg1;	// IMP=0x00000001000f53b0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000f53a8
- (id)dictionaryRepresentation;	// IMP=0x00000001000f2d00
- (id)description;	// IMP=0x00000001000f2c4c
