...
- (void).cxx_destruct;	// IMP=0x00000001000cafa8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000cae44
- (unsigned long long)hash;	// IMP=0x00000001000cad78
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000cac1c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000caaec
- (void)copyTo:(id)arg1;	// IMP=0x00000001000caa00
- (void)writeTo:(id)arg1;	// IMP=0x00000001000ca920
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000ca918
- (id)dictionaryRepresentation;	// IMP=0x00000001000ca398
- (id)description;	// IMP=0x00000001000ca2e4
