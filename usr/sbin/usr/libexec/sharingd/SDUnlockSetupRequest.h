...
- (void).cxx_destruct;	// IMP=0x00000001000dfbd0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000dfa70
- (unsigned long long)hash;	// IMP=0x00000001000df998
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000df830
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000df70c
- (void)copyTo:(id)arg1;	// IMP=0x00000001000df624
- (void)writeTo:(id)arg1;	// IMP=0x00000001000df550
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000df548
- (id)dictionaryRepresentation;	// IMP=0x00000001000defc4
- (id)description;	// IMP=0x00000001000def10
