...
+ (id)sharedManager;	// IMP=0x00000001000dda98
- (void).cxx_destruct;	// IMP=0x00000001000dec4c
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x00000001000deaf0
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00000001000deae0
- (void)appleAccountSignedOut;	// IMP=0x00000001000dea60
- (void)appleAccountSignedIn;	// IMP=0x00000001000de9e0
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000001000de958
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000001000de690
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001000de318
- (void)cleanUpConnections;	// IMP=0x00000001000de078
- (void)start;	// IMP=0x00000001000ddc5c
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00000001000ddb04
