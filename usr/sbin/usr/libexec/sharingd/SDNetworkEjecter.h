...
- (void).cxx_destruct;	// IMP=0x0000000100107ed4
...
- (void)stop;	// IMP=0x0000000100107e40
- (int)start;	// IMP=0x0000000100107d90
- (void)eject;	// IMP=0x0000000100107b5c
- (void)ejectMountPoints:(id)arg1 useAssistant:(_Bool)arg2;	// IMP=0x0000000100107b58
- (void)notifyClientAboutEject:(int)arg1;	// IMP=0x00000001001079d8
- (void)dealloc;	// IMP=0x0000000100107990
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x000000010010791c
