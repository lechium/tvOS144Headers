...
- (void)updatePossibleActions;	// IMP=0x00000001000b8764
- (id)suitableContentsDescription;	// IMP=0x00000001000b8500
- (long long)transferTypes;	// IMP=0x00000001000b84c8
- (_Bool)canHandleTransfer;	// IMP=0x00000001000b84a8
