...
- (void).cxx_destruct;	// IMP=0x0000000100089094
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100088d98
- (unsigned long long)hash;	// IMP=0x0000000100088be8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100088960
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008871c
- (void)copyTo:(id)arg1;	// IMP=0x000000010008851c
- (void)writeTo:(id)arg1;	// IMP=0x000000010008834c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100088344
- (id)dictionaryRepresentation;	// IMP=0x00000001000877a8
- (id)description;	// IMP=0x00000001000876f4
