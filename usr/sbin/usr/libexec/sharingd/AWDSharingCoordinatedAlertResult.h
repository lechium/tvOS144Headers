...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010016087c
- (unsigned long long)hash;	// IMP=0x0000000100160788
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001605d4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100160474
- (void)copyTo:(id)arg1;	// IMP=0x0000000100160330
- (void)writeTo:(id)arg1;	// IMP=0x00000001001601f8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001601f0
- (id)dictionaryRepresentation;	// IMP=0x000000010015f8f0
- (id)description;	// IMP=0x000000010015f83c
