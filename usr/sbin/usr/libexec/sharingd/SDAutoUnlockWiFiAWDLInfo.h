...
- (void).cxx_destruct;	// IMP=0x00000001000590c4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100058f28
- (unsigned long long)hash;	// IMP=0x0000000100058e3c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100058cbc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100058b64
- (void)copyTo:(id)arg1;	// IMP=0x0000000100058a50
- (void)writeTo:(id)arg1;	// IMP=0x000000010005894c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100058944
- (id)dictionaryRepresentation;	// IMP=0x00000001000582d0
- (id)description;	// IMP=0x000000010005821c
