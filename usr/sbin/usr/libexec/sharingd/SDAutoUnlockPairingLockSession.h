...
- (id)userInfoForNewProtocol;	// IMP=0x0000000100055538
- (id)userInfoForOldProtocol;	// IMP=0x0000000100055440
- (id)userInfoForNoCommunincation;	// IMP=0x0000000100055348
- (id)userInfoForNoPasscode;	// IMP=0x0000000100055250
- (id)userInfoForNoWristDetection;	// IMP=0x0000000100055158
- (id)userInfoForNoWristDetectionNoPasscode;	// IMP=0x0000000100055060
- (id)userInfoCompanionViewNotSyncing;	// IMP=0x0000000100054f68
- (id)userInfoForWatchLocked;	// IMP=0x0000000100054e70
- (id)userInfoForNotCloudPaired;	// IMP=0x0000000100054dc0
- (id)userInfoForMacNotSignedIn;	// IMP=0x0000000100054cc8
- (id)userInfoForWatchNotSignedIn;	// IMP=0x0000000100054bd0
- (id)userInfoForMissingLTK;	// IMP=0x0000000100054ad8
- (id)userInfoForInternetSharing;	// IMP=0x00000001000549e0
- (id)userInfoForKeychainMismatch;	// IMP=0x00000001000548e8
- (id)userInfoForiPhoneNeedsUnlock;	// IMP=0x00000001000547f0
- (void)transport:(id)arg1 didReceiveMessageACKForIdentifier:(id)arg2;	// IMP=0x00000001000545dc
- (void)transport:(id)arg1 didReceivePayload:(id)arg2 type:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x00000001000542cc
- (void)sendCreateEscrowSecretWithStepData:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x0000000100053ef0
- (void)sendSetupRequest;	// IMP=0x00000001000539f4
- (void)handleSuccessfulPairing;	// IMP=0x000000010005338c
- (void)handleSetupCreateRecord:(id)arg1;	// IMP=0x0000000100052c4c
- (void)handleEscrowSessionRequest;	// IMP=0x00000001000522d4
- (void)handleSetupSessionCreated:(id)arg1;	// IMP=0x00000001000519a0
- (void)handleKeyDeviceLocked;	// IMP=0x0000000100051894
- (_Bool)ltkHashMatches;	// IMP=0x000000010005176c
- (void)handleLTKTimerFired;	// IMP=0x00000001000514c8
- (void)invalidateLTKTimer;	// IMP=0x00000001000513f0
- (void)restartLTKTimer;	// IMP=0x00000001000511e0
- (void)notifyDelegateKeyDeviceIsLocked;	// IMP=0x000000010005113c
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001000509cc
- (_Bool)validatePasscode:(id)arg1;	// IMP=0x000000010005084c
- (void)handleTimerFired;	// IMP=0x0000000100050664
- (id)generatedError;	// IMP=0x0000000100050508
- (void)invalidate;	// IMP=0x00000001000503f8
- (void)onqueue_updateForCloudPairing;	// IMP=0x000000010005038c
- (void)updateForCloudPairing;	// IMP=0x0000000100050300
- (void)onqueue_cancel;	// IMP=0x00000001000501d0
- (void)cancel;	// IMP=0x0000000100050144
- (void)onqueue_start;	// IMP=0x000000010004fb24
- (void)start;	// IMP=0x000000010004fa98
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x000000010004f6d4
