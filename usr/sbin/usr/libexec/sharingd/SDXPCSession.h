...
+ (id)sharedSession;	// IMP=0x00000001000cff48
- (void).cxx_destruct;	// IMP=0x00000001000d0214
...
- (void)connectionManagerDidInvalidate:(id)arg1;	// IMP=0x00000001000d01dc
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000d013c
- (void)stop;	// IMP=0x00000001000d00e4
- (void)start;	// IMP=0x00000001000d0024
- (id)init;	// IMP=0x00000001000cffb4
