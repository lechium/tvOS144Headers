...
- (void).cxx_destruct;	// IMP=0x0000000100172f98
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100172afc
- (unsigned long long)hash;	// IMP=0x0000000100172878
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001724c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010017216c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100171e64
- (void)writeTo:(id)arg1;	// IMP=0x0000000100171ba8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100171ba0
- (id)dictionaryRepresentation;	// IMP=0x0000000100170aa4
- (id)description;	// IMP=0x00000001001709f0
