...
- (void).cxx_destruct;	// IMP=0x00000001000c9abc
...
- (void)stop;	// IMP=0x00000001000c9a18
- (int)start;	// IMP=0x00000001000c9730
- (void)mount;	// IMP=0x00000001000c972c
- (void)bonjourResolverDidChange:(id)arg1;	// IMP=0x00000001000c9474
- (void)mountDiskImageAsync;	// IMP=0x00000001000c9470
- (void)notifyClientAboutResolve:(int)arg1;	// IMP=0x00000001000c933c
- (void)dealloc;	// IMP=0x00000001000c92f4
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x00000001000c9274
