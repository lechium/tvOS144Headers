...
- (void).cxx_destruct;	// IMP=0x0000000100049910
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100049784
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100049248
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00000001000491d4
- (_Bool)fetchNext:(id)arg1;	// IMP=0x0000000100048df4
- (id)createNextRequest:(id)arg1;	// IMP=0x0000000100048de0
- (id)init;	// IMP=0x0000000100048d4c
