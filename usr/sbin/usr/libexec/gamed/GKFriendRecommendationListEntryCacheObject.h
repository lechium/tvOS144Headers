...
+ (id)entityName;	// IMP=0x00000001000555d4
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00000001000555e0
- (id)internalRepresentation;	// IMP=0x00000001000553ac
