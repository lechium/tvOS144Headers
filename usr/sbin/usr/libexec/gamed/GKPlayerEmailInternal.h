...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100131ab0
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100131a38
...
- (unsigned long long)hash;	// IMP=0x0000000100131c5c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100131b94
- (void)dealloc;	// IMP=0x0000000100131a40
