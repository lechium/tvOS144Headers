...
+ (id)entityName;	// IMP=0x000000010005f598
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005fa0c
- (id)internalRepresentation;	// IMP=0x000000010005f718
- (Class)classForInternalRepresentation;	// IMP=0x000000010005f70c
- (_Bool)hasDetails;	// IMP=0x000000010005f5a4
