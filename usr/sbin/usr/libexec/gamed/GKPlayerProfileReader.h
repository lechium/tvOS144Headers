...
+ (id)readerWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x000000010013b4c4
...
- (void)readResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010013b860
- (id)poolName;	// IMP=0x000000010013b80c
- (int)familiarityForPlayer:(id)arg1;	// IMP=0x000000010013b664
- (void)dealloc;	// IMP=0x000000010013b5fc
- (id)initWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x000000010013b52c
