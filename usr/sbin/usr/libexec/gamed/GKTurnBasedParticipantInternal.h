...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013d328
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013d744
- (id)serverRepresentation;	// IMP=0x000000010013d5b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013d4e4
- (unsigned long long)hash;	// IMP=0x000000010013d4c8
- (void)dealloc;	// IMP=0x000000010013d278
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100144060
