...
+ (id)entityName;	// IMP=0x000000010004a5fc
+ (id)playerProfilesWithPlayerIDs:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000100048f94
+ (id)playerProfilesWithPlayers:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000100048f34
+ (id)profileForPlayer:(id)arg1 context:(id)arg2;	// IMP=0x0000000100048eac
+ (id)playerProfileWithPlayerID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000100048ca8
+ (id)localPlayerInManagedObjectContext:(id)arg1;	// IMP=0x0000000100048ae8
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x0000000100048164
+ (id)uniqueAttributeName;	// IMP=0x0000000100048158
+ (id)filterPlayerIDs:(id)arg1 familiarity:(int)arg2 includeSelf:(_Bool)arg3;	// IMP=0x000000010004b680
+ (unsigned char)piecesToLoadForFamiliarity:(int)arg1;	// IMP=0x000000010004b650
+ (id)playersByFamiliarity:(id)arg1;	// IMP=0x000000010004b1f0
+ (void)setFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x000000010004b054
+ (void)removeFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x000000010004acf4
+ (void)addFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x000000010004ab80
+ (int)familiarityForPlayerID:(id)arg1;	// IMP=0x000000010004aa48
+ (id)selfPlayerID;	// IMP=0x000000010004aa1c
+ (void)buildFamiliarilyLookupForProfile:(id)arg1;	// IMP=0x000000010004a878
+ (id)_familiarityLookup;	// IMP=0x000000010004a71c
- (void)expireRecentMatchesWithGame:(id)arg1;	// IMP=0x000000010004a608
- (id)internalRepresentation;	// IMP=0x000000010004a4c4
- (id)internalRepresentationWithPieces:(unsigned char)arg1;	// IMP=0x000000010004a2c0
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2 pieces:(unsigned char)arg3;	// IMP=0x00000001000495dc
- (id)updateImagesWithImageURLs:(id)arg1;	// IMP=0x0000000100049244
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100049234
- (void)deleteCachedImage:(id)arg1;	// IMP=0x000000010004873c
- (void)deleteCachedAvatars;	// IMP=0x0000000100048530
- (void)clearImages;	// IMP=0x00000001000482c8
...
- (void)invalidate;	// IMP=0x00000001000481e8
