...
+ (Class)entryClass;	// IMP=0x0000000100057810
+ (id)entityName;	// IMP=0x0000000100057804
- (id)internalRepresentation;	// IMP=0x00000001000579d4
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005781c
