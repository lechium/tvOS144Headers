...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013d9b8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013dc80
- (unsigned long long)hash;	// IMP=0x000000010013dc68
- (void)dealloc;	// IMP=0x000000010013d8e8
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100144260
