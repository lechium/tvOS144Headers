...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013f3cc
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x000000010013f21c
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x000000010013f0e4
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x000000010013ec48
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013f774
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013f6d8
- (unsigned long long)hash;	// IMP=0x000000010013f6b4
- (void)dealloc;	// IMP=0x000000010013f2bc
- (id)init;	// IMP=0x000000010013f258
