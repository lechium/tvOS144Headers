...
- (_Bool)isEnabledForDataClass:(id)arg1;	// IMP=0x000000010012f3e8
...
- (void)dealloc;	// IMP=0x000000010012f370
- (id)initWithInternalAccount:(id)arg1;	// IMP=0x000000010012f318
