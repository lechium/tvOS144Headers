...
+ (id)entityName;	// IMP=0x000000010004bbb0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004b988
- (id)internalRepresentation;	// IMP=0x000000010004b7c8
