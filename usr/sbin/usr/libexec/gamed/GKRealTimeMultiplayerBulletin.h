...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000391a4
...
- (id)description;	// IMP=0x000000010003a8cc
- (id)customInviteSoundPathForBundleID:(id)arg1;	// IMP=0x000000010003a75c
- (void)declineInviteWithReason:(int)arg1;	// IMP=0x000000010003a594
- (void)updateDeclineInviteTrackingForReason:(long long)arg1;	// IMP=0x000000010003a40c
- (id)clientNotification;	// IMP=0x000000010003a090
- (id)clientNotificationWithiCloudID:(id)arg1;	// IMP=0x000000010003a024
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100039ce8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100039914
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000395b4
- (void)parseClientData:(id)arg1;	// IMP=0x0000000100039438
- (long long)inviteVersionFromMessage:(id)arg1;	// IMP=0x00000001000392c0
- (void)dealloc;	// IMP=0x00000001000391e0
- (id)init;	// IMP=0x00000001000391ac
