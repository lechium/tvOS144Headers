...
+ (id)entityName;	// IMP=0x000000010004e2c4
- (id)internalRepresentation;	// IMP=0x000000010004e4f0
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004e338
- (_Bool)isValid;	// IMP=0x000000010004e2d0
