...
+ (id)bagKey;	// IMP=0x00000001001da360
- (void).cxx_destruct;	// IMP=0x00000001001dab38
...
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00000001001da978
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001da974
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001da918
- (id)taskInfo;	// IMP=0x00000001001da7a8
- (id)postBody;	// IMP=0x00000001001da79c
- (id)initWithInstanceScore:(id)arg1 bundleID:(id)arg2 challenges:(id)arg3;	// IMP=0x00000001001da510
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001da36c
