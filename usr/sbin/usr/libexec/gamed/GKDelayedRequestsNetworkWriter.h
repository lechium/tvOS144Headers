...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x000000010012578c
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010012589c
- (void)dealloc;	// IMP=0x000000010012584c
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00000001001257cc
