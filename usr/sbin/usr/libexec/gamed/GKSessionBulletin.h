...
+ (_Bool)displayNotification;	// IMP=0x00000001000e0a5c
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000e0a54
- (void).cxx_destruct;	// IMP=0x00000001000e3068
...
- (id)description;	// IMP=0x00000001000e2df4
- (void)assembleBulletin;	// IMP=0x00000001000e27f8
- (void)localizeMessage;	// IMP=0x00000001000e2724
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000e2428
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000e2108
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000e1df8
- (void)distributeData;	// IMP=0x00000001000e1df4
- (void)loadDataWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e18e0
- (void)determineGameLocationOnDeviceOrInStoreWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e0a64
