...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100135420
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100134efc
...
- (unsigned long long)hash;	// IMP=0x00000001001358d4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001356ec
- (id)serverRepresentation;	// IMP=0x00000001001355c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001352f4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100134f24
- (void)dealloc;	// IMP=0x0000000100134e6c
