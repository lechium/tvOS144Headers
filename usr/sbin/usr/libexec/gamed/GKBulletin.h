...
+ (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e7f08
+ (_Bool)shouldProcessNotification;	// IMP=0x00000001000e7c60
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000e7890
+ (void)loadBulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e6f24
+ (void)bulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e68d0
+ (id)syncQueue;	// IMP=0x00000001000e685c
...
- (id)description;	// IMP=0x00000001000e8198
- (void)handleAction:(id)arg1;	// IMP=0x00000001000e8060
- (void)executeBulletinWithBulletinController:(id)arg1;	// IMP=0x00000001000e7db4
- (void)dealloc;	// IMP=0x00000001000e7bb8
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000e79fc
- (id)dataFrom64String:(id)arg1;	// IMP=0x00000001000e7898
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000e7474
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000e7048
