...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001336d4
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001334cc
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100133b7c
...
- (unsigned long long)hash;	// IMP=0x0000000100133a6c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013399c
- (id)serverRepresentation;	// IMP=0x000000010013383c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100133778
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001336dc
- (void)dealloc;	// IMP=0x000000010013340c
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x0000000100133c88
