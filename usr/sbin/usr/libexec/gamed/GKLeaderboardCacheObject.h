...
+ (id)entityName;	// IMP=0x00000001000577f8
- (id)internalRepresentation;	// IMP=0x000000010005748c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100056eb8
