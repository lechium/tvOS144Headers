...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100084b68
...
- (void)dealloc;	// IMP=0x0000000100084bdc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100084b70
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000848c8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010008463c
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000001000845b4
- (id)init;	// IMP=0x0000000100084574
