...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100131f8c
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100131f84
+ (int)familiarity;	// IMP=0x0000000100142b64
...
- (int)defaultFamiliarity;	// IMP=0x0000000100132120
- (void)dealloc;	// IMP=0x0000000100131f24
