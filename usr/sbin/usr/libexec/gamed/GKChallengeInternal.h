...
+ (id)internalRepresentation;	// IMP=0x0000000100137760
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100137308
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100137ba4
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x0000000100137880
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x0000000100137774
- (id)serverRepresentation;	// IMP=0x0000000100137768
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001376dc
- (unsigned long long)hash;	// IMP=0x00000001001376b8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001375e0
- (void)dealloc;	// IMP=0x0000000100137510
