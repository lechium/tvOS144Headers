...
- (void)startObservingStateChangesForBundleID:(id)arg1;	// IMP=0x0000000100081e6c
- (_Bool)observingStateChangesForBundleID:(id)arg1;	// IMP=0x0000000100081e34
@property(copy, nonatomic) CDUnknownBlockType handler;
- (void)dealloc;	// IMP=0x0000000100081dbc
- (id)init;	// IMP=0x0000000100081d50
