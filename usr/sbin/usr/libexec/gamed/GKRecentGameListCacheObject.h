...
+ (Class)entryClass;	// IMP=0x0000000100057fa8
+ (id)entityName;	// IMP=0x0000000100057f9c
- (id)internalRepresentation;	// IMP=0x000000010005816c
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100057fb4
