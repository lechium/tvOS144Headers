...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0000000100179044
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100179164
- (void)dealloc;	// IMP=0x0000000100179104
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0000000100179084
