...
+ (id)entityName;	// IMP=0x0000000100051264
- (_Bool)isValid;	// IMP=0x0000000100051324
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100051270
