...
+ (id)entityName;	// IMP=0x0000000100050664
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x00000001000502dc
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00000001000504c4
