...
+ (id)bagKey;	// IMP=0x00000001001d92a8
- (void).cxx_destruct;	// IMP=0x00000001001da2f4
...
- (id)taskInfo;	// IMP=0x00000001001d9ffc
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001d9ce8
- (id)postBody;	// IMP=0x00000001001d9c50
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001d9a5c
- (id)initWithChallenges:(id)arg1 bundleID:(id)arg2;	// IMP=0x00000001001d9924
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001d92b4
