...
+ (id)displayNameForEnvironment:(long long)arg1;	// IMP=0x000000010007fee8
+ (id)hostNameForEnvironment:(long long)arg1;	// IMP=0x000000010007febc
+ (id)shared;	// IMP=0x000000010007edec
...
- (void)removeOverrideForKey:(id)arg1;	// IMP=0x000000010007f2ac
- (void)setStringValue:(id)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007f294
- (id)stringValueForKey:(struct __CFString *)arg1 defaultValue:(id)arg2;	// IMP=0x000000010007f264
- (void)setTimeInterval:(double)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007f208
- (double)timeIntervalForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x000000010007f1c4
- (void)setUnsignedIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007f168
- (long long)unsignedIntegerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x000000010007f124
- (void)setIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007f0c8
- (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x000000010007f084
- (void)setBooleanValue:(_Bool)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010007f024
- (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x000000010007f014
- (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x000000010007efd0
- (id)preferencesValueForKey:(id)arg1;	// IMP=0x000000010007ef80
- (void)_didWriteKey:(struct __CFString *)arg1;	// IMP=0x000000010007ef58
- (void)synchronize;	// IMP=0x000000010007ef1c
- (void)invalidate;	// IMP=0x000000010007ef0c
- (_Bool)isInternalBuild;	// IMP=0x000000010007ee90
- (void)dealloc;	// IMP=0x000000010007eda4
- (id)init;	// IMP=0x000000010007ed98
- (id)initWithoutUIKitNotifications;	// IMP=0x000000010007ed18
- (id)initWithUIKitNotifications;	// IMP=0x000000010007ed0c
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000001000e8838
- (id)valueRestrictionForKey:(id)arg1;	// IMP=0x00000001000e87fc
- (_Bool)restrictionEnabledForKey:(id)arg1;	// IMP=0x00000001000e87b4
