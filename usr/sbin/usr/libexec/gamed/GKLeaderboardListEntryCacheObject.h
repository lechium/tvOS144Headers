...
+ (id)entityName;	// IMP=0x0000000100050f84
- (id)internalRepresentation;	// IMP=0x0000000100051138
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100050f90
