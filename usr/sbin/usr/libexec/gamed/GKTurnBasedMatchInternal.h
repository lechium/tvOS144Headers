...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013c2a0
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013cfd4
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x000000010013c9ac
- (long long)previousParticipantIndex;	// IMP=0x000000010013c824
- (long long)localPlayerParticipantIndex;	// IMP=0x000000010013c7d0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013c6bc
- (unsigned long long)hash;	// IMP=0x000000010013c698
- (void)dealloc;	// IMP=0x000000010013c140
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00000001001437dc
