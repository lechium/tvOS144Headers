...
+ (id)entityName;	// IMP=0x000000010005ee90
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005f23c
- (id)internalRepresentation;	// IMP=0x000000010005ef04
- (Class)classForInternalRepresentation;	// IMP=0x000000010005eef8
- (_Bool)hasDetails;	// IMP=0x000000010005ee9c
