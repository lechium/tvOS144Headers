...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013e640
...
- (_Bool)hasGuestPlayers;	// IMP=0x000000010013e960
- (unsigned long long)hash;	// IMP=0x000000010013e5cc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013e1ac
- (void)dealloc;	// IMP=0x000000010013e0fc
- (id)init;	// IMP=0x000000010013e07c
