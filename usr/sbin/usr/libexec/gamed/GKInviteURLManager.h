...
+ (id)sharedManager;	// IMP=0x0000000100108d4c
- (void).cxx_destruct;	// IMP=0x0000000100109264
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x0000000100108fbc
- (id)init;	// IMP=0x0000000100108f04
