...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013fa2c
...
- (unsigned long long)hash;	// IMP=0x000000010013fd60
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013fbf4
- (void)dealloc;	// IMP=0x000000010013f9ac
