...
+ (id)entityName;	// IMP=0x00000001000540b0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00000001000544ec
- (id)internalRepresentation;	// IMP=0x00000001000540bc
