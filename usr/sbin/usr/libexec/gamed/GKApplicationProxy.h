...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x0000000100092cd4
...
- (id)bundleURL;	// IMP=0x0000000100092ecc
...
- (void)dealloc;	// IMP=0x0000000100092dac
- (id)initWithBundleID:(id)arg1;	// IMP=0x0000000100092c94
- (id)initWithProxy:(id)arg1;	// IMP=0x0000000100092c34
