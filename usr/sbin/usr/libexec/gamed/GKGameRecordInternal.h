...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012abe8
+ (id)gameRecordForGame:(id)arg1;	// IMP=0x000000010012aa54
+ (id)_gameProperties;	// IMP=0x0000000100141500
+ (id)propertiesToFetch;	// IMP=0x0000000100141220
...
- (void)updateWithGame:(id)arg1;	// IMP=0x000000010012aa9c
- (void)dealloc;	// IMP=0x000000010012a9e4
- (void)updateWithProperties:(id)arg1;	// IMP=0x00000001001415e4
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100140fcc
