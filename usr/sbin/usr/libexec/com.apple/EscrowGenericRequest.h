...
- (void).cxx_destruct;	// IMP=0x000000010001c198
...
- (id)_filteredMetadataForDoubleEnrollment:(id)arg1;	// IMP=0x000000010001be7c
- (id)urlString;	// IMP=0x000000010001bdc0
- (id)urlRequest;	// IMP=0x000000010001bc88
- (id)authorizationHeader;	// IMP=0x000000010001bb60
- (id)authorizationHeaderWithUser:(id)arg1 password:(id)arg2 authType:(id)arg3;	// IMP=0x000000010001b92c
- (id)bodyDictionary;	// IMP=0x000000010001b608
- (id)validateInput;	// IMP=0x000000010001b2b8
...
- (id)initWithRequest:(id)arg1;	// IMP=0x000000010001aa24
