...
- (void).cxx_destruct;	// IMP=0x000000010005f3bc
...
- (void)dealloc;	// IMP=0x000000010005f268
- (id)recoveryResponseForBlob:(id)arg1;	// IMP=0x000000010005e9d8
- (id)srpResponseForEscrowBlob:(id)arg1 withKey:(struct __SecKey *)arg2 withFullCCKey:(struct ccrsa_full_ctx *)arg3;	// IMP=0x000000010005df00
- (id)decodedEscrowRecordFromData:(id)arg1 stingray:(_Bool)arg2 enroll:(_Bool)arg3 env:(id)arg4 duplicate:(_Bool)arg5;	// IMP=0x000000010005d1ec
- (id)encodedEscrowRecordWithPublicKey:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x000000010005b5d0
- (id)srpRecoveryBlobFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000010005a874
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;	// IMP=0x000000010005a7f8
- (unsigned long long)srpPublicKeySize;	// IMP=0x000000010005a794
- (unsigned long long)srpKeySize;	// IMP=0x000000010005a704
- (id)srpInitBlob;	// IMP=0x000000010005a580
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5 ckvrFlag:(_Bool)arg6 reqVersion:(int)arg7;	// IMP=0x000000010005a2e8
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5;	// IMP=0x000000010005a1f8
- (id)initWithRequest:(id)arg1 ckvrFlag:(_Bool)arg2 reqVersion:(int)arg3;	// IMP=0x000000010005a040
- (id)initWithRequest:(id)arg1 reqVersion:(int)arg2;	// IMP=0x0000000100059fcc
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000100059fbc
