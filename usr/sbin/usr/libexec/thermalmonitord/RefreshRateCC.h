...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x000000010000f5d0
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x000000010000f534
- (int)numberOfFields;	// IMP=0x000000010000f500
- (void)refreshTGraphTelemetry;	// IMP=0x000000010000f4fc
- (void)initRefreshRateTable:(struct __CFArray *)arg1;	// IMP=0x000000010000f2b8
- (void)defaultAction;	// IMP=0x000000010000f20c
- (id)initWithParams:(struct __CFDictionary *)arg1;	// IMP=0x000000010000f0fc
