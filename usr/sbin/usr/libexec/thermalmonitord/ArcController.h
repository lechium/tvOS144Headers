...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x00000001000296b4
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x00000001000296a0
- (int)numberOfFields;	// IMP=0x0000000100029698
- (void)overrideParam:(id)arg1 value:(int)arg2;	// IMP=0x000000010002954c
- (void)updateInternal;	// IMP=0x00000001000293d0
- (void)update;	// IMP=0x0000000100029364
- (id)initWithParams:(id)arg1 product:(id)arg2;	// IMP=0x00000001000290bc
- (id)init;	// IMP=0x00000001000290a8
