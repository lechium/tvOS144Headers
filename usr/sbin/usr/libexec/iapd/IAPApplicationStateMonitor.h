...
- (void).cxx_destruct;	// IMP=0x000000010005b3f0
...
- (id)applicationInfoForPIDSync:(int)arg1;	// IMP=0x000000010005b1d8
- (id)applicationInfoForBundleIDSync:(id)arg1;	// IMP=0x000000010005b174
- (void)layoutMonitor:(id)arg1 didUpdateDisplayLayout:(id)arg2 withContext:(id)arg3;	// IMP=0x000000010005ae34
- (void)stopObserving;	// IMP=0x000000010005ad00
- (void)startObserving;	// IMP=0x000000010005a840
- (void)dealloc;	// IMP=0x000000010005a7ac
- (id)init;	// IMP=0x000000010005a738
- (void)sharedInit;	// IMP=0x000000010005a68c
