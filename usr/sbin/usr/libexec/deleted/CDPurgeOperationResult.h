...
- (void).cxx_destruct;	// IMP=0x0000000100026660
...
- (void)addResult:(id)arg1;	// IMP=0x00000001000264d4
...
- (id)initWithVolumes:(id)arg1 requestedBytes:(unsigned long long)arg2 beginFreeSpace:(unsigned long long)arg3;	// IMP=0x0000000100026274
