...
- (void).cxx_destruct;	// IMP=0x000000010002c914
@property(retain, nonatomic) CDPeriodicOperationResult *periodicResult; // @synthesize periodicResult=_periodicResult;
- (void)_startOperation:(CDUnknownBlockType)arg1;	// IMP=0x000000010002b3ec
- (id)initWithInfo:(id)arg1 services:(id)arg2 volumes:(id)arg3;	// IMP=0x000000010002b0e4
