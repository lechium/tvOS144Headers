...
- (void).cxx_destruct;	// IMP=0x000000010003f6fc
...
- (void)_startOperation:(CDUnknownBlockType)arg1;	// IMP=0x000000010003c738
- (id)copyInFlights;	// IMP=0x000000010003c5cc
- (void)removeInFlight:(id)arg1;	// IMP=0x000000010003c4d0
- (void)addInFlight:(id)arg1;	// IMP=0x000000010003c3d4
- (void)cancelOperation;	// IMP=0x000000010003c3c4
- (id)initWithInfo:(id)arg1 services:(id)arg2 volumes:(id)arg3;	// IMP=0x000000010003c0fc
