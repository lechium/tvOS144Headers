...
+ (_Bool)isSpindumpFile:(const char *)arg1;	// IMP=0x00000001000191a8
...
- (_Bool)parseSpindumpFile:(const char *)arg1 andReportToStream:(struct __sFILE *)arg2;	// IMP=0x0000000100019274
