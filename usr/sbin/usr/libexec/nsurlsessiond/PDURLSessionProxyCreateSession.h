...
- (void).cxx_destruct;	// IMP=0x0000000100007e08
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100007be4
- (unsigned long long)hash;	// IMP=0x0000000100007ab4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000078b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000770c
- (void)copyTo:(id)arg1;	// IMP=0x00000001000075a8
- (void)writeTo:(id)arg1;	// IMP=0x000000010000745c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100006d9c
- (id)dictionaryRepresentation;	// IMP=0x0000000100006ae4
- (id)description;	// IMP=0x0000000100006a30
