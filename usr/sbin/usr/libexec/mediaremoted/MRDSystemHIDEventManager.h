...
- (void).cxx_destruct;	// IMP=0x000000010001419c
- (void)dispatchHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x00000001000140f4
- (void)dealloc;	// IMP=0x00000001000140a4
- (id)init;	// IMP=0x0000000100013fe4
