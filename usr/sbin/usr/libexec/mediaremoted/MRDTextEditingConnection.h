...
- (void).cxx_destruct;	// IMP=0x000000010003c1f0
...
- (id)concatenatedTextForDocumentState:(id)arg1;	// IMP=0x000000010003bf64
- (void)_setCurrentSession:(id)arg1;	// IMP=0x000000010003bf50
- (void)_killRemoteTextEditingSession;	// IMP=0x000000010003bebc
- (oneway void)endRemoteTextInputSessionWithID:(id)arg1;	// IMP=0x000000010003bd70
- (oneway void)remoteTextInputSessionWithID:(id)arg1 documentTraitsDidChange:(id)arg2;	// IMP=0x000000010003bc54
- (oneway void)remoteTextInputSessionWithID:(id)arg1 documentDidChange:(id)arg2;	// IMP=0x000000010003bac8
- (oneway void)beginRemoteTextInputSessionWithID:(id)arg1 documentTraits:(id)arg2 initialDocumentState:(id)arg3;	// IMP=0x000000010003b050
@property(readonly, nonatomic) MRTextEditingSession *currentSession;
- (void)didInitializeWithConnection:(id)arg1;	// IMP=0x000000010003af20
