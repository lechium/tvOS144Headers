...
- (void).cxx_destruct;	// IMP=0x000000010002d3ac
...
- (void)_invalidate;	// IMP=0x000000010002d298
- (void)getAvailableOutputDevicesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d228
- (void)getAvailableEndpointsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d1b8
- (void)setEndpointFeatures:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002d158
- (void)setDiscoveryMode:(unsigned int)arg1 enableThrottling:(_Bool)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000010002d08c
- (void)getDiscoveryModeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d078
- (void)getDevicePresenceDetectedWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002d018
- (void)hostedRoutingController:(id)arg1 outputDevicesDidChange:(id)arg2 forFeature:(unsigned int)arg3;	// IMP=0x000000010002cd1c
- (void)hostedRoutingController:(id)arg1 endpointsDidChange:(id)arg2;	// IMP=0x000000010002ca20
@property(readonly, copy) NSString *debugDescription;
- (void)dealloc;	// IMP=0x000000010002c508
- (id)initWithConnection:(id)arg1 hostedRoutingController:(id)arg2;	// IMP=0x000000010002c218
