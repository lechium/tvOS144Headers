...
- (void).cxx_destruct;	// IMP=0x0000000100092e28
...
- (void)_onSyncSelf_maybeSetupPlaybackTimeoutTimerForEvent:(long long)arg1;	// IMP=0x00000001000928d8
- (id)_onSyncSelf_calculateElectedPlayerForOriginClient:(id)arg1 event:(long long)arg2 reason:(id *)arg3;	// IMP=0x00000001000925d8
- (long long)_resolveChangeTypeWithOriginClient:(id)arg1 forEvent:(long long)arg2;	// IMP=0x0000000100092250
- (void)_onSyncSelf_reevaluateElectedPlayerForEvent:(long long)arg1 withReason:(id)arg2;	// IMP=0x0000000100091d74
- (void)_handleActiveSystemEndpointDidChangeNotification:(id)arg1;	// IMP=0x0000000100091814
- (void)_handleNowPlayingApplicationDidForegroundNotification:(id)arg1;	// IMP=0x00000001000916bc
- (void)_handleNowPlayingApplicationDidChangeNotification:(id)arg1;	// IMP=0x00000001000915a8
- (void)_handleIsPlayingDidChangeNotification:(id)arg1;	// IMP=0x0000000100091420
- (void)_handlePlaybackQueueChangedNotification:(id)arg1;	// IMP=0x0000000100091318
- (_Bool)_shouldUseNotification:(id)arg1;	// IMP=0x0000000100091278
@property(retain, nonatomic) NSString *activeSystemEndpointOutputDeviceUID;
- (void)setOriginClient:(id)arg1 withChangeType:(long long)arg2;	// IMP=0x0000000100091110
- (id)initWithOriginClient:(id)arg1;	// IMP=0x0000000100090d04
