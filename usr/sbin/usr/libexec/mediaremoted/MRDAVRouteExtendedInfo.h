...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x000000010003331c
- (void).cxx_destruct;	// IMP=0x0000000100033574
...
- (id)_extendedInfo;	// IMP=0x0000000100033534
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000100033370
