...
- (void).cxx_destruct;	// IMP=0x0000000100036fdc
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100036818
- (id)description;	// IMP=0x00000001000366fc
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000001000364c8
