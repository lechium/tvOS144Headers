...
- (void).cxx_destruct;	// IMP=0x00000001000a55f4
...
- (void)notifyDelegateOfWake;	// IMP=0x00000001000a552c
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000a5488
- (id)init;	// IMP=0x00000001000a5154
