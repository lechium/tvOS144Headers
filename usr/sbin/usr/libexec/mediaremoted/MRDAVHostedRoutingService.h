...
- (void).cxx_destruct;	// IMP=0x0000000100030df0
...
- (void)collectDiagnostic:(id)arg1;	// IMP=0x0000000100030c74
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000100030b80
- (void)hostedDiscoverySessionDidInvalidate:(id)arg1;	// IMP=0x0000000100030aec
- (id)endpointForDeviceUID:(id)arg1;	// IMP=0x00000001000308b0
- (id)endpointForOrigin:(id)arg1;	// IMP=0x0000000100030548
@property(readonly, nonatomic) NSXPCListenerEndpoint *xpcEndpoint;
- (id)init;	// IMP=0x00000001000303cc
