...
- (void).cxx_destruct;	// IMP=0x0000000100024694
...
- (id)createNotificationInfo;	// IMP=0x000000010002459c
- (void)migrateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000244fc
- (void)_prepareWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002445c
- (void)prepareWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100023dac
@property(readonly, nonatomic) NSString *label;
- (id)description;	// IMP=0x0000000100023be8
- (id)initWithUID:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000100023a68
