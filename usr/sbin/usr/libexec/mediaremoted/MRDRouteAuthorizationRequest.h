...
- (void).cxx_destruct;	// IMP=0x00000001000b5734
...
- (void)cancel;	// IMP=0x00000001000b5718
- (void)respondWithAuthorizationToken:(id)arg1;	// IMP=0x00000001000b5708
- (id)initWithRoute:(id)arg1 inputType:(long long)arg2 responseCallback:(CDUnknownBlockType)arg3 cancelCallback:(CDUnknownBlockType)arg4;	// IMP=0x00000001000b5610
