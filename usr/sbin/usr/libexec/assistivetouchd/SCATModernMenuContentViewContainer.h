...
- (void).cxx_destruct;	// IMP=0x0000000100090a68
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000001000909b8
- (id)collectionView;	// IMP=0x0000000100090854
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100090494
