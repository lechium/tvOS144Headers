...
@interface AXElementGroup (UsefulLogging) <SCATElement>
- (id)elemLog;	// IMP=0x000000010002e700
@property(nonatomic) _Bool scatAssistiveTechFocused;
- (void)prepareElementsForScanning:(id)arg1;	// IMP=0x00000001000a3960
...
- (void)scatScrollToVisible;	// IMP=0x00000001000a372c
@property(readonly, nonatomic) _Bool scatIsValid;
@property(readonly, nonatomic) NSString *scatSpeakableDescription;
- (id)scatSpeakableDescription:(_Bool)arg1;	// IMP=0x00000001000a33f4
@property(readonly, nonatomic) struct CGRect scatFrame;
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x00000001000a3380
- (id)scrollableElement;	// IMP=0x00000001000a3308
...
- (id)scatSupportedGestures;	// IMP=0x00000001000a305c
@property(readonly, nonatomic) struct CGPath *scatPath;
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x00000001000a304c
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x00000001000a3044
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x00000001000a303c
