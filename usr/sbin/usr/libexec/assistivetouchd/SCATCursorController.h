...
- (void).cxx_destruct;	// IMP=0x00000001000bd554
...
- (void)hide:(_Bool)arg1 animate:(_Bool)arg2;	// IMP=0x00000001000bd410
- (void)updatePath:(id)arg1 frame:(struct CGRect)arg2 isSimpleRect:(_Bool)arg3 animated:(_Bool)arg4 options:(int)arg5;	// IMP=0x00000001000bd224
- (void)updateLevel:(int)arg1 animated:(_Bool)arg2 options:(int)arg3;	// IMP=0x00000001000bd144
- (void)updateTheme:(int)arg1 animated:(_Bool)arg2 options:(int)arg3;	// IMP=0x00000001000bd064
- (void)updateTheme:(int)arg1 level:(int)arg2 path:(id)arg3 frame:(struct CGRect)arg4 isSimpleRect:(_Bool)arg5 animated:(_Bool)arg6 options:(int)arg7;	// IMP=0x00000001000bcf80
- (id)description;	// IMP=0x00000001000bced8
