...
+ (id)factoryWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3;	// IMP=0x000000010006a444
...
- (id)_animation;	// IMP=0x000000010006a610
- (id)_springAnimation;	// IMP=0x000000010006a580
- (void)_calculateDuration;	// IMP=0x000000010006a524
- (id)_initWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3;	// IMP=0x000000010006a48c
