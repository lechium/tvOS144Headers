...
- (void).cxx_destruct;	// IMP=0x000000010005b40c
...
- (id)description;	// IMP=0x000000010005b298
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x000000010005b10c
- (void)scatDidBecomeFocused:(_Bool)arg1;	// IMP=0x000000010005af98
- (_Bool)scatIndicatesOwnFocus;	// IMP=0x000000010005af90
