...
- (void).cxx_destruct;	// IMP=0x0000000100088880
...
- (void)_didReceiveActionWithIdentifier:(long long)arg1 start:(_Bool)arg2 ignoreInputHold:(_Bool)arg3;	// IMP=0x0000000100088700
- (void)handleReceivedSwitchEvent:(id)arg1 deviceName:(id)arg2;	// IMP=0x00000001000882c8
- (id)_resolveSwitchForSwitchEvent:(id)arg1 deviceName:(id)arg2;	// IMP=0x0000000100087c78
- (void)_getActionIdentifier:(long long *)arg1 longPressActionIdentifier:(long long *)arg2 forSwitchEvent:(id)arg3;	// IMP=0x0000000100087a34
- (void)updateWithSwitches:(id)arg1 recipe:(id)arg2;	// IMP=0x0000000100087740
- (void)setDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x00000001000876d8
