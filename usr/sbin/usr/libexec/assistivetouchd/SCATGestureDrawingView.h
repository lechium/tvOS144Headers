...
+ (struct CGRect)_frameWithIntegralOrigin:(struct CGRect)arg1;	// IMP=0x0000000100099884
+ (struct CGRect)_bestFrameFor90ControlAtAngle:(double)arg1 size:(struct CGSize)arg2 centerPoint:(struct CGPoint)arg3;	// IMP=0x0000000100099558
+ (_Bool)_isValidPositionFor90ControlWithXAlignment:(unsigned long long)arg1 yAlignment:(unsigned long long)arg2 size:(struct CGSize)arg3 nearestPoint:(struct CGPoint)arg4 centerPoint:(struct CGPoint)arg5 frame:(struct CGRect *)arg6;	// IMP=0x00000001000991e0
+ (struct CGRect)_frameFor90ControlWithXAlignment:(unsigned long long)arg1 yAlignment:(unsigned long long)arg2 size:(struct CGSize)arg3 nearestPoint:(struct CGPoint)arg4;	// IMP=0x000000010009915c
- (void).cxx_destruct;	// IMP=0x000000010009a3d0
...
- (void)_updateCurvatureControls;	// IMP=0x000000010009a080
- (void)_updateCurvatureControl:(id)arg1 withTailPoint:(struct CGPoint)arg2 tailAngle:(double)arg3 distance:(double)arg4 curvature:(double)arg5;	// IMP=0x0000000100099fd8
- (void)_updateRotationControls;	// IMP=0x0000000100099c84
- (double)_midAngleForCurvedTrailWithTailPoint:(struct CGPoint)arg1 fingerTrailDistance:(double)arg2 distanceAlongArc:(double)arg3 useSecondIntersectionPointIfNecessary:(_Bool)arg4;	// IMP=0x0000000100099a9c
- (void)_updateRotation90Controls;	// IMP=0x0000000100099890
- (void)_updateControls;	// IMP=0x0000000100099118
- (double)_actualDistanceForFingerTrail;	// IMP=0x00000001000990b8
- (struct CGPoint)_tailPoint;	// IMP=0x0000000100099044
- (void)_adjustArrowViewsForNumberOfFingers:(unsigned long long)arg1;	// IMP=0x0000000100098ed8
- (id)_newRotate90Button;	// IMP=0x0000000100098c9c
- (id)_newControlArrowForCurvature:(_Bool)arg1;	// IMP=0x0000000100098c40
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100097e70
