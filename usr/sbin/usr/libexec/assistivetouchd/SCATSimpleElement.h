...
- (id)keyboardContainer;	// IMP=0x00000001000a1d14
@property(readonly, nonatomic) struct CGRect frame;
- (_Bool)isGroup;	// IMP=0x00000001000a1d00
- (id)highestAncestorGroup;	// IMP=0x00000001000a1cac
...
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x00000001000a1b70
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x00000001000a1b68
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x00000001000a1b5c
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x00000001000a1b54
- (void)scatScrollToVisible;	// IMP=0x00000001000a1b50
- (id)scatSupportedGestures;	// IMP=0x00000001000a1b48
@property(readonly, nonatomic) _Bool scatHidesGroupCursorWhenFocused;
@property(readonly, nonatomic) NSArray *scatCustomActions;
- (id)scrollableElement;	// IMP=0x00000001000a1b30
