...
+ (id)adHocFocusContext:(id)arg1;	// IMP=0x00000001000abcd0
+ (id)menuOnlyFocusContext:(id)arg1;	// IMP=0x00000001000abc7c
+ (int)_behaviorForElement:(id)arg1 manager:(id)arg2;	// IMP=0x00000001000abbd0
+ (id)focusContextWithElement:(id)arg1 elementManager:(id)arg2 selectBehavior:(int)arg3 options:(int)arg4;	// IMP=0x00000001000abb18
+ (id)focusContextAutomatic;	// IMP=0x00000001000abaac
+ (id)focusContextSelf;	// IMP=0x00000001000aba40
- (void).cxx_destruct;	// IMP=0x00000001000ac65c
...
- (_Bool)containsPoint:(struct CGPoint)arg1;	// IMP=0x00000001000ac554
@property(readonly, nonatomic) _Bool isGroup;
@property(readonly, nonatomic) AXElementGroup *parentGroup;
- (_Bool)waitsForSelectAction;	// IMP=0x00000001000ac3b0
- (id)_descriptionForSelectBehavior:(int)arg1;	// IMP=0x00000001000ac354
- (id)description;	// IMP=0x00000001000ac008
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000abe98
- (id)initWithElement:(id)arg1 elementManager:(id)arg2 selectBehavior:(int)arg3;	// IMP=0x00000001000abd4c
- (id)elemLog;	// IMP=0x000000010002e5a8
