...
@interface SDPromptDelegate : NSObject
{
    ...
    NSString *_ttrOverrideURLStr;	// 40 = 0x28
}

- (void).cxx_destruct;	// IMP=0x0000000100027610
@property(retain) NSString *ttrOverrideURLStr; // @synthesize ttrOverrideURLStr=_ttrOverrideURLStr;
...
- (id)copy;	// IMP=0x00000001000273cc
