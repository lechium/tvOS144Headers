...
+ (id)containerWithName:(id)arg1 forBlock:(CDUnknownBlockType)arg2 withTimeout:(double)arg3 withDelegate:(id)arg4;	// IMP=0x000000010003d7a4
- (void).cxx_destruct;	// IMP=0x000000010003de84
...
- (_Bool)execute;	// IMP=0x000000010003d8b4
