...
- (void).cxx_destruct;	// IMP=0x000000010000c840
...
- (id)startChargeRateLoop;	// IMP=0x000000010000c584
- (void)recordSessionAnalytics;	// IMP=0x000000010000c370
- (id)currentStatus;	// IMP=0x000000010000c21c
- (void)resetAnalyticsState;	// IMP=0x000000010000c1c4
- (void)resetState;	// IMP=0x000000010000c150
- (id)startBatteryTemperatureLoop;	// IMP=0x000000010000c090
- (void)resetDutyCyclingEffort;	// IMP=0x000000010000bfd8
- (void)executeDutyCyclingWithEffort:(unsigned long long)arg1;	// IMP=0x000000010000bed8
- (unsigned long long)dutyCycleTimeFromEffort:(unsigned long long)arg1;	// IMP=0x000000010000becc
- (void)resetSFIEffort;	// IMP=0x000000010000be4c
- (void)executeSFIWithEffort:(unsigned long long)arg1;	// IMP=0x000000010000bc44
- (unsigned long long)SFITimeFromEffort:(unsigned long long)arg1;	// IMP=0x000000010000bc1c
- (void)resetInitialAction;	// IMP=0x000000010000bbf8
- (void)invokeInitialActionWithValue:(long long)arg1;	// IMP=0x000000010000baf8
- (void)updateControlAction:(id)arg1 withEffort:(long long)arg2;	// IMP=0x000000010000b8f0
- (void)checkControlAction:(id)arg1;	// IMP=0x000000010000b2b4
- (void)saveControlEffort:(long long)arg1;	// IMP=0x000000010000af5c
- (void)saveTLCState:(_Bool)arg1;	// IMP=0x000000010000ab7c
- (id)intializeAnalyzerTimerWithCadence:(double)arg1 forAction:(id)arg2;	// IMP=0x000000010000a9e4
- (void)registerTriggers;	// IMP=0x000000010000a62c
- (id)status;	// IMP=0x000000010000a5dc
- (void)intializeAnalyzers;	// IMP=0x000000010000a054
- (void)loadTrialParameters;	// IMP=0x0000000100009ac0
- (id)init;	// IMP=0x000000010000975c
