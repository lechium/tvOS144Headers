...
+ (id)pluginForIdentifier:(id)arg1 ofType:(id)arg2;	// IMP=0x000000010006abc4
+ (id)existingPluginForIdentifier:(id)arg1 ofType:(id)arg2;	// IMP=0x000000010006ab0c
+ (id)extensionForIdentifier:(id)arg1 ofType:(id)arg2;	// IMP=0x000000010006a5e8
- (void).cxx_destruct;	// IMP=0x000000010006c45c
...
- (id)description;	// IMP=0x000000010006c2e0
@property(readonly) _Bool isInternal;
@property(readonly) NSString *extensionID;
- (id)containerID;	// IMP=0x000000010006c1f8
- (id)container;	// IMP=0x000000010006c15c
- (void)unload;	// IMP=0x000000010006bea0
- (void)extensionDidFinishWithStatus:(unsigned char)arg1;	// IMP=0x000000010006bcb4
- (void)suspend;	// IMP=0x000000010006bb44
- (void)performActivity:(id)arg1;	// IMP=0x000000010006b80c
- (void)_setupSessionIfNecessary;	// IMP=0x000000010006b650
- (id)_contextForSession;	// IMP=0x000000010006b5c4
- (void)_setupExtension;	// IMP=0x000000010006b084
- (id)initWithExtension:(id)arg1 pluginMapKey:(id)arg2;	// IMP=0x000000010006adcc
