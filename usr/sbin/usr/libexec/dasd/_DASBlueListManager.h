...
+ (id)managerWithContext:(id)arg1;	// IMP=0x000000010003dc00
+ (long long)nextHoursBudgetWithPreviousBudget:(long long)arg1;	// IMP=0x000000010003dbe4
- (void).cxx_destruct;	// IMP=0x000000010003ec08
...
- (void)registerForBlueListNotifications;	// IMP=0x000000010003e530
- (_Bool)shouldBlueListPushes;	// IMP=0x000000010003e274
- (void)updateBlueListStatus:(_Bool)arg1;	// IMP=0x000000010003e1d0
- (void)setupResetTimer;	// IMP=0x000000010003e084
- (_Bool)overBudget;	// IMP=0x000000010003e040
- (void)decrementPushBudgetRemaining;	// IMP=0x000000010003dfe0
- (void)updateBudgetsForNextSlot;	// IMP=0x000000010003dfa0
- (void)updateGlobalBudget:(long long)arg1;	// IMP=0x000000010003dee8
- (id)initWithContext:(id)arg1;	// IMP=0x000000010003dc50
