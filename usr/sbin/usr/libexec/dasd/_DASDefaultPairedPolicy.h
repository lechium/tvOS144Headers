...
+ (id)policyInstance;	// IMP=0x0000000100022c78
- (void).cxx_destruct;	// IMP=0x0000000100023390
...
- (double)predictedScoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x00000001000232c8
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x0000000100022ffc
- (double)scoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100022d14
- (double)weightForActivity:(id)arg1;	// IMP=0x0000000100022c70
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x0000000100022c00
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x0000000100022b28
- (id)predictionForDeviceNearby;	// IMP=0x000000010002295c
- (id)init;	// IMP=0x0000000100022858
- (id)initializeTriggers;	// IMP=0x0000000100022700
