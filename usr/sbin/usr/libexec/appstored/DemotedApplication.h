...
- (void).cxx_destruct;	// IMP=0x00000001001b5ab0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001b57a8
@property(readonly, nonatomic) RestoreAppInstall *restoreAppInstall;
- (id)initWithApplication:(id)arg1;	// IMP=0x00000001001b5288
