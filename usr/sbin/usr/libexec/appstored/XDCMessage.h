...
- (void).cxx_destruct;	// IMP=0x00000001000bc844
...
- (id)replyWithProtobuf:(id)arg1 messageType:(long long)arg2;	// IMP=0x00000001000bc750
- (id)copyIDSRepresentation;	// IMP=0x00000001000bc714
- (id)initWithProtobuf:(id)arg1 device:(id)arg2 messageID:(id)arg3;	// IMP=0x00000001000bc620
- (id)initWithProtobuf:(id)arg1 messageType:(long long)arg2;	// IMP=0x00000001000bc588
