...
+ (void)enumerateApplicationsOfType:(unsigned long long)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001002e9204
+ (id)proxyForBundleURL:(id)arg1;	// IMP=0x00000001002e8114
+ (id)proxyForItemID:(id)arg1;	// IMP=0x00000001002e80b0
+ (id)proxyForBundleID:(id)arg1;	// IMP=0x00000001002e804c
- (void).cxx_destruct;	// IMP=0x00000001002e9624
...
- (id)description;	// IMP=0x00000001002e9388
...
- (id)_initWithLSApplicationProxy:(id)arg1;	// IMP=0x00000001002e8370
- (id)initWithBundleURL:(id)arg1;	// IMP=0x00000001002e81d8
- (id)initWithBundlePath:(id)arg1;	// IMP=0x00000001002e8178
