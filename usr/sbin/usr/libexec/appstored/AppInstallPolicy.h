...
+ (id)defaultInstallPolicy;	// IMP=0x000000010007c3a0
- (void).cxx_destruct;	// IMP=0x000000010007cbcc
- (id)copyDictionaryRepresentation;	// IMP=0x000000010007cbbc
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000010007c43c
- (id)init;	// IMP=0x000000010007c3dc
