...
- (_Bool)resetPurchaseIntentTimestampsForBundleID:(id)arg1;	// IMP=0x00000001000da6e4
- (_Bool)clearPurchaseIntentsForBundleID:(id)arg1;	// IMP=0x00000001000da584
- (_Bool)addPurchaseIntent:(id)arg1;	// IMP=0x00000001000da4b0
