...
- (void).cxx_destruct;	// IMP=0x000000010006deb8
...
- (id)remoteObjectProxyWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010006de7c
- (id)remoteObjectProxy;	// IMP=0x000000010006de68
- (void)startWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010006dca8
- (void)cancelWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010006dae8
- (id)initWithBroker:(id)arg1 request:(id)arg2 delegate:(id)arg3;	// IMP=0x000000010006da24
- (id)init;	// IMP=0x000000010006da0c
