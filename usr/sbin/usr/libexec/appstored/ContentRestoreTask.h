...
- (void).cxx_destruct;	// IMP=0x0000000100287970
...
- (id)_newBodyDictionaryWithAccountID:(id)arg1;	// IMP=0x0000000100286ff4
- (void)main;	// IMP=0x000000010028675c
- (id)initWithRestoreAppInstalls:(id)arg1 account:(id)arg2;	// IMP=0x00000001002866a8
