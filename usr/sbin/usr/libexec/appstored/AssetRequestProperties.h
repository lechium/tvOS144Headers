...
@interface AssetRequestProperties : NSObject <NSCopying, NSMutableCopying>
{
    ...
    _Bool _enforceATS;	// 12 = 0xc
    _Bool _locateAssetCache;	// 13 = 0xd
    _Bool _requiresPowerPluggedIn;	// 14 = 0xe
...
- (void).cxx_destruct;	// IMP=0x00000001000bae04
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000baa40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000baa34
- (id)init;	// IMP=0x00000001000ba9b0
