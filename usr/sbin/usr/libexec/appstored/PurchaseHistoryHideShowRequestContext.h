...
+ (id)newContextWithItems:(id)arg1 account:(id)arg2 client:(id)arg3;	// IMP=0x000000010026dda4
- (void).cxx_destruct;	// IMP=0x000000010026df30
...
- (id)_initWithItems:(id)arg1 account:(id)arg2 client:(id)arg3;	// IMP=0x000000010026de34
