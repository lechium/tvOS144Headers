...
+ (id)_newResponseWithURLResult:(id)arg1 error:(id *)arg2;	// IMP=0x000000010026eba0
- (void).cxx_destruct;	// IMP=0x000000010026ef84
...
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010026e450
- (id)initWithRequestToken:(id)arg1;	// IMP=0x000000010026e3ec
- (id)init;	// IMP=0x000000010026e358
