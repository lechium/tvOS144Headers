...
- (void).cxx_destruct;	// IMP=0x000000010007ec44
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010007e96c
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x000000010007e91c
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000010007e7f4
- (void)setValue:(id)arg1 forRequestParameter:(id)arg2;	// IMP=0x000000010007e694
- (void)setValue:(id)arg1 forRequestHeader:(id)arg2;	// IMP=0x000000010007e530
...
- (id)init;	// IMP=0x000000010007d578
