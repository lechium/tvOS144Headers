...
+ (id)_defaultProperties;	// IMP=0x00000001001955cc
- (void).cxx_destruct;	// IMP=0x0000000100195808
...
- (id)description;	// IMP=0x0000000100195508
- (_Bool)requiresDiagnosticSendingPermission;	// IMP=0x0000000100195500
- (id)initWithTopic:(id)arg1;	// IMP=0x0000000100195168
