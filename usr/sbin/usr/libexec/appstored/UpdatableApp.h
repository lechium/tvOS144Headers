...
- (void).cxx_destruct;	// IMP=0x000000010028471c
...
- (id)initWithStoreItemID:(id)arg1 externalVersionID:(id)arg2;	// IMP=0x00000001002845f8
- (id)initWithApplicationProxy:(id)arg1 ignoreEVID:(_Bool)arg2;	// IMP=0x000000010028443c
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x000000010028442c
