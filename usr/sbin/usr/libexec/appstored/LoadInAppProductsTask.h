...
- (void).cxx_destruct;	// IMP=0x000000010013243c
...
- (id)_parseResponse:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001317c4
- (id)_requestBatches:(id)arg1 error:(id *)arg2;	// IMP=0x000000010013135c
- (id)_queryDictionary;	// IMP=0x0000000100130db8
- (void)main;	// IMP=0x0000000100130688
- (id)initWithProductIdentifiers:(id)arg1 client:(id)arg2;	// IMP=0x00000001001305d4
