...
- (void).cxx_destruct;	// IMP=0x00000001002a4090
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00000001002a3a64
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002a396c
