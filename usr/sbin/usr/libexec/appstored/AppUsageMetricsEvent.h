...
- (void).cxx_destruct;	// IMP=0x0000000100255164
...
- (id)_typeForMetricsType:(unsigned char)arg1;	// IMP=0x0000000100254dd8
- (id)_metricsTypeForInstallationType:(unsigned char)arg1;	// IMP=0x0000000100254dac
- (id)_eventForType:(unsigned char)arg1;	// IMP=0x0000000100254d18
- (_Bool)requiresDiagnosticSendingPermission;	// IMP=0x0000000100254d10
- (id)metricsDictionary;	// IMP=0x000000010025483c
...
- (id)externalMapping;	// IMP=0x00000001002534f8
