...
- (void).cxx_destruct;	// IMP=0x00000001001e9850
...
- (void)main;	// IMP=0x00000001001e930c
- (id)initWithTransactionIdentifier:(id)arg1 client:(id)arg2;	// IMP=0x00000001001e9258
