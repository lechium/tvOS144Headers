...
- (void).cxx_destruct;	// IMP=0x00000001001a7974
...
- (void)_lookupWhitelistedProviderAppsWithOutError:(id *)arg1;	// IMP=0x00000001001a75e4
- (void)_lookupHeadboardAppsWithOutError:(id *)arg1;	// IMP=0x00000001001a6d0c
- (void)main;	// IMP=0x00000001001a6c60
