...
+ (id)contextWithMetadata:(id)arg1;	// IMP=0x000000010008d5fc
- (void).cxx_destruct;	// IMP=0x000000010008daf8
...
- (void)_findReason;	// IMP=0x000000010008d950
- (id)application;	// IMP=0x000000010008d820
- (id)init;	// IMP=0x000000010008d588
