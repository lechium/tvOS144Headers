...
- (void).cxx_destruct;	// IMP=0x0000000100140468
...
- (void)updateGeneratedProperties;	// IMP=0x000000010013fda0
...
- (void)setCoordinatorID:(id)arg1;	// IMP=0x000000010013fb54
- (id)coordinatorID;	// IMP=0x000000010013fb40
- (void)setWatchType:(long long)arg1;	// IMP=0x000000010013fae4
- (long long)watchType;	// IMP=0x000000010013fa90
...
- (void)purchase_addVendorIDForApplication:(id)arg1;	// IMP=0x00000001002bd670
- (void)purchase_addThinningHeaders;	// IMP=0x00000001002bd550
