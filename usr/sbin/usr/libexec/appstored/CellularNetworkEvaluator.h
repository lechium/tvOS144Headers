...
+ (id)evaluatorForIdentity:(id)arg1;	// IMP=0x00000001001bab78
- (void).cxx_destruct;	// IMP=0x00000001001bb3c8
- (long long)evaluateForDownload:(id)arg1;	// IMP=0x00000001001bac70
- (id)initWithIdentity:(id)arg1;	// IMP=0x00000001001babc8
