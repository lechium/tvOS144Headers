...
- (void).cxx_destruct;	// IMP=0x000000010018e9f4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010018e72c
- (unsigned long long)hash;	// IMP=0x000000010018e5c8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010018e35c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010018e144
- (void)copyTo:(id)arg1;	// IMP=0x000000010018dfa0
- (void)writeTo:(id)arg1;	// IMP=0x000000010018de28
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010018de20
- (id)dictionaryRepresentation;	// IMP=0x000000010018d6bc
- (id)description;	// IMP=0x000000010018d608
...
- (int)StringAsConnection:(id)arg1;	// IMP=0x000000010018d4b4
- (id)connectionAsString:(int)arg1;	// IMP=0x000000010018d424
