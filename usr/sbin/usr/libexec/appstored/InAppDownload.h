...
@interface InAppDownload : NSObject
{
    ...
    NSArray *_info;	// 24 = 0x18
    InAppDownloadTask *_task;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x00000001002f10b0
...
- (id)initWithIdentifier:(id)arg1 transactionIdentifier:(id)arg2 info:(id)arg3;	// IMP=0x00000001002f0fb4
