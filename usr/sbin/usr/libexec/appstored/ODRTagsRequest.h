...
- (void).cxx_destruct;	// IMP=0x000000010026dd38
...
- (void)updateReportForRequestID:(id)arg1 withSecondsRemaining:(double)arg2 bytesDownloaded:(unsigned long long)arg3;	// IMP=0x000000010026d904
- (id)initWithProgress:(id)arg1;	// IMP=0x000000010026d80c
