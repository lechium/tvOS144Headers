...
+ (id)_keySet;	// IMP=0x00000001002efdbc
+ (id)sandboxBag;	// IMP=0x00000001002ee750
+ (id)octaneBag;	// IMP=0x00000001002ee6d8
+ (id)defaultBag;	// IMP=0x00000001002ee66c
- (void).cxx_destruct;	// IMP=0x00000001002f0e50
...
- (id)updatesReloadIntervalCellular;	// IMP=0x00000001002efc9c
- (id)updatesReloadInterval;	// IMP=0x00000001002efc84
- (id)updateProductContentType;	// IMP=0x00000001002efc6c
- (id)v2UpdateSchedulingEnabled;	// IMP=0x00000001002efc54
- (id)viewUpdatesRequestURL;	// IMP=0x00000001002efc3c
- (id)updateUsingOptimizedRequest;	// IMP=0x00000001002efc24
- (id)doNotUpdateList;	// IMP=0x00000001002efc0c
- (id)availableUpdatesRequestURL;	// IMP=0x00000001002efbf4
...
- (id)URLForKey:(id)arg1;	// IMP=0x00000001002ef888
- (id)stringForKey:(id)arg1;	// IMP=0x00000001002ef878
- (id)integerForKey:(id)arg1;	// IMP=0x00000001002ef868
- (id)doubleForKey:(id)arg1;	// IMP=0x00000001002ef858
- (id)dictionaryForKey:(id)arg1;	// IMP=0x00000001002ef60c
- (void)createSnapshotWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001002ef5fc
- (id)boolForKey:(id)arg1;	// IMP=0x00000001002ef5ec
- (id)arrayForKey:(id)arg1;	// IMP=0x00000001002ef5dc
...
- (id)initWithOctane;	// IMP=0x00000001002ee90c
- (id)initWithSandbox:(_Bool)arg1;	// IMP=0x00000001002ee7dc
- (id)init;	// IMP=0x00000001002ee7cc
