...
- (void).cxx_destruct;	// IMP=0x0000000100119444
...
- (id)_formatTimeInternal:(long long)arg1;	// IMP=0x0000000100119164
- (id)_simpleTime:(id)arg1;	// IMP=0x000000010011909c
- (id)_simpleDate:(id)arg1;	// IMP=0x0000000100118f94
- (id)description;	// IMP=0x0000000100118e20
- (id)dictionary;	// IMP=0x000000010011894c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100118710
