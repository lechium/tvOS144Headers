...
+ (id)_variantDescriptorsFromTargetArray:(id)arg1;	// IMP=0x000000010001aa48
+ (id)_variantDeltasFromDeltasInfo:(id)arg1;	// IMP=0x000000010001a8a4
- (void).cxx_destruct;	// IMP=0x000000010001ac30
...
- (id)variantDeltaFromAssetToken:(id)arg1;	// IMP=0x000000010001a5e8
@property(readonly) _Bool deltaUpdate;
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000010001a430
