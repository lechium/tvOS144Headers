...
- (void).cxx_destruct;	// IMP=0x00000001000199b8
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000001000198d8
- (void)close;	// IMP=0x0000000100019884
@property(readonly) _Bool hasBytesAvailable;
- (id)initWithData:(id)arg1;	// IMP=0x00000001000197b8
