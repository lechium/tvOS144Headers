...
- (void).cxx_destruct;	// IMP=0x00000001002843ec
...
- (id)_newCoordinatorWithType:(unsigned long long)arg1 forBundleID:(id)arg2 createIfNotExisting:(_Bool)arg3 wasCreated:(_Bool *)arg4 error:(id *)arg5;	// IMP=0x0000000100284130
- (_Bool)_cancelOwnedCoordinatorsForBundleID:(id)arg1;	// IMP=0x0000000100283f28
- (void)main;	// IMP=0x0000000100283b58
- (id)initWithBundleID:(id)arg1 coordinatorType:(unsigned long long)arg2;	// IMP=0x0000000100283a98
