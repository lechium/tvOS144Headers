...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logUUID:(id)arg3;	// IMP=0x000000010025fcf4
- (void).cxx_destruct;	// IMP=0x000000010026077c
- (_Bool)_handleVPPRecoveryWithOutError:(id *)arg1;	// IMP=0x00000001002603e8
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x000000010025ff00
- (void)setRepairedBundleIDs:(id)arg1;	// IMP=0x000000010025fc88
...
- (id)initWithApplication:(id)arg1 options:(id)arg2;	// IMP=0x000000010025fa1c
- (id)init;	// IMP=0x000000010025f9e0
