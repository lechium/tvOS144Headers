...
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x000000010028a09c
+ (void)removeTaskInfo:(id)arg1;	// IMP=0x000000010028a010
+ (void)removeAllTaskInfo;	// IMP=0x0000000100289fd4
+ (void)recordTaskInfo:(id)arg1 forTask:(id)arg2;	// IMP=0x0000000100289e7c
+ (void)exchangeTaskForTaskInfo:(id)arg1 withTask:(id)arg2;	// IMP=0x0000000100289e2c
+ (id)newTaskInfoForTask:(id)arg1;	// IMP=0x0000000100289d14
- (void).cxx_destruct;	// IMP=0x000000010028a234
...
- (id)initWithTask:(id)arg1;	// IMP=0x0000000100289d8c
