...
+ (id)shortNameForAppUsageType:(long long)arg1;	// IMP=0x000000010015e894
+ (id)contextForType:(long long)arg1;	// IMP=0x000000010015e860
- (void).cxx_destruct;	// IMP=0x000000010015efb4
...
- (id)_startDateForAppUsageType:(long long)arg1;	// IMP=0x000000010015ee24
- (void)_recordLaunchesIntervalStartDateForAppUsageType:(long long)arg1;	// IMP=0x000000010015edf4
- (void)_recordIntervalStartDateForAppUsageType:(long long)arg1;	// IMP=0x000000010015edc4
- (void)_setLogKey:(id)arg1;	// IMP=0x000000010015edb8
- (id)_metricsTopic;	// IMP=0x000000010015ecd8
- (id)_launchesStartDateForAppUsageType:(long long)arg1;	// IMP=0x000000010015ec8c
- (void)recordLaunchesIntervalStartDate;	// IMP=0x000000010015eb1c
- (void)recordIntervalStartDate;	// IMP=0x000000010015e9ac
@property(readonly, nonatomic) Class metadataEntityClass;
@property(readonly, nonatomic) Class appEventEntityClass;
- (id)initWithAppUsageType:(long long)arg1;	// IMP=0x000000010015e490
