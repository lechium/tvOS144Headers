...
- (void).cxx_destruct;	// IMP=0x0000000100295038
@property(copy, nonatomic) NSArray *bundleIDs; // @synthesize bundleIDs=_bundleIDs;
- (void)main;	// IMP=0x0000000100294d1c
- (_Bool)attemptVPPMigrationForApp:(id)arg1;	// IMP=0x00000001002949b4
- (id)init;	// IMP=0x0000000100294918
