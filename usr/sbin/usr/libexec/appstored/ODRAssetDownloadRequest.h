...
+ (id)_logPrefixForPriority:(double)arg1;	// IMP=0x00000001001a47d8
+ (id)downloadWithAssetPack:(id)arg1 andManifest:(id)arg2 forApplication:(id)arg3 originatingLogKey:(id)arg4;	// IMP=0x00000001001a2bc8
- (void).cxx_destruct;	// IMP=0x00000001001a4f88
...
- (void)_validateSourceURL;	// IMP=0x00000001001a4bc0
- (void)_unlock;	// IMP=0x00000001001a4bb0
- (id)_streamingZipOptions;	// IMP=0x00000001001a4970
- (id)_simulatedDownloadTimerWithInterval:(double)arg1 dispatchBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001001a48a8
- (double)_simulatedDownloadTime;	// IMP=0x00000001001a4808
- (void)_lock;	// IMP=0x00000001001a47c8
- (unsigned long long)_getFileSizeAtURL:(id)arg1;	// IMP=0x00000001001a44b0
- (void)_completeCoordinatorPromise:(id)arg1;	// IMP=0x00000001001a4380
- (void)_cancelSimulatedDownloadTimer;	// IMP=0x00000001001a4344
- (id)_calculateLocalURLForEmbeddedAssetPackWithKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000001001a4238
@property(readonly) unsigned long long totalNewPins;
- (void)simulateDownloadForEmbeddedAssetWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a3d70
- (void)setExtractionProgress:(double)arg1;	// IMP=0x00000001001a3d18
- (id)requestProperties;	// IMP=0x00000001001a3b8c
@property(readonly) IXPromisedOutOfBandTransfer *outOfBandTransferPromise;
- (id)extractor;	// IMP=0x00000001001a3a94
@property(readonly) long long duplicateDownloadCount;
@property(readonly) NSString *downloadPath;
- (void)completeWithSuccess;	// IMP=0x00000001001a37ec
- (void)completeWithError:(id)arg1;	// IMP=0x00000001001a3658
- (_Bool)allowCellularAccess;	// IMP=0x00000001001a3650
- (void)addSuccessBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a3640
- (void)addErrorBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a3630
- (void)addDuplicateDownload:(id)arg1;	// IMP=0x00000001001a3544
- (id)init;	// IMP=0x00000001001a3220
