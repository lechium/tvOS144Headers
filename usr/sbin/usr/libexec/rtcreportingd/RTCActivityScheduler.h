...
- (void)oldestFilePruned:(id)arg1;	// IMP=0x0000000100014888
- (void)postURLRequest:(id)arg1 isRealtime:(_Bool)arg2;	// IMP=0x00000001000145cc
- (void)releaseXPCTransaction;	// IMP=0x000000010001458c
- (void)retainXPCTransaction;	// IMP=0x0000000100014554
- (_Bool)taskDispatched;	// IMP=0x0000000100014208
- (_Bool)performTask:(id)arg1;	// IMP=0x0000000100013478
- (void)dispatchedWorker;	// IMP=0x00000001000132dc
- (void)dispatchedStop;	// IMP=0x00000001000130d8
- (void)dispatchedStart;	// IMP=0x0000000100012d40
- (id)xpcActivityState:(long long)arg1;	// IMP=0x0000000100012cd0
- (int)randomizedDelay;	// IMP=0x0000000100012ae0
- (id)activityDescription;	// IMP=0x0000000100012a84
- (void)processSuspendActivity:(id)arg1;	// IMP=0x0000000100012998
- (void)processStartActivity:(id)arg1;	// IMP=0x0000000100012870
- (void)prepareNextActivity:(int)arg1;	// IMP=0x00000001000125dc
- (void)stop;	// IMP=0x0000000100012574
- (void)start;	// IMP=0x00000001000124bc
- (void)dealloc;	// IMP=0x00000001000123e0
- (id)initWithOptions:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000100012270
