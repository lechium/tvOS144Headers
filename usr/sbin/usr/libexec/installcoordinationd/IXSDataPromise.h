...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010005d020
- (void).cxx_destruct;	// IMP=0x000000010005ee08
...
- (id)description;	// IMP=0x000000010005ec64
- (void)supersede;	// IMP=0x000000010005ebb8
- (void)decommission;	// IMP=0x000000010005ea6c
...
- (void)_removeSavedState;	// IMP=0x000000010005dbf4
- (void)saveState;	// IMP=0x000000010005d890
- (_Bool)awakeFromSerializationWithLookupBlock:(CDUnknownBlockType)arg1 error:(id *)arg2;	// IMP=0x000000010005d824
- (void)cancelForReason:(id)arg1 client:(unsigned long long)arg2;	// IMP=0x000000010005d3a0
- (void)reset;	// IMP=0x000000010005d144
- (unsigned long long)hash;	// IMP=0x000000010005d0f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005d028
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010005ce48
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010005cbdc
@property(readonly, copy, nonatomic) IXDataPromiseSeed *clientSeed; // @dynamic clientSeed;
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x000000010005c9d8
- (void)_internalInitWithUniqueIdentifier:(id)arg1;	// IMP=0x000000010005c87c
- (oneway void)_remote_preflightWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f8a0
- (oneway void)_remote_getErrorInfo:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f758
- (oneway void)_remote_resetWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f490
- (oneway void)_remote_cancelForReason:(id)arg1 client:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010005f334
- (oneway void)_remote_setIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f14c
- (oneway void)_remote_getIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f038
- (oneway void)_remote_setPercentComplete:(double)arg1;	// IMP=0x000000010005ef68
- (oneway void)_remote_getPercentComplete:(CDUnknownBlockType)arg1;	// IMP=0x000000010005ee58
