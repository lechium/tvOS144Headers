...
+ (double)_computeOverallProgressForCurrentProgress:(double)arg1 progressPhase:(unsigned long long)arg2;	// IMP=0x000000010000dea4
...
- (void)_notifyDelegateAndUpdateProgressWithPhaseCompleted:(_Bool)arg1;	// IMP=0x000000010000dee4
- (void)finishInstalling;	// IMP=0x000000010000de28
- (void)finishLoading;	// IMP=0x000000010000ddb4
- (id)description;	// IMP=0x000000010000dcb4
- (id)initForCoordinatorWithBundleID:(id)arg1 totalUnits:(unsigned long long)arg2 delegate:(id)arg3;	// IMP=0x000000010000dc00
