...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000fa9c
- (void).cxx_destruct;	// IMP=0x0000000100011658
...
- (id)description;	// IMP=0x00000001000114c0
- (id)infoPlistContent;	// IMP=0x0000000100011184
- (void)setRequiredDeviceCapabilitiesWithArray:(id)arg1;	// IMP=0x0000000100010f94
- (id)initWithInfoPlistDictionary:(id)arg1;	// IMP=0x0000000100010900
- (id)initWithInfoPlistFromBundle:(struct __CFBundle *)arg1 error:(id *)arg2;	// IMP=0x0000000100010858
- (id)initWithInfoPlistFromBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100010798
- (id)_plistKeys;	// IMP=0x00000001000106e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010001040c
- (unsigned long long)hash;	// IMP=0x00000001000101dc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000faa4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000f790
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000f438
- (id)init;	// IMP=0x000000010000f404
