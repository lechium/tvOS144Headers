...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100031a78
- (void).cxx_destruct;	// IMP=0x0000000100031dc8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100031c00
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100031a80
