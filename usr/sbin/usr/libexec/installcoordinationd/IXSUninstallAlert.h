...
+ (id)stringForCFOptionFlag:(unsigned long long)arg1;	// IMP=0x0000000100030544
- (void).cxx_destruct;	// IMP=0x0000000100030640
...
- (void)dealloc;	// IMP=0x00000001000304ec
- (_Bool)isMDMRestrictedWithOrganizationName:(id *)arg1;	// IMP=0x0000000100030374
- (id)localizedStringForKey:(id)arg1;	// IMP=0x00000001000302c4
- (void)otherButtonActionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000302b0
- (void)displayAlertWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010002fe30
- (void)_onMainQueue_displayAlertWithCompletion:(CDUnknownBlockType)arg1 alertParameters:(id)arg2;	// IMP=0x000000010002f75c
- (_Bool)_onMainQueue_deleteButtonActionWithDisposition:(unsigned long long *)arg1 error:(id *)arg2;	// IMP=0x000000010002f5e0
...
- (id)initWithAppRecord:(id)arg1 bundleIdentifier:(id)arg2 isRemovable:(_Bool)arg3;	// IMP=0x000000010002f388
