...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000d9dc
- (void).cxx_destruct;	// IMP=0x000000010000db64
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000d9e4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000d844
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000d6b0
