...
- (void).cxx_destruct;	// IMP=0x00000001000123b8
...
- (void)parser:(id)arg1 didEndElement:(id)arg2 namespaceURI:(id)arg3 qualifiedName:(id)arg4;	// IMP=0x0000000100012334
- (void)parser:(id)arg1 foundCharacters:(id)arg2;	// IMP=0x00000001000122c8
- (void)parser:(id)arg1 didStartElement:(id)arg2 namespaceURI:(id)arg3 qualifiedName:(id)arg4 attributes:(id)arg5;	// IMP=0x0000000100012274
- (id)initWithXMLData:(id)arg1;	// IMP=0x00000001000121c4
