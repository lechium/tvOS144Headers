...
+ (id)copyEvaluatorDownloadForDownload:(id)arg1;	// IMP=0x000000010003fb9c
+ (id)copyEvaluatorDownloadForDownloadMetadataArray:(id)arg1 logKey:(id)arg2;	// IMP=0x000000010003f8dc
+ (id)copyEvaluatorDownloadForPurchaseResponse:(id)arg1;	// IMP=0x000000010003f6dc
+ (id)formatSize:(unsigned long long)arg1;	// IMP=0x000000010003f660
