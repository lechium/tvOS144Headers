...
- (void).cxx_destruct;	// IMP=0x0000000100038788
...
- (void)run;	// IMP=0x00000001000386fc
- (id)initWithBLDownloadPipeline:(id)arg1 response:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100038624
