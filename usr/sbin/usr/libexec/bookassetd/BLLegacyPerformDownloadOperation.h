...
- (void).cxx_destruct;	// IMP=0x0000000100038a44
@property(retain, nonatomic) _BLPerformDownloadOperation *operation; // @synthesize operation=_operation;
- (void)run;	// IMP=0x00000001000389e0
- (id)initWithBLDownloadPipeline:(id)arg1 response:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010003890c
