...
- (void).cxx_destruct;	// IMP=0x000000010002df24
...
- (id)_accountUniqueIdentifierFromValue:(id)arg1;	// IMP=0x000000010002de58
- (id)_responseDictionary:(id)arg1 valueForProtocolKey:(id)arg2;	// IMP=0x000000010002dd98
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2 responseDictionary:(id)arg3;	// IMP=0x000000010002dc2c
...
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x000000010002d924
@property(readonly) NSOrderedSet *downloads;
- (id)initWithError:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x000000010002d788
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2 preferredAssetFlavor:(id)arg3;	// IMP=0x000000010002c998
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x000000010002c938
- (id)init;	// IMP=0x000000010002c92c
- (id)_initStoreDownloadQueueResponse;	// IMP=0x000000010002c8c4
