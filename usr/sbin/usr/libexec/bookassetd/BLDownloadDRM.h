...
- (void).cxx_destruct;	// IMP=0x000000010001ee98
@property(retain, nonatomic) NSArray *sinfs; // @synthesize sinfs=_sinfs;
- (id)_sinfsArrayWithDataKey:(id)arg1;	// IMP=0x000000010001ecb8
@property(readonly) BLSinfsArray *sinfsArray;
- (id)sinfForIdentifier:(long long)arg1;	// IMP=0x000000010001eb64
@property(readonly) BLSinfsArray *pinfsArray;
@property(readonly, getter=isDRMFree) _Bool DRMFree;
- (id)firstDataForSinfDataKey:(id)arg1;	// IMP=0x000000010001e9bc
- (id)initWithSinfArray:(id)arg1;	// IMP=0x000000010001e800
