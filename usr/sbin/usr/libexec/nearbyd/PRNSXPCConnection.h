...
- (void).cxx_destruct;	// IMP=0x000000010019e5e0
...
- (void)invalidate;	// IMP=0x000000010019e54c
- (void)actOnRemoteObjectAndScheduleBarrierBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010019e198
- (id)initWithConnection:(id)arg1;	// IMP=0x000000010019e0f8
