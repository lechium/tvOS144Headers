...
- (void).cxx_destruct;	// IMP=0x00000001001008d4
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000100100894
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000100100834
@property double endWaitTime;
@property double interspeechWaitTime;
@property double startWaitTime;
@property int endpointMode;
- (void)reset;	// IMP=0x00000001001007a4
- (int)getStatus:(struct AudioQueueBuffer *)arg1;	// IMP=0x0000000100100714
- (_Bool)configureWithASBD:(struct AudioStreamBasicDescription *)arg1 andFrameRate:(unsigned int)arg2;	// IMP=0x0000000100100670
