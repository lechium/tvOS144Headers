...
- (void).cxx_destruct;	// IMP=0x000000010018ad28
- (id)generate;	// IMP=0x000000010018ab80
- (void)setUserInfo:(id)arg1;	// IMP=0x000000010018ab48
- (void)setExpirationDuration:(double)arg1;	// IMP=0x000000010018ab34
- (void)setEffectiveDate:(id)arg1;	// IMP=0x000000010018aafc
- (void)setReason:(id)arg1;	// IMP=0x000000010018aac4
- (void)setTimestamp:(unsigned long long)arg1;	// IMP=0x000000010018aab0
- (id)initWithBaseModel:(id)arg1;	// IMP=0x000000010018aa38
- (id)init;	// IMP=0x000000010018aa28
