...
- (void).cxx_destruct;	// IMP=0x00000001000dd4a8
...
- (void)synchronizeUsingActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000dd428
- (void)fetchDeviceTypesForAllLanguages:(CDUnknownBlockType)arg1;	// IMP=0x00000001000dd40c
- (void)fetchDeviceTypesForLanguage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000dd3f4
- (void)deleteUserData:(id)arg1;	// IMP=0x00000001000dd350
- (void)mergeDataWithModifiedRecords:(id)arg1 deletedRecordIDs:(id)arg2 containsAllChanges:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000dd284
- (void)synchronizeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000dd09c
@property(retain, nonatomic) CKServerChangeToken *serverChangeToken;
@property(nonatomic) _Bool hasSetUpRecordZoneSubscription;
- (id)init;	// IMP=0x00000001000dcf94
