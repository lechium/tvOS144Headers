...
- (void).cxx_destruct;	// IMP=0x00000001000dcf5c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000dce10
@property(readonly, nonatomic) NSArray *trackedChanges;
- (void)setDuration:(double)arg1;	// IMP=0x00000001000dcc88
- (void)setState:(unsigned long long)arg1;	// IMP=0x00000001000dcb5c
