...
- (void).cxx_destruct;	// IMP=0x00000001000fc3d8
- (id)build;	// IMP=0x00000001000fc1b8
- (void)setStorageValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000001000fc074
- (void)reset;	// IMP=0x00000001000fc008
