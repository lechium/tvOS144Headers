...
- (void).cxx_destruct;	// IMP=0x000000010024a63c
- (oneway void)sendContext:(id)arg1;	// IMP=0x000000010024a520
- (id)initWithCollector:(id)arg1 pid:(int)arg2 connection:(id)arg3;	// IMP=0x000000010024a480
