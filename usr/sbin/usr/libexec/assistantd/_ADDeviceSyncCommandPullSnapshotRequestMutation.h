...
- (void).cxx_destruct;	// IMP=0x0000000100053884
- (id)generate;	// IMP=0x00000001000537d0
- (void)setDataType:(id)arg1;	// IMP=0x000000010005379c
- (id)initWithBaseModel:(id)arg1;	// IMP=0x0000000100053724
- (id)init;	// IMP=0x0000000100053714
