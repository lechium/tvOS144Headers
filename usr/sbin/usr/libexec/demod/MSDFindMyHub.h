...
+ (id)sharedInstance;	// IMP=0x0000000100058d54
- (void).cxx_destruct;	// IMP=0x000000010005a738
...
- (_Bool)compareSavedHubHostsWithNewHosts;	// IMP=0x000000010005a2d4
- (_Bool)compareSavedHubHostNameWithNewHostName;	// IMP=0x000000010005a040
- (_Bool)enrollAndSetup:(id *)arg1;	// IMP=0x0000000100059ca4
- (_Bool)askFindMyHubForHubInfoAndDeviceOptions;	// IMP=0x00000001000591c4
- (unsigned long long)queryFindMyHubAndDetermineLogicSyncResult;	// IMP=0x0000000100058ec4
- (_Bool)discoverAndEnrollWithHub:(id *)arg1;	// IMP=0x0000000100058e04
