...
+ (id)sharedInstance;	// IMP=0x000000010000ca18
- (void).cxx_destruct;	// IMP=0x000000010000d524
...
- (id)sanitizeTestLog:(id)arg1;	// IMP=0x000000010000d3c0
- (void)pushTestLog:(id)arg1;	// IMP=0x000000010000d328
- (void)sendCommandsToDemod:(id)arg1 replyFromDemod:(CDUnknownBlockType)arg2;	// IMP=0x000000010000d084
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010000ce1c
- (void)sendTestEvents:(id)arg1;	// IMP=0x000000010000cce0
- (void)pushTestEvent:(id)arg1 ofType:(id)arg2;	// IMP=0x000000010000cc10
- (id)getTimeStamp;	// IMP=0x000000010000cbb4
- (void)start;	// IMP=0x000000010000ca9c
