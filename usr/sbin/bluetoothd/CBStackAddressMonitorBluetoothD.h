...
- (void).cxx_destruct;	// IMP=0x0000000100019740
...
- (id)_dataWithBTAddress:(unsigned long long)arg1;	// IMP=0x0000000100019670
- (void)forceNonConnectableAddressReadAndUpdate;	// IMP=0x0000000100019468
- (void)addressChanged:(_Bool)arg1;	// IMP=0x0000000100019148
- (void)invalidate;	// IMP=0x0000000100018fec
- (void)activate;	// IMP=0x0000000100018e74
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x0000000100018d6c
- (id)description;	// IMP=0x0000000100018d5c
