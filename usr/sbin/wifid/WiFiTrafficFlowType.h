...
- (_Bool)canTrigger11axPerfStudy;	// IMP=0x00000001001245ec
- (id)copyStringRepresentationWithFlowClassification:(unsigned int)arg1;	// IMP=0x000000010012409c
- (id)copyStringRepresentationWithFlowProperty:(unsigned int)arg1 flowPropertyString:(id)arg2;	// IMP=0x0000000100123f24
- (void)processFlowClassifications:(unsigned int)arg1;	// IMP=0x0000000100123c5c
- (void)processCombinedFlowProperties:(unsigned long long)arg1;	// IMP=0x0000000100123a50
- (void)dealloc;	// IMP=0x0000000100123a00
- (id)initWithType:(_Bool)arg1;	// IMP=0x0000000100123988
