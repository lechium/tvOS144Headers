...
- (void)blacklistDidUpdate;	// IMP=0x0000000100129348
- (_Bool)isUserModeInteractive;	// IMP=0x0000000100129328
- (_Bool)retrieveBatteryInfo:(_Bool *)arg1 batteryLevel:(unsigned int *)arg2;	// IMP=0x00000001001291f0
- (void)dealloc;	// IMP=0x00000001001291a8
- (id)initWithArgs:(struct __WiFiDeviceManager *)arg1;	// IMP=0x000000010012905c
