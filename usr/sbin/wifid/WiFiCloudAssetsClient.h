...
+ (id)sharedInstance;	// IMP=0x00000001000025e8
...
- (void)initializeWithManager:(struct __WiFiManager *)arg1 queue:(id)arg2;	// IMP=0x00000001000029f8
- (void)runAssetQuery;	// IMP=0x000000010000268c
