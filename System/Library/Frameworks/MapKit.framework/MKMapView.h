...
#import <libobjc.A.dylib/MKMapInteractionControlsViewDelegate.h>
#import <libobjc.A.dylib/_MKAnnotationSelectionEngineDelegate.h>
...
@class NSMutableArray, NSMutableSet, NSMutableDictionary, MKUsageCounter, UILongPressGestureRecognizer, UIVisualEffectView, UITapGestureRecognizer, UISwipeGestureRecognizer, _MKMapInteractionControlsView, NSArray, _MKMapInteractionControlAction, NSTimer, _MKAnnotationSelectionEngine, _MKZoomSliderView, _MKRightSideOfTrackpadTouchGestureRecognizer, _MKGameControllerObserver, MKMapViewInternal, UIView, MKAnnotationManager, MKAnnotationContainerView, MKAttributionLabel, UIImageView, MKDebugLocationConsole, _MKEnvironmentLabel, UIGestureRecognizer, MKMapGestureController, MKOverlayContainerView, MKBasicMapView, VKMapView, VKLabelMarker, MKScaleView, MKLocationManager, MKUserLocation, VKRouteContext, VKNavContext, MKMapCamera, UITextView, UIPanGestureRecognizer, NSObject, UITraitCollection, MKRotationFilter, MKAnnotationView, UILayoutGuide, NSLayoutConstraint, _MKCustomFeatureStore, MKMapViewLabelMarkerState, MKMapCameraZoomRange, MKMapCameraBoundary, MKPointOfInterestFilter, CLLocation, NSString, NSDictionary, GEOMapRegion, UIPinchGestureRecognizer, UIRotationGestureRecognizer, VKVenueFeatureMarker, VKVenueBuildingFeatureMarker;

@interface MKMapView : UIView <MKLocationManagerObserver, MKOverlayContainerViewDelegate, MKMapGestureControllerDelegate, UIGestureRecognizerDelegate, MKVariableDelayTapRecognizerDelegate, MKMapInteractionControlsViewDelegate, _MKAnnotationSelectionEngineDelegate, VKMapViewDelegate, VKMapViewCameraDelegate, MKAnnotationMarkerContainer, MKAnnotationManagerDelegate, GEOLogContextDelegate, MKRotationFilterDelegate, GEOConfigChangeListenerDelegate, GEOResourceManifestTileGroupObserver, UIGestureRecognizerDelegate, MKAnnotationContainerViewDelegate, NSCoding> {
	...
	UILongPressGestureRecognizer* _interactionControlsInfoOverlayGestureRecognizer;
	UIVisualEffectView* _interactionControlsInfoView;
	UITapGestureRecognizer* _interactionControlsGestureRecognizer;
	UITapGestureRecognizer* _dismissInteractionControlsGestureRecognizer;
	UISwipeGestureRecognizer* _dismissInteractionControlsSwipeRecognizer;
	_MKMapInteractionControlsView* _interactionControlsView;
	NSArray* _interactionControlActions;
	_MKMapInteractionControlAction* _moveMapAction;
	_MKMapInteractionControlAction* _changeSelectionAction;
	NSTimer* _hudInfoOverlayTimer;
	long long _interactionMode;
	_MKAnnotationSelectionEngine* _annotationSelectionEngine;
	BOOL _needsAnnotationSelectionUpdateAfterRedraw;
	BOOL _isProcessingSelectionEngine;
	_MKZoomSliderView* _zoomSliderView;
	_MKRightSideOfTrackpadTouchGestureRecognizer* _rightSideTouchpadGestureRecognizer;
	BOOL _isTouchingRightSideOfTouchpad;
	_MKGameControllerObserver* _gameControllerObserver;
	...
	SCD_Struct_MK5 _annotationTrackingBehavior;
	id _topLayoutGuide;
...
@property (setter=_setInteractionControlActions:,getter=_interactionControlActions,nonatomic,copy) NSArray * interactionControlActions;                                            //@synthesize interactionControlActions=_interactionControlActions - In the implementation block
...
@property (assign,setter=_setUserTrackingBehavior:,getter=_userTrackingBehavior,nonatomic) SCD_Struct_MK5 userTrackingBehavior; 
...
+(SCD_Struct_MK7)_regionThatFitsMapType:(unsigned long long)arg1 viewSize:(CGSize)arg2 viewInsets:(UIEdgeInsets)arg3 edgePadding:(UIEdgeInsets)arg4 region:(SCD_Struct_MK7)arg5 minZoomLevel:(double)arg6 maxZoomLevel:(double)arg7 snapToZoomLevel:(BOOL)arg8 ;
+(SCD_Struct_MK7)regionThatFitsMapType:(unsigned long long)arg1 viewSize:(CGSize)arg2 edgeInsets:(UIEdgeInsets)arg3 region:(SCD_Struct_MK7)arg4 ;
...
+(SCD_Struct_MK7)regionThatFitsMapType:(unsigned long long)arg1 viewSize:(CGSize)arg2 region:(SCD_Struct_MK7)arg3 ;
...
-(void)valueChangedForGEOConfigKey:(SCD_Struct_MK3*)arg1 ;
...
-(void)setVehicleState:(SCD_Struct_MK8)arg1 ;
...
-(void)_commonTvOSInitFromIB:(BOOL)arg1 ;
-(void)_updateAttribution;
-(void)_updateZoomSliderVisibility;
-(void)_stopEffects;
...
-(void)_displayWorld;
-(void)setRegion:(SCD_Struct_MK7)arg1 animated:(BOOL)arg2 ;
...
-(CGRect)_convertRegion:(SCD_Struct_MK7)arg1 toRectToView:(id)arg2 ;
-(SCD_Struct_MK7)_convertRect:(CGRect)arg1 toRegionFromView:(id)arg2 ;
...
-(double)_zoomLevelForRegion:(SCD_Struct_MK7)arg1 includeAccessoryPadding:(BOOL)arg2 ;
...
-(SCD_Struct_MK9)_zoomRegionForMapRect:(SCD_Struct_MK1)arg1 edgePadding:(UIEdgeInsets)arg2 maxZoomLevel:(long long)arg3 minZoomLevel:(long long)arg4 ;
...
-(void)__setInteractionMode:(long long)arg1 ;
-(void)_updateInteractionControlActions;
...
-(CGRect)convertRegion:(SCD_Struct_MK7)arg1 toRectToView:(id)arg2 ;
-(SCD_Struct_MK7)convertRect:(CGRect)arg1 toRegionFromView:(id)arg2 ;
...
-(SCD_Struct_MK5)_userTrackingBehavior;
-(void)_setUserTrackingBehavior:(SCD_Struct_MK5)arg1 ;
...
-(SCD_Struct_MK7)regionThatFits:(SCD_Struct_MK7)arg1 ;
...
-(void)_setInteractionControlActions:(id)arg1 ;
...
-(void)_showInteractionControlsInfoOverlay:(id)arg1 ;
-(void)_showInteractionControls:(id)arg1 ;
-(void)_handleRightSideTouchpadTouch:(id)arg1 ;
-(void)_hideInteractionControlsInfoOverlay;
...
-(void)selectionEngine:(id)arg1 didChooseAnnotationView:(id)arg2 ;
...
-(void)_dismissInteractionControls;
