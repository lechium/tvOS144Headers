...
@property (nonatomic,readonly) SCD_Struct_MK47 currentComparisonContext; 
...
-(void)setMapDisplayStyle:(SCD_Struct_MK27)arg1 ;
-(CGRect)_visibleRect;
...
-(SCD_Struct_MK47)currentComparisonContext;
