...
typedef struct {
	SCD_Struct_VN52 start;
	SCD_Struct_VN52 duration;
} SCD_Struct_VN53;
...
typedef struct _compressed_pair<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float> *, std::__1::default_delete<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float> > > {
	ImageDescriptorProcessorHyperplaneLSH<float> __value_;
} compressed_pair<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float> *, std::__1::default_delete<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float> > >;

typedef struct unique_ptr<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float>, std::__1::default_delete<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float> > > {
	compressed_pair<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float> *, std::__1::default_delete<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float> > > __ptr_;
} unique_ptr<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float>, std::__1::default_delete<vision::mod::ImageDescriptorProcessorHyperplaneLSH<float> > >;
