...
@interface VNSceneTaxonomyOperationPoints : VNOperationPoints {
	...
	SCD_Struct_VN62* _operationPointsDataArray;
...
-(id)initWithLabelToOperationPointsDataIndexMap:(id)arg1 operationPointsDataArray:(SCD_Struct_VN62*)arg2 ;
-(const SCD_Struct_VN62*)_operationPointsDataForClassificationIdentifier:(id)arg1 error:(id*)arg2 ;
