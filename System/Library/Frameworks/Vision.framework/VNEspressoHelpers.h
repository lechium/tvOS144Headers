...
+(CVBufferRef)createCVPixelBufferWithPixelFormat:(unsigned)arg1 fromImageInEspressoBuffer:(const SCD_Struct_VN40*)arg2 error:(id*)arg3 ;
+(BOOL)renderEspressoBufferImage:(const SCD_Struct_VN40*)arg1 intoCVPixelBuffer:(CVBufferRef)arg2 error:(id*)arg3 ;
+(unsigned long long)pixelValueSizeInBytesForBuffer:(const SCD_Struct_VN40*)arg1 error:(id*)arg2 ;
+(BOOL)enableMontrealAndReturnError:(id*)arg1 ;
+(BOOL)feedForwardEspressoBufferForNetwork:(SCD_Struct_VN58*)arg1 fromBufferWithName:(id)arg2 toBufferWithName:(id)arg3 firstFrame:(BOOL)arg4 error:(id*)arg5 ;
@end
