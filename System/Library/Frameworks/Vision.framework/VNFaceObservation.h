...
@property (nonatomic,readonly) SCD_Struct_VN54 pose; 
...
+(BOOL)computeYawPitchRollFromPoseMatrix:(SCD_Struct_VN54)arg1 outputYaw:(float*)arg2 outputPitch:(float*)arg3 outputRoll:(float*)arg4 ;
