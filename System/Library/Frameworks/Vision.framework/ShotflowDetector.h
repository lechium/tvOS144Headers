...
+(id)processingDeviceDetectorWithEspressoNetwork:(SCD_Struct_Sh41*)arg1 espressoPlan:(void*)arg2 networkThreshold:(float)arg3 filterThreshold:(id)arg4 ;
+(id)processingDeviceDetectorWithEspressoNetwork:(SCD_Struct_Sh41*)arg1 espressoPlan:(void*)arg2 ;
