...
@interface VNTrajectoryProcessor : NSObject {
	...
	SCD_Struct_VN52 _lastAnalyzedFramePTS;
	SCD_Struct_VN52 _nextFrameToBeAnalyzedPTS;
...
-(void)dealloc;
-(id)initWithFrameAnalysisSpacing:(SCD_Struct_VN52)arg1 trajectoryLength:(long long)arg2 ;
