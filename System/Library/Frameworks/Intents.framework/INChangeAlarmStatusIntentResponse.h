...
#import <libobjc.A.dylib/INChangeAlarmStatusIntentResponseExport.h>

@class NSArray, NSString;

@interface INChangeAlarmStatusIntentResponse : INIntentResponse <INChangeAlarmStatusIntentResponseExport>
