...
#import <libobjc.A.dylib/INStopAnnouncementIntentResponseExport.h>

@class NSArray, NSString;

@interface INStopAnnouncementIntentResponse : INIntentResponse <INStopAnnouncementIntentResponseExport>
