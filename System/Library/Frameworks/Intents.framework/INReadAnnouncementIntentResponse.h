...
#import <libobjc.A.dylib/INReadAnnouncementIntentResponseExport.h>

@class NSArray, NSString;

@interface INReadAnnouncementIntentResponse : INIntentResponse <INReadAnnouncementIntentResponseExport>
