...
@property (nonatomic,readonly) long long itemLabel;                            //@synthesize itemLabel=_itemLabel - In the implementation block
@property (nonatomic,copy,readonly) NSString * itemID;                         //@synthesize itemID=_itemID - In the implementation block
@property (nonatomic,readonly) long long contentRating;                        //@synthesize contentRating=_contentRating - In the implementation block
@property (nonatomic,copy,readonly) INSpeakableString * itemName;              //@synthesize itemName=_itemName - In the implementation block
