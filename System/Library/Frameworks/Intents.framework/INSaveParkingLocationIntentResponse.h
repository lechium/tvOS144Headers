...
#import <libobjc.A.dylib/INSaveParkingLocationIntentResponseExport.h>

@class CLPlacemark, NSString;

@interface INSaveParkingLocationIntentResponse : INIntentResponse <INSaveParkingLocationIntentResponseExport>
