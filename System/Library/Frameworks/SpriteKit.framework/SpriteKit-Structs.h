...
typedef union GLKVector2 {
	SCD_Struct_IK23 field1;
	SCD_Struct_IK23 field2;
	float v[2];
} GLKVector2;
...
typedef struct SKCStats {
	...
	CGPoint update;
	SCD_Struct_SK45 physics;
	SCD_Struct_SK45 constraints;
	SCD_Struct_SK46 render;
} SKCStats;
...
typedef union {
	...
	SCD_Struct_SK22 _floatMatrix3Value;
