...
-(void)addCompiledOutput:(id)arg1 cachedCompiledOutput:(id)arg2 importedSymbols:(id)arg3 importedLibraries:(id)arg4 hashKey:(const SCD_Struct_MT6*)arg5 functionCache:(const MultiLevelPipelineCache*)arg6 ;
-(BOOL)validateLanguageAndAIRVersionForFunction:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)addCompiledOutput:(id)arg1 importedSymbols:(id)arg2 importedLibraries:(id)arg3 hashKey:(const SCD_Struct_MT6*)arg4 functionCache:(const MultiLevelPipelineCache*)arg5 ;
...
-(SCD_Struct_MT6)hashKeyForStatelessCompilationRequest:(id)arg1 ;
-(void)statelessBackendCompileRequestInternal:(MTLCompilerFunctionRequest*)arg1 sync:(BOOL)arg2 compilerHash:(const SCD_Struct_MT6*)arg3 completionHandler:(/*^block*/id)arg4 ;
-(SCD_Struct_MT6)hashKeyForLibraryRequest:(MTLCompileLibraryRequestData*)arg1 ;
...
-(id)initWithTargetData:(id)arg1 cacheUUID:(SCD_Struct_MT6*)arg2 pluginPath:(id)arg3 device:(id)arg4 compilerFlags:(unsigned long long)arg5 ;
