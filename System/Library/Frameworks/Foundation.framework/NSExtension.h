...
-(void)_instantiateViewControllerWithInputItems:(id)arg1 asAccessory:(BOOL)arg2 traitCollection:(id)arg3 listenerEndpoint:(id)arg4 connectionHandler:(/*^block*/id)arg5 ;
-(void)_instantiateAccessoryViewControllerWithInputItems:(id)arg1 connectionHandler:(/*^block*/id)arg2 ;
-(void)instantiateViewControllerWithInputItems:(id)arg1 traitCollection:(id)arg2 connectionHandler:(/*^block*/id)arg3 ;
