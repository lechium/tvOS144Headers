...
@class IKAppPlayerBridge, NSNumber, NSDate, IKAppDocument, NSArray, NSDictionary, TVPMusicContextMenuData, UINavigationController, NSObject, NSString;
...
@interface _TVPlayer : NSObject <IKAppPlayer, TVPlayerBridging> {
	...
	NSObject*<TVPlaying> _playerImpl;

}

@property (nonatomic,retain) NSObject*<TVPlaying> playerImpl;                                   //@synthesize playerImpl=_playerImpl - In the implementation block
...
@property (nonatomic,readonly) BOOL isInternalPlayerImpl;                                       //@synthesize isInternalPlayerImpl=_isInternalPlayerImpl - In the implementation block
...
-(void)setPlayerImpl:(NSObject*<TVPlaying>)arg1 ;
