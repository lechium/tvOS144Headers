...
@property (nonatomic,copy) NSNumber * playbackProgress;                                      //@synthesize playbackProgress=_playbackProgress - In the implementation block
...
-(void)setPlaybackProgress:(NSNumber *)arg1 ;
