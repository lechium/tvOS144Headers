...
@interface _TVSiriSearchTemplateView : UIView {
	...
	BOOL _spinning;
	id<_TVSiriSearchTemplateViewDelegate> _delegate;
	UIView* _bannerView;
...
@property (assign,nonatomic,__weak) id<_TVSiriSearchTemplateViewDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(id<_TVSiriSearchTemplateViewDelegate>)delegate;
-(void)setDelegate:(id<_TVSiriSearchTemplateViewDelegate>)arg1 ;
