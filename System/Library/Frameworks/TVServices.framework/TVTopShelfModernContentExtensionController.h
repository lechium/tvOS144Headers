...
#import <TVServices/TVSExtensionRequestOberver.h>
...
@class NSString, NSExtension, NSUUID, NSObject, NSXPCConnection, NSMutableArray;
...
@property (nonatomic,copy) NSUUID * extensionRequestIdentifier;                                              //@synthesize extensionRequestIdentifier=_extensionRequestIdentifier - In the implementation block
...
-(void)_resetRequestData;
-(void)_handleRequestObservance:(id)arg1 withBlock:(/*^block*/id)arg2 ;
