...
@property (assign,nonatomic) long long currentRemoteType;                                         //@synthesize currentRemoteType=_currentRemoteType - In the implementation block
...
-(long long)currentRemoteType;
-(void)setCurrentRemoteType:(long long)arg1 ;
