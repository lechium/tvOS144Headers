...
@interface SCNAuthoringEnvironment : NSObject {
	...
	SCD_Struct_SC148* _logsInfo;
	SCD_Struct_SC148* _boldLogsInfo;
	SCD_Struct_SC148* _dynamicLinesInfo;
	SCD_Struct_SC148* _dynamicLinesNoDepthTestInfo;
	SCD_Struct_SC148* _dynamicTrianglesInfo;
	SCD_Struct_SC148* _overlayDynamicLinesInfo;
	SCD_Struct_SC148* _overlayDynamicTriangleInfo;
	SCD_Struct_SC148* _textInfo;
	SCD_Struct_SC148* _lightProbesInfo;
	SCD_Struct_SC150* _normalTextInfo;
	SCD_Struct_SC150* _boldTextInfo;
	...
	SCD_Struct_SC152* _statisticsInfo;
	float _drawScale;
	id _delegate;
