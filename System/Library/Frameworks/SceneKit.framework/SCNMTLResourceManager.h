...
@interface SCNMTLResourceManager : NSObject {
	...
	SCD_Struct_SC32 _availableLightingSystemReflectionProbeTextures;
	SCD_Struct_SC32 _availableIrradianceTextures;
	SCD_Struct_SC32 _availableRadianceTextures;
	SCD_Struct_SC32 _availableImages;
	SCD_Struct_SC32 _availableImageProxy;
	SCD_Struct_SC32 _availableSamplers;
	SCD_Struct_SC32 _availableIESTextures;
	SCD_Struct_SC32 _availableBuffers;
	SCD_Struct_SC32 _availableMeshes;
	SCD_Struct_SC32 _availableMeshSources;
	SCD_Struct_SC32 _availableMeshElements;
	SCD_Struct_SC32 _availableRasterizerStates;
	SCD_Struct_SC32 _availableMorphs;
	SCD_Struct_SC32 _availableSkins;
	SCD_Struct_SC32 _availableComputePipelines;
	SCD_Struct_SC32 _availableComputePipelinesWithStageDescriptor;
	SCD_Struct_SC32 _availableTessellators;
	SCD_Struct_SC32 _availableWireframeMaterials;
	SCD_Struct_SC32 _availableShadables;
...
-(id)newRenderPipelineStateWithDesc:(SCD_Struct_SC36*)arg1 ;
...
-(void)_removeMatchingProgram:(_C3DFXMetalProgram*)arg1 pass:(_C3DFXPass*)arg2 ;
...
-(id)renderResourceForProgramDesc:(SCD_Struct_SC39*)arg1 renderPassDescriptor:(id)arg2 ;
...
-(C3DFXMetalProgramRef)defaultProgramUsingTessellation:(BOOL)arg1 ;
...
-(id)defaultTexture3D;
-(void)_createPipelineStateWithDescriptor:(id)arg1 desc:(SCD_Struct_SC43*)arg2 pipeline:(id)arg3 ;
-(id)_newComputeDescriptorForPipelineDesc:(SCD_Struct_SC44)arg1 library:(id)arg2 ;
-(void)_configureComputePipeline:(id)arg1 withDescriptor:(id)arg2 ;
-(id)newComputePipelineStateForDesc:(SCD_Struct_SC44)arg1 library:(id)arg2 ;
