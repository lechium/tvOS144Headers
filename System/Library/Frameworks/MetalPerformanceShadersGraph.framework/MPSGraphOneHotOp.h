...
-(id)initWithGraph:(id)arg1 inputTensors:(id)arg2 controlDependencies:(id)arg3 depth:(unsigned long long)arg4 axis:(unsigned long long)arg5 dataType:(unsigned)arg6 name:(id)arg7 ;
@end
