...
@class NSArray, CNContact, CNGroup, CNContainer, NSString, UIViewController, CNCardGroup, CNMutableContact, CNContactView, CNContactFormatter, CNContactHeaderDisplayView, CNContactHeaderEditView, NSMutableArray, NSMutableDictionary, NSMapTable, CNCardLinkedCardsGroup, CNPropertyAction, CNPropertyFaceTimeAction, CNPropertyLinkedCardsAction, CNContactAddLinkedCardAction, CNContactAction, CNContactAddFavoriteAction, CNContactToggleBlockCallerAction, CNContactAddNewFieldAction, CNContactCreateNewContactAction, CNContactAddToExistingContactAction, CNContactUpdateExistingContactAction, CNContactSuggestionAction, NSLayoutConstraint, CNShareLocationController, CNContactInlineActionsViewController, UIView, CNSiriContactContextProvider, CNPropertyIDSRequest, NSDictionary, HKHealthStore, CNUIIDSAvailabilityProvider, CNUIUserActionListDataSource, UIKeyCommand, CNPolicy, CNContactStore, CNCardFaceTimeGroup, UITableView, CNContactHeaderView;
...
-(UIEdgeInsets)insetsForTableView:(id)arg1 ;
