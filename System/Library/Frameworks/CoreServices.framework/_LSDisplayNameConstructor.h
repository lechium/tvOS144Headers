...
-(BOOL)showExtensionWithContextIfNeeded:(Context*)arg1 asIfShowingAllExtensions:(id)arg2 ;
...
-(id)initWithContextIfNeeded:(Context*)arg1 node:(id)arg2 isDirectory:(BOOL)arg3 bundleClass:(const unsigned*)arg4 desiredDisplayName:(id)arg5 treatAsFSName:(BOOL)arg6 ;
-(BOOL)mayHideExtensionWithContextIfNeeded:(Context*)arg1 ;
-(BOOL)canSetExtensionHiddenWithContext:(LSContext*)arg1 ;
-(void)initNodeBitsWithContextIfNeeded:(Context*)arg1 node:(id)arg2 isDirectory:(BOOL)arg3 bundleClass:(const unsigned*)arg4 ;
