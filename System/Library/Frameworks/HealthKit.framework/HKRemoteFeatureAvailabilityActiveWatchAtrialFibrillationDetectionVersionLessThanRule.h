...
@interface HKRemoteFeatureAvailabilityActiveWatchAtrialFibrillationDetectionVersionLessThanRule : HKRemoteFeatureAvailabilityBaseRule <HKRemoteFeatureAvailabilityRule> {
