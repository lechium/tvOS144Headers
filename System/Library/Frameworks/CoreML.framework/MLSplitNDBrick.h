...
@property (nonatomic,readonly) NSNumber * numSplits;                //@synthesize numSplits=_numSplits - In the implementation block
@property (nonatomic,readonly) NSArray * splitSizes;                //@synthesize splitSizes=_splitSizes - In the implementation block
