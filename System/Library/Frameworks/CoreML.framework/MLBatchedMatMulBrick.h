...
@property (nonatomic,readonly) NSNumber * transposeA;               //@synthesize transposeA=_transposeA - In the implementation block
@property (nonatomic,readonly) NSNumber * transposeB;               //@synthesize transposeB=_transposeB - In the implementation block
