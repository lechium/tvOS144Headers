...
#import <TVUIKit/TVRowHosting.h>
#import <UIKit/UICollectionViewDataSource.h>
#import <UIKit/UICollectionViewDelegate.h>

@protocol OS_dispatch_source, TVCarouselViewDataSource, TVCarouselViewDelegate;
@class NSObject, _TVCarouselCollectionView, NSIndexPath, NSDictionary, UIView, UIFocusGuide, CADisplayLink, NSDate, UIPageControl, NSString, NSArray;
...
@interface _TVCarouselView : UIView <TVRowHosting, UICollectionViewDataSource, UICollectionViewDelegate> {
	...
	struct {
		...
		unsigned delegateIndexForPreferredCenteredView : 1;
