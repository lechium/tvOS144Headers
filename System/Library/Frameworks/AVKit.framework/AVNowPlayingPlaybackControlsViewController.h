...
@interface AVNowPlayingPlaybackControlsViewController : AVPlaybackControlsViewController <AVChannelInterstitialContainerDelegate, AVNowPlayingFrameSource, AVFrameSetDelegate, AVInfoPanelNavigationDelegate, AVInfoPanelSubtitlesDelegate, AVInfoPanelLanguageDelegate, AVInfoPanelViewControllerDelegate, UIViewControllerTransitioningDelegate> {
	...
	AVFocusTensionGestureRecognizer* _focusTensionGestureRecognizer;
	...
	NSString* _infoHint;
	NSArray* _transportBarObservers;
	...
	double _assetTimeAtStartOfScan;
...
@property (assign,nonatomic) double assetTimeAtStartOfScan;                                                               //@synthesize assetTimeAtStartOfScan=_assetTimeAtStartOfScan - In the implementation block
...
@property (nonatomic,retain) NSArray * transportBarObservers;                                                             //@synthesize transportBarObservers=_transportBarObservers - In the implementation block
...
-(void)_focusTensionGestureRecognizer:(id)arg1 ;
...
-(void)_updateScanningSpeedHintNumberForRate:(float)arg1 ;
-(void)_setHintForRate:(float)arg1 ;
-(void)_startScanningSession;
-(void)_startScanningSessionIfNecessary;
-(void)scanForwardNext;
-(void)scanBackwardNext;
-(void)scanAtRate:(double)arg1 displayingRateIndicator:(BOOL)arg2 ;
-(void)scanAtRate:(double)arg1 ;
-(void)didPressLeftArrowB39;
-(void)didPressRightArrowB39;
-(void)didLongPressLeftArrowB39;
-(void)didLongPressRightArrowB39;
-(void)didPressUpArrowB39;
-(void)navigateDown;
-(void)didPressDownArrowB39;
-(void)didPressSelectB39;
-(void)handleB39LongPressGesture:(id)arg1 ;
...
-(BOOL)isSystemOverlayPresentedOverInfoPane;
...
-(NSArray *)transportBarObservers;
-(void)setTransportBarObservers:(NSArray *)arg1 ;
...
-(double)assetTimeAtStartOfScan;
-(void)setAssetTimeAtStartOfScan:(double)arg1 ;
