...
@interface AVPlayerViewController : UIViewController <AVPictureInPictureContentSource, AVPictureInPictureControllerDelegate, PBSPictureInPicturePlaybackDelegate, _AVFocusContainerDelegate> {
	...
	BOOL _shouldBecomeNowPlayingAfterAppBecomesActive;
	...
	BOOL _pausedDueToInsufficientExternalProtection;
	...
	NSString* __playerIdentifier;
	MRPlayerPath* __mediaRemotePlayerPath;
	AVMediaRemoteManager* _mediaRemoteManager;
	...
	AVNonDigitizerTapRecognizer* _b39ArrowLongPressGestureRecognizer;
...
@property (nonatomic,readonly) NSString * _playerIdentifier;                                                                                                                                             //@synthesize _playerIdentifier=__playerIdentifier - In the implementation block
@property (setter=_setMediaRemotePlayerPath:,nonatomic,retain) MRPlayerPath * _mediaRemotePlayerPath;                                                                                                    //@synthesize _mediaRemotePlayerPath=__mediaRemotePlayerPath - In the implementation block
...
-(void)_updateInteractiveOverlayControls;
...
-(void)deactivateForApplicationSwitcher;
...
-(MRPlayerPath *)_mediaRemotePlayerPath;
-(void)_setMediaRemotePlayerPath:(id)arg1 ;
