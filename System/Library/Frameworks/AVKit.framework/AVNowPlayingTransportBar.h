...
@interface AVNowPlayingTransportBar : UIView {
	...
	NSLayoutConstraint* _layoutConstraintElapsedTimeLabelTop;
	NSLayoutConstraint* _layoutConstraintCurrentClockTimeLabelTop;
	...
	UILabel* _scanningSpeedLeft;
	UIImageView* _hintIconRight;
	UILabel* _scanningSpeedRight;
	...
	double _timeOfLastCoastingAliveUpdate;
	...
	long long _focusTracking;
	double _focusTrackingTension;
	double _startTime;
	NSDate* _startDate;
	NSDate* _endDate;
	...
	long long _hint;
	unsigned long long _scanningSpeedHintNumber;
...
@property (assign,setter=_setCoastingAlive:,getter=_isCoastingAlive,nonatomic) BOOL coastingAlive;                             //@synthesize coastingAlive=_coastingAlive - In the implementation block
@property (assign,setter=_setTrackingScrubTouch:,getter=_isTrackingScrubTouch,nonatomic) BOOL trackingScrubTouch;              //@synthesize trackingScrubTouch=_trackingScrubTouch - In the implementation block
...
@property (assign,nonatomic) long long focusTracking;                                                                          //@synthesize focusTracking=_focusTracking - In the implementation block
@property (assign,nonatomic) double focusTrackingTension;                                                                      //@synthesize focusTrackingTension=_focusTrackingTension - In the implementation block
...
@property (assign,nonatomic) unsigned long long scanningSpeedHintNumber;                                                       //@synthesize scanningSpeedHintNumber=_scanningSpeedHintNumber - In the implementation block
...
-(void)createViews;
-(void)_updateScanningSpeedHintLabel;
-(void)setScanningSpeedHintNumber:(unsigned long long)arg1 ;
-(void)_updateBackgroundAppearanceOfLabel:(id)arg1 ;
-(void)_setFocusedAppearance:(BOOL)arg1 forLabel:(id)arg2 ;
-(void)setFocusTracking:(long long)arg1 ;
-(void)setFocusTrackingTension:(double)arg1 ;
-(CGPoint)_attachmentRangeForScrubNeedle;
...
-(void)_setCoastingAlive:(BOOL)arg1 ;
-(BOOL)_isScrubberCoasting;
...
-(long long)focusTracking;
-(double)focusTrackingTension;
-(BOOL)isUnusable;
...
-(NSString *)needleText;
-(unsigned long long)scanningSpeedHintNumber;
...
-(BOOL)_isCoastingAlive;
-(BOOL)_isTrackingScrubTouch;
-(void)_setTrackingScrubTouch:(BOOL)arg1 ;
