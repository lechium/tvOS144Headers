...
@property (nonatomic,readonly) SCD_Struct_MP72 options;                                                        //@synthesize options=_options - In the implementation block
...
-(SCD_Struct_MP72)options;
-(MPSectionedCollection *)results;
-(void)_parse;
-(MPChangeDetails *)changeDetails;
-(id)initWithRawResponseOutput:(id)arg1 options:(SCD_Struct_MP72)arg2 sectionBuilder:(id)arg3 contentItemBuilder:(id)arg4 userIdentity:(id)arg5 ;
-(id)initWithPreviousParser:(id)arg1 additionalStoreItemMetadataResponse:(id)arg2 options:(SCD_Struct_MP72)arg3 sectionBuilder:(id)arg4 contentItemBuilder:(id)arg5 userIdentity:(id)arg6 ;
