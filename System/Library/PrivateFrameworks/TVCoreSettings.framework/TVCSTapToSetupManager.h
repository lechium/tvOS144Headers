...
@class NSString, TVSWiFiNetworkConnectionOperation, NSOperationQueue, TRDeviceSetupServer, HMDeviceSetupOperationHandler, TRNearbyDeviceAdvertiser, TRSession, SFDeviceSetupAppleTVService, ACAccountStore, TVSiCloudAccountManager, TVCSTapToSetupDeviceInfo;
...
@interface TVCSTapToSetupManager : NSObject <TRDeviceSetupServerDelegate, TVSWiFiNetworkConnectionOperationDelegate, TRNearbyDeviceAdvertiserDelegate> {
	...
	TVCSTapToSetupDeviceInfo* _deviceInfo;
...
@property (nonatomic,retain) TVCSTapToSetupDeviceInfo * deviceInfo;                                                    //@synthesize deviceInfo=_deviceInfo - In the implementation block
...
-(TVCSTapToSetupDeviceInfo *)deviceInfo;
-(void)setDeviceInfo:(TVCSTapToSetupDeviceInfo *)arg1 ;
-(int)setupCompleted;
...
-(void)_didFailToStartSetupWithError:(id)arg1 ;
