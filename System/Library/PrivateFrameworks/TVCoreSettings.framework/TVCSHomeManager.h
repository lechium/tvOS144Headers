...
@class TVCSAccessory, HMAccessory, SFDeviceSetupWHAService, HMHomeManager, HMAccessoryBrowser, NSObject, NSArray, NSMutableArray, TVCSHome, NSString;
...
@interface TVCSHomeManager : NSObject <HMHomeManagerDelegatePrivate, HMAccessoryBrowserPrivateDelegate, HMAccessoryDelegatePrivate> {
	...
	NSMutableArray* _updateAudioDestinationRequests;
...
@property (nonatomic,retain) NSMutableArray * updateAudioDestinationRequests;                                             //@synthesize updateAudioDestinationRequests=_updateAudioDestinationRequests - In the implementation block
...
-(void)accessoryAudioDestinationControllerUpdated;
...
-(NSMutableArray *)updateAudioDestinationRequests;
-(void)_updateAudioDestinationController:(id)arg1 withAudioDestination:(id)arg2 forceUpdateWithUnavailableDestination:(BOOL)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)updateLocalAccessoryAudioDestinationWithRouteUID:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)updateLocalAccessoryAudioDestination:(id)arg1 forceUpdateWithUnavailableDestination:(BOOL)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)setUpdateAudioDestinationRequests:(NSMutableArray *)arg1 ;
@end
