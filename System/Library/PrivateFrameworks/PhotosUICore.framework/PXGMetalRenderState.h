...
@property (nonatomic,readonly) const SCD_Struct_PX52* spriteGeometries; 
...
-(SCD_Struct_PX52*)spriteGeometriesBufferWithCount:(long long)arg1 ;
...
-(SCD_Struct_PX53*)effectDataBufferWithCount:(long long)arg1 ;
-(void)setEffectData:(const SCD_Struct_PX53*)arg1 shaderFlags:(const int*)arg2 withCount:(long long)arg3 ;
