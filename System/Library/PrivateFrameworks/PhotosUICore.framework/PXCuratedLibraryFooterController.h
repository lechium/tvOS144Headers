...
@class NSTimer, PXCuratedLibraryFooterViewModel, PXPhotosGlobalFooterView, PXGView, PXCuratedLibraryLayout, PXCuratedLibraryViewModel, PXCuratedLibraryStyleGuide, PXAssetsDataSourceCountsController, PXUpdater, UIView, NSString;
...
@property (assign,getter=isFooterFullyMasked,nonatomic) BOOL footerFullyMasked;                         //@synthesize footerFullyMasked=_footerFullyMasked - In the implementation block
