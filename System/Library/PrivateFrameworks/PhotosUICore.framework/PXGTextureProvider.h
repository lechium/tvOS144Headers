...
@interface PXGTextureProvider : NSObject <PXImageDataSpecRegistration> {
	...
	SCD_Struct_PX139 _lastImageDataSpec;
...
-(long long)registerImageDataSpec:(SCD_Struct_PX139)arg1 ;
...
-(SCD_Struct_PX139)imageDataSpecAtIndex:(long long)arg1 ;
-(long long)requestQueue_indexForImageDataSpec:(SCD_Struct_PX139)arg1 ;
