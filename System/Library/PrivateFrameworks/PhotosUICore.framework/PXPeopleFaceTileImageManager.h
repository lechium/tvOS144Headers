...
-(void)_cropImage:(id)arg1 synchronous:(BOOL)arg2 cacheResult:(BOOL)arg3 isDegraded:(BOOL)arg4 forRequest:(id)arg5 cropInfo:(SCD_Struct_PX69)arg6 didCallFastBlock:(BOOL)arg7 completionBlock:(/*^block*/id)arg8 ;
