...
+(SCD_Struct_AX3*)_languageHintsEvenlyDistributedWithProbability:(float)arg1 excludingHints:(id)arg2 ;
...
+(SCD_Struct_AX3*)_calculateLanguageHintsForContent:(id)arg1 ;
+(void)_hypothesesForContent:(id)arg1 withHints:(SCD_Struct_AX3*)arg2 guesses:(SCD_Struct_AX3*)arg3 ;
...
+(id)_dialectWithHighestProbability:(SCD_Struct_AX3*)arg1 ;
+(id)_secondaryDialects:(SCD_Struct_AX3*)arg1 ;
