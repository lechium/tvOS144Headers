...
#import <TVSystemMenuUI/TVSMModuleOverlayContentViewControllerDelegate.h>

@protocol TVSMModuleContentViewController, TVSMModuleDelegate;
@class NSString, NSArray, TVSMButtonViewController, UIImage, NSBundle;

@interface TVSMOverlayModule : NSObject <TVSMModule, TVSMModuleOverlayContentViewControllerDelegate> {
