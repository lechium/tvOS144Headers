...
@property (readonly) id<AVOutputDeviceImpl> secondaryImpl;                                                             //@synthesize secondaryImpl=_secondaryImpl - In the implementation block
@property (__weak) id<AVOutputDeviceImplSupport> implEventListener;                                                    //@synthesize implEventListener=_implEventListener - In the implementation block
...
-(id)initWithSyncController:(OpaqueAPSyncControllerRef)arg1 secondaryImpl:(id)arg2 ;
-(void)_volumeDidChangeForEndpointWithID:(CFStringRef)arg1 ;
-(id<AVOutputDeviceImpl>)secondaryImpl;
-(void)_volumeControlSupportedDidChangeForEndpointWithID:(CFStringRef)arg1 ;
-(void)_volumeControlTypeDidChangeForEndpointWithID:(CFStringRef)arg1 ;
-(void)_proposedGroupIDDidChangeForEndpointWithID:(CFStringRef)arg1 ;
@end
