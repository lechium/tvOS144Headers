...
@class AVMetadataItemInternal, TVImageProxy, NSString, NSNumber, NSDate, NSData, NSLocale, NSDictionary;
...
@property (setter=tv_setArtworkProxy:,nonatomic,retain) TVImageProxy * tv_artworkProxy; 
...
-(TVImageProxy *)tv_artworkProxy;
-(void)tv_setArtworkProxy:(id)arg1 ;
-(id)tvp_numberValue;
