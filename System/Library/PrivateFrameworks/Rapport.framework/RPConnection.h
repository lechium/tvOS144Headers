...
@class NSString, NSObject, NSError, CUPairingStream, NSData, CUPairingSession, NSMutableDictionary, NSMutableArray, NSDictionary, CUBLEConnection, NSUUID, CUBonjourDevice, CUBluetoothScalablePipe, RPIdentity, CUHomeKitManager, RPIdentityDaemon, RPCompanionLinkDevice, CUNetLinkManager, CUTCPConnection;
