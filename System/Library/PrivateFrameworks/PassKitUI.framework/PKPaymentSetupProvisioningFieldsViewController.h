...
@class PKPaymentSetupFooterView, CLInUseAssertion, PKPaymentVerificationController, NSTimer, NSString, PKPaymentProvisioningTracker, PKPasscodeUpgradeFlowController, PKPaymentProvisioningController;
