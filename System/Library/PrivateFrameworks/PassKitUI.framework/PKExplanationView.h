...
@class UIImageView, PKPaymentSetupDockView, NSString, UILabel, UIActivityIndicatorView, _PKUIKVisibilityBackdropView, UIButton, UITextView, UIView, UIImage, UIColor, UIFont, NSAttributedString, UIScrollView;
