...
@class NSString, NSArray, PKPasscodeUpgradeFlowController, PKPaymentProvisioningController, PKAddPaymentPassRequestConfiguration, CLInUseAssertion, NSObject, PKAddPaymentPassRequest, PKTableHeaderView, PKPaymentProvisioningTracker, PKPaymentWebService;
