...
@property (nonatomic,retain) NSString * originalCountry;                                             //@synthesize originalCountry=_originalCountry - In the implementation block
...
-(void)setOriginalCountry:(NSString *)arg1 ;
