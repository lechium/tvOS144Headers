...
-(id)_LI_iconImageWithName:(id)arg1 size:(CGSize)arg2 scale:(double)arg3 idiom:(long long)arg4 subtype:(unsigned long long)arg5 gamut:(long long)arg6 layoutDirection:(long long)arg7 ;
-(id)debugDescription;
-(void)dealloc;
-(id)imageWithName:(id)arg1 scaleFactor:(double)arg2 deviceIdiom:(long long)arg3 layoutDirection:(long long)arg4 adjustRenditionKeyWithBlock:(/*^block*/id)arg5 ;
-(id)localObjectCache;
...
-(id)_resolvedRenditionKeyForName:(id)arg1 scaleFactor:(double)arg2 deviceIdiom:(long long)arg3 deviceSubtype:(unsigned long long)arg4 displayGamut:(long long)arg5 layoutDirection:(long long)arg6 sizeClassHorizontal:(long long)arg7 sizeClassVertical:(long long)arg8 memoryClass:(unsigned long long)arg9 graphicsClass:(unsigned long long)arg10 graphicsFallBackOrder:(id)arg11 deviceSubtypeFallBackOrder:(id)arg12 withBaseKeySelector:(SEL)arg13 adjustRenditionKeyWithBlock:(/*^block*/id)arg14 ;
...
-(id)compositingFilterForStylePresetWithName:(id)arg1 styleConfiguration:(id)arg2 foregroundColor:(CGColorRef)arg3 ;
-(void)_vibrantColorMatrixBrightnessSaturationForColor:(CGColorRef)arg1 saturation:(double*)arg2 brightness:(double*)arg3 ;
...
-(SCD_Struct_CS11)styledInsetsForStylePresetName:(id)arg1 styleConfiguration:(id)arg2 foregroundColor:(CGColorRef)arg3 scale:(double)arg4 ;
