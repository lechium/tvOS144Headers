...
-(void)accessoryDidUpdateSupportsMusicAlarm:(id)arg1;
-(void)accessoryDidUpdateSupportsAnnounce:(id)arg1;
...
-(void)accessoryDidUpdateSupportsPreferredMediaUser:(id)arg1;
