...
+(id)reportFeaturesWith:(unsigned char)arg1 deviceTypes:(unsigned char)arg2 rcProfile:(SCD_Struct_CE10)arg3 deviceFeatures:(unsigned char)arg4 from:(unsigned char)arg5 ;
...
-(BOOL)parseReportFeatures:(unsigned char*)arg1 deviceTypes:(char*)arg2 rcProfile:(SCD_Struct_CE10*)arg3 features:(char*)arg4 ;
