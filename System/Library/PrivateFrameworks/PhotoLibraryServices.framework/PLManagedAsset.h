...
-(void)generateThumbnailsWithImageSource:(CGImageSourceRef)arg1 imageData:(id)arg2 metadata:(id)arg3 allowMediumPreview:(BOOL)arg4 forceSRGBConversion:(BOOL)arg5 outSmallThumbnail:(id*)arg6 outLargeThumbnail:(id*)arg7 isPreviewSource:(BOOL)arg8 ;
