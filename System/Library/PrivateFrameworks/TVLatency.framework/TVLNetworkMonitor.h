...
@class NSObject, NSNetService, TVLNetworkInterface, NSString;
...
@property (nonatomic,retain) NSNetService * awdlService;                                  //@synthesize awdlService=_awdlService - In the implementation block
...
-(NSNetService *)awdlService;
-(void)setAwdlService:(NSNetService *)arg1 ;
