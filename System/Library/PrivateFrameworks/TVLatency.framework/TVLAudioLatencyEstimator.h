...
@class TVLNetworkMonitor, TVLNetworkInterface, CUMessageSession, TVLTimeSync, AVAudioEngine, AVAudioPlayerNode, NSString, NSObject, NSDate;
...
@interface TVLAudioLatencyEstimator : NSObject {
	...
	TVLNetworkInterface* _ethernetInterface;
...
@property (nonatomic,retain) TVLNetworkInterface * ethernetInterface;              //@synthesize ethernetInterface=_ethernetInterface - In the implementation block
...
-(void)_requestSynchronizeClocks;
...
-(TVLNetworkInterface *)ethernetInterface;
-(void)setEthernetInterface:(TVLNetworkInterface *)arg1 ;
