...
@class NSString, UIViewController, UIActivityIndicatorView, UILabel, GKLabel, GKSignInInputView, UIImageView, AKInlineSignInViewController, AKAppleIDAuthenticationInAppContext, NSMutableArray, UIScrollView, GKGame, GKAccountRemoteUIController;
