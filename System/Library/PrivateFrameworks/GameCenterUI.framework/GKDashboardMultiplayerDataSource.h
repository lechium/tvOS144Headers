...
@property (assign,nonatomic) double cancellationTimeDelay;                           //@synthesize cancellationTimeDelay=_cancellationTimeDelay - In the implementation block
...
-(void)updateCell:(id)arg1 atIndexPath:(id)arg2 withParticipant:(id)arg3 ;
...
-(double)cancellationTimeDelay;
-(void)setCancellationTimeDelay:(double)arg1 ;
