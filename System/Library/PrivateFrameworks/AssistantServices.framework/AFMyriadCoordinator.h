...
@class NSData, NSMutableDictionary, NSString, NSObject, NSUUID, AFWatchdogTimer, AFPowerAssertionManager, AFMyriadRecord, NSDateFormatter, WPHeySiri, _DKKnowledgeStore, NSDate, AFMyriadEmergencyCallPunchout, AFMyriadAdvertisementContextManager, AFMyriadAdvertisementContextRecord, AFMyriadSession, AFNotifyStatePublisher;
...
-(void)startAdvertisingFromVoiceTriggerWithAdjustment:(char)arg1 bias:(unsigned char)arg2 withContext:(id)arg3 ;
