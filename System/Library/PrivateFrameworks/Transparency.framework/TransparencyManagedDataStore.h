...
-(BOOL)performAndWaitForFetchId:(id)arg1 error:(id*)arg2 block:(/*^block*/id)arg3 ;
...
-(void)performForSTHs:(id)arg1 isMapHead:(BOOL)arg2 revision:(id)arg3 error:(id*)arg4 block:(/*^block*/id)arg5 ;
