...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
	...
	SCD_Struct_MT106 _vertexBuffers[36];
	SCD_Struct_MT106 _vertexTextures[31];
	SCD_Struct_MT106 _vertexSamplers[16];
	SCD_Struct_MT106 _fragmentBuffers[31];
	SCD_Struct_MT106 _fragmentTextures[31];
	SCD_Struct_MT106 _fragmentSamplers[16];
	...
	SCD_Struct_MT106 _tessellationFactorBufferArgument;
...
@property (nonatomic,readonly) SCD_Struct_MT5 viewport; 
@property (nonatomic,readonly) SCD_Struct_MT6 scissorRect; 
...
@property (nonatomic,readonly) SCD_Struct_MT106 tessellationFactorBufferArgument;                      //@synthesize tessellationFactorBufferArgument=_tessellationFactorBufferArgument - In the implementation block
...
-(SCD_Struct_MT106)tessellationFactorBufferArgument;
