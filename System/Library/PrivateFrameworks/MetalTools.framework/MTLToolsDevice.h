...
@property (readonly) const SCD_Struct_MT46* limits; 
...
-(void)getDefaultSamplePositions:(SCD_Struct_MT51*)arg1 count:(unsigned long long)arg2 ;
...
-(SCD_Struct_MT52)heapTextureSizeAndAlignWithDescriptor:(id)arg1 ;
-(SCD_Struct_MT52)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 ;
...
-(BOOL)mapShaderSampleBufferWithBuffer:(SCD_Struct_MT49*)arg1 capacity:(unsigned long long)arg2 size:(unsigned long long)arg3 ;
