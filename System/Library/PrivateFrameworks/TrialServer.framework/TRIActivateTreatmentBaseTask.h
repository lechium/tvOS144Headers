...
@property (nonatomic,readonly) BOOL requiresTreatmentInstallation;              //@synthesize requiresTreatmentInstallation=_requiresTreatmentInstallation - In the implementation block
