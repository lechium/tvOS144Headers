...
@interface TVPMusicNowPlayingViewController : UIViewController <TVPCollectionViewDelegate, TVPMusicNowPlayingViewDelegate, TVPPlaybackProgressAnimatorDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate, UIScrollViewDelegate, AVPlayerViewControllerDelegate, AVRoutePickerViewDelegate, TVPMusicVideoPlayerViewControllerDelegate, TVPMusicNowPlayingSnapshotBackgroundViewDelegate> {
	...
	BOOL _delegateHandlesGestures;
	NSObject*<OS_dispatch_queue> _controlItemRequestQueue;
	BOOL _autoplay;
	...
	BOOL _showingIdleViewController;
...
@property (assign,getter=isShowingIdleViewController,nonatomic) BOOL showingIdleViewController;                     //@synthesize showingIdleViewController=_showingIdleViewController - In the implementation block
...
@property (nonatomic,retain) id<TVPMusicNowPlayingBackgroundProvider> customBackgroundProvider;                     //@synthesize customBackgroundProvider=_customBackgroundProvider - In the implementation block
...
-(id<TVPMusicNowPlayingBackgroundProvider>)customBackgroundProvider;
...
-(void)setShowingIdleViewController:(BOOL)arg1 ;
...
-(BOOL)_changeMediaInDirection:(long long)arg1 ;
...
-(void)setCustomBackgroundProvider:(id<TVPMusicNowPlayingBackgroundProvider>)arg1 ;
