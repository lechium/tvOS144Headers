...
+(id)sharedInstance;
+(id)_getActiveAccountIdentifier;
...
-(void)_updateScreenSaverImages;
-(void)_beginCachingPhotoAssets:(id)arg1 sessionID:(id)arg2 clientError:(id)arg3 completionBlock:(/*^block*/id)arg4 ;
