...
-(BOOL)_createApplicationIcon:(id)arg1 maskCorners:(BOOL)arg2 ;
-(BOOL)_createApplicationIcon:(id)arg1 variant:(long long)arg2 maskCorners:(BOOL)arg3 destination:(id)arg4 ;
@end
