...
@property (nonatomic,readonly) BOOL hasDestructiveButtons;                                             //@synthesize hasDestructiveButtons=_hasDestructiveButtons - In the implementation block
