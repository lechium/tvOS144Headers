...
@class _UISearchBarAppearanceStorage, UIBarButtonItem, UINavigationItem, UILabel, UIView, UISearchBarTextField, UISearchBarBackground, _UIBackdropView, UIVisualEffectView, UIButton, NSString, UINavigationButton, UIImageView, UISegmentedControl, _UISearchBarScopeBarBackground, NSArray, UIColor, _UINavigationBarTitleViewOverlayRects, NSAttributedString, UITextField, UIImage;
...
@interface _UISearchBarVisualProviderTVOS : NSObject <_UISearchBarVisualProviding> {
	...
	UILabel* _helperPlaceholderLabel;
	BOOL _forceShiftHelperMessage;
	...
	NSAttributedString* _originalPlaceholderText;
	UIEdgeInsets _minimumContentInsetPrivate;

}

@property (nonatomic,retain) NSAttributedString * originalPlaceholderText;                                                                                        //@synthesize originalPlaceholderText=_originalPlaceholderText - In the implementation block
...
-(void)_setupHelperPlaceholder;
-(NSAttributedString *)originalPlaceholderText;
-(void)setOriginalPlaceholderText:(NSAttributedString *)arg1 ;
@end
