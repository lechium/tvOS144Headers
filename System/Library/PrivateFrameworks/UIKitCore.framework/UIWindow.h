...
@class CAContext, _UIContextBinder, NSString, UIViewController, UIScene, UIResponder, UIView, NSUndoManager, CALayer, NSMutableArray, NSMutableSet, _UISystemGestureGateGestureRecognizer, UITraitCollection, UIAccessibilityHUDView, NSHashTable, _UIRootPresentationController, _UIViewControllerNullAnimationTransitionCoordinator, _UIWindowOrientationUpdate, NSArray, _UIWindowAnimationController, _UIFocusEventRecognizer, PXImageModulationManager, PXContextualNotificationCenter, AVDisplayManager, UIWindowScene, UIScreen;
...
-(SCD_Struct_UI33)_bindingDescription;
