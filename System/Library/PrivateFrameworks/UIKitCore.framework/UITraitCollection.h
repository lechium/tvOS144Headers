...
@interface UITraitCollection : NSObject <_UIFallbackEnvironment, NSCopying, NSSecureCoding> {
	...
	SCD_Struct_UI86 _builtinTraits;
...
-(id)_initWithBuiltinTraitStorage:(SCD_Struct_UI86*)arg1 clientDefinedTraits:(id)arg2 ;
...
-(id)_initWithBuiltinTraitStorage:(SCD_Struct_UI86*)arg1 clientDefinedTraits:(id)arg2 environmentWrapper:(id)arg3 ;
