...
#import <libobjc.A.dylib/_TVSUITextAlertButtonViewInterface.h>
...
@class NSString, NSDictionary, UIImageView, _UIFloatingContentView, UIVisualEffectView, UILabel, UITapGestureRecognizer, UIView, _UIButtonMaskAnimationView, UIFont, NSArray, UIMenu, UIColor, UIImage, UIImageSymbolConfiguration, NSAttributedString;

@interface UIButton : UIControl <_TVSUITextAlertButtonViewInterface, ABText, UIAccessibilityContentSizeCategoryImageAdjusting, UIAccessibilityContentSizeCategoryImageAdjustingInternal, UIGestureRecognizerDelegate, _UIFloatingContentViewDelegate, UIButtonControl, NSCoding> {
