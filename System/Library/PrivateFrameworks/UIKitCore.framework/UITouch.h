...
@property (assign,setter=_setPrecision:,nonatomic) unsigned long long _precision;                                                   //@synthesize precision=_precision - In the implementation block
...
-(void)_setPrecision:(unsigned long long)arg1 ;
