...
-(SCD_Struct_UI95)viewPointFromDataPoint:(SCD_Struct_UI95)arg1 ;
-(CGRect)handwritingPointToRect:(SCD_Struct_UI95)arg1 ;
...
-(void)addTrapezoidFromFirstPoint:(SCD_Struct_UI95)arg1 secondPoint:(SCD_Struct_UI95)arg2 ;
-(void)addHandwritingPoint:(SCD_Struct_UI95)arg1 ;
