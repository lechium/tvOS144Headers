...
@class UIColor, _UILabelContent, NSAttributedString, NSDictionary, NSMutableDictionary, _UILabelScaledMetrics, _UITextSizeCache, CUICatalog, CUIStyleEffectConfiguration, UIFont, _UILabelVisualStyle, MPUTextContainerContentSizeUpdater, NSString;

@interface UILabel : UIView <MPUAutoupdatingTextContainer, ABText, _UIViewBaselineSpacing, _UIMultilineTextContentSizing, _UILabelVisualStyleSubject, NSCoding, UIContentSizeCategoryAdjusting> {

	CGSize _size;
	UIColor* _highlightedColor;
	long long _numberOfLines;
	SCD_Struct_UI152 _baselineInfo;
...
@property (assign,nonatomic) BOOL smu_marqueeEnabled; 
@property (assign,nonatomic) double smu_firstLineCapFrameOriginY; 
...
@property (assign,setter=_setSupportMultiLineShrinkToFit:,nonatomic) BOOL _supportMultiLineShrinkToFit; 
...
-(void)_invalidateCuiDependencies;
-(void)_invalidateStringDrawingLayout;
-(void)_setNeedsDisplayOnly;
-(void)_setContent:(id)arg1 ;
-(void)_noteInstanceCustomizationForAttributedString:(id)arg1 attributes:(id)arg2 ;
-(void)_setContent:(id)arg1 adjustingFontForAccessibilityTraits:(BOOL)arg2 checkingForDifferences:(BOOL)arg3 ;
-(id)_contentAdjustingFontForAccessibilityTraits:(id)arg1 forced:(BOOL)arg2 ;
-(void)_invalidateLabelSize;
-(void)_invalidateMarquee;
-(void)_invalidateTextSize;
-(void)_invalidateIntrinsicContentSizeConsideringShortcuts;
...
-(id)_synthesizedAttributedTextForContent:(id)arg1 ;
...
-(id)_scaledMetricsForText:(id)arg1 inRect:(CGRect)arg2 ;
-(BOOL)_updateScaledMetricsForRect:(CGRect)arg1 ;
-(BOOL)_supportMultiLineShrinkToFit;
-(void)_setContent:(id)arg1 checkingForDifferences:(BOOL)arg2 ;
...
-(id)_scaledMetricsSupportingMultiLineShrinkToFitForText:(id)arg1 inRect:(CGRect)arg2 ;
