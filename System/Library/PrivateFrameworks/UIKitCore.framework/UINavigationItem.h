...
@property (assign,nonatomic) NSDirectionalEdgeInsets smu_largeTitleInsets; 
...
+(id)defaultFont;
-(UIView *)smu_largeTitleAccessoryView;
-(void)setSmu_largeTitleAccessoryView:(UIView *)arg1 ;
-(NSDirectionalEdgeInsets)smu_largeTitleInsets;
-(void)setSmu_largeTitleInsets:(NSDirectionalEdgeInsets)arg1 ;
