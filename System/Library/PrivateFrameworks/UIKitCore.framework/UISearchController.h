...
#import <UIKitCore/_UISearchSuggestionControllerDelegate.h>
#import <UIKit/UIViewControllerTransitioningDelegate.h>
#import <UIKit/UIViewControllerAnimatedTransitioning.h>

@protocol UIViewControllerAnimatedTransitioning, UISearchResultsUpdating, UISearchControllerDelegate, UISearchSuggestion, UISearchResultsUpdatingPrivate;
@class UITextField, UIColor, UISearchBar, _UISearchControllerDidScrollDelegate, UISystemInputViewController, UITapGestureRecognizer, UIView, _UINavigationControllerManagedSearchPalette, UIViewController, _UISearchSuggestionController, UINavigationItem, _UISearchControllerTVKeyboardContainerView, UICollectionView, UIFocusContainerGuide, NSArray, UIFocusGuide, UIScrollView, NSString;

@interface UISearchController : UIViewController <NSCoding, UIGestureRecognizerDelegate, _UIScrollViewScrollObserver_Internal, _UISearchSuggestionControllerDelegate, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning> {
	...
	id<UISearchSuggestion> _selectedSuggestion;
...
@property (nonatomic,retain) _UISearchSuggestionController * suggestionController;                                                                                                                 //@synthesize suggestionController=_suggestionController - In the implementation block
@property (nonatomic,retain) id<UISearchSuggestion> selectedSuggestion;                                                                                                                            //@synthesize selectedSuggestion=_selectedSuggestion - In the implementation block
...
@property (assign,setter=_setShouldDisplayDefaultSuggestion:,getter=_shouldDisplayDefaultSuggestion,nonatomic) BOOL _shouldDisplayDefaultSuggestion; 
...
-(id<UISearchSuggestion>)selectedSuggestion;
-(void)setSelectedSuggestion:(id<UISearchSuggestion>)arg1 ;
...
-(void)setSuggestionController:(_UISearchSuggestionController *)arg1 ;
