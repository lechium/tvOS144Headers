...
@interface _UISwipeHandler : NSObject <UIGestureRecognizerDelegate, _UISwipeDismissalGestureRecognizerDelegate> {
	...
	SCD_Struct_UI122 _currentSwipeConfig;
...
@property (nonatomic,readonly) SCD_Struct_UI122 currentSwipeConfig; 
...
-(SCD_Struct_UI122)currentSwipeConfig;
-(void)resetSwipe;
...
-(SCD_Struct_UI121)_currentSwipeInfoWithTargetOffset:(double)arg1 animated:(BOOL)arg2 usingSpringWithStiffness:(double)arg3 ;
