...
@interface UIApplication : UIResponder <PXPPTDelegate, FBSUIApplicationWorkspaceDelegate, FBSDisplayLayoutObserver, PKPushRegistryDelegate, UIActivityContinuationManagerApplicationContext, UIApplicationSnapshotPreparing, UIRepeatedActionDelegate, UIStatusBarStyleDelegate_SpringBoardOnly, _UIApplicationInitializationContextFactory> {
...
@property (nonatomic,copy) id accessibilityKeyboardKeyDispatchOverride; 
...
-(void)setAccessibilityKeyboardKeyDispatchOverride:(id)arg1 ;
