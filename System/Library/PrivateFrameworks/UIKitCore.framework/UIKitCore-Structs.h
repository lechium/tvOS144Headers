...
typedef struct {
	...
	double field2;
	double field3;
	SCD_Struct_UI61 field4;
	SCD_Struct_UI61 field5;
	SCD_Struct_UI61 field6;
	SCD_Struct_UI61 field7;
	BOOL field8;
} SCD_Struct_UI62;
...
typedef struct {
	SCD_Struct_UI81 field1;
	SCD_Struct_UI81 field2;
	SCD_Struct_UI81 field3;
} SCD_Struct_UI82;
...
typedef union GLKVector3 {
	SCD_Struct_UI101 field1;
	SCD_Struct_UI101 field2;
	SCD_Struct_UI101 field3;
	float v[3];
} GLKVector3;
...
typedef union GLKQuaternion {
	SCD_Struct_UI103 field1;
	SCD_Struct_UI104 field2;
	float q[4];
} GLKQuaternion;
...
typedef struct {
	SCD_Struct_UI51 dampingRatioParameters;
	SCD_Struct_UI51 responseParameters;
	SCD_Struct_UI51 targetParameters;
...
typedef struct {
	/*function pointer*/void* field1;
	= field2;
	SCD_Struct_UI103 field3;
	float field4[4];
} SCD_Struct_UI158;

typedef struct {
	float field1;
	SCD_Struct_UI158 field2;
	float field3;
