...
@property (nonatomic,readonly) CGPoint isui_digitizerLocation; 
@property (nonatomic,readonly) BOOL isui_isSyntheticB39Tap; 
...
+(id)isui_digitizerTapRecognizerWithTarget:(id)arg1 action:(SEL)arg2 ;
+(id)isui_b39TapRecognizerWithTarget:(id)arg1 action:(SEL)arg2 ;
+(BOOL)supportsSecureCoding;
+(BOOL)_shouldDefaultToTouches;
+(BOOL)_supportsTouchContinuation;
+(BOOL)_shouldUseLinearForceLevelClassifier;
+(BOOL)_shouldSupportStylusTouches;
-(CGPoint)isui_digitizerLocation;
-(BOOL)isui_isSyntheticB39Tap;
-(void)cancel;
