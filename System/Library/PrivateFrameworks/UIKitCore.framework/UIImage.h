...
@class NSMapTable, UIImageConfiguration, UIImageAsset, _UIImageContent, NSURL, NSString, CIImage, NSArray, UIGraphicsImageRendererFormat, UITraitCollection, UIImageSymbolConfiguration;

@interface UIImage : NSObject <MKArtworkImageSource, NSCopying, NSSecureCoding> {
...
+(CGSize)sfui_scaleSize:(CGSize)arg1 toSize:(CGSize)arg2 contentMode:(long long)arg3 ;
+(id)sfui_systemImageNamed:(id)arg1 withBackgroundColor:(id)arg2 symbolColor:(id)arg3 size:(CGSize)arg4 cornerRadius:(double)arg5 configuration:(id)arg6 ;
+(id)sfui_bulletImageWithSystemName:(id)arg1 color:(id)arg2 ;
+(id)sfui_systemImageNamed:(id)arg1 withBackgroundColor:(id)arg2 symbolColor:(id)arg3 size:(CGSize)arg4 cornerRadius:(double)arg5 ;
+(id)imageWith:(CGSize)arg1 format:(id)arg2 actions:(/*^block*/id)arg3 ;
+(id)compositedImageOf:(CGSize)arg1 for:(id)arg2 cornerRadius:(double)arg3 blendMode:(int)arg4 legacyMode:(BOOL)arg5 ;
...
+(id)px_roundedCornerMaskImage:(SCD_Struct_UI76)arg1 size:(CGSize)arg2 ;
...
-(id)sfui_imageScaledToSize:(CGSize)arg1 contentMode:(long long)arg2 ;
-(id)applyBlurWithRadius:(double)arg1 tintColor:(id)arg2 saturationDeltaFactor:(double)arg3 maskImage:(id)arg4 ;
-(id)initWithData:(id)arg1 immediateLoadWithMaxSize:(CGSize)arg2 scale:(double)arg3 ;
...
-(SCD_Struct_UI80)_calculateStatisticsOfEdge:(BOOL)arg1 ;
...
-(SCD_Struct_UI80)_calculateStatistics;
-(SCD_Struct_UI80)_calculateEdgeStatistics;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI82)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI82)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)compositeToPoint:(CGPoint)arg1 fromRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI81)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI81)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI82)arg1 inRect:(CGRect)arg2 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI81)arg1 inRect:(CGRect)arg2 ;
