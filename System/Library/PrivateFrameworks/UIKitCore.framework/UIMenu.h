...
@property (assign,nonatomic) SCD_Struct_UI36 metadata;                  //@synthesize metadata=_metadata - In the implementation block
...
-(NSArray *)children;
-(SCD_Struct_UI36)metadata;
-(void)setMetadata:(SCD_Struct_UI36)arg1 ;
