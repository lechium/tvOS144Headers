...
#import <libobjc.A.dylib/PXLayoutParticipant.h>
#import <libobjc.A.dylib/PXGInternalReusableView.h>
...
@class NSString, NSMutableArray, UITraitCollection, UIViewAnimationInfo, CALayer, UIWindow, NSArray, UIViewController, UILayoutGuide, NSISVariable, NSISEngine, NSMapTable, _UIViewLayoutEngineRelativeAlignmentRectOriginCache, UIColor, NAUITextStyleDescriptor, UIFont, PXViewSpec, MPArtworkCatalog, MKMapView, CNContactStyle, _UIAccessibilityLimits, UIInputResponderController, UIKBRenderConfig, _UITouchForceObservable, NSLayoutXAxisAnchor, NSLayoutYAxisAnchor, NSLayoutDimension, _UIBoundingPath, NSMutableSet, UIStoryboardPreviewingSegueTemplateStorage, UIPresentationController, _UIFocusGroupDescriptor, UIBezierPath;

@interface UIView : UIResponder <CRKCardSectionView, NUIArrangementItem, _UIMultilineTextContentSizing, PXLayoutParticipant, PXGInternalReusableView, MKStackingViewControllerSizableView, MKInfoCardThemeListener, _UIFallbackEnvironment, UILayoutItem_Internal, UITextEffectsOrdering, NSISVariableDelegate, _UILayoutItem, _UIMultilineTextContentSizing, NSISEngineDelegate, _UIScrollViewScrollObserver_Internal, _UIViewSubtreeMonitor, _UITraitEnvironmentInternal, _UIFocusItemInternal, _UIFocusItemDebuggable, _UIFocusRegionContainerInternal, _UILegacyFocusRegion, _UIGeometryChangeObserver, _UIFocusEnvironmentPrivate, _UIFocusRegionContainer, NSCoding, UIAppearance, UIAppearanceContainer, UIDynamicItem, UITraitEnvironment, UICoordinateSpace, UIFocusItem, UIFocusItemContainer, CALayerDelegate> {
...
@property (assign,setter=smu_setContinuousCornerRadius:,nonatomic) double smu_continuousCornerRadius; 
@property (assign,setter=smu_setCornerRadius:,nonatomic) double smu_cornerRadius; 
@property (assign,nonatomic) UIEdgeInsets smu_touchInsets; 
@property (assign,setter=smu_setSpeedBumpEdges:,nonatomic) unsigned long long smu_speedBumpEdges; 
@property (nonatomic,retain) UIColor * debugingBorderColor; 
@property (assign,nonatomic) long long layoutDirection; 
@property (readonly,nonatomic) CGRect mt_statusBarFrame; 
...
@property (nonatomic,copy,readonly) id<UITraitEnvironment> asc_layoutTraitEnvironment; 
...
@property (assign,nonatomic) BOOL neverCacheEffectiveLayoutSize; 
...
@property (setter=tvsui_setBlendMode:,nonatomic,retain) NSString * tvsui_blendMode; 
...
+(id)smu_floatingContentViewWithFrame:(CGRect)arg1 ;
+(id)smu_tvCarouselView;
+(unsigned long long)smu_coreAnimationDefaultCurve;
+(void)smu_animateUsingSpringWithTension:(double)arg1 friction:(double)arg2 animations:(/*^block*/id)arg3 completion:(/*^block*/id)arg4 ;
+(id)smu_animationConfigurationForStyle:(long long)arg1 ;
+(id)_lp_createFlippedView;
+(void)vui_performByPreventingAdditiveAnimations:(/*^block*/id)arg1 ;
...
+(void)PG_performWithoutRetargetingAnimation:(/*^block*/id)arg1 ;
...
+(void)_mapkit_performWithoutAnimation:(/*^block*/id)arg1 ;
...
-(UIEdgeInsets)smu_touchInsets;
-(void)setSmu_touchInsets:(UIEdgeInsets)arg1 ;
...
-(CGSize)vui_sizeThatFits:(CGSize)arg1 layout:(id)arg2 withSizeCalculation:(/*^block*/id)arg3 ;
...
-(id)asc_nearestSuperviewPassingTest:(/*^block*/id)arg1 ;
-(id<UITraitEnvironment>)asc_layoutTraitEnvironment;
...
-(void)setLayoutSize:(CGSize)arg1 withHorizontalContentPriority:(float)arg2 verticalContentPriority:(float)arg3 ;
...
-(PXViewSpec *)px_spec;
-(void)px_enumerateDescendantSubviewsUsingBlock:(/*^block*/id)arg1 ;
-(CGAffineTransform)px_convertTransform:(CGAffineTransform)arg1 fromView:(id)arg2 ;
-(BOOL)px_intersectsWindowBounds;
-(double)px_screenScale;
-(UIEdgeInsets)px_peripheryInsets;
-(BOOL)px_hasHiddenAncestor;
-(CGAffineTransform)px_convertTransform:(CGAffineTransform)arg1 toView:(id)arg2 ;
...
-(void)tvsui_setBlendMode:(id)arg1 ;
-(NSString *)tvsui_blendMode;
...
-(void)ax_setContentHuggingAndCompressionResistance:(SCD_Struct_UI103)arg1 ;
...
-(BOOL)_willForceLayoutForBoundsChangeToNewBounds:(CGRect)arg1 ;
