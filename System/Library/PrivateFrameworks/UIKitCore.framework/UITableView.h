...
@class UIScrollView, UIView, UITableViewRowData, _UITableViewSubviewManager, NSMutableArray, NSMutableDictionary, NSIndexPath, _UITableViewDeleteAnimationSupport, _UITableViewReorderingSupport, UITableViewWrapperView, UITableViewIndex, UITableViewCountView, NSArray, UITableViewIndexOverlayIndicatorView, NSTimer, UITableViewIndexOverlaySelectionView, UIColor, UIVisualEffect, UITableViewCell, _UIIndexPathIdentityTracker, UILongPressGestureRecognizer, UITapGestureRecognizer, UITouch, NSMutableSet, _UITableViewUpdateSupport, _UITableViewShadowUpdatesController, UIFocusContainerGuide, _UITableViewPrefetchContext, _UITableViewMultiSelectController, UIContextMenuInteraction, NSString;
...
@property (assign,nonatomic) BOOL selectionFollowsFocus;                                                                                                                                       //@synthesize selectionFollowsFocus=_selectionFollowsFocus - In the implementation block
