...
@class WebView, DOMHTMLElement, UIAutoscroll, CALayer, NSArray, UITextInputTraits, UITapGestureRecognizer, _UIWebHighlightLongPressGestureRecognizer, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPreviewItemController, _UIWebViewportHandler, WebThreadSafeUndoManager, UIWebSelectionAssistant, UITextInteractionAssistant, UITextChecker, UIWebFileUploadPanel, UIWebTextPlaceholder, DOMRange, UIWebPlaybackTargetPicker, _UITextServiceSession, WebHistoryItem, NSString, RTIInputSystemSourceSession, UITextRange, NSDictionary, UITextPosition, UIView, UITextInputPasswordRules, NSIndexSet, UIColor, UIImage, UIInputContextHistory;
