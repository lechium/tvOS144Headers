...
@class PXProgrammaticNavigationDestination, UIView, UITabBarItem, UINavigationItem, NSArray, NSString, NSBundle, UIResponder, UIViewControllerAction, UIStoryboard, NSDictionary, UIBarButtonItem, UISearchDisplayController, UIPopoverController, UIScrollView, NSMapTable, NSMutableArray, UITraitCollection, UIAccessibilityHUDView, UITransitionView, UIPresentationController, NSLayoutConstraint, UIStoryboardSegue, UIWindow, UINavigationContentAdjustments, TVSKAnimationViewController, UIColor, UINavigationController, AMSUIWebContainerViewController, TVLDocument, NSURL, TVLElement, TVRelatedContentViewController, TVPRelatedContentViewController, UIToolbar, PXBarAppearance, PXExtendedTraitCollection, PXImageModulationManager, PXOneUpPresentation, _UIActionSheetPresentationController, UIMultiColumnViewController, UITabBarController, UISplitViewController, NSExtensionContext, UIDropShadowView, NSUUID, UIStatusBarStyleAnimationParameters, UIStatusBarHideAnimationParameters;

@interface UIViewController : UIResponder <IMMetricsDataSource, GKContentRefresh, GKURLHandling, PXDiagnosticsEnvironment, PXAnonymousViewController, PXProgrammaticNavigationParticipant, PXProgrammaticNavigationUpdateTarget, MKInfoCardThemeListener, BSTraitEnvironment, NSExtensionRequestHandling, _UIFallbackEnvironment, _UIViewServiceDeputy, UIWindowDelegate, _UITraitEnvironmentInternal, _UIContentContainerInternal, _UIFocusEnvironmentInternal, _UIStatusBarAnimationProviding, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment> {
	...
	SCD_Struct_UI57 _presentationSizeClassPair;
...
@property (nonatomic,readonly) TVSKAnimationViewController * tvsk_animationViewController; 
...
@property (nonatomic,readonly) SCD_Struct_UI57 __sizeClassPair; 
...
@property (assign,setter=_setPresentationSizeClassPair:,getter=_presentationSizeClassPair,nonatomic) SCD_Struct_UI57 presentationSizeClassPair;                                                    //@synthesize presentationSizeClassPair=_presentationSizeClassPair - In the implementation block
...
-(TVSKAnimationViewController *)tvsk_animationViewController;
...
-(UIViewController *)ams_navigationItemViewController;
...
-(void)ams_dismissViewControllerAnimated:(BOOL)arg1 includePresented:(BOOL)arg2 completion:(/*^block*/id)arg3 ;
...
-(SCD_Struct_UI58)_hostAuditToken;
...
-(void)_getRotationContentSettings:(SCD_Struct_UI50*)arg1 ;
-(UIViewController *)_parentModalViewController;
...
-(SCD_Struct_UI57)__sizeClassPair;
...
-(void)getRotationContentSettings:(SCD_Struct_UI50*)arg1 forWindow:(id)arg2 ;
...
-(void)_setPresentationSizeClassPair:(SCD_Struct_UI57)arg1 ;
...
-(SCD_Struct_UI59)_cumulativeOverlayInsetsInView:(id)arg1 ;
...
-(void)_setHostAuditToken:(SCD_Struct_UI58)arg1 ;
