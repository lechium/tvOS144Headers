...
#import <UIKitCore/_UIColorPickerColorQueueDelegate.h>

@protocol UIColorPickerViewControllerDelegate, NSCopying;
@class _UIRemoteViewController, UIPresentationController, _UIColorPickerRemoteViewController, UIColor, NSExtension, NSLayoutConstraint, _UIColorPickerColorQueue, _UIColorPickerViewControllerConfiguration, NSString;
...
@property (nonatomic,retain) _UIColorPickerColorQueue * colorQueue;                                                                       //@synthesize colorQueue=_colorQueue - In the implementation block
...
-(void)setColorQueue:(_UIColorPickerColorQueue *)arg1 ;
