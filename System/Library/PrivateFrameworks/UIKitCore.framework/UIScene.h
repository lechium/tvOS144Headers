...
@class UISceneSession, NSString, UISceneActivationConditions, FBSScene, NSArray, NSDictionary, _UISceneLifecycleMonitor, FBSSceneSettings, NSMutableDictionary, NSPointerArray, NSNumber, _UIFocusSystemSceneComponent, UIApplicationSceneSettings, UIApplicationSceneClientSettings, BKSAnimationFenceHandle;
