...
-(int)load:(id)arg1 ;
-(int)reload;
-(SCD_Struct_Es3*)getEspressoNetwork;
...
-(int)encodeToCommandBuffer:(id)arg1 sourceTexture:(id)arg2 destinationTexture:(id)arg3 cropRect:(SCD_Struct_Es21)arg4 destinationRect:(SCD_Struct_Es21)arg5 ;
-(int)submitToQueueWithSourceTexture:(id)arg1 destinationTexture:(id)arg2 ;
-(void)tweak:(id)arg1 value:(float)arg2 ;
-(int)submitToQueueWithSourceTexture:(id)arg1 destinationTexture:(id)arg2 cropRect:(SCD_Struct_Es21)arg3 ;
-(int)encodeToCommandBuffer:(id)arg1 sourceTexture:(id)arg2 destinationTexture:(id)arg3 cropRect:(SCD_Struct_Es21)arg4 ;
