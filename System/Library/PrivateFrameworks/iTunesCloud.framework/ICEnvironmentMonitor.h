...
@class NSObject, NSHashTable, NWPathEvaluator, CoreTelephonyClient, NSDictionary, CWFInterface, CWFLinkQualityMetric, NWNetworkOfInterestManager, NSMutableSet, NSString;
