...
@property (assign,nonatomic) unsigned long long selectedChannelFromFirstPass;                             //@synthesize selectedChannelFromFirstPass=_selectedChannelFromFirstPass - In the implementation block
