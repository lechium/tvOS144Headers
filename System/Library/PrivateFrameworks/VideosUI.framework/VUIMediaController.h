...
@interface VUIMediaController : UIViewController <TVMediaController> {
	...
	unsigned long long _ambientVideoRemainingRepeatLoopCount;
...
@property (assign,nonatomic) unsigned long long ambientVideoRemainingRepeatLoopCount;                                                  //@synthesize ambientVideoRemainingRepeatLoopCount=_ambientVideoRemainingRepeatLoopCount - In the implementation block
...
-(BOOL)_isAmbientVideoMediaItem:(id)arg1 ;
...
-(unsigned long long)ambientVideoRemainingRepeatLoopCount;
-(void)setAmbientVideoRemainingRepeatLoopCount:(unsigned long long)arg1 ;
@end
