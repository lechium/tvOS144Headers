...
@property (assign,nonatomic) BOOL showingAuthDialog;                                                                     //@synthesize showingAuthDialog=_showingAuthDialog - In the implementation block
...
-(void)setShowingAuthDialog:(BOOL)arg1 ;
