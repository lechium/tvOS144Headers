...
@class TVMediaPlaybackManager, VUIMediaController, IKAppContext, NSArray, UIViewController, VUINowPlayingHudView, VUINowPlayingViewModel, VUILegacyButton, NSDictionary, VUINowPlayingSkipButtonLayout, VUIVideoAdvisoryView, VUIProductPlacementView, UITapGestureRecognizer, NSString;
...
@interface VUINowPlayingViewController : UIViewController <TVMediaControllerDelegate, VUIPostPlayControllerDelegate, TVMediaControllerHosting> {
	...
	VUILegacyButton* _skipIntroButton;
...
@property (nonatomic,retain) VUILegacyButton * skipIntroButton;                                                   //@synthesize skipIntroButton=_skipIntroButton - In the implementation block
@property (nonatomic,retain) NSDictionary * skipButtonImpressionMetrics;                                          //@synthesize skipButtonImpressionMetrics=_skipButtonImpressionMetrics - In the implementation block
...
-(VUILegacyButton *)skipIntroButton;
...
-(void)setSkipIntroButton:(VUILegacyButton *)arg1 ;
-(void)setSkipButtonImpressionMetrics:(NSDictionary *)arg1 ;
...
-(void)showSkipIntro:(BOOL)arg1 animated:(BOOL)arg2 skipInfo:(id)arg3 ;
