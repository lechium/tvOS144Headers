...
@interface VUIStoreMediaItem_tvOS : VUIBaseMediaItem <VUIVideoLeaseAgentDelegate, VUIStoreFPSKeyLoaderDelegate, TVPContentKeyLoading> {
...
@property (assign,nonatomic) BOOL isBingeWatched;                                                 //@synthesize isBingeWatched=_isBingeWatched - In the implementation block
