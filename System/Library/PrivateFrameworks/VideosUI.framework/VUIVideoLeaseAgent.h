...
@protocol VUIVideoLeaseAgentDelegate, TVPMediaItem;
...
@property (assign,nonatomic,__weak) id<VUIVideoLeaseAgentDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
+(void)initialize;
+(id)_documentForOperation:(id)arg1 mediaItem:(id)arg2 clientData:(id)arg3 leaseID:(id)arg4 storeMediaKind:(id)arg5 ;
+(void)stopAllLeases;
-(id<VUIVideoLeaseAgentDelegate>)delegate;
-(void)setDelegate:(id<VUIVideoLeaseAgentDelegate>)arg1 ;
