...
@property (nonatomic,retain) UIColor * progressBgColor;                              //@synthesize progressBgColor=_progressBgColor - In the implementation block
...
-(void)setProgressBgColor:(UIColor *)arg1 ;
