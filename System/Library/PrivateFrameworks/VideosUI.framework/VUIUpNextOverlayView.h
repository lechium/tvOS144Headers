...
@class VUIUpNextOverlayLayout, VUIProgressView, UIView, VUILabel, VUITextBadgeView, CALayer, IKViewElement, NSNumber, VUICountDownProgressIndicator, NSString;
...
@property (nonatomic,retain) UIView * logoImageView;                                         //@synthesize logoImageView=_logoImageView - In the implementation block
...
-(void)setLogoImageView:(UIView *)arg1 ;
