...
#import <libobjc.A.dylib/SMUFocusAnimationConfiguration.h>

@interface _SMUIFocusAnimationConfiguration : _UIFocusAnimationConfiguration <SMUFocusAnimationConfiguration>

@property (assign,nonatomic) double focusingBaseDuration; 
@property (assign,nonatomic) double unfocusingBaseDuration; 
@end
