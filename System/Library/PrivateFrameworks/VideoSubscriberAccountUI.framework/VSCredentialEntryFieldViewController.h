...
@property (nonatomic,retain) UITapGestureRecognizer * doneRecognizer;                                       //@synthesize doneRecognizer=_doneRecognizer - In the implementation block
...
-(void)setDoneRecognizer:(UITapGestureRecognizer *)arg1 ;
...
-(UITapGestureRecognizer *)doneRecognizer;
