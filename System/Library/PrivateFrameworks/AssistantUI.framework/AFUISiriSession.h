...
@class NSObject, AFUIStateMachine, AFUISpeechSynthesis, AFSpeechSynthesisRecord, NSMutableSet, AFConnection, AFSettingsConnection, AFUISiriSessionInfo, NSArray, AFAnalyticsTurnBasedInstrumentationContext, NSString;
