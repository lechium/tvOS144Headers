...
@interface BWFrameStatistics : NSObject {
	...
	SCD_Struct_BW120* _storage;

}

@property (nonatomic,readonly) NSString * portType; 
@property (nonatomic,readonly) SCD_Struct_BW7 pts; 
...
-(id)initWthPortType:(id)arg1 storage:(SCD_Struct_BW120*)arg2 ;
-(SCD_Struct_BW120*)frameStatisticsStorage;
