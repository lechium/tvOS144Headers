...
@interface BWFigVideoCaptureDevice : NSObject <BWZoomCompletionDelegate, BWSupplementalPointCloudCaptureDeviceDelegate> {
	...
	SCD_Struct_BW7 _autoTorchRampedUpTime;
	BOOL _torchActive;
	float _torchLevel;
	...
	SCD_Struct_BW7 _lastStillImageCaptureEndPTS;
	...
	float _lensPosition;
	SCD_Struct_BW7 _exposureDuration;
	float _ISO;
	float _exposureTargetBias;
	float _exposureTargetOffset;
	SCD_Struct_Fi128 _deviceWhiteBalanceGains;
	SCD_Struct_Fi128 _grayWorldWhiteBalanceGains;
	...
	BOOL _stationary;
	SCD_Struct_BW7 _ptsOfLastFrameForStationaryCheck;
	...
	SCD_Struct_BW7 _zeroShutterLagEarliestAllowedPTS;
...
-(float)torchLevel;
-(float)lensPosition;
-(SCD_Struct_BW7)exposureDuration;
-(float)ISO;
-(float)exposureTargetBias;
-(SCD_Struct_Fi128)deviceWhiteBalanceGains;
-(SCD_Struct_Fi128)grayWorldDeviceWhiteBalanceGains;
...
-(void)setSmartCameraVersion:(SCD_Struct_BW56)arg1 ;
...
-(void)captureStream:(id)arg1 didCompleteStillImageCaptureWithPTS:(SCD_Struct_BW7)arg2 error:(int)arg3 ;
...
-(void)initiateCaptureStillImageNowWithPTS:(SCD_Struct_BW7)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)prepareToCaptureStillImageNow:(/*^block*/id)arg1 ;
-(id)copyCurrentFrameStatistics;
-(int)stillImageFusionScheme;
-(id)unifiedBracketingStillImageCaptureSettingsWithID:(long long)arg1 captureRequestIdentifier:(id)arg2 requestedOutputDimensions:(SCD_Struct_BW2)arg3 frameStatisticsByPortType:(id)arg4 flashMode:(int)arg5 digitalFlashMode:(int)arg6 autoRedEyeReductionEnabled:(BOOL)arg7 hdrMode:(int)arg8 qualityPrioritization:(int)arg9 speedOverQualityCaptureEnabled:(BOOL)arg10 waitForTimeMachineToFill:(BOOL)arg11 burstQualityCaptureEnabled:(BOOL)arg12 deliverOriginalImage:(BOOL)arg13 bravoConstituentImageDeliveryDeviceTypes:(id)arg14 deliverDepthData:(BOOL)arg15 autoDeferredProcessingEnabled:(BOOL)arg16 includePreBracketedEV0ForProcessing:(BOOL)arg17 clientBracketSettings:(id)arg18 userInitiatedRequestPTS:(SCD_Struct_BW7)arg19 rawOutputFormat:(unsigned)arg20 processingSupportProvider:(id)arg21 ;
-(id)stillImageCaptureSettingsWithID:(long long)arg1 captureType:(int)arg2 deliverOriginalImage:(BOOL)arg3 deliverSushiRaw:(BOOL)arg4 bravoConstituentImageDeliveryDeviceTypes:(id)arg5 includePreBracketedEV0ForProcessing:(BOOL)arg6 clientBracketSettings:(id)arg7 captureFlags:(unsigned long long)arg8 userInitiatedRequestPTS:(SCD_Struct_BW7)arg9 frameStatisticsByPortType:(id)arg10 ;
-(id)captureStream;
...
-(void)setZeroShutterLagEarliestAllowedPTS:(SCD_Struct_BW7)arg1 ;
...
-(id)_zeroShutterLagStillImageCaptureSettingsWithID:(long long)arg1 captureType:(int)arg2 deliverOriginalImage:(BOOL)arg3 deliverSushiRaw:(BOOL)arg4 bravoConstituentImageDeliveryDeviceTypes:(id)arg5 includePreBracketedEV0ForProcessing:(BOOL)arg6 clientBracketSettings:(id)arg7 captureFlags:(unsigned long long)arg8 userInitiatedRequestPTS:(SCD_Struct_BW7)arg9 captureStreams:(int)arg10 frameStatisticsByPortType:(id)arg11 ;
...
-(BOOL)_tryZeroShutterLagReferenceFrameSelectionWithZeroShutterLagPTS:(SCD_Struct_BW7)arg1 captureType:(int)arg2 captureFlags:(unsigned long long)arg3 framesMetadata:(id)arg4 frameCount:(int)arg5 referenceFrameBracketedCaptureSequenceNumberOut:(int*)arg6 preferredPTSOut:(SCD_Struct_BW7*)arg7 selectedFramesRangeOut:(NSRange*)arg8 ;
...
-(void)_initiateCaptureStillImageNowWithPTS:(SCD_Struct_BW7)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(id)_ubStillImageCaptureSettingsWithID:(long long)arg1 userInitiatedRequestPTS:(SCD_Struct_BW7)arg2 captureType:(int)arg3 captureFlags:(unsigned long long)arg4 sceneFlags:(unsigned long long)arg5 frameStatisticsByPortType:(id)arg6 deliverOriginalImage:(BOOL)arg7 deliverSushiRaw:(BOOL)arg8 bravoConstituentImageDeliveryDeviceTypes:(id)arg9 outputDimensions:(SCD_Struct_BW2)arg10 ;
...
-(id)initWithCaptureDevice:(id)arg1 attributes:(id)arg2 synchronizedStreamsAttributes:(id)arg3 multiCamEnabled:(BOOL)arg4 applicationID:(id)arg5 clientAuditToken:(SCD_Struct_Fi79)arg6 error:(int*)arg7 ;
...
-(int)setExposureModeCustomWithExposureDuration:(SCD_Struct_BW7)arg1 minFrameRate:(double)arg2 maxFrameRate:(double)arg3 ISO:(float)arg4 requestID:(int)arg5 ;
-(int)setWhiteBalanceModeAuto;
-(int)setWhiteBalanceModeLockedWithGains:(SCD_Struct_Fi128)arg1 requestID:(int)arg2 ;
...
-(SCD_Struct_BW7)zeroShutterLagEarliestAllowedPTS;
