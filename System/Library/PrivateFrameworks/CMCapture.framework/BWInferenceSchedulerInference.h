...
@property (nonatomic,readonly) SCD_Struct_BW7 previousExecutionTime; 
...
-(SCD_Struct_BW7)previousExecutionTime;
-(void)propagateInferenceResultsToInferenceDictionary:(id)arg1 usingStorage:(id)arg2 propagationSampleBuffer:(opaqueCMSampleBufferRef)arg3 withExecutionTime:(SCD_Struct_BW7)arg4 ;
@end
