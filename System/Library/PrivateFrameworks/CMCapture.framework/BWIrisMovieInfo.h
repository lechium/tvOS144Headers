...
@interface BWIrisMovieInfo : NSObject <NSCopying> {
	...
	SCD_Struct_BW7 _stillImageCaptureTime;
	SCD_Struct_BW7 _stillImageCaptureHostTime;
	...
	SCD_Struct_BW7 _movieStartTime;
	SCD_Struct_BW7 _movieEndTime;
	SCD_Struct_BW7 _movieTrimStartTime;
	SCD_Struct_BW7 _movieTrimEndTime;
	SCD_Struct_BW7 _beginTrimMasterPTS;
	SCD_Struct_BW7 _audioOffset;
	SCD_Struct_BW7 _stillTimeOffsetToVideoPrerollStartInMilliseconds;
	SCD_Struct_BW7 _stillTimeOffsetToVideoPrerollStopInMilliseconds;
	SCD_Struct_BW7 _stillTimeOffsetToAudioPrerollStartInMilliseconds;
	SCD_Struct_BW7 _stillTimeOffsetToAudioPrerollStopInMilliseconds;
	SCD_Struct_BW7 _masterMovieStartTime;
	...
	SCD_Struct_BW7 _stillTimeOffsetToVideoPrerollStartTime;
	SCD_Struct_BW7 _stillTimeOffsetToVideoPrerollStopTime;
	SCD_Struct_BW7 _stillTimeOffsetToAudioPrerollStartTime;
	SCD_Struct_BW7 _stillTimeOffsetToAudioPrerollStopTime;
...
@property (assign,nonatomic) SCD_Struct_BW7 stillImageCaptureTime;                                               //@synthesize stillImageCaptureTime=_stillImageCaptureTime - In the implementation block
@property (nonatomic,readonly) SCD_Struct_BW7 stillImageCaptureHostTime;                                         //@synthesize stillImageCaptureHostTime=_stillImageCaptureHostTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_BW7 movieStartTime;                                                      //@synthesize movieStartTime=_movieStartTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW7 movieEndTime;                                                        //@synthesize movieEndTime=_movieEndTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW7 movieTrimStartTime;                                                  //@synthesize movieTrimStartTime=_movieTrimStartTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW7 movieTrimEndTime;                                                    //@synthesize movieTrimEndTime=_movieTrimEndTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW7 beginTrimMasterPTS;                                                  //@synthesize beginTrimMasterPTS=_beginTrimMasterPTS - In the implementation block
@property (nonatomic,readonly) BOOL containsTrims; 
@property (assign,nonatomic) SCD_Struct_BW7 masterMovieStartTime;                                                //@synthesize masterMovieStartTime=_masterMovieStartTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_BW7 audioOffset;                                                         //@synthesize audioOffset=_audioOffset - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW7 stillTimeOffsetToVideoPrerollStartTime;                              //@synthesize stillTimeOffsetToVideoPrerollStartTime=_stillTimeOffsetToVideoPrerollStartTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW7 stillTimeOffsetToVideoPrerollStopTime;                               //@synthesize stillTimeOffsetToVideoPrerollStopTime=_stillTimeOffsetToVideoPrerollStopTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW7 stillTimeOffsetToAudioPrerollStartTime;                              //@synthesize stillTimeOffsetToAudioPrerollStartTime=_stillTimeOffsetToAudioPrerollStartTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW7 stillTimeOffsetToAudioPrerollStopTime;                               //@synthesize stillTimeOffsetToAudioPrerollStopTime=_stillTimeOffsetToAudioPrerollStopTime - In the implementation block
...
+(id)irisMovieInfoWithFigCaptureMovieFileRecordingSettings:(id)arg1 stillImageCaptureTime:(SCD_Struct_BW7)arg2 stillImageCaptureHostTime:(SCD_Struct_BW7)arg3 stillImageCaptureAbsoluteStartTime:(double)arg4 stillImageCaptureType:(int)arg5 originalPhotoRecording:(BOOL)arg6 ;
-(id)copyWithZone:(NSZone*)arg1 ;
-(id)description;
-(void)dealloc;
-(FigCaptureMovieFileRecordingSettings *)settings;
-(SCD_Struct_BW7)movieTrimEndTime;
-(int)numberOfRequestedVariants;
-(SCD_Struct_BW7)movieTrimStartTime;
-(SCD_Struct_BW7)masterMovieStartTime;
-(SCD_Struct_BW7)movieEndTime;
-(SCD_Struct_BW7)audioOffset;
-(BOOL)isVitalityScoreValid;
-(float)vitalityScore;
-(unsigned)vitalityScoringVersion;
-(SCD_Struct_BW7)stillImageCaptureHostTime;
-(SCD_Struct_BW7)movieStartTime;
-(void)setMovieStartTime:(SCD_Struct_BW7)arg1 ;
-(void)setMovieTrimStartTime:(SCD_Struct_BW7)arg1 ;
-(void)setMasterMovieStartTime:(SCD_Struct_BW7)arg1 ;
-(NSURL *)temporaryMovieURL;
-(NSURL *)outputMovieURL;
-(NSURL *)masterMovieURL;
-(unsigned)requestedSDOFVariants;
-(SCD_Struct_BW7)stillImageCaptureTime;
-(NSString *)livePhotoMetadataStillImageKeyFrameSettingsID;
-(BOOL)containsTrims;
-(void)setMovieTrimEndTime:(SCD_Struct_BW7)arg1 ;
-(void)setMovieEndTime:(SCD_Struct_BW7)arg1 ;
...
-(void)setMomentCaptureRecordingStillImageCaptureHostTimeOverride:(SCD_Struct_BW7)arg1 stillImageCaptureTimeOverride:(SCD_Struct_BW7)arg2 ;
-(SCD_Struct_BW7)beginTrimMasterPTS;
...
-(void)setStillTimeOffsetToVideoPrerollStartTime:(SCD_Struct_BW7)arg1 ;
-(void)setStillTimeOffsetToVideoPrerollStopTime:(SCD_Struct_BW7)arg1 ;
-(void)setStillTimeOffsetToAudioPrerollStartTime:(SCD_Struct_BW7)arg1 ;
-(void)setStillTimeOffsetToAudioPrerollStopTime:(SCD_Struct_BW7)arg1 ;
...
-(void)setAudioOffset:(SCD_Struct_BW7)arg1 ;
...
-(id)_initWithFigCaptureMovieFileRecordingSettings:(id)arg1 stillImageCaptureTime:(SCD_Struct_BW7)arg2 stillImageCaptureHostTime:(SCD_Struct_BW7)arg3 stillImageCaptureAbsoluteStartTime:(double)arg4 stillImageCaptureType:(int)arg5 originalPhotoRecording:(BOOL)arg6 ;
...
-(void)setBeginTrimMasterPTS:(SCD_Struct_BW7)arg1 ;
-(SCD_Struct_BW7)stillTimeOffsetToVideoPrerollStartTime;
-(SCD_Struct_BW7)stillTimeOffsetToVideoPrerollStopTime;
-(SCD_Struct_BW7)stillTimeOffsetToAudioPrerollStartTime;
-(SCD_Struct_BW7)stillTimeOffsetToAudioPrerollStopTime;
...
-(void)setStillImageCaptureTime:(SCD_Struct_BW7)arg1 ;
