...
@class BWRamp, NSMutableArray, BWNodeError, NSMutableDictionary, NSArray, BWNodeOutput, NSObject<OS_dispatch_queue>, BWPixelBufferPool, BWStats;
...
typedef struct {
	...
	int blinkLeft;
	int blinkRight;
	SCD_Struct_BW15 eyeRectLeft;
	SCD_Struct_BW15 eyeRectRight;
...
typedef struct {
	SCD_Struct_BW14 modelInfo;
	unsigned frameId;
	unsigned numObjects;
	SCD_Struct_BW16 objects[4];
} SCD_Struct_BW17;
...
typedef struct {
	SCD_Struct_BW24 instanceNetControl;
	SCD_Struct_BW24 exemplarNetControl;
...
typedef struct {
	SCD_Struct_BW26 instanceCrop;
	SCD_Struct_BW26 exemplarCrop;
	SCD_Struct_BW26 templateKernels[2];
	SCD_Struct_BW26 xcorrOutputs[2];
} SCD_Struct_BW27;
...
typedef struct {
	SCD_Struct_BW7 start;
	SCD_Struct_BW7 duration;
} SCD_Struct_BW38;
...
typedef struct {
	SCD_Struct_BW51 lastWideSpherePos;
	SCD_Struct_BW51 lastTeleSpherePos;
	SCD_Struct_BW51 currentTeleSpherePos;
	SCD_Struct_BW51 previousTeleSpherePos;
...
typedef struct {
	...
	unsigned field3;
	int field4;
	SCD_Struct_BW16 field5;
} SCD_Struct_BW74;

typedef struct {
	SCD_Struct_BW15 field1;
	unsigned field2;
...
typedef struct {
	unsigned maximumImageWidth;
	unsigned maximumImageHeight;
	unsigned maximumPersonMaskWidth;
	unsigned maximumPersonMaskHeight;
} SCD_Struct_BW153;
