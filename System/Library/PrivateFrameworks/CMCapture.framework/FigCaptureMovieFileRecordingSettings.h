...
@interface FigCaptureMovieFileRecordingSettings : FigCaptureRecordingSettings {
	...
	SCD_Struct_BW7 _movieFragmentInterval;
...
@property (assign,nonatomic) SCD_Struct_BW7 movieFragmentInterval;                             //@synthesize movieFragmentInterval=_movieFragmentInterval - In the implementation block
...
-(SCD_Struct_BW7)movieFragmentInterval;
-(void)setMovieFragmentInterval:(SCD_Struct_BW7)arg1 ;
