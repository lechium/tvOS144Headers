...
@interface BWFigVideoCaptureStream : NSObject <BWFigCaptureStreamStartStopDelegate> {
	...
	SCD_Struct_BW7 _lastStillImagePTS;
	SCD_Struct_BW7 _largestStillImagePTS;
	BOOL _usesStillFusionReferenceFramePTSForDidCaptureCallback;
	NSMutableArray* _stillFusionBracketFramesMetadata;
	SCD_Struct_BW7 _stillCaptureReferenceFramePTS;
...
@property (nonatomic,readonly) SCD_Struct_BW7 maxExposureDuration; 
...
@property (nonatomic,readonly) SCD_Struct_BW7 lastStillImagePTS;                                                          //@synthesize lastStillImagePTS=_lastStillImagePTS - In the implementation block
...
-(SCD_Struct_BW7)_updateMaxExposureDuration;
-(void)_updateSphereMode;
-(void)_setMaxExposureDuration:(SCD_Struct_BW7)arg1 ;
...
-(SCD_Struct_BW7)updateMaxExposureDurationClientOverride:(SCD_Struct_BW7)arg1 ;
-(SCD_Struct_BW7)updateMaxExposureDuration;
-(BOOL)hasSphere;
...
-(SCD_Struct_BW7)lastStillImagePTS;
