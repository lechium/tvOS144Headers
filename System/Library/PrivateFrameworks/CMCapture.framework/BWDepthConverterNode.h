...
@interface BWDepthConverterNode : BWNode {
	...
	SCD_Struct_BW13 _infraredCameraExtrinsicMatrix;
	int _depthAccuracy;
	BOOL _depthLensDistortionCorrectionPolynomialsAvailable;
	SCD_Struct_BW96 _depthLensDistortionCorrectionBasePolynomial;
	SCD_Struct_BW96 _depthLensDistortionCorrectionDynamicPolynomial;
...
-(int)_computeConversionParametersFromSampleBuffer:(opaqueCMSampleBufferRef)arg1 convertOptionsOut:(SCD_Struct_BW131*)arg2 ;
-(int)_convertDepthDisparityToFloat_NEON:(CVBufferRef)arg1 dst:(CVBufferRef)arg2 options:(SCD_Struct_BW131*)arg3 ;
-(int)_convertDepthDisparityToFloat_C:(CVBufferRef)arg1 dst:(CVBufferRef)arg2 options:(SCD_Struct_BW131*)arg3 ;
