...
-(SCD_Struct_BW7)_findStartMarkersWithMatchedStagedSetting:(id*)arg1 thumbnailSourcePixelBuffer:(_CVBuffer*)arg2 thumbnailSourceFinalCropRect:(CGRect*)arg3 sensorVideoPort:(const _CFString*)arg4 ;
-(int)_doStartRecordingAtTime:(SCD_Struct_BW7)arg1 withSettings:(id)arg2 thumbnailSourcePixelBuffer:(CVBufferRef)arg3 thumbnailSourceFinalCropRect:(CGRect)arg4 sensorVideoPort:(CFStringRef)arg5 ;
