...
@property (assign,nonatomic) SCD_Struct_BW7 maxDuration;                   //@synthesize maxDuration=_maxDuration - In the implementation block
...
-(SCD_Struct_BW7)maxDuration;
-(void)setMaxDuration:(SCD_Struct_BW7)arg1 ;
