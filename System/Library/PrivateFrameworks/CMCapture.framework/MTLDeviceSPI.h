/*
                       ...
                       * on Wednesday, April 14, 2021 at 2:33:43 PM Mountain Standard Time
                       * Operating System: Version 14.4 (Build 18K802)
                       * Image Source: /System/Library/PrivateFrameworks/CMCapture.framework/CMCapture
                       * classdump-dyld is licensed under GPLv3, Copyright © 2013-2016 by Elias Limneos. Updated by Kevin Bradley.
                       */

@class MTLTargetDeviceArchitecture;
...
@property (readonly) const SCD_Struct_CM60* limits; 
...
-(id)newLibraryWithCIFilters:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM61*)arg2 error:(id*)arg3;
...
-(id)newComputePipelineStateWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM61*)arg2 error:(id*)arg3;
-(id)newLibraryWithDAG:(id)arg1 functions:(id)arg2 error:(id*)arg3;
-(id)newLibraryWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM61*)arg2 error:(id*)arg3;
...
-(BOOL)mapShaderSampleBufferWithBuffer:(SCD_Struct_CM63*)arg1 capacity:(unsigned long long)arg2 size:(unsigned long long)arg3;
-(void)unmapShaderSampleBuffer;
-(id)newIndirectArgumentEncoderWithArguments:(id)arg1;
-(id)newLibraryWithCIFiltersForComputePipeline:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM61*)arg2 error:(id*)arg3;
