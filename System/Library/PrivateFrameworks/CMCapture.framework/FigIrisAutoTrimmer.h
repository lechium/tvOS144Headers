...
@interface FigIrisAutoTrimmer : NSObject {
	...
	SCD_Struct_BW93 _captureMotionDelta;
	double _captureMotionDeltaPeriod;
	BOOL _haveCaptureMotionDelta;
	SCD_Struct_BW93 _lastAttitude;
	SCD_Struct_BW93 _lastDelta;
...
-(float)computeVitalityScoreForStillImageHostPTS:(SCD_Struct_BW7)arg1 movieRange:(SCD_Struct_BW38)arg2 ;
...
-(void)_processMotionSample:(const SCD_Struct_BW93*)arg1 gravity:(const SCD_Struct_Fi128*)arg2 motionTimestamp:(double)arg3 frameTimestamp:(SCD_Struct_BW7)arg4 metadata:(id)arg5 ;
