...
-(int)_buildMetadataObjectRemoteQueueSinkPipeline:(id)arg1 graph:(id)arg2 metadataNodeOutputs:(id)arg3 videoPreviewEnabled:(BOOL)arg4 deferredPrepareEnabled:(BOOL)arg5 delegate:(id)arg6 clientAuditToken:(SCD_Struct_Fi79)arg7 ;
