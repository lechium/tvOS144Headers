...
@property (nonatomic,copy) NSArray * payloadQueries;                //@synthesize payloadQueries=_payloadQueries - In the implementation block
...
-(int)executionLevel;
-(void)setPayloadQueries:(NSArray *)arg1 ;
