...
@property (nonatomic,copy) NSString * payloadIdentityIdentifier;              //@synthesize payloadIdentityIdentifier=_payloadIdentityIdentifier - In the implementation block
...
-(void)setPayloadIdentityIdentifier:(NSString *)arg1 ;
