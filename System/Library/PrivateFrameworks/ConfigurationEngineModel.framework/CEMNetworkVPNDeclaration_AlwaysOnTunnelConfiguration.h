...
@class NSString, NSNumber, CEMNetworkVPNDeclaration_SecurityAssociationParameters, NSArray;
...
@property (nonatomic,copy) NSString * payloadProtocolType;                                                                                  //@synthesize payloadProtocolType=_payloadProtocolType - In the implementation block
...
@property (nonatomic,copy) NSArray * payloadInterfaces;                                                                                     //@synthesize payloadInterfaces=_payloadInterfaces - In the implementation block
...
-(void)setPayloadInterfaces:(NSArray *)arg1 ;
