...
@property (nonatomic,copy) NSNumber * payloadAllowBluetoothModification;              //@synthesize payloadAllowBluetoothModification=_payloadAllowBluetoothModification - In the implementation block
...
-(void)setPayloadAllowBluetoothModification:(NSNumber *)arg1 ;
