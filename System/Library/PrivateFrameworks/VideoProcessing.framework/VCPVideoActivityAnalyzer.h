...
-(float)validationScoreOfTimeRange:(SCD_Struct_VC17)arg1 fromResult:(id)arg2 startIdx:(int*)arg3 ;
-(float)actionScoreInTimeRange:(SCD_Struct_VC17)arg1 ;
-(void)validateActivityScores;
-(float)scaleBasedOnFaceForTimeRange:(SCD_Struct_VC17)arg1 ;
...
-(int)finishAnalysisPass:(SCD_Struct_VC17)arg1 fpsRate:(float)arg2 ;
@end
