...
-(void)updateWithFirstFrame:(SCD_Struct_VC17)arg1 score:(float)arg2 valid:(BOOL)arg3 ;
-(void)updateSegment:(SCD_Struct_VC17)arg1 score:(float)arg2 valid:(BOOL)arg3 ;
