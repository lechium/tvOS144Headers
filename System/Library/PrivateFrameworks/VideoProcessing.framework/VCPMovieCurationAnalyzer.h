...
-(id)initWithAnalysisTypes:(unsigned long long)arg1 transform:(CGAffineTransform)arg2 timeRange:(SCD_Struct_VC17)arg3 isLivePhoto:(BOOL)arg4 frameStats:(id)arg5 hadFlash:(BOOL)arg6 hadZoom:(BOOL)arg7 keyFrameResults:(id)arg8 ;
