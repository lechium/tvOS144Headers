...
@interface NightModeControl : NSObject {
	...
	SCD_Struct_Ni9 _status;
	SCD_Struct_Ni8 _backupSchedule;
	BOOL _statusUpdated;
...
-(BOOL)parseStatusDictionary:(id)arg1 intoStruct:(SCD_Struct_Ni11*)arg2 shouldUpdatePrefs:(BOOL*)arg3 ;
-(id)copyDictionaryFromStatus:(SCD_Struct_Ni11*)arg1 ;
