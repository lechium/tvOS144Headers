...
@interface PVLivePlayer : NSObject {
	...
	SCD_Struct_PV21 _renderTime;
	SCD_Struct_PV21 _previousSignalTime;
...
@property (nonatomic,readonly) SCD_Struct_PV21 renderTime; 
...
-(void)renderLinkSignal:(SCD_Struct_PV21)arg1 ;
...
-(void)_renderLinkSignal:(SCD_Struct_PV21)arg1 ;
