...
-(id)objectToImageTransform_NoLock:(unsigned)arg1 time:(FigTime)arg2 effectTime:(SCD_Struct_PV21)arg3 flatten:(BOOL)arg4 includeTransformAnimation:(BOOL)arg5 documentInfo:(const PVMotionDocumentInfo*)arg6 ;
...
-(PVCGPointQuad)objectCorners_NoLock:(unsigned)arg1 time:(FigTime)arg2 effectTime:(SCD_Struct_PV21)arg3 includeDropShadow:(BOOL)arg4 includeMasks:(BOOL)arg5 documentInfo:(const PVMotionDocumentInfo*)arg6 ;
-(PVCGPointQuad)transformObjectCornersToImage_NoLock:(PVCGPointQuad)arg1 objectID:(unsigned)arg2 time:(FigTime)arg3 effectTime:(SCD_Struct_PV21)arg4 flatten:(BOOL)arg5 documentInfo:(const PVMotionDocumentInfo*)arg6 ;
-(void)applyTransforms_NoLock:(id)arg1 defaultProperties:(id)arg2 time:(SCD_Struct_PV21)arg3 documentInfo:(const PVMotionDocumentInfo*)arg4 ;
...
-(id)transformObjectPointsToImage_NoLock:(id)arg1 objectID:(unsigned)arg2 time:(FigTime)arg3 effectTime:(SCD_Struct_PV21)arg4 flatten:(BOOL)arg5 documentInfo:(const PVMotionDocumentInfo*)arg6 ;
