...
-(BOOL)variesOverTime;
-(HGRef<HGNode>*)quakeHeliumNodeWithInputImage:(HGRef<HGNode>*)arg1 inputImage:(id)arg2 outputImage:(id)arg3 renderInfo:(SCD_Struct_PA83*)arg4 twist:(float)arg5 horizontalShake:(float)arg6 verticalShake:(float)arg7 layers:(float)arg8 centerX:(float)arg9 centerY:(float)arg10 randomSeed:(int)arg11 ;
@end
