...
@interface PVVideoCompositing : PVRendererBase <AVVideoCompositing> {
	...
	SCD_Struct_PV21 _videoCompositionDuration;
	...
	SCD_Struct_PV21 _schedulingTime;
...
-(void)setSchedulingTime:(SCD_Struct_PV21)arg1 ;
-(SCD_Struct_PV21)schedulingTime;
-(float)playerRate;
...
-(void)signalScheduling:(SCD_Struct_PV21)arg1 playerRate:(float)arg2 ;
