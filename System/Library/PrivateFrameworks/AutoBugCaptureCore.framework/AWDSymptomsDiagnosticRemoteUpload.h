...
@interface AWDSymptomsDiagnosticRemoteUpload : PBCodable <NSCopying> {
	...
	SCD_Struct_AW9* _primaryNetworkObservedOnCompletions;
	SCD_Struct_AW10* _taskErrorCodes;
	SCD_Struct_AW10* _taskFileSizes;
	SCD_Struct_AW9* _taskHttpStatusCodes;
	SCD_Struct_AW9* _taskRetryCounts;
	SCD_Struct_AW9* _taskStatus;
