...
@property (nonatomic,readonly) SCD_Struct_GE73* roadFeature;                        //@synthesize roadFeature=_roadFeature - In the implementation block
-(void)dealloc;
-(double)roadWidth;
...
-(void)setRoadFeature:(SCD_Struct_GE73*)arg1 ;
-(SCD_Struct_GE73*)roadFeature;
