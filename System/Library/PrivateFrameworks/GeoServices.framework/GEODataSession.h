...
+(void)asynchronousGetURL:(id)arg1 kind:(SCD_Struct_GE86)arg2 auditToken:(id)arg3 requestCounterTicket:(id)arg4 queue:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
-(id)init;
-(void)asynchronousGetURL:(id)arg1 kind:(SCD_Struct_GE86)arg2 auditToken:(id)arg3 requestCounterTicket:(id)arg4 queue:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
