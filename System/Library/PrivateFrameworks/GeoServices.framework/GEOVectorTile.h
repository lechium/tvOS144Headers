...
@interface GEOVectorTile : NSObject {
	...
	SCD_Struct_GE137* _linesLabelAnnotations;
	unsigned long long _linesLabelAnnotationCount;
	SCD_Struct_GE138* _linesAnnotationBezierVertices;
	SCD_Struct_GE73* _coastlines;
	unsigned long long _coastlinesCount;
	SCD_Struct_GE139* _polygons;
	...
	SCD_Struct_GE147* _lineStrokeSpecifications;
	unsigned long long _lineStrokeSpecificationCount;
	SCD_Struct_GE147* _polygonStrokeSpecifications;
	...
	SCD_Struct_GE138* _transitVertices;
	...
	SCD_Struct_GE138* _transitStationTransferVertices;
	...
	SCD_Struct_GE147* _transitPointsOnRoad;
	...
	SCD_Struct_GE137* _transitLinkLabelAnnotations;
	unsigned long long _transitLinkLabelAnnotationCount;
	SCD_Struct_GE138* _transitLinkAnnotationBezierVertices;
	...
	SCD_Struct_GE163* _labelSummaryIcons;
...
@property (nonatomic,readonly) SCD_Struct_GE144* threeDBuildings; 
@property (nonatomic,readonly) SCD_Struct_GE144* overlapThreeDBuildings; 
...
@property (nonatomic,readonly) SCD_Struct_GE137* linesLabelAnnotations;                               //@synthesize linesLabelAnnotations=_linesLabelAnnotations - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE138* linesAnnotationBezierVertices;                       //@synthesize linesAnnotationBezierVertices=_linesAnnotationBezierVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE139* polygons;                                            //@synthesize polygons=_polygons - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE140* venues;                                              //@synthesize venues=_venues - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE141* venueBuildings;                                      //@synthesize venueBuildings=_venueBuildings - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE138* venueVertices;                                       //@synthesize venuesVertices=_venuesVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE142* venueLevels;                                         //@synthesize venueLevels=_venueLevels - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE143* venueComponents;                                     //@synthesize venueComponents=_venueComponents - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE145* labelTextPlacements;                                 //@synthesize labelTextPlacements=_labelTextPlacements - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE146* overpasses;                                          //@synthesize overpasses=_overpasses - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE148* lineCrossings;                                       //@synthesize lineCrossings=_lineCrossings - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE147* pointsOnRoad;                                        //@synthesize pointsOnRoad=_pointsOnRoad - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE147* laneConnections;                                     //@synthesize laneConnections=_laneConnections - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE147* lineStrokeSpecifications;                            //@synthesize lineStrokeSpecifications=_lineStrokeSpecifications - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE147* polygonStrokeSpecifications;                         //@synthesize polygonStrokeSpecifications=_polygonStrokeSpecifications - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE138* lineVertices; 
...
@property (nonatomic,readonly) SCD_Struct_GE138* transitVertices;                                     //@synthesize transitVertices=_transitVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE138* transitStationTransferVertices;                      //@synthesize transitStationTransferVertices=_transitStationTransferVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE147* transitPointsOnRoad;                                 //@synthesize transitPointsOnRoad=_transitPointsOnRoad - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE137* transitLinkLabelAnnotations;                         //@synthesize transitLinkLabelAnnotations=_transitLinkLabelAnnotations - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE138* transitLinkAnnotationBezierVertices;                 //@synthesize transitLinkAnnotationBezierVertices=_transitLinkAnnotationBezierVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE163* labelSummaryIcons;                                   //@synthesize labelSummaryIcons=_labelSummaryIcons - In the implementation block
...
-(SCD_Struct_GE138*)transitVertices;
...
-(SCD_Struct_GE147*)transitPointsOnRoad;
...
-(SCD_Struct_GE138*)lineVertices;
-(SCD_Struct_GE150*)curveLineVertices;
-(SCD_Struct_GE147*)pointsOnRoad;
...
-(SCD_Struct_GE147*)lineStrokeSpecifications;
-(unsigned long long)lineStrokeSpecificationCount;
-(SCD_Struct_GE147*)polygonStrokeSpecifications;
...
-(SCD_Struct_GE138*)transitStationTransferVertices;
...
-(SCD_Struct_GE137*)transitLinkLabelAnnotations;
-(unsigned long long)transitLinkLabelAnnotationCount;
-(SCD_Struct_GE138*)transitLinkAnnotationBezierVertices;
