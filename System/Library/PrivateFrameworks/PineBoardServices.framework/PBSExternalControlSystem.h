...
@interface PBSExternalControlSystem : NSObject <CoreControlDelegate> {
	...
	CoreControlHeldChord* _muteHeldChord;
	id _domainObserver;
...
@property (nonatomic,retain) CoreControlHeldChord * muteHeldChord;                                             //@synthesize muteHeldChord=_muteHeldChord - In the implementation block
...
-(CoreControlHeldChord *)muteHeldChord;
...
-(void)setMuteHeldChord:(CoreControlHeldChord *)arg1 ;
