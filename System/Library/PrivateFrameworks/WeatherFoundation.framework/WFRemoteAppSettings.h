...
@property (nonatomic,readonly) BOOL disableForecastRequestCancelation;                               //@synthesize disableForecastRequestCancelation=_disableForecastRequestCancelation - In the implementation block
@property (nonatomic,readonly) BOOL disablePriorityForecastRequestQueue;                             //@synthesize disablePriorityForecastRequestQueue=_disablePriorityForecastRequestQueue - In the implementation block
@property (nonatomic,readonly) BOOL loadSavedCitiesFromKVSOnly;                                      //@synthesize loadSavedCitiesFromKVSOnly=_loadSavedCitiesFromKVSOnly - In the implementation block
@property (nonatomic,readonly) BOOL disableLimitReverseGeocoding;                                    //@synthesize disableLimitReverseGeocoding=_disableLimitReverseGeocoding - In the implementation block
