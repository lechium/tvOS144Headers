...
@class HalogenAudio, NSMutableData, NSCondition, HalogenCalcTypeC, NSObject, NSString;
...
-(BOOL)_doLDCMCalculation:(BOOL)arg1 isReceptacleWet:(BOOL)arg2 withWetTransitionThreshold:(double)arg3 withDryTransitionThreshold:(double)arg4 ;
