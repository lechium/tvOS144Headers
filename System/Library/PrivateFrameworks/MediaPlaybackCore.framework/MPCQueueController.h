...
@property (nonatomic,copy,readonly) NSString * revisionString; 
@property (nonatomic,retain) id rtcSessionHierarchyToken;                                                  //@synthesize rtcSessionHierarchyToken=_rtcSessionHierarchyToken - In the implementation block
...
-(void)finalizeStateRestorationWithCompletion:(/*^block*/id)arg1 ;
-(void)clearUpNext;
