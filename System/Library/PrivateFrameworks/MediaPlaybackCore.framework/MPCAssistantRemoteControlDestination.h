...
-(void)resolveWithHashedRouteIdentifiers:(id)arg1 audioRoutingInfo:(SCD_Struct_MP8)arg2 completion:(/*^block*/id)arg3 ;
-(void)resolveWithQueue:(id)arg1 hashedRouteIdentifiers:(id)arg2 localPlaybackPermitted:(BOOL)arg3 audioRoutingInfo:(SCD_Struct_MP8)arg4 completion:(/*^block*/id)arg5 ;
-(void)resolveWithRouteIdentifiers:(id)arg1 audioRoutingInfo:(SCD_Struct_MP8)arg2 completion:(/*^block*/id)arg3 ;
-(void)resolveWithQueue:(id)arg1 routeIdentifiers:(id)arg2 localPlaybackPermitted:(BOOL)arg3 audioRoutingInfo:(SCD_Struct_MP8)arg4 completion:(/*^block*/id)arg5 ;
