...
@interface MPCPlayerRequest : MPRequest <MPCMediaRemoteMiddlewareMetadataOperationConfiguration> {
	...
	SCD_Struct_MP9 _tracklistRange;
...
@property (assign,nonatomic) SCD_Struct_MP9 tracklistRange;                           //@synthesize tracklistRange=_tracklistRange - In the implementation block
...
-(void)setTracklistRange:(SCD_Struct_MP9)arg1 ;
