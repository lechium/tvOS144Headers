...
#import <libobjc.A.dylib/SFWatchListCardSection.h>
@class NSArray, NSString, SFColor, SFWatchListItem, NSDictionary, NSData;
...
@class NSArray, NSString, SFColor, SFWatchListItem, NSDictionary, NSData, SFCard, SFUserReportRequest, SFCommand;
...
@property (nonatomic,retain) SFWatchListItem * watchListItem;                        //@synthesize watchListItem=_watchListItem - In the implementation block
@property (nonatomic,readonly) NSDictionary * dictionaryRepresentation; 
@property (nonatomic,readonly) NSData * jsonData; 
