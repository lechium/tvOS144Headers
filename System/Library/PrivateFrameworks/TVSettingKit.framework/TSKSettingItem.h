...
@interface TSKSettingItem : NSObject {
	...
	BOOL _hidden;
	BOOL _sortsByTitle;
	BOOL _minimizeTruncationOfLocalizedValue;
	BOOL _readOnly;
	...
	id<TSKDynamicDeepLinkKey> _dynamicDeepLinkKey;
...
@property (nonatomic,retain) id<TSKDynamicDeepLinkKey> dynamicDeepLinkKey;                             //@synthesize dynamicDeepLinkKey=_dynamicDeepLinkKey - In the implementation block
...
@property (assign,nonatomic) BOOL minimizeTruncationOfLocalizedValue;                                  //@synthesize minimizeTruncationOfLocalizedValue=_minimizeTruncationOfLocalizedValue - In the implementation block
...
-(BOOL)sortsByTitle;
-(BOOL)minimizeTruncationOfLocalizedValue;
-(void)setMinimizeTruncationOfLocalizedValue:(BOOL)arg1 ;
-(NSString *)deepLinkKey;
-(void)setDeepLinkKey:(NSString *)arg1 ;
-(id<TSKDynamicDeepLinkKey>)dynamicDeepLinkKey;
-(void)setDynamicDeepLinkKey:(id<TSKDynamicDeepLinkKey>)arg1 ;
