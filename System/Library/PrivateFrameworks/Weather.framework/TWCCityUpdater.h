...
@class NSLocale, WALocationPrivacySampler, WAForecastModelController, NSString;
...
@property (nonatomic,readonly) WALocationPrivacySampler * locationGeocodingSampler;              //@synthesize locationGeocodingSampler=_locationGeocodingSampler - In the implementation block
