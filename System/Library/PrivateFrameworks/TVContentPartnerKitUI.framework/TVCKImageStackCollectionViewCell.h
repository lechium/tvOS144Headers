...
@class UIMotionEffectGroup, _UIStackedImageContainerView, TVStackedImageView, NSString, UIView, UILabel, UIColor, UIFont, _UIStackedImageConfiguration;
...
@interface TVCKImageStackCollectionViewCell : UICollectionViewCell {
	...
	TVStackedImageView* _imageStackView;
	NSString* _title;
...
@property (nonatomic,retain) TVStackedImageView * imageStackView;                                                                                                   //@synthesize imageStackView=_imageStackView - In the implementation block
...
-(void)setImageStackView:(TVStackedImageView *)arg1 ;
-(TVStackedImageView *)imageStackView;
