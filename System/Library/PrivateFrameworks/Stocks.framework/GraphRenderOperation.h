...
@property (assign,nonatomic) SCD_Struct_St7* volumeBars;                                    //@synthesize volumeBars=_volumeBars - In the implementation block
...
-(void)setVolumeBars:(SCD_Struct_St7*)arg1 ;
