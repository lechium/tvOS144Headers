...
-(void)sendWRMStatusUpdate:(const SCD_Struct_VC111*)arg1 ;
...
-(void)callAlarmsWithRTPTimeStamp:(SCD_Struct_AV88*)arg1 ;
-(void)processResolutionChangeToVideoRule:(id)arg1 captureRule:(id)arg2 featuresListString:(id)arg3 ;
-(BOOL)onCaptureFrame:(opaqueCMSampleBufferRef)arg1 audioTS:(unsigned)arg2 audioHT:(double)arg3 videoHT:(SCD_Struct_AV88)arg4 cameraBits:(unsigned char)arg5 ;
...
-(void)onPlayVideo:(CVBufferRef)arg1 frameTime:(SCD_Struct_AV88)arg2 cameraStatusBits:(unsigned char)arg3 ;
