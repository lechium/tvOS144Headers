...
typedef struct {
	...
	SCD_Struct_VC115 report;
	SCD_Struct_VC118 dropAck;
	SCD_Struct_VC117) codecRateChange;
} SCD_Struct_VC119;
...
typedef struct VCMediaStreamTransportSetupInfo {
	...
	/*function pointer*/void* ;
	SCD_Struct_VC148 socketInfo;
	SCD_Struct_VC150 ipInfo;
	SCD_Struct_VC149 transportStreamInfo;
	id nwConnection;
...
typedef struct tagWRMMetricsInfo {
	...
	SCD_Struct_VC174 wrmMetricsReportingContext;
