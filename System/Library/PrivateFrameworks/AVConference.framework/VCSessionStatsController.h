...
-(void)sendLocalStats;
-(void)triggerRateControlWithLocalSessionStats:(SCD_Struct_VC83)arg1 time:(double)arg2 forUplink:(BOOL)arg3 forDownlink:(BOOL)arg4 fromVCRCExternalThread:(BOOL)arg5 ;
-(BOOL)isRemoteSessionStatsTooLateWithStatsId:(unsigned short)arg1 ;
-(unsigned short)translateTimestampFromMicro:(double)arg1 ;
-(void)handleRemoteSessionStats:(SCD_Struct_VC170*)arg1 ;
-(void)healthPrintForServerStats;
-(void)calculateInterCallbackDurationWithTime:(double)arg1 ;
-(void)updateRemoteSessionStats:(SCD_Struct_VC169)arg1 ;
