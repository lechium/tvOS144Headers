...
@property (nonatomic,readonly) BOOL isParticipantVersionPeace;                                     //@synthesize isParticipantVersionPeace=_isParticipantVersionPeace - In the implementation block
...
-(void)vcMediaStream:(id)arg1 didReceiveFirstVideoFrameWithTime:(SCD_Struct_AV88)arg2 ;
