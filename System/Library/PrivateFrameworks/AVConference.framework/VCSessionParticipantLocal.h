...
@property (assign,nonatomic) BOOL isRemoteOnPeace;                                               //@synthesize isRemoteOnPeace=_isRemoteOnPeace - In the implementation block
...
-(void)updateVideoStreamAndProcessFrame:(id)arg1 sampleBuffer:(opaqueCMSampleBufferRef)arg2 lastSentAudioHostTime:(double)arg3 lastSentAudioSampleTime:(unsigned)arg4 frameTime:(SCD_Struct_AV88)arg5 attribute:(SCD_Struct_Vi128)arg6 ;
