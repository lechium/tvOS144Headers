...
@interface VCBitrateArbiter : NSObject {
	...
	unsigned _maxAllowedBitrateHighRat;
...
@property (readonly) unsigned maxAllowedBitrateHighRat;              //@synthesize maxAllowedBitrateHighRat=_maxAllowedBitrateHighRat - In the implementation block
