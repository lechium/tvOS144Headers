...
@interface VCMovieWriter : NSObject <VCMovieWriterProtocol> {
	...
	SCD_Struct_AV88 _lastVideoPresentationTime;
	SCD_Struct_AV88 _lastLocalAudioPresentationTime;
	SCD_Struct_AV88 _lastRemoteAudioPresentationTime;
	SCD_Struct_AV88 _startTime;
	SCD_Struct_AV88 _stillImageTime;
...
-(void)setupInputs;
-(void)processSampleQueue:(opaqueCMBufferQueueRef)arg1 input:(id)arg2 lastPresentationTime:(SCD_Struct_AV88*)arg3 ;
-(void)startWritingAtTime:(SCD_Struct_AV88)arg1 ;
-(void)appendMetaData;
-(void)setupInput:(id)arg1 queue:(opaqueCMBufferQueueRef)arg2 dispatchGroup:(id)arg3 lastPresentationTime:(SCD_Struct_AV88*)arg4 ;
