...
@interface VCVideoTransmitterBase : NSObject <VCConnectionChangedHandler> {
	...
	SCD_Struct_AV88 _latestSampleBufferTimestamp;
...
@property (assign) SCD_Struct_AV88 lastFrameTime;                                    //@synthesize latestSampleBufferTimestamp=_latestSampleBufferTimestamp - In the implementation block
...
-(void)startVideo;
-(void)stopVideo;
-(BOOL)enqueueVideoFrame:(opaqueCMSampleBufferRef)arg1 frameTime:(SCD_Struct_AV88)arg2 cameraStatusBits:(unsigned char)arg3 ;
...
-(SCD_Struct_AV88)lastFrameTime;
-(void)setLastFrameTime:(SCD_Struct_AV88)arg1 ;
