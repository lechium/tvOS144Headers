...
@property (assign,setter=setiRATDuplicationEnabled:,nonatomic) BOOL iRATDuplicationEnabled;                    //@synthesize iRATDuplicationEnabled=_iRATDuplicationEnabled - In the implementation block
