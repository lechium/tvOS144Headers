...
@interface AVCVideoDataOutput : NSObject {
	...
	SCD_Struct_AV146 _videoAttributes;
	id _delegate;
...
@property (assign,nonatomic) SCD_Struct_AV147 videoAttributes;                                //@synthesize videoAttributes=_videoAttributes - In the implementation block
...
-(SCD_Struct_AV147)videoAttributes;
-(void)setVideoAttributes:(SCD_Struct_AV147)arg1 ;
