...
@interface CallSegment : NSObject {
	...
	SCD_Struct_Ca2 _linkProbingConfig;
...
@property (assign) NSNumber * wrmLinkTypeWifiRSSIThreshold;                                    //@synthesize wrmLinkTypeWifiRSSIThreshold=_wrmLinkTypeWifiRSSIThreshold - In the implementation block
...
@property (assign) NSNumber * wrmLinkTypeWifiRemoteRSSIThreshold;                              //@synthesize wrmLinkTypeWifiRemoteRSSIThreshold=_wrmLinkTypeWifiRemoteRSSIThreshold - In the implementation block
...
-(NSNumber *)wrmLinkTypeWifiRSSIThreshold;
-(void)setWrmLinkTypeWifiRSSIThreshold:(NSNumber *)arg1 ;
...
-(NSNumber *)wrmLinkTypeWifiRemoteRSSIThreshold;
-(void)setWrmLinkTypeWifiRemoteRSSIThreshold:(NSNumber *)arg1 ;
