...
@class AVCaptureDeviceInput, AVCaptureVideoDataOutput, NSObject, AVCaptureSession, AVCaptureDataOutputSynchronizer, NSMutableArray, AVCaptureMetadataOutput, AVCaptureDepthDataOutput, AVCaptureDevice, VCImageResizingConverter, VCImageRotationConverter, VCImageMirroringConverter, NSString;
...
-(BOOL)isFrontCamera;
-(void)updateVideoCaptureServerWithSampleBuffer:(opaqueCMSampleBufferRef)arg1 time:(SCD_Struct_AV88)arg2 frontCamera:(BOOL)arg3 shouldMirrorFrontPreview:(BOOL)arg4 isFromEffects:(BOOL)arg5 ;
...
-(opaqueCMSampleBufferRef)newResizedFrame:(opaqueCMSampleBufferRef)arg1 time:(SCD_Struct_AV88)arg2 ;
...
-(SCD_Struct_AV88)frameDurationForVideoDeviceFormat:(id)arg1 frameRate:(int)arg2 ;
