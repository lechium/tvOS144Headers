...
@interface CLIPSShim : NSObject {
	...
	SCD_Struct_CL43* _consoleNameRegex;
	SCD_Struct_CL43* _dumpStringRegex;
...
@property (assign,nonatomic) SCD_Struct_CL44* consoleNameRegex;                    //@synthesize consoleNameRegex=_consoleNameRegex - In the implementation block
@property (assign,nonatomic) SCD_Struct_CL44* dumpStringRegex;                     //@synthesize dumpStringRegex=_dumpStringRegex - In the implementation block
...
-(SCD_Struct_CL44*)consoleNameRegex;
-(void)setConsoleNameRegex:(SCD_Struct_CL44*)arg1 ;
-(SCD_Struct_CL44*)dumpStringRegex;
-(void)setDumpStringRegex:(SCD_Struct_CL44*)arg1 ;
