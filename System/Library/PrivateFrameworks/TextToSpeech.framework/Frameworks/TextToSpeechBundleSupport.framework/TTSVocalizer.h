...
@property (assign,nonatomic) long long speechGender;                                  //@synthesize speechGender=_speechGender - In the implementation block
-(void)dealloc;
-(void)stopSynthesis;
...
-(unsigned)_ttsVocalizerCopyAvailableVoiceInfo:(const _CFArray*)arg1 ;
