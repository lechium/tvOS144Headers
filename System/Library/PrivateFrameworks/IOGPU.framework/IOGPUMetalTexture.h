...
@property (readonly) SCD_Struct_IO22 swizzle; 
...
-(SCD_Struct_IO22)swizzle;
-(id)formattedDescription:(unsigned long long)arg1 ;
-(unsigned long long)rotation;
-(unsigned)swizzleKey;
-(BOOL)isDrawable;
-(unsigned long long)numFaces;
-(id)initWithTextureInternal:(id)arg1 pixelFormat:(unsigned long long)arg2 textureType:(unsigned long long)arg3 levels:(NSRange)arg4 slices:(NSRange)arg5 swizzle:(SCD_Struct_IO22)arg6 compressedView:(BOOL)arg7 ;
...
-(id)initWithTexture:(id)arg1 pixelFormat:(unsigned long long)arg2 textureType:(unsigned long long)arg3 levels:(NSRange)arg4 slices:(NSRange)arg5 swizzle:(SCD_Struct_IO22)arg6 ;
