...
-(id)_outputLoudnessRangeWithDetectionTime:(SCD_Struct_VE9)arg1 ;
-(BOOL)_setupAndStartReadingTrack:(id)arg1 usingTimeRange:(SCD_Struct_VE9)arg2 outputSettings:(id)arg3 assetReader:(id*)arg4 trackOutput:(id*)arg5 error:(id*)arg6 ;
...
-(void)_stopDetectingLoudnessWithTimeRange:(SCD_Struct_VE9)arg1 loudnessRanges:(id*)arg2 ;
