...
@interface VideoMovie : Movie <NSCoding, NSCopying> {
	...
	SCD_Struct_TV3 _cachedPreciseAssetDuration;
...
@property (assign,nonatomic) SCD_Struct_TV3 cachedPreciseAssetDuration;                //@synthesize cachedPreciseAssetDuration=_cachedPreciseAssetDuration - In the implementation block
...
-(void)setCachedPreciseAssetDuration:(SCD_Struct_TV3)arg1 ;
...
-(SCD_Struct_TV3)cachedPreciseAssetDuration;
