...
@interface EditListCompositionState : NSObject <NSCopying> {
	...
	SCD_Struct_VE9 m_videoCompTimeRange;
	SCD_Struct_VE9 m_audioCompTimeRange;
...
@property (assign,nonatomic) SCD_Struct_VE9 videoCompTimeRange; 
@property (assign,nonatomic) SCD_Struct_VE9 audioCompTimeRange; 
...
-(SCD_Struct_VE9)videoCompTimeRange;
-(void)setVideoCompTimeRange:(SCD_Struct_VE9)arg1 ;
-(SCD_Struct_VE9)audioCompTimeRange;
-(void)setAudioCompTimeRange:(SCD_Struct_VE9)arg1 ;
