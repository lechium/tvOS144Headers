...
@class HMFUnfairLock, NSMutableDictionary, NSUUID, NSObject, HMFMessageDispatcher, NSNotificationCenter, HMDHome, HMDHomeMediaSystemControllerMessageHandler, HMDStereoPairDailyCountProvider, NSArray, NSString;
...
@property (readonly) HMDStereoPairDailyCountProvider * stereoPairDailyCountProvider;              //@synthesize stereoPairDailyCountProvider=_stereoPairDailyCountProvider - In the implementation block
...
-(HMDStereoPairDailyCountProvider *)stereoPairDailyCountProvider;
@end
