...
@class HMDBackingStore, NSArray, HMDDevice, NSUUID, HMFMessageDispatcher, HMDLogEventDispatcher, NSMutableArray, HMDUser, NSString, HMFTimer, NSMutableSet, NSMapTable, HMDNetworkRouterClientManager, HMDAccessoryNetworkProtectionGroupRegistry, NSMutableDictionary, HMDHomeKitVersion, HMHomePersonManagerSettings, HMDNaturalLightingContext, HMDHomeObjectLookup, HMDHomeManager, HMDHomeLocationHandler, HMUserPresenceAuthorization, HMUserPresenceCompute, HMDHomeAdministratorHandler, NSDate, HMDHomeRemoteNotificationHandler, HMDHomePresenceMonitor, HMDUserPresenceFeeder, HMDHomeMediaSystemHandler, HMDHomePeriodicReader, HMDUserActionPredictionManager, HMDHomeNaturalLightingCurveWriter, NSHashTable, HMDApplicationData, HMDHomeReprovisionHandler, HMDHomePersonDataManager, HMDHomeNaturalLightingContextUpdater, HMDBonjourBrowserHelper, HMDHomeObjectChangeHandler, NSObject, HMDRelayManager, HMDRoom, HMDNotificationRegistry, HMDResidentDeviceManager, HMDSharedHomeUpdateHandler, HMDResidentDevice, HMDPredicateUtilities, HMDMediaActionRouter, HMDResidentReachabilityNotificationManager, HMDAccessoryCount, HMDHAPAccessory, HMFMessageDestination, HMDAccessory, NSSet, HMDHomePersonManager;
...
@property (nonatomic,retain) HMDBonjourBrowserHelper * borderRouterBrowser;                                              //@synthesize borderRouterBrowser=_borderRouterBrowser - In the implementation block
...
@property (nonatomic,readonly) NSString * unfilteredThreadNetworkID;                                                     //@synthesize unfilteredThreadNetworkID=_unfilteredThreadNetworkID - In the implementation block
@property (assign,nonatomic) unsigned long long threadNetworkSequenceNumber;                                             //@synthesize threadNetworkSequenceNumber=_threadNetworkSequenceNumber - In the implementation block
...
@property (copy,readonly) NSArray * mediaDestinations; 
...
@property (copy,readonly) NSSet * notificationRegistrations; 
@property (copy,readonly) NSSet * notificationDeregistrations; 
...
-(void)_registerCameraReachabilityEventNotificationsWithCompletionHandler:(/*^block*/id)arg1 ;
-(void)_registerResidentReachabilityNotificationWithEnableAccessories:(id)arg1 disableAccessories:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)_readCharacteristicValuesForAccessories:(id)arg1 readRequestMap:(id)arg2 responseTuples:(id)arg3 requestMessage:(id)arg4 source:(unsigned long long)arg5 viaDevice:(id)arg6 completionHandler:(/*^block*/id)arg7 ;
...
-(HMDBonjourBrowserHelper *)borderRouterBrowser;
...
-(void)registerCameraReachabilityEventNotificationsWithCompletionHandler:(/*^block*/id)arg1 ;
-(void)setCameraReachabilityEventNotificationsEnabled:(BOOL)arg1 forAccessory:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)setBorderRouterBrowser:(HMDBonjourBrowserHelper *)arg1 ;
...
-(void)_startThreadNetworkWithCompletion:(/*^block*/id)arg1 ;
-(void)_unjoinThreadNetworkWithCompletion:(/*^block*/id)arg1 ;
-(void)_incrementCurrentSequenceNumber;
-(void)_retryStartThreadNetwork:(double)arg1 ;
-(BOOL)_isCurrentThreadNetwork;
