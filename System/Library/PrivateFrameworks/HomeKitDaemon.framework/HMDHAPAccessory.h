...
@property (nonatomic,readonly) BOOL supportsThreadCommissioning;                                                   //@synthesize supportsThreadCommissioning=_supportsThreadCommissioning - In the implementation block
