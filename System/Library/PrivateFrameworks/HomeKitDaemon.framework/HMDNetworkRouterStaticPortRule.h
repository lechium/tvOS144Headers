...
@class HMDNetworkRouterRuleDirection, HMDNetworkRouterLANIdentifierList, HMDNetworkRouterProtocol, HMDNetworkRouterIPAddress, HAPTLVUnsignedNumberValue, NSString;
...
@property (nonatomic,retain) HAPTLVUnsignedNumberValue * destinationPortStart;                   //@synthesize destinationPortStart=_destinationPortStart - In the implementation block
@property (nonatomic,retain) HAPTLVUnsignedNumberValue * destinationPortEnd;                     //@synthesize destinationPortEnd=_destinationPortEnd - In the implementation block
...
-(void)setDestinationPortStart:(HAPTLVUnsignedNumberValue *)arg1 ;
-(void)setDestinationPortEnd:(HAPTLVUnsignedNumberValue *)arg1 ;
