...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x0000000000005ba8
...
- (void)setupRawReportHandling;	// IMP=0x0000000000006420
- (void)dispatchAlternateHomeButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000006324
- (id)initWithService:(unsigned int)arg1;	// IMP=0x0000000000005cf8
