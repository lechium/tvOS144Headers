...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000053ac
...
- (id)description;	// IMP=0x0000000000005268
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x000000000000504c
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000004fac
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000004df8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000054fc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000053b4
