...
- (void).cxx_destruct;	// IMP=0x0000000100010b9c
...
- (void)_callElapsedTimeObserversDueToTimeJump:(_Bool)arg1;	// IMP=0x00000001000107b8
- (void)_fireElapsedTimeUpdate:(id)arg1;	// IMP=0x00000001000107a8
- (void)_updateElapsedTimeTimer;	// IMP=0x00000001000106cc
@property(readonly, nonatomic) double elapsedTime;
- (float)_rateForState:(id)arg1;	// IMP=0x00000001000102ac
...
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x0000000100010008
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x0000000100010004
- (void)updateSubtitleOptions;	// IMP=0x0000000100010000
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x000000010000fffc
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000fff4
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000ffec
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x000000010000ff78
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x000000010000feb0
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x000000010000fe5c
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x000000010000fe50
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2;	// IMP=0x000000010000fe44
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x000000010000fe38
- (void)setElapsedTime:(double)arg1;	// IMP=0x000000010000fd38
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000fd2c
- (void)stop;	// IMP=0x000000010000fc9c
- (void)scanWithRate:(double)arg1;	// IMP=0x000000010000fb2c
- (void)togglePlayPause;	// IMP=0x000000010000fae4
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000fad8
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000facc
- (void)pause;	// IMP=0x000000010000fa84
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000fa78
- (void)play;	// IMP=0x000000010000f98c
- (void)continueLoadingCurrentItem;	// IMP=0x000000010000f988
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x000000010000f91c
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x000000010000f90c
- (void)setLastElapsedTime:(double)arg1 atTimestamp:(id)arg2;	// IMP=0x000000010000f898
- (void)invalidate;	// IMP=0x000000010000f864
- (id)initWithName:(id)arg1;	// IMP=0x000000010000f77c
- (id)init;	// IMP=0x000000010000f76c
