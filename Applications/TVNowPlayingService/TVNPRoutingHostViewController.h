...
+ (id)_remoteViewControllerInterface;	// IMP=0x000000010000592c
+ (id)_exportedInterface;	// IMP=0x000000010000582c
- (void).cxx_destruct;	// IMP=0x00000001000059e0
...
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0000000100005948
- (void)viewServiceEndPresentationWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000056ec
- (void)viewServiceHandleMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000001000056e8
- (void)viewServiceBeginPresentationWithOptions:(id)arg1;	// IMP=0x00000001000053e4
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100005188
