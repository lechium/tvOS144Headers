...
- (void).cxx_destruct;	// IMP=0x0000000100008ab4
...
- (id)_indexPathForCurrentDestination;	// IMP=0x0000000100008854
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x0000000100008148
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x0000000100008068
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x000000010000805c
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000100007acc
- (struct CGPoint)collectionView:(id)arg1 targetContentOffsetForProposedContentOffset:(struct CGPoint)arg2;	// IMP=0x0000000100007a38
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100007748
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100007458
- (_Bool)_ignoreVolumeChangesWhilePendingSelection;	// IMP=0x00000001000072f0
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)arg1;	// IMP=0x0000000100007090
- (void)updateCollectionViewWithDestinations:(id)arg1;	// IMP=0x0000000100006d7c
- (void)viewDidLayoutSubviews;	// IMP=0x0000000100006834
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000001000067a0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100006428
- (void)viewDidLoad;	// IMP=0x0000000100006034
- (void)dealloc;	// IMP=0x0000000100005f7c
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x0000000100005d94
