...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0000000100028b10
- (void).cxx_destruct;	// IMP=0x000000010002b304
...
- (id)_preloadArtwork;	// IMP=0x000000010002b0f4
- (id)_placeholderArtwork;	// IMP=0x000000010002b020
- (void)_updateState;	// IMP=0x000000010002ae8c
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000010002adcc
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000010002a978
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000010002a870
- (void)_updateMetadata;	// IMP=0x0000000100029714
- (void)_createRequestController;	// IMP=0x00000001000292a4
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000100029068
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000100028f58
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000100028ca8
- (void)playPause;	// IMP=0x0000000100028c94
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000100028c38
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100028b9c
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000100028abc
- (id)playerPath;	// IMP=0x0000000100028a10
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x00000001000288d0
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000100028664
