...
- (id)_unfocusedProgressColor;	// IMP=0x0000000100003dac
- (id)_focusedProgressColor;	// IMP=0x0000000100003d28
- (void)_rightPressed:(id)arg1;	// IMP=0x0000000100003cc4
- (void)_leftPressed:(id)arg1;	// IMP=0x0000000100003c60
- (void)_panUpdated:(id)arg1;	// IMP=0x00000001000039f8
- (void)_menuPressed;	// IMP=0x00000001000039f4
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000039f0
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000039e8
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000039e0
- (_Bool)shouldTrack;	// IMP=0x00000001000039d8
- (double)maxBarWidth;	// IMP=0x00000001000039c8
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x00000001000039a0
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100003758
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100003730
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000010000371c
- (void)layoutSubviews;	// IMP=0x0000000100003488
- (_Bool)canBecomeFocused;	// IMP=0x0000000100003480
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100002ed8
