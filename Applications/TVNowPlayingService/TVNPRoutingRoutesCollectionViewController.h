...
- (void).cxx_destruct;	// IMP=0x0000000100021bb4
...
- (void)_pickRoute:(id)arg1;	// IMP=0x00000001000217a4
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0000000100021710
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x00000001000215e0
- (void)_calculateVisibleVolumeCells;	// IMP=0x00000001000212b0
- (void)_cleanupRouteForVolumeIfNeeded;	// IMP=0x00000001000211a0
- (id)_gradientMask;	// IMP=0x0000000100020d70
- (void)routeCellDidSelectAccessoryView:(id)arg1;	// IMP=0x0000000100020cac
- (void)routeCellDidSelectRouteView:(id)arg1;	// IMP=0x0000000100020684
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x000000010002066c
- (void)shareAudioSelected;	// IMP=0x00000001000205d8
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x0000000100020398
- (void)longPressSelect:(id)arg1;	// IMP=0x00000001000202dc
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x0000000100020200
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x00000001000200e8
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x000000010001ffd0
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x000000010001ff94
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000010001fd30
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x000000010001fbf0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010001fb04
- (void)handleVolumeDown;	// IMP=0x000000010001f7ac
- (void)handleVolumeUp;	// IMP=0x000000010001f454
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x000000010001e914
- (void)viewDidLayoutSubviews;	// IMP=0x000000010001e6d4
- (void)viewDidLoad;	// IMP=0x000000010001dcc0
- (void)dealloc;	// IMP=0x000000010001dc70
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x000000010001db7c
