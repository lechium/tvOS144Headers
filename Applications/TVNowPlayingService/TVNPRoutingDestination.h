...
- (void).cxx_destruct;	// IMP=0x000000010000f6dc
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000010000f5c0
- (void)connectAndPair;	// IMP=0x000000010000f5bc
- (void)togglePlayPause;	// IMP=0x000000010000f5b8
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000010000f584
- (id)init;	// IMP=0x000000010000f56c
