...
+ (id)_destinationLayout;	// IMP=0x0000000100018988
...
- (id)_routesLayout;	// IMP=0x0000000100018a88
- (void)_updateHintText;	// IMP=0x0000000100017c30
- (void)_updateTitleView;	// IMP=0x0000000100017b88
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100017a9c
- (void)didPressPlayPause:(id)arg1;	// IMP=0x0000000100017a28
- (void)didPressMenu:(id)arg1;	// IMP=0x00000001000179b4
- (void)routingViewController:(id)arg1 shareAudioPresentationRequested:(id)arg2;	// IMP=0x000000010001799c
- (void)routingViewControllerWillEndEditingVolume:(id)arg1;	// IMP=0x000000010001794c
- (void)routingViewControllerWillBeginEditingVolume:(id)arg1;	// IMP=0x00000001000178f8
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x00000001000178a0
- (id)preferredFocusEnvironments;	// IMP=0x0000000100017828
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000001000177d0
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000100017778
- (void)viewDidLoad;	// IMP=0x0000000100016b54
- (void)dealloc;	// IMP=0x0000000100016a08
- (id)initWithRoutingController:(id)arg1 options:(id)arg2;	// IMP=0x0000000100016468
