...
+ (Class)layoutAttributesClass;	// IMP=0x000000010001d588
- (void).cxx_destruct;	// IMP=0x000000010001d99c
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000010001d874
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000010001d6dc
- (void)prepareLayout;	// IMP=0x000000010001d594
