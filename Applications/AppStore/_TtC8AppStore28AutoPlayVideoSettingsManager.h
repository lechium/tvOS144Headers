...
- (void).cxx_destruct;	// IMP=0x00000001000fa45c
- (void)saveFullScreenAudioSettings;	// IMP=0x00000001000fb260
- (void)restoreFullScreenAudioSettings;	// IMP=0x00000001000fb25c
- (void)updateAutoPlayVideoSettings;	// IMP=0x00000001000faf04
- (void)dealloc;	// IMP=0x00000001000fa3b0
- (id)init;	// IMP=0x00000001000fa300
