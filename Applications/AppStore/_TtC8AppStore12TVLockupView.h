...
- (void).cxx_destruct;	// IMP=0x00000001001360b8
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100135ed4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100135ac0
- (void)layoutSubviews;	// IMP=0x0000000100135a94
@property(nonatomic, readonly) struct CGRect jet_focusedFrame;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001357c4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001001357a4
