...
- (void).cxx_destruct;	// IMP=0x00000001000a8898
...
- (void)prepareForReuse;	// IMP=0x00000001000a877c
@property(nonatomic, readonly) struct CGSize intrinsicContentSize;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000a8560
- (id)_preferredConfigurationForFocusAnimation:(long long)arg1 inContext:(id)arg2;	// IMP=0x00000001000a847c
- (void)layoutSubviews;	// IMP=0x00000001000a80c8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000a7c4c
