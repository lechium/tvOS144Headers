...
- (void).cxx_destruct;	// IMP=0x00000001000d1628
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000d15c8
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000d148c
- (void)layoutSubviews;	// IMP=0x00000001000d10d4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000d09ec
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000001000d0948
@property(nonatomic, readonly) NSArray *preferredFocusEnvironments;
@property(nonatomic, readonly) _Bool canBecomeFocused;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000d0260
