...
- (void).cxx_destruct;	// IMP=0x00000001000a1b00
- (id)init;	// IMP=0x00000001000a1b78
- (void)animateTransition:(id)arg1;	// IMP=0x00000001000a1134
- (double)transitionDuration:(id)arg1;	// IMP=0x00000001000a1008
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x00000001000a0ff8
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x00000001000a0f5c
