...
- (void).cxx_destruct;	// IMP=0x000000010009b1a8
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010009b074
@property(nonatomic, readonly) struct CGSize intrinsicContentSize;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010009af04
- (void)layoutSubviews;	// IMP=0x000000010009aed8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010009ac50
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010009ac30
