...
- (void).cxx_destruct;	// IMP=0x000000010006a368
@property(nonatomic, readonly) _Bool canBecomeFocused;
- (void)willMoveToSuperview:(id)arg1;	// IMP=0x000000010006a2dc
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010006a11c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010006a104
- (void)layoutSubviews;	// IMP=0x000000010006a0d8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100069848
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100069828
