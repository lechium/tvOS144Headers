...
- (void).cxx_destruct;	// IMP=0x00000001000b1254
...
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000b1098
@property(nonatomic, readonly) struct CGRect jet_focusedFrame;
- (void)prepareForReuse;	// IMP=0x00000001000b0ce4
- (void)layoutSubviews;	// IMP=0x00000001000b0bf8
@property(nonatomic) struct CATransform3D transform3D;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000b0610
