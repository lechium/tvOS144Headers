...
+ (id)labelWithFont:(id)arg1 andColor:(id)arg2;	// IMP=0x0000000100027bbc
- (void).cxx_destruct;	// IMP=0x0000000100027d78
...
- (void)_addLayoutContraintsForSubviews;	// IMP=0x00000001000278b8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100027494
