...
+ (void)initialize;	// IMP=0x0000000100049344
- (void).cxx_destruct;	// IMP=0x000000010004a16c
...
- (_Bool)_isPresentableStepAfterCurrentlyActiveStep:(id)arg1;	// IMP=0x0000000100049f38
- (id)_presentedStepClassesToSteps;	// IMP=0x0000000100049de4
- (void)_removeAllStepsTillStep:(id)arg1;	// IMP=0x0000000100049ce4
- (_Bool)_wasStepPresented:(id)arg1;	// IMP=0x0000000100049bc8
- (void)_configurePresentableStep:(id)arg1 withViewController:(id)arg2;	// IMP=0x00000001000497e0
- (void)popToStepViewControllerForStep:(id)arg1;	// IMP=0x0000000100049644
- (void)presentStepViewController:(id)arg1 forStep:(id)arg2;	// IMP=0x00000001000494bc
- (id)viewControllerForStepClass:(Class)arg1;	// IMP=0x0000000100049488
- (id)initWithNavigationController:(id)arg1 flowStepClasses:(id)arg2;	// IMP=0x00000001000493a8
