...
- (void).cxx_destruct;	// IMP=0x0000000100018e90
...
- (_Bool)_isFactoryActivated;	// IMP=0x0000000100018af0
- (void)_stopObservingWiFiInterfaceChanges;	// IMP=0x00000001000188ec
- (void)_observeWiFiInterfaceChanges;	// IMP=0x00000001000186ec
- (void)_stopObservingEthernetlInterfaceChanges;	// IMP=0x00000001000184b4
- (void)_observeEthernetInterfaceChanges;	// IMP=0x0000000100018280
- (void)_pushNetworkConfigurationController;	// IMP=0x0000000100018170
- (void)_pushWiFiController;	// IMP=0x0000000100017ca8
- (void)_forgetCurrentWiFiNetwork;	// IMP=0x0000000100017b74
- (void)_wiFiConnectionFailed;	// IMP=0x0000000100017998
- (void)_ethernetConnectionFailed;	// IMP=0x00000001000177bc
- (void)_connectionSucceeded;	// IMP=0x00000001000176a0
- (void)_presentReachabilityErrorIsWiFi:(_Bool)arg1 withOKAction:(CDUnknownBlockType)arg2;	// IMP=0x000000010001710c
- (void)_cancelInterfaceAvailabilityTimer;	// IMP=0x00000001000170c8
- (void)_startInterfaceAvailabilityTimerIfNeeded;	// IMP=0x0000000100016ed4
- (void)_testReachabilityForWifi;	// IMP=0x0000000100016c24
- (void)_testReachabilityForEthernet;	// IMP=0x0000000100016974
- (void)_testReachabilityForActiveInterfaceIfPossible;	// IMP=0x00000001000166fc
- (void)_hideActivityIndicator;	// IMP=0x00000001000166bc
- (void)_showActivityIndicator;	// IMP=0x000000010001667c
- (void)didCompleteNetworkConfiguration;	// IMP=0x000000010001657c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100016268
- (void)viewDidLayoutSubviews;	// IMP=0x000000010001610c
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000001000160bc
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000100016010
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100015f90
- (void)loadView;	// IMP=0x0000000100015b70
- (void)autoAdvance;	// IMP=0x0000000100015af0
- (void)dealloc;	// IMP=0x0000000100015a84
- (id)init;	// IMP=0x00000001000159b0
