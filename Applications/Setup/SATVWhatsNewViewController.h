...
+ (void)initialize;	// IMP=0x0000000100052728
...
- (void)_callCompletionHandler;	// IMP=0x0000000100052d8c
- (void)_updateDisplayPostFetchWithStatus:(_Bool)arg1 viewController:(id)arg2 error:(id)arg3;	// IMP=0x0000000100052b74
- (void)_beginWhatsNewTask;	// IMP=0x00000001000528ac
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100052838
- (void)viewDidLoad;	// IMP=0x00000001000527e8
