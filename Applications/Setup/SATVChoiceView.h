...
- (void).cxx_destruct;	// IMP=0x0000000100073af0
...
- (void)_setUpUI;	// IMP=0x0000000100073520
- (void)_didSelectAuxiliaryButton;	// IMP=0x00000001000734cc
- (void)_didSelectFooterButton;	// IMP=0x0000000100073478
- (void)_didSelectButton:(id)arg1;	// IMP=0x00000001000733b4
- (_Bool)_hasAuxiliaryButton;	// IMP=0x00000001000732a4
- (_Bool)_hasFooterButton;	// IMP=0x0000000100073194
- (id)_newFooterButton;	// IMP=0x00000001000730e8
- (id)_newDefaultButton;	// IMP=0x0000000100072e50
- (id)_choiceHeaderButton;	// IMP=0x0000000100072e18
- (void)_populateView;	// IMP=0x0000000100072508
- (struct CGSize)_computeFramesForBounds:(struct CGRect)arg1 forCalculationOnly:(_Bool)arg2;	// IMP=0x0000000100071890
- (void)setChoice:(unsigned long long)arg1 enabled:(_Bool)arg2;	// IMP=0x0000000100071758
- (void)reloadData;	// IMP=0x000000010007174c
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100071570
- (_Bool)canBecomeFocused;	// IMP=0x00000001000714ec
- (id)preferredFocusEnvironments;	// IMP=0x000000010007139c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100071378
- (void)layoutSubviews;	// IMP=0x0000000100071314
@property(readonly, nonatomic) UIView *buttonContainerView;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000712b0
- (id)initWithChoiceViewStyle:(long long)arg1 frame:(struct CGRect)arg2;	// IMP=0x0000000100071248
