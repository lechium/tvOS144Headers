...
- (void).cxx_destruct;	// IMP=0x0000000100010490
...
- (void)viewController:(id)arg1 connectedToNetwork:(id)arg2;	// IMP=0x0000000100010388
- (void)_didSelectMenu;	// IMP=0x0000000100010308
- (void)viewDidLoad;	// IMP=0x0000000100010138
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000001000100dc
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000010001007c
- (void)loadView;	// IMP=0x000000010000f888
