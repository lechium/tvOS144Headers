...
+ (id)activationEngineWithOverrideActivationURL:(id)arg1 sessionURL:(id)arg2;	// IMP=0x000000010002b258
- (void).cxx_destruct;	// IMP=0x000000010002d100
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000010002ce18
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010002cb50
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x000000010002cab0
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010002c9e0
- (void)makeRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002c8ac
- (void)tryActivateWithOptions:(id)arg1 requestMutator:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010002c4a0
- (void)_sendSessionRequest:(id)arg1 withOptions:(id)arg2;	// IMP=0x000000010002bb38
- (id)_newActivationRequestWithOptions:(id)arg1 sessionData:(id)arg2 error:(id *)arg3;	// IMP=0x000000010002b59c
@property(readonly, nonatomic) NSURLSession *session;
- (void)_cleanup;	// IMP=0x000000010002b440
- (void)cancel;	// IMP=0x000000010002b370
- (id)initWithOverrideActivationURL:(id)arg1 sessionURL:(id)arg2;	// IMP=0x000000010002b2cc
