...
- (void).cxx_destruct;	// IMP=0x00000001000395ec
...
- (id)_labelFont;	// IMP=0x0000000100039414
- (id)hiddenDigitImage;	// IMP=0x0000000100039170
- (id)arrowImage:(_Bool)arg1;	// IMP=0x0000000100038f50
- (void)downGesture:(id)arg1;	// IMP=0x0000000100038e28
- (void)upGesture:(id)arg1;	// IMP=0x0000000100038d14
@property(copy, nonatomic) NSString *text;
- (void)setHighlightProgress:(double)arg1;	// IMP=0x0000000100038c08
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100038ad0
- (_Bool)canBecomeFocused;	// IMP=0x0000000100038ac8
- (void)layoutSubviews;	// IMP=0x0000000100038850
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100038250
