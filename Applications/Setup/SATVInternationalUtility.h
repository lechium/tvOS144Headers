...
+ (id)sharedInstance;	// IMP=0x000000010000d570
...
- (id)_pairingHelpStringWithString:(id)arg1;	// IMP=0x000000010000ee94
- (id)_orderedLanguageStringsForKey:(id)arg1;	// IMP=0x000000010000ecb0
- (void)_generateLanguageCodes;	// IMP=0x000000010000e8c0
- (void)_notifyPineBoard;	// IMP=0x000000010000e85c
- (id)localizedString:(id)arg1 forLanguage:(id)arg2;	// IMP=0x000000010000e584
@property(nonatomic) _Bool localeCommitted;
@property(nonatomic) _Bool languageCommitted;
- (_Bool)commitLanguageWillRestartSystem;	// IMP=0x000000010000e218
- (void)commitRegion;	// IMP=0x000000010000e160
- (_Bool)commitLocaleWillRestartSystem;	// IMP=0x000000010000dfe4
- (void)commitLanguage;	// IMP=0x000000010000de20
- (id)regionOtherStringWithUserSelectedLanguageCode;	// IMP=0x000000010000ddb8
- (id)regionHeaderStringWithUserSelectedLanguageCode;	// IMP=0x000000010000dd50
@property(readonly, nonatomic) NSArray *orderedGreetingLanguageCodes;
- (id)languageCodeWithGuessedRegionForCode:(id)arg1;	// IMP=0x000000010000db98
- (id)languageHeaderStringForLanguageCode:(id)arg1;	// IMP=0x000000010000db80
