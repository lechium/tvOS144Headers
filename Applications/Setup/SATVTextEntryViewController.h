...
- (void).cxx_destruct;	// IMP=0x0000000100007590
...
- (void)_submitButtonAction:(id)arg1;	// IMP=0x00000001000073e0
- (void)_handleMenuButton:(id)arg1;	// IMP=0x000000010000737c
- (void)_textChanged;	// IMP=0x00000001000072a8
- (id)preferredFocusEnvironments;	// IMP=0x0000000100007234
- (void)_doneButtonPressed:(id)arg1;	// IMP=0x0000000100006de0
- (_Bool)_enableAutomaticKeyboardPressDone;	// IMP=0x0000000100006dd8
- (_Bool)_disableAutomaticKeyboardUI;	// IMP=0x0000000100006dd0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100006d60
- (void)loadView;	// IMP=0x00000001000068c8
