...
- (void).cxx_destruct;	// IMP=0x000000010006ab38
...
- (void)_setSystemInputView:(id)arg1;	// IMP=0x000000010006a92c
- (id)_createButtonStackView;	// IMP=0x000000010006a864
- (id)_buildDialogueColumnStackView;	// IMP=0x000000010006a644
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010006a4f0
- (void)setPreferredFocusedEnvironmentForGridLayoutGuide:(id)arg1;	// IMP=0x000000010006a3f8
- (void)setSystemInputView:(id)arg1 touchInputEnabled:(_Bool)arg2;	// IMP=0x0000000100069f40
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100069890
