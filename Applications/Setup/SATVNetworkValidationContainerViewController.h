...
- (void).cxx_destruct;	// IMP=0x000000010007ad3c
...
- (id)preferredFocusEnvironments;	// IMP=0x000000010007aa14
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010007a9a0
- (void)viewDidLoad;	// IMP=0x000000010007a86c
- (void)autoAdvance;	// IMP=0x000000010007a82c
