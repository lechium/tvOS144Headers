...
- (void).cxx_destruct;	// IMP=0x000000010007a74c
...
- (void)_setSystemInputView:(id)arg1;	// IMP=0x000000010007a58c
- (void)_gridAlignFrame:(struct CGRect *)arg1;	// IMP=0x000000010007a54c
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010007a3f8
- (void)layoutSubviews;	// IMP=0x00000001000799b4
- (void)updateConstraints;	// IMP=0x000000010007962c
- (id)preferredFocusedViewForGridLayoutGuide;	// IMP=0x0000000100079594
- (void)setSystemInputView:(id)arg1 touchInputEnabled:(_Bool)arg2;	// IMP=0x0000000100079374
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100078e84
