...
- (void).cxx_destruct;	// IMP=0x000000010005b238
@property(readonly, nonatomic) id <TVSKPrefetchStep> bundlePrefetchStep; // @synthesize bundlePrefetchStep=_bundlePrefetchStep;
- (void)triggerStatusDidChangeForTriggers:(id)arg1 context:(id)arg2;	// IMP=0x000000010005b1a0
- (id)triggers;	// IMP=0x000000010005b14c
- (id)init;	// IMP=0x000000010005b058
