...
- (void).cxx_destruct;	// IMP=0x000000010007054c
...
- (void)tableView:(id)arg1 didUnfocusRowAtIndexPath:(id)arg2;	// IMP=0x0000000100070388
- (void)tableView:(id)arg1 didFocusRowAtIndexPath:(id)arg2;	// IMP=0x0000000100070304
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x000000010006ffac
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x000000010006fc78
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x000000010006fc50
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x000000010006fc48
@property(readonly, nonatomic) struct CGSize sizeThatFits;
- (id)preferredFocusEnvironments;	// IMP=0x000000010006fb28
- (void)viewDidLayoutSubviews;	// IMP=0x000000010006f92c
- (void)loadView;	// IMP=0x000000010006f4a8
