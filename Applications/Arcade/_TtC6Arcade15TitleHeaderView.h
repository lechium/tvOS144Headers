...
- (void).cxx_destruct;	// IMP=0x000000010013d3ac
@property(nonatomic, readonly) NSArray *preferredFocusEnvironments;
@property(nonatomic, readonly) _Bool canBecomeFocused;
- (id)_accessibilitySupplementaryFooterViews;	// IMP=0x000000010013d0c4
@property(nonatomic) unsigned long long accessibilityTraits;
@property(nonatomic) _Bool isAccessibilityElement;
@property(nonatomic, copy) NSString *accessibilityLabel;
- (void)prepareForReuse;	// IMP=0x000000010013c954
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010013c718
- (void)layoutSubviews;	// IMP=0x000000010013c6ec
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010013b094
- (void)didTapWithAccessoryView:(id)arg1;	// IMP=0x000000010013acf0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100139924
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100139904
