...
- (void).cxx_destruct;	// IMP=0x00000001000f499c
- (void)saveFullScreenAudioSettings;	// IMP=0x00000001000f57a0
- (void)restoreFullScreenAudioSettings;	// IMP=0x00000001000f579c
- (void)updateAutoPlayVideoSettings;	// IMP=0x00000001000f5444
- (void)dealloc;	// IMP=0x00000001000f48f0
- (id)init;	// IMP=0x00000001000f4840
