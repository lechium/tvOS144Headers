...
- (void).cxx_destruct;	// IMP=0x00000001000a8bf4
...
- (void)prepareForReuse;	// IMP=0x00000001000a8ad8
@property(nonatomic, readonly) struct CGSize intrinsicContentSize;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000a88bc
- (id)_preferredConfigurationForFocusAnimation:(long long)arg1 inContext:(id)arg2;	// IMP=0x00000001000a87d8
- (void)layoutSubviews;	// IMP=0x00000001000a8424
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000a7fa8
