...
- (void).cxx_destruct;	// IMP=0x0000000100064078
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100063f78
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100063e60
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100063c60
- (void)prepareForReuse;	// IMP=0x0000000100063be4
@property(nonatomic, readonly) struct CGRect jet_focusedFrame;
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000639b4
@property(nonatomic, readonly) _Bool canBecomeFocused;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100062774
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100062754
