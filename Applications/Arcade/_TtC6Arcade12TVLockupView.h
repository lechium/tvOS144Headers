...
- (void).cxx_destruct;	// IMP=0x0000000100134624
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100134440
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010013402c
- (void)layoutSubviews;	// IMP=0x0000000100134000
@property(nonatomic, readonly) struct CGRect jet_focusedFrame;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100133d30
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100133d10
